...
def parse_reporter_info(environment):
    ...
    reporter_info["user_email"] = environment["GITLAB_USER_EMAIL"].strip("\"")
    reporter_info["user_fullname"] = environment["GITLAB_USER_NAME"].strip("\"")
    reporter_info["workload_factor"] = environment["EXACB_WORKLOAD_FACTOR"].strip("\"")
