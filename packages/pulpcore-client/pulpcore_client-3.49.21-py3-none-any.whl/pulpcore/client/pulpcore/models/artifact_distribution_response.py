...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, pulp_created=None, name=None, pulp_labels=None, content_guard=None, base_url=None, hidden=False, pulp_href=None, pulp_last_updated=None, base_path=None, local_vars_configuration=None):  # noqa: E501
