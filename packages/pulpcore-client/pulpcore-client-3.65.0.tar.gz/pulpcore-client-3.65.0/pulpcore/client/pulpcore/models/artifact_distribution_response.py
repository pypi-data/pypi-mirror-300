...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, hidden=False, pulp_href=None, prn=None, content_guard=None, name=None, pulp_last_updated=None, pulp_labels=None, base_url=None, pulp_created=None, no_content_change_since=None, base_path=None, local_vars_configuration=None):  # noqa: E501
