...
def config_generator(model_save_path: str, warmup_epochs: int = None, lr_milestones: list = None,
                     ...
                     auto_save: int = 10, if_mix: bool = False, initial_rate: float = None, final_rate: float = None, cov: object = None,
    ...
    if if_mix and cov is not None:
        ...
        if initial_rate is not None and final_rate is not None and event_rate is not None:
            raise ValueError("Can't using two mix strategy at the same time")
        ...
        elif initial_rate is None and final_rate is None and event_rate is not None:
