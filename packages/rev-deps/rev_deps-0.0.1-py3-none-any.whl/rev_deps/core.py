...
def _rev_deps(project: str) -> Iterator[str]:
    ...
    json_api_sub_folder = f'/json/projects/{project}/rdepends{starting_page_query}'
    ...
    while True:
        ...
        if not json_api_sub_folder or json_api_sub_folder.endswith(starting_page_query):
            break
