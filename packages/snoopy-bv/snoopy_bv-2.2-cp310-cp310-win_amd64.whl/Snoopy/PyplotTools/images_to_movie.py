...
def pictures_2_movie( pictures = "pic_%03d.png", output = "movie",  ffmpeg_path = "ffmpeg", cleanPictures = True, engine = "cv2", fps = 25 ):
    ...
    if engine == "ffmeg":
        ...
        video = cv2.VideoWriter( f"{output:}.mp4", fourcc, fps, (width,height))
