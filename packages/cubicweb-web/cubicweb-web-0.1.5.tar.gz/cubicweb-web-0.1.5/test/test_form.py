...
class EntityFieldsFormTC(CubicWebTC):
    ...
    def _test_richtextfield(self, req, expected):
        ...
        form.field_by_name("description", "subject").format = (
            lambda form, field=None: "text/html"
        )
    ...
    def test_filefield(self):
        ...
        with self.admin_access.web_request() as req:
            ...
            self.assertMultiLineEqual(
                ...
                f"""<input id="data-subject:%(eid)s" name="data-subject:%(eid)s" type="file" value="" />
<a href="javascript: toggleVisibility(&#39;data-subject:%(eid)s-advanced&#39;)" title="show advanced fields"><img src="{BASE_URL}data/puce_down.png" alt="show advanced fields"/></a>
