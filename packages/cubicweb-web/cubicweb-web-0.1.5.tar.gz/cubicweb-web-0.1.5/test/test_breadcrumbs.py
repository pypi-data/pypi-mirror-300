...
class BreadCrumbsTC(CubicWebTC):
    def test_base(self):
        with self.admin_access.web_request() as req:
            ...
            self.assertEqual(
                f2.view("breadcrumbs"),
                f'<a href="{BASE_URL}folder/{f2.eid}" title="">' f"chi&amp;ld</a>",
            )
            ...
            self.assertMultiLineEqual(
                f'<span id="breadcrumbs" class="pathbar">&#160;&gt;&#160;'
                f'<a href="{BASE_URL}Folder">Folder_plural</a>'
                f'&#160;&gt;&#160;<a href="{BASE_URL}folder/{f1.eid}" '
                f'title="">par&amp;ent</a>&#160;&gt;&#160;\n'
                f'<a href="{BASE_URL}folder/{f2.eid}" title="">'
                f"chi&amp;ld</a></span>",
                "".join(f_list),
            )
