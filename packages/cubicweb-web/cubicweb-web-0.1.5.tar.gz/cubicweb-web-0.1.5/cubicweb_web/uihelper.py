...
.. autofunction:: cubicweb_web.uihelper.append_to_addmenu
.. autofunction:: cubicweb_web.uihelper.remove_from_addmenu


and a few other ones for *form configuration*:

.. autofunction:: cubicweb_web.uihelper.set_fields_order
.. autofunction:: cubicweb_web.uihelper.hide_field
.. autofunction:: cubicweb_web.uihelper.hide_fields
.. autofunction:: cubicweb_web.uihelper.set_field_kwargs
.. autofunction:: cubicweb_web.uihelper.set_field
.. autofunction:: cubicweb_web.uihelper.edit_inline
.. autofunction:: cubicweb_web.uihelper.edit_as_attr
.. autofunction:: cubicweb_web.uihelper.set_muledit_editable
...
.. autoclass:: cubicweb_web.uihelper.FormConfig
...
class FormConfig(metaclass=meta_formconfig):
    """helper base class to define uicfg rules on a given entity type.
        ...
        **Attributes**
        ...
        :attr:`uicfg_afs`
          an instance of ``cubicweb_web.uicfg.AutoformSectionRelationTags``
          Default is None, meaning ``cubicweb_web.uicfg.autoform_section`` is used.

        :attr:`uicfg_aff`
          an instance of ``cubicweb_web.uicfg.AutoformFieldTags``
          Default is None, meaning ``cubicweb_web.uicfg.autoform_field`` is used.

        :attr:`uicfg_affk`
          an instance of ``cubicweb_web.uicfg.AutoformFieldKwargsTags``
          Default is None, meaning ``cubicweb_web.uicfg.autoform_field_kwargs`` is used.
