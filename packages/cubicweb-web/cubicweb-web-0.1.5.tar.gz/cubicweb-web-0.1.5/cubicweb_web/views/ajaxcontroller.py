...
.. autoclass:: cubicweb_web.views.ajaxcontroller.AjaxController
   :members:
...
with the :func:`~cubicweb_web.views.ajaxcontroller.ajaxfunc` decorator:
...
or inherit from :class:`~cubicweb_web.views.ajaxcontroller.AjaxFunction` and
...
.. autoclass:: cubicweb_web.views.ajaxcontroller.AjaxFunction
   :members:

.. autofunction:: cubicweb_web.views.ajaxcontroller.ajaxfunc
...
class AjaxController(Controller):
    ...
    and will itself select the :class:`cubicweb_web.views.ajaxcontroller.AjaxFunction`
