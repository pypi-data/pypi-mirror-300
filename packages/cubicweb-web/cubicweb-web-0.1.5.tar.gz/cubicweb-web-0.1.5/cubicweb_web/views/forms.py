...
.. autoclass:: cubicweb_web.views.forms.FieldsForm
.. autoclass:: cubicweb_web.views.forms.EntityFieldsForm
...
.. autoclass:: cubicweb_web.views.forms.CompositeForm
...
class FieldsForm(form.Form):
    ...
    **Attributes**
    ...
    :attr:`needs_js`
      ...
      (through :meth:`~cubicweb_web.request.Request.add_js`)

    :attr:`needs_css`
      sequence of css files that should be added to handle this form (through
      :meth:`~cubicweb_web.request.Request.add_css`)
    ...
    :attr:`form_buttons`
      sequence of form control (:class:`~cubicweb_web.formwidgets.Button`
      widgets instances)
    ...
    **Generic methods**
    ...
    .. automethod:: cubicweb_web.form.Form.field_by_name(name, role=None)
    .. automethod:: cubicweb_web.form.Form.fields_by_name(name, role=None)

    **Form construction methods**

    .. automethod:: cubicweb_web.form.Form.remove_field(field)
    .. automethod:: cubicweb_web.form.Form.append_field(field)
    .. automethod:: cubicweb_web.form.Form.insert_field_before(field, name, role=None)
    .. automethod:: cubicweb_web.form.Form.insert_field_after(field, name, role=None)
    .. automethod:: cubicweb_web.form.Form.add_hidden(name, value=None, **kwargs)

    **Form rendering methods**

    .. automethod:: cubicweb_web.views.forms.FieldsForm.render
    ...
    **Form posting methods**
    ...
    .. automethod:: cubicweb_web.views.forms.FieldsForm.process_posted
    .. automethod:: cubicweb_web.views.forms.FieldsForm.iter_modified_fields
    """
...
class EntityFieldsForm(FieldsForm):
    ...
    generic :class:`~cubicweb_web.views.editcontroller.EditController`.
    """
