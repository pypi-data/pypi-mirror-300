...
setuptools.setup(
    name='pollination-sandbox-solar-irradiance',                                     # will be used for package name
    ...
    url='https://github.com/pollination/sandbox-solar-irradiance',                   # will be translated to home
    project_urls={
    ...
    description='A recipe to assess average solar irradiance beneath Sandbox Solar agrivoltaic panels.',                  # will be used as package description
    ...
    keywords='honeybee, radiance, ladybug-tools, daylight, sandbox-solar-irradiance',# will be used as keywords
