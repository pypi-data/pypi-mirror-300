...
class OrderManagementApi(object):
    ...
    def cancel_orders_and_move_remaining(self, request_body, **kwargs):  # noqa: E501
    ...
    def cancel_orders_and_move_remaining_with_http_info(self, request_body, **kwargs):  # noqa: E501
        """[EARLY ACCESS] CancelOrdersAndMoveRemaining: Cancel existing orders and move any unplaced quantities to new orders in new blocks  # noqa: E501
        ...
        :return: Returns the result object, the HTTP status code, and the headers.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: (CancelOrdersAndMoveRemainingResponse, int, HTTPHeaderDict)
        """
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method cancel_orders_and_move_remaining" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'request_body' is set
        if self.api_client.client_side_validation and ('request_body' not in local_var_params or  # noqa: E501
                                                        local_var_params['request_body'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `request_body` when calling `cancel_orders_and_move_remaining`")  # noqa: E501
