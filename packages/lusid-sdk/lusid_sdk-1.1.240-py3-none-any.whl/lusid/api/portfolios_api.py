...
class PortfoliosApi(object):
    ...
    def batch_upsert_portfolio_access_metadata(self, request_body, **kwargs):  # noqa: E501
        ...
        >>> thread = api.batch_upsert_portfolio_access_metadata(request_body, async_req=True)
        >>> result = thread.get()
        ...
        return self.batch_upsert_portfolio_access_metadata_with_http_info(request_body, **kwargs)  # noqa: E501

    def batch_upsert_portfolio_access_metadata_with_http_info(self, request_body, **kwargs):  # noqa: E501
        """[EARLY ACCESS] BatchUpsertPortfolioAccessMetadata: Upsert multiple Portfolio Access Metadata Rules to multiple Portfolios  # noqa: E501
        ...
        >>> thread = api.batch_upsert_portfolio_access_metadata_with_http_info(request_body, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object, the HTTP status code, and the headers.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: (BatchUpsertPortfolioAccessMetadataResponse, int, HTTPHeaderDict)
        """
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method batch_upsert_portfolio_access_metadata" % key
                )
        ...
        if self.api_client.client_side_validation and ('request_body' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `request_body` when calling `batch_upsert_portfolio_access_metadata`")  # noqa: E501
