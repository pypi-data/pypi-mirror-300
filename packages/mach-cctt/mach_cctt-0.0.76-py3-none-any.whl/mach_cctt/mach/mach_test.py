...
async def run(
    ...
    delayed_transaction_logger = make_logger(
        "delayed_transactions", False, log_files.get("delayed_transactions", None)
    )
    stuck_transaction_logger = make_logger(
        "stuck_transactions", False, log_files.get("stuck_transactions", None)
    )
    improper_fill_logger = make_logger(
        "improper_fills", False, log_files.get("improper_fills", None)
    )
    slippage_logger = make_logger("slippage_manager", True, log_files["slippage"])
