...
from planqk.client.job_dtos import JobDto, JOB_STATUS, JOB_FINAL_STATES
...
class PlanqkBaseJob(ABC):
    ...
    def _result(self) -> any:
        ...
        status = PlanqkBaseJob._status(self)
    ...
    def _wait_for_final_state(self, timeout: Optional[float] = None, wait: float = 5) -> JOB_STATUS:
    ...
    def _status(self, use_cached_value: bool = False) -> JOB_STATUS:
        """
