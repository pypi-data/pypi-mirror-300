...
class ProcCore:
    ...
    def start_proc(self, proc_name:str, func, *func_args, **func_kwargs):
        ...
        Make sure the proc_name is unique and is not "__core__" or "__all__".
        Make sure your function has parmas::this_proc at last to handle shared data of processing.
        """
        assert not proc_name in ["__core__", "__all__"]
        ...
        assert get_func_args_name(func)[-1] == "this_proc"
...
class ProcChild(Process):
    ...
    def __init__(
        ...
        self.self_pipe, self.target_pipe = Pipe()
    ...
    def send_msg(self, target_name, command, data=None, pipe:ConnectionClass|None=None):
    ...
    def recv_msg(self):
        ...
        return (sender_name, command, data)
    ...
    def get_from_shared_list(self, idx):
