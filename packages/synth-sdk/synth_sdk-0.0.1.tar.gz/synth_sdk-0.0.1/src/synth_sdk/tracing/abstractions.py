...
def send_trajectory_traces(traces: List[TrajectoryTrace], base_url: str, email: str, password: str) -> requests.Response:
    token_url = f"{base_url}/token"
    token_response = requests.post(token_url, data={"username": email, "password": password})
