<template>
  <div class="w-full h-full flex flex-col gap-2">
    <div class="compliance-step bg-white w-full border border-transparent rounded-md">
      ...
      <div class="compliance-step-content compliance-status w-full flex p-[0.75rem] gap-2">
        <div class="compliance-step-content-el-name flex items-center">Status</div>
        <div class="compliance-step-content-el-value py-[0.25rem] px-[0.75rem]">Confirmed</div>
      </div>
    </div>
    <div class="compliance-step bg-white w-full border border-transparent rounded-md">
      <div class="compliance-step-header flex justify-between py-[1rem] px-[0.75rem]">
      ...
      <div class="compliance-step-content w-full flex flex-col">
        <div class="compliance-step-content-header-wrap w-full flex items-center">
          ...
          <div class="compliance-step-content-col w-6/12">
            <div class="compliance-step-content-col-header px-[0.75rem] py-[0.5rem] uppercase">Supplier Restrictions</div>
          </div>
        </div>
      ...
      <div class="compliance-step-content-divider py-[0.5rem] px-[0.75rem] uppercase">Aircraft Recent Destinations</div>
      <div class="compliance-step-content w-full flex flex-col">
        <div class="compliance-step-content-destination-el flex w-full py-5 px-[0.75rem]" v-for="el in mockDestinations">
      ...
      <div class="compliance-step-content-divider py-[0.5rem] px-[0.75rem] uppercase">Fuel-Related NOTAMs</div>
      <div class="compliance-step-content w-full flex flex-col">
        <div class="compliance-step-content-activity border-0 rounded-lg pl-[0.75rem] flex" v-for="activity in mockActivity"
          :key="activity.date">
          ...
          <div class="compliance-step-info-wrap p-[0.75rem] flex flex-col">
      ...
      <div class="compliance-step-content w-full flex py-8 px-[0.75rem] flex flex-col" v-if="isLoadingCompliance">
        <Loading />
      </div>
    </div>
    <div class="compliance-step bg-white w-full border border-transparent rounded-md">
      ...
      <div class="compliance-step-content compliance-credit w-full flex p-[0.75rem] gap-2">
        <div class="compliance-credit-wrap flex w-full">
          <div class="compliance-credit-confirmed w-full flex flex-col gap-4"
            ...
            <div class="compliance-credit-confirmed-value pl-[0.5rem]">
          ...
          <div class="compliance-credit-open w-full flex flex-col gap-4"
            ...
            <div class="compliance-credit-open-value pl-[0.5rem]">
          ...
          <div class="compliance-credit-maximum w-full flex flex-col gap-4"
            ...
            <div class="compliance-credit-maximum-value pl-[0.5rem]">
              <div class="compliance-credit-maximum-value-name">Uplift Exposure (Maximum)</div>
              {{ mockCredit.maximum }}
            </div>
            <div class="compliance-credit-maximum-popup px-[0.75rem] py-[0.25rem]">Credit Limit:
              <span>{{ mockCredit.limit }}</span>
              <div class="compliance-credit-maximum-popup-line"></div>
              <div class="compliance-credit-maximum-popup-dot"></div>
            </div>
          </div>
          <div class="compliance-credit-remaining w-full flex flex-col gap-4" v-if="overuse === 0"
            ...
            <div class="compliance-credit-remaining-value pl-[0.5rem]">
              <div class="compliance-credit-remaining-value-name">Credit Remaining</div>
              {{ remaining }}
            </div>
            <div class="compliance-credit-remaining-popup px-[0.75rem] py-[0.25rem]">Total Credit Exposure (Maximum):
              <span>{{ use }}</span>
              <div class="compliance-credit-remaining-popup-line"></div>
              <div class="compliance-credit-remaining-popup-dot"></div>
            </div>
          </div>
          <div class="compliance-credit-overuse w-full flex flex-col gap-4" v-else
            ...
            <div class="compliance-credit-overuse-value pl-[0.5rem]">
              <div class="compliance-credit-overuse-value-name">Credit Overuse</div>
              {{ overuse }}
            </div>
            <div class="compliance-credit-overuse-popup px-[0.75rem] py-[0.25rem]">Total Credit Exposure (Maximum):
              <span>{{ capacity }}</span>
              <div class="compliance-credit-overuse-popup-line"></div>
              <div class="compliance-credit-overuse-popup-dot"></div>
            </div>
          </div>
        </div>
      </div>
...
const use = computed(() => mockCredit.value.maximum + mockCredit.value.confirmed + mockCredit.value.open);
