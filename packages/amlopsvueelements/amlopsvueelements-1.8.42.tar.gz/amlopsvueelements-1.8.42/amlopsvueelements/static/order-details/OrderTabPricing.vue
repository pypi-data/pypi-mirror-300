<template>
  <div class="w-full h-full flex flex-col gap-2">
    <SupplyFuelDetailsModal :is-open="isModalOpened" ref="clientInput" @modal-close="closeModal"
      :supply-fuel="supplyFuel" :result-index="selectedModalSupplier!" :is-open-release="order?.type.is_fuel && order?.fuel_order?.is_open_release" name="supply-modal" />
      ...
      <div class="pricing-step-content" v-if="orderPricing && order && orderPricing.supplier_id">
        ...
        <div class="pricing-step-content-element flex">
          ...
          <div class="pricing-step-content-element-wrap flex w-4/12 py-[0.5rem] pl-[0.75rem] el-border-light">
            ...
            <div class="pricing-step-content-element-el flex w-full justify-start items-center">
              ...
              {{ orderPricing?.fuel_pricing?.supplier?.unit_price_pricing_unit?.currency?.code }}</div>
          </div>
        ...
        <div class="pricing-step-content-element flex" v-for="(fee, key) in orderPricing.fees" :key="key"
          ...
          <div class="pricing-step-content-element-wrap flex w-4/12 py-[0.5rem] pl-[0.75rem] el-border-light">
            ...
            <div class="pricing-step-content-element-el flex w-full justify-start items-center">{{
              formatNumber(parseFloat(fee.supplier?.amount_total).toFixed(2)) }} {{ fee.supplier?.unit_price_pricing_unit?.currency?.code
              }}</div>
          </div>
          <div class="pricing-step-content-element-wrap flex w-4/12 py-[0.5rem] pl-[0.75rem]">
            <div class="pricing-step-content-element-el flex w-full justify-start items-center">
          ...
          <div class="pricing-step-content-results-wrap flex w-4/12 py-[0.5rem]">
            ...
            <div class="pricing-step-content-results-el-value flex w-full p-1 justify-start items-center">{{
              formatNumber(orderPricing?.pricing_summary?.supplier_total) }} {{
                orderPricing?.fuel_pricing?.supplier?.unit_price_pricing_unit?.currency?.code }}
            </div>
          </div>
          <div class="pricing-step-content-results-wrap flex w-4/12 py-[0.5rem]">
            <div
            ...
            <div class="pricing-step-content-results-el-value flex w-full p-1 justify-start items-center">{{
              formatNumber(orderPricing?.pricing_summary?.client_total) }} {{
                orderPricing?.fuel_pricing?.client?.unit_price_pricing_unit?.currency?.code }}
            </div>
          </div>
        </div>
    ...
    <div class="pricing-step bg-white w-full border border-transparent rounded-md">
      <div class="pricing-step-header flex justify-between py-[1rem] px-[0.75rem]">
        <div class="pricing-step-header-name">{{ order?.fuel_order?.is_open_release ? 'Indicative' : '' }} ROI Calculation
        </div>
        <div class="loading-wrap">
