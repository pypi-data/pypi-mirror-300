<template>
  <div class="pricing-step bg-white w-full border border-transparent rounded-md">
    <div class="pricing-step-header flex justify-between py-[0.5rem] px-[0.75rem]">
    ...
    <div class="pricing-step-content w-full flex flex-col" v-if="mockCRM.length">
      <div class="pricing-step-content-header-wrap w-full flex items-center">
        ...
        <div class="pricing-step-content-col w-1/12">
          <div class="pricing-step-content-col-header px-[0.75rem] py-[0.5rem]">Opportunity / order</div>
        </div>
        <div class="pricing-step-content-col w-2/12">
          <div class="pricing-step-content-col-header px-[0.75rem] py-[0.5rem]">Applicable person</div>
        </div>
      ...
      <div class="pricing-step-content-data-wrap selected-supplier w-full flex items-center"
        ...
        <div class="pricing-step-content-col w-1/12">
          <div class="pricing-step-content-col-data px-[0.75rem] py-[0.5rem] flex gap-1 items-center">
        ...
        <div class="pricing-step-content-col w-1/12">
          <div class="pricing-step-content-col-data px-[0.75rem] py-[0.5rem]">{{ activity.date }}</div>
        </div>
        <div class="pricing-step-content-col w-1/12">
          <div class="pricing-step-content-col-data px-[0.75rem] py-[0.5rem]">{{ activity.activity_type }}</div>
        </div>
        <div class="pricing-step-content-col w-1/12">
          <div class="pricing-step-content-col-data px-[0.75rem] py-[0.5rem]">{{ activity.opportunity ?? '--' }}</div>
        </div>
        <div class="pricing-step-content-col w-2/12">
          <div class="pricing-step-content-col-data px-[0.75rem] py-[0.5rem]">{{ activity.person ?? '--' }}</div>
        </div>
        <div class="pricing-step-content-col w-4/12">
          <div class="pricing-step-content-col-data px-[0.75rem] py-[0.5rem]">{{ activity.description }}</div>
        </div>
