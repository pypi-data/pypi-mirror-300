...
class OrcaCalculation:
    ...
    def RunCalculation(self):
        ...
        orcaCachePath = f"{os.getcwd()}\\{orcaCache}\\{self.CalculationMolecule.Name}"
        orcaCachePath = orcaCachePath.replace('.', '')
        orcaCachePath = os.path.normpath(orcaCachePath)
        self.OutputFilePath = os.path.normpath(f'{orcaCachePath}\\{self.GetOutputFileName()}')
        self.InputFilePath = os.path.normpath(f'{orcaCachePath}\\{self.GetInputFileName()}')
    ...
    def RunLocally (self, cachePath: str):
        ...
        if os.name == 'nt':
            ...
            print("Running on Linux or another Unix-like system")
