...
class BDDScenariosLoader(BaseLoader):
    ...
    def __init__(self, **kwargs):
        ...
        self.delete_git_dir = kwargs.get('delete_git_dir', False)
        # Git username
        ...
        self.path_to_get_features_from = kwargs.get('path_to_get_features_from', None)
    ...
    def load(self) -> List[Document]:
        ...
        for scenario in scenarios:
            ...
            metadata = {
                ...
                "source": f"{self.repo_url}@{self.branch}:{scenario['Scenario Name']}",
