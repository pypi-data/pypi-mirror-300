...
class FoundationImageArgs:
    def __init__(__self__, *,
                 ...
                 installer_type: pulumi.Input[str],
                 source: pulumi.Input[str]):
        """
        The set of arguments for constructing a FoundationImage resource.
        :param pulumi.Input[str] filename: - (Required) Name of installer file to be kept in foundation vm.
        :param pulumi.Input[str] installer_type: - (Required) One of "kvm", "esx", "hyperv", "xen", or "nos".
        :param pulumi.Input[str] source: - (Required) Complete path to the file in machine where the .tf  files runs.
        """
    ...
    def installer_type(self) -> pulumi.Input[str]:
        """
    ...
    def installer_type(self, value: pulumi.Input[str]):
...
class _FoundationImageState:
    def __init__(__self__, *,
                 ...
                 in_whitelist: Optional[pulumi.Input[bool]] = None,
                 installer_type: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.Input[str] filename: - (Required) Name of installer file to be kept in foundation vm.
        :param pulumi.Input[bool] in_whitelist: - If hypervisor ISO is in whitelist.
        :param pulumi.Input[str] installer_type: - (Required) One of "kvm", "esx", "hyperv", "xen", or "nos".
        :param pulumi.Input[str] md5sum: - md5sum of the ISO.
        :param pulumi.Input[str] name: - file location in foundation vm
        :param pulumi.Input[str] source: - (Required) Complete path to the file in machine where the .tf  files runs.
        """
    ...
    def in_whitelist(self) -> Optional[pulumi.Input[bool]]:
        """
    ...
    @in_whitelist.setter
    def in_whitelist(self, value: Optional[pulumi.Input[bool]]):
        pulumi.set(self, "in_whitelist", value)

    @property
    @pulumi.getter(name="installerType")
    def installer_type(self) -> Optional[pulumi.Input[str]]:
        """
        - (Required) One of "kvm", "esx", "hyperv", "xen", or "nos".
        """
        return pulumi.get(self, "installer_type")
    ...
    @installer_type.setter
    def installer_type(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "installer_type", value)
...
class FoundationImage(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            md5sum: Optional[pulumi.Input[str]] = None,
            name: Optional[pulumi.Input[str]] = None,
            source: Optional[pulumi.Input[str]] = None) -> 'FoundationImage':
        """
    ...
    @property
    @pulumi.getter(name="inWhitelist")
    def in_whitelist(self) -> pulumi.Output[bool]:
        """
        - If hypervisor ISO is in whitelist.
        """
        return pulumi.get(self, "in_whitelist")
    ...
    @property
    @pulumi.getter(name="installerType")
    def installer_type(self) -> pulumi.Output[str]:
        """
        - (Required) One of "kvm", "esx", "hyperv", "xen", or "nos".
        """
        return pulumi.get(self, "installer_type")
