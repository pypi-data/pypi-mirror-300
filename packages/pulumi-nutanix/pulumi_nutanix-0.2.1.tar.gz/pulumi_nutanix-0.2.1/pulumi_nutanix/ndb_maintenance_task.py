...
class NdbMaintenanceTaskArgs:
    ...
    def dbserver_clusters(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[str]]]]:
        """
    ...
    def dbserver_clusters(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]]):
        pulumi.set(self, "dbserver_clusters", value)

    @property
    @pulumi.getter(name="dbserverIds")
    def dbserver_ids(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[str]]]]:
        """
    ...
    @dbserver_ids.setter
    def dbserver_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]]):
...
class NdbMaintenanceTask(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="dbserverClusters")
    def dbserver_clusters(self) -> pulumi.Output[Optional[Sequence[str]]]:
        """
        dbserver cluster ids. Conflicts with "dbserver_id"
        """
        return pulumi.get(self, "dbserver_clusters")
    ...
    @property
    @pulumi.getter(name="dbserverIds")
    def dbserver_ids(self) -> pulumi.Output[Optional[Sequence[str]]]:
        """
        dbserver vm id. Conflicts with "dbserver_cluster"
        """
        return pulumi.get(self, "dbserver_ids")
