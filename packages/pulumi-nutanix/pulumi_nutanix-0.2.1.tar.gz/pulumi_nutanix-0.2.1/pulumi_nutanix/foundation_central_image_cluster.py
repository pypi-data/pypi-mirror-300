...
class FoundationCentralImageClusterArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] aos_package_sha256sum: Sha256sum of AOS package.
        :param pulumi.Input[str] aos_package_url: URL to download AOS package. Required only if imaging is needed.
