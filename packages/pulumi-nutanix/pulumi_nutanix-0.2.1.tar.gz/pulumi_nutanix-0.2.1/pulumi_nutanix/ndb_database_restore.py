...
class NdbDatabaseRestoreArgs:
    ...
    def latest_snapshot(self) -> Optional[pulumi.Input[str]]:
        """
        latest snapshot id
        """
    ...
    def latest_snapshot(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "latest_snapshot", value)

    @property
    @pulumi.getter(name="restoreVersion")
    def restore_version(self) -> Optional[pulumi.Input[int]]:
        """
    ...
    def restore_version(self, value: Optional[pulumi.Input[int]]):
    ...
    def time_zone_pitr(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def time_zone_pitr(self, value: Optional[pulumi.Input[str]]):
...
class NdbDatabaseRestore(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            time_zone_pitr: Optional[pulumi.Input[str]] = None,
            type: Optional[pulumi.Input[str]] = None,
            user_pitr_timestamp: Optional[pulumi.Input[str]] = None) -> 'NdbDatabaseRestore':
        """
    ...
    @property
    @pulumi.getter(name="latestSnapshot")
    def latest_snapshot(self) -> pulumi.Output[Optional[str]]:
        """
        latest snapshot id
        """
        return pulumi.get(self, "latest_snapshot")
    ...
    @property
    @pulumi.getter(name="restoreVersion")
    def restore_version(self) -> pulumi.Output[Optional[int]]:
        """
        helps to restore the database with same config.
        """
        return pulumi.get(self, "restore_version")
    ...
    @property
    @pulumi.getter(name="timeZonePitr")
    def time_zone_pitr(self) -> pulumi.Output[Optional[str]]:
        """
        timezone . Should be used with  `user_pitr_timestamp`
        """
        return pulumi.get(self, "time_zone_pitr")
