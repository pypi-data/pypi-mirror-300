...
class NdbCloneRefreshArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] clone_id: clone id
        :param pulumi.Input[str] snapshot_id: snapshot id where clone has to be refreshed
    ...
    def clone_id(self) -> pulumi.Input[str]:
        """
        clone id
        """
    ...
    @clone_id.setter
    def clone_id(self, value: pulumi.Input[str]):
...
class NdbCloneRefresh(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            snapshot_id: Optional[pulumi.Input[str]] = None,
            timezone: Optional[pulumi.Input[str]] = None,
            user_pitr_timestamp: Optional[pulumi.Input[str]] = None) -> 'NdbCloneRefresh':
        """
    ...
    @property
    @pulumi.getter(name="cloneId")
    def clone_id(self) -> pulumi.Output[str]:
        """
        clone id
        """
        return pulumi.get(self, "clone_id")
