...
class VpcArgs:
    ...
    def external_subnet_reference_names(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[str]]]]:
        """
    ...
    def external_subnet_reference_names(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]]):
        pulumi.set(self, "external_subnet_reference_names", value)

    @property
    @pulumi.getter(name="externalSubnetReferenceUuids")
    def external_subnet_reference_uuids(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[str]]]]:
        """
    ...
    def external_subnet_reference_uuids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]]):
...
class Vpc(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="externalSubnetReferenceNames")
    def external_subnet_reference_names(self) -> pulumi.Output[Optional[Sequence[str]]]:
        """
        List of external subnets name attached to this VPC. Should not be used with external_subnet_reference_uuid.
        """
        return pulumi.get(self, "external_subnet_reference_names")
    ...
    @property
    @pulumi.getter(name="externalSubnetReferenceUuids")
    def external_subnet_reference_uuids(self) -> pulumi.Output[Sequence[str]]:
        """
        List of external subnets uuid attached to this VPC. Should not be used with external_subnet_reference_name.
        """
        return pulumi.get(self, "external_subnet_reference_uuids")
