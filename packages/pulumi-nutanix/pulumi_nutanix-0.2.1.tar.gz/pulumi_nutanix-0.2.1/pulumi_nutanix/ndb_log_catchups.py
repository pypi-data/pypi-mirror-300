...
class NdbLogCatchupsArgs:
    def __init__(__self__, *,
                 ...
                 for_restore: Optional[pulumi.Input[bool]] = None,
                 log_catchup_version: Optional[pulumi.Input[int]] = None,
                 time_machine_id: Optional[pulumi.Input[str]] = None):
        """
        The set of arguments for constructing a NdbLogCatchups resource.
        :param pulumi.Input[bool] for_restore: Logs to Backup. The database may contain additional logs. Backup any remaining logs before restore or they will be lost.
        :param pulumi.Input[int] log_catchup_version: it helps to perform same operation with same config.
        ...
        :param pulumi.Input[str] time_machine_id: Time machine id of
        """
    ...
    def for_restore(self) -> Optional[pulumi.Input[bool]]:
        """
    ...
    @for_restore.setter
    def for_restore(self, value: Optional[pulumi.Input[bool]]):
        pulumi.set(self, "for_restore", value)

    @property
    @pulumi.getter(name="logCatchupVersion")
    def log_catchup_version(self) -> Optional[pulumi.Input[int]]:
        """
    ...
    def log_catchup_version(self, value: Optional[pulumi.Input[int]]):
...
class NdbLogCatchups(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            for_restore: Optional[pulumi.Input[bool]] = None,
            log_catchup_version: Optional[pulumi.Input[int]] = None,
            time_machine_id: Optional[pulumi.Input[str]] = None) -> 'NdbLogCatchups':
        """
    ...
    @property
    @pulumi.getter(name="forRestore")
    def for_restore(self) -> pulumi.Output[Optional[bool]]:
        """
        Logs to Backup. The database may contain additional logs. Backup any remaining logs before restore or they will be lost.
        """
        return pulumi.get(self, "for_restore")
    ...
    @property
    @pulumi.getter(name="logCatchupVersion")
    def log_catchup_version(self) -> pulumi.Output[Optional[int]]:
        """
        it helps to perform same operation with same config.
