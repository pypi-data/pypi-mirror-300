...
class CategoryValueArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] value: The value for the category value.
        :param pulumi.Input[str] description: - (Optional) A description for category value.
        :param pulumi.Input[str] name: - (Required) The category_key name for the category value.
        """
...
class _CategoryValueState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] api_version: (Optional) The version of the API.
        :param pulumi.Input[str] description: - (Optional) A description for category value.
        :param pulumi.Input[str] name: - (Required) The category_key name for the category value.
        :param pulumi.Input[bool] system_defined: - Specifying whether its a system defined category.
        :param pulumi.Input[str] value: The value for the category value.
        """
...
class CategoryValue(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[str]] = None,
            system_defined: Optional[pulumi.Input[bool]] = None,
            value: Optional[pulumi.Input[str]] = None) -> 'CategoryValue':
        """
