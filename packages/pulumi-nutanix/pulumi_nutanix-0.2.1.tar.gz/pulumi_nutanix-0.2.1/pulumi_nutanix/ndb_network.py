...
class NdbNetworkArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] type: Vlan type. Supports [DHCP, Static]
...
class NdbNetwork(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            stretched_vlan_id: Optional[pulumi.Input[str]] = None,
            subnet_mask: Optional[pulumi.Input[str]] = None,
            type: Optional[pulumi.Input[str]] = None) -> 'NdbNetwork':
        """
    ...
    @property
    @pulumi.getter(name="primaryDns")
    def primary_dns(self) -> pulumi.Output[Optional[str]]:
        """
        primary dns for vlan. (Static IP address assignment only)
        """
        return pulumi.get(self, "primary_dns")
    ...
    @property
    @pulumi.getter(name="secondaryDns")
    def secondary_dns(self) -> pulumi.Output[Optional[str]]:
        """
        secondary dns for vlan. (Static IP address assignment only)
        """
        return pulumi.get(self, "secondary_dns")
    ...
    @property
    @pulumi.getter(name="stretchedVlanId")
    def stretched_vlan_id(self) -> pulumi.Output[str]:
        """
        stretched vlan id
        """
        return pulumi.get(self, "stretched_vlan_id")
