...
class PbrArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[int] priority: priority of policy
        :param pulumi.Input[str] protocol_type: Protocol type of policy based routing. Must be one of {TCP, UDP, ICMP, PROTOCOL_NUMBER, ALL} .
        ...
        :param pulumi.Input[Sequence[pulumi.Input[str]]] service_ip_lists: IP addresses of network services. This field is valid only when action is REROUTE.
        :param pulumi.Input[str] vpc_name: The reference to a vpc. Should not be used with {vpc_reference_uuid}
        :param pulumi.Input[str] vpc_reference_uuid: The reference to a vpc . Should not be used with {vpc_name} .
        """
...
class _PbrState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] api_version: The version of the API.
        :param pulumi.Input[bool] is_bidirectional: Additionally create Policy in reverse direction. Should be used with {TCP, UDP with start and end port ranges and ICMP with icmp code and type}. Supported with 2022.x.
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] metadata: The routing policies kind metadata.
        :param pulumi.Input[str] name: name of policy
        :param pulumi.Input[int] priority: priority of policy
        :param pulumi.Input[str] protocol_type: Protocol type of policy based routing. Must be one of {TCP, UDP, ICMP, PROTOCOL_NUMBER, ALL} .
        :param pulumi.Input[Sequence[pulumi.Input[str]]] service_ip_lists: IP addresses of network services. This field is valid only when action is REROUTE.
...
class Pbr(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="isBidirectional")
    def is_bidirectional(self) -> pulumi.Output[bool]:
        """
        Additionally create Policy in reverse direction. Should be used with {TCP, UDP with start and end port ranges and ICMP with icmp code and type}. Supported with 2022.x.
        """
        return pulumi.get(self, "is_bidirectional")
