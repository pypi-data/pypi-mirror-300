...
class Column(_message.Message):
    __slots__ = ["batch_table_feature_view_index", "calculation", "data_type", "description", "feature_service_space_name", "feature_view_index", "feature_view_space_name", "tags"]
    ...
    CALCULATION_FIELD_NUMBER: ClassVar[int]
    ...
    calculation: _calculation_node__client_pb2.CalculationNode
    ...
    def __init__(self, data_type: Optional[Union[_data_type__client_pb2.DataType, Mapping]] = ..., feature_view_space_name: Optional[str] = ..., feature_service_space_name: Optional[str] = ..., feature_view_index: Optional[int] = ..., batch_table_feature_view_index: Optional[int] = ..., description: Optional[str] = ..., tags: Optional[Mapping[str, str]] = ..., calculation: Optional[Union[_calculation_node__client_pb2.CalculationNode, Mapping]] = ...) -> None: ...
