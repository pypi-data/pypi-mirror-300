...
class GoogleCloudInstanceGroup(_message.Message):
    ...
    target_id: str
    def __init__(self, project: Optional[str] = ..., region: Optional[str] = ..., target_id: Optional[str] = ..., machine_type: Optional[str] = ..., subnetworks: Optional[Iterable[str]] = ..., health_check_name: Optional[str] = ..., service_account: Optional[str] = ..., scopes: Optional[Iterable[str]] = ...) -> None: ...
...
class InstanceGroup(_message.Message):
    __slots__ = ["aws_instance_group", "capacity", "container_image", "environment_variables", "google_cloud_instance_group", "grpc_port", "health_check_config", "health_check_name", "host", "http_port", "metrics_namespace", "name", "prometheus_port", "tags"]
    ...
    METRICS_NAMESPACE_FIELD_NUMBER: ClassVar[int]
    NAME_FIELD_NUMBER: ClassVar[int]
