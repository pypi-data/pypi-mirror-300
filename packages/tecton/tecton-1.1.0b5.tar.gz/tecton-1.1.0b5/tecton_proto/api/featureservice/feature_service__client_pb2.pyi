...
class FeatureServiceLocatorV2(_message.Message):
    __slots__ = ["feature_service_name", "workspace_name"]
    FEATURE_SERVICE_NAME_FIELD_NUMBER: ClassVar[int]
    WORKSPACE_NAME_FIELD_NUMBER: ClassVar[int]
    feature_service_name: str
    workspace_name: str
    def __init__(self, feature_service_name: Optional[str] = ..., workspace_name: Optional[str] = ...) -> None: ...
...
class ServiceMetadataRequestV2(_message.Message):
    __slots__ = ["params"]
    PARAMS_FIELD_NUMBER: ClassVar[int]
    params: FeatureServiceLocatorV2
    def __init__(self, params: Optional[Union[FeatureServiceLocatorV2, Mapping]] = ...) -> None: ...
