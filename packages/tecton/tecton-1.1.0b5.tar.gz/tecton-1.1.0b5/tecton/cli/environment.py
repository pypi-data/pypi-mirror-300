...
def environment():
    """Manage Environments for Realtime execution.
...
def _validate_and_get_dependencies(lock_file_path: Path) -> EnvironmentDependencies:
    ...
    if not tecton_runtime_version and not tecton_rift_version:
        ...
        printer.safe_print(
            ...
            "\nFor more information, please see: https://docs.tecton.ai/docs/defining-features/feature-views/realtime-feature-view/realtime-feature-view-environments/custom-realtime-feature-view-environments",
            file=sys.stderr,
        )
        sys.exit(1)
    return dependencies
