...
class SsoAdmin(Base):  # pylint: disable=too-many-instance-attributes
    ...
    def load_account_assignments(self):
        ...
        for (
            ...
            for index, permission_set in self.df_permission_sets.iterrows():
    ...
    def display_overview(self):
        ...
        print(
            f"Number of Account Assignments: {len(self.df_account_assignments.index)}"
        )
        print()
    ...
    def to_excel(self):
        ...
        with pd.ExcelWriter(
            ...
            self.df_account_assignments.to_excel(
                writer, sheet_name="Account Assignments"
            )
    ...
    def menu_overview(self):
        ...
        obj.add_option(
            o7m.Option(
                ...
                short="Groups",
                callback=lambda: pprint.pprint(
                    self.df_groups.to_dict(orient="records")
                ),
            )
        )
        obj.add_option(
