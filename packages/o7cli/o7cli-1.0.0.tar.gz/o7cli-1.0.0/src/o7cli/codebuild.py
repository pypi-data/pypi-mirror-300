...
class CodeBuild(Base):
    ...
    def load_builds(self, max_builds=25):
        ...
        for page in paginator.paginate(**param):
            ...
            resp = self.client.batch_get_builds(ids=page.get("ids", [])[:left])
    ...
    def display_project_details(self):
        ...
        print(
            f'Modified: { o7f.elapse_time(self.project.get("lastModified", None))} ago'
        )
    ...
    #
    # *************************************************
    def display_build_detailsa(self):
    ...
    def menu_build_details(self, index):
        ...
        #     )
        # )
        obj.display_callback = self.display_build_detailsa
        obj.loop()
