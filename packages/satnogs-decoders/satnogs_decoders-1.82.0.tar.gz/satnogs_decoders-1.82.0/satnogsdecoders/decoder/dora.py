...
class Dora(KaitaiStruct):
    """:field openlst_destination: openlst_header.openlst_destination
    :field openlst_seq_num: openlst_header.openlst_seq_num
    :field openlst_system: openlst_header.openlst_system
    ...
    def _read(self):
        self.openlst_header = Dora.OpenlstHeader(self._io, self, self._root)
        self.callsign = (self._io.read_bytes(6)).decode(u"ASCII")
        if not  ((self.callsign == u"KE7DHQ")) :
            raise kaitaistruct.ValidationNotAnyOfError(self.callsign, self._io, u"/seq/1")
        self.dora_syncbytes = self._io.read_bytes(4)
        if not self.dora_syncbytes == b"\x35\x2E\xF8\x53":
            raise kaitaistruct.ValidationNotEqualError(b"\x35\x2E\xF8\x53", self.dora_syncbytes, self._io, u"/seq/2")
    ...
    class BatteryTelemetry(KaitaiStruct):
        ...
        def output_voltage_battery(self):
            if hasattr(self, '_m_output_voltage_battery'):
                return self._m_output_voltage_battery if hasattr(self, '_m_output_voltage_battery') else None
        ...
        def daughter_temp1(self):
            if hasattr(self, '_m_daughter_temp1'):
                return self._m_daughter_temp1 if hasattr(self, '_m_daughter_temp1') else None
        ...
        def current_magnitude(self):
            if hasattr(self, '_m_current_magnitude'):
                return self._m_current_magnitude if hasattr(self, '_m_current_magnitude') else None
        ...
        def daughter_temp3(self):
            if hasattr(self, '_m_daughter_temp3'):
                return self._m_daughter_temp3 if hasattr(self, '_m_daughter_temp3') else None
        ...
        def daughter_temp2(self):
            if hasattr(self, '_m_daughter_temp2'):
                return self._m_daughter_temp2 if hasattr(self, '_m_daughter_temp2') else None
        ...
        def motherboard_temperature(self):
            if hasattr(self, '_m_motherboard_temperature'):
                return self._m_motherboard_temperature if hasattr(self, '_m_motherboard_temperature') else None
    ...
    class OpenlstHeader(KaitaiStruct):
        def __init__(self, _io, _parent=None, _root=None):
            self._io = _io
            self._parent = _parent
            self._root = _root if _root else self
        ...
        def _read(self):
            self.openlst_destination = self._io.read_bits_int_be(16)
            self._io.align_to_byte()
            self.openlst_seq_num = self._io.read_u2be()
            self.openlst_system = self._io.read_u1()
    ...
    class AdcsTelemetry(KaitaiStruct):
        ...
        def fine_est_ang_rates_x(self):
            if hasattr(self, '_m_fine_est_ang_rates_x'):
                return self._m_fine_est_ang_rates_x if hasattr(self, '_m_fine_est_ang_rates_x') else None
        ...
        def temp_redmag(self):
            if hasattr(self, '_m_temp_redmag'):
                return self._m_temp_redmag if hasattr(self, '_m_temp_redmag') else None
        ...
        def temp_mag(self):
            if hasattr(self, '_m_temp_mag'):
                return self._m_temp_mag if hasattr(self, '_m_temp_mag') else None
        ...
        def cubecontrl_cur_5v(self):
            if hasattr(self, '_m_cubecontrl_cur_5v'):
                return self._m_cubecontrl_cur_5v if hasattr(self, '_m_cubecontrl_cur_5v') else None
        ...
        def wheel3_current(self):
            if hasattr(self, '_m_wheel3_current'):
                return self._m_wheel3_current if hasattr(self, '_m_wheel3_current') else None
        ...
        def cubesenes2_3v3_current(self):
            if hasattr(self, '_m_cubesenes2_3v3_current'):
                return self._m_cubesenes2_3v3_current if hasattr(self, '_m_cubesenes2_3v3_current') else None
        ...
        def cubesenes1_3v3_current(self):
            if hasattr(self, '_m_cubesenes1_3v3_current'):
                return self._m_cubesenes1_3v3_current if hasattr(self, '_m_cubesenes1_3v3_current') else None
        ...
        def wheel2_current(self):
            if hasattr(self, '_m_wheel2_current'):
                return self._m_wheel2_current if hasattr(self, '_m_wheel2_current') else None
        ...
        def fine_est_ang_rates_z(self):
            if hasattr(self, '_m_fine_est_ang_rates_z'):
                return self._m_fine_est_ang_rates_z if hasattr(self, '_m_fine_est_ang_rates_z') else None
        ...
        def fine_sv_y(self):
            if hasattr(self, '_m_fine_sv_y'):
                return self._m_fine_sv_y if hasattr(self, '_m_fine_sv_y') else None
        ...
        def fine_est_ang_rates_y(self):
            if hasattr(self, '_m_fine_est_ang_rates_y'):
                return self._m_fine_est_ang_rates_y if hasattr(self, '_m_fine_est_ang_rates_y') else None
        ...
        def magnetorquer_current(self):
            if hasattr(self, '_m_magnetorquer_current'):
                return self._m_magnetorquer_current if hasattr(self, '_m_magnetorquer_current') else None
        ...
        def cubecontrol_cur_vbat(self):
            if hasattr(self, '_m_cubecontrol_cur_vbat'):
                return self._m_cubecontrol_cur_vbat if hasattr(self, '_m_cubecontrol_cur_vbat') else None
        ...
        def cubecontrl_cur_3v3(self):
            if hasattr(self, '_m_cubecontrl_cur_3v3'):
                return self._m_cubecontrl_cur_3v3 if hasattr(self, '_m_cubecontrl_cur_3v3') else None
        ...
        def wheel1_current(self):
            if hasattr(self, '_m_wheel1_current'):
                return self._m_wheel1_current if hasattr(self, '_m_wheel1_current') else None
        ...
        def cubesenes1_sram_current(self):
            if hasattr(self, '_m_cubesenes1_sram_current'):
                return self._m_cubesenes1_sram_current if hasattr(self, '_m_cubesenes1_sram_current') else None
        ...
        def fine_sv_x(self):
            if hasattr(self, '_m_fine_sv_x'):
                return self._m_fine_sv_x if hasattr(self, '_m_fine_sv_x') else None
        ...
        def cubesenes2_sram_current(self):
            if hasattr(self, '_m_cubesenes2_sram_current'):
                return self._m_cubesenes2_sram_current if hasattr(self, '_m_cubesenes2_sram_current') else None
        ...
        def fine_sv_z(self):
            if hasattr(self, '_m_fine_sv_z'):
                return self._m_fine_sv_z if hasattr(self, '_m_fine_sv_z') else None
    ...
    class FirstDoraPacket(KaitaiStruct):
        ...
        def _read(self):
            self.timestamp = self._io.read_u8be()
            self.missionticks = self._io.read_u8be()
    ...
    class EpsTelemetry(KaitaiStruct):
        ...
        def bcr_output_current(self):
            if hasattr(self, '_m_bcr_output_current'):
                return self._m_bcr_output_current if hasattr(self, '_m_bcr_output_current') else None
        ...
        def daughterboard_temperature(self):
            if hasattr(self, '_m_daughterboard_temperature'):
                return self._m_daughterboard_temperature if hasattr(self, '_m_daughterboard_temperature') else None
        ...
        def output_current_switch_6(self):
            if hasattr(self, '_m_output_current_switch_6'):
                return self._m_output_current_switch_6 if hasattr(self, '_m_output_current_switch_6') else None
        ...
        def output_current_switch_7(self):
            if hasattr(self, '_m_output_current_switch_7'):
                return self._m_output_current_switch_7 if hasattr(self, '_m_output_current_switch_7') else None
        ...
        def voltage_feeding_bcr9(self):
            if hasattr(self, '_m_voltage_feeding_bcr9'):
                return self._m_voltage_feeding_bcr9 if hasattr(self, '_m_voltage_feeding_bcr9') else None
        ...
        def current_bcr7_connector_sa7a(self):
            if hasattr(self, '_m_current_bcr7_connector_sa7a'):
                return self._m_current_bcr7_connector_sa7a if hasattr(self, '_m_current_bcr7_connector_sa7a') else None
        ...
        def current_bcr7_connector_sa7b(self):
            if hasattr(self, '_m_current_bcr7_connector_sa7b'):
                return self._m_current_bcr7_connector_sa7b if hasattr(self, '_m_current_bcr7_connector_sa7b') else None
        ...
        def output_current_battery(self):
            if hasattr(self, '_m_output_current_battery'):
                return self._m_output_current_battery if hasattr(self, '_m_output_current_battery') else None
        ...
        def current_bcr9_connector_sa9b(self):
            if hasattr(self, '_m_current_bcr9_connector_sa9b'):
                return self._m_current_bcr9_connector_sa9b if hasattr(self, '_m_current_bcr9_connector_sa9b') else None
        ...
        def output_current_5v(self):
            if hasattr(self, '_m_output_current_5v'):
                return self._m_output_current_5v if hasattr(self, '_m_output_current_5v') else None
        ...
        def output_voltage_5v(self):
            if hasattr(self, '_m_output_voltage_5v'):
                return self._m_output_voltage_5v if hasattr(self, '_m_output_voltage_5v') else None
        ...
        def output_voltage_3v3(self):
            if hasattr(self, '_m_output_voltage_3v3'):
                return self._m_output_voltage_3v3 if hasattr(self, '_m_output_voltage_3v3') else None
        ...
        def voltage_feeding_bcr8(self):
            if hasattr(self, '_m_voltage_feeding_bcr8'):
                return self._m_voltage_feeding_bcr8 if hasattr(self, '_m_voltage_feeding_bcr8') else None
        ...
        def voltage_feeding_bcr6(self):
            if hasattr(self, '_m_voltage_feeding_bcr6'):
                return self._m_voltage_feeding_bcr6 if hasattr(self, '_m_voltage_feeding_bcr6') else None
        ...
        def current_bcr9_connector_sa9a(self):
            if hasattr(self, '_m_current_bcr9_connector_sa9a'):
                return self._m_current_bcr9_connector_sa9a if hasattr(self, '_m_current_bcr9_connector_sa9a') else None
        ...
        def output_current_switch_5(self):
            if hasattr(self, '_m_output_current_switch_5'):
                return self._m_output_current_switch_5 if hasattr(self, '_m_output_current_switch_5') else None
        ...
        def output_current_3v3(self):
            if hasattr(self, '_m_output_current_3v3'):
                return self._m_output_current_3v3 if hasattr(self, '_m_output_current_3v3') else None
        ...
        def output_voltage_switch_6(self):
            if hasattr(self, '_m_output_voltage_switch_6'):
                return self._m_output_voltage_switch_6 if hasattr(self, '_m_output_voltage_switch_6') else None
        ...
        def output_voltage_switch_5(self):
            if hasattr(self, '_m_output_voltage_switch_5'):
                return self._m_output_voltage_switch_5 if hasattr(self, '_m_output_voltage_switch_5') else None
        ...
        def output_voltage_switch_7(self):
            if hasattr(self, '_m_output_voltage_switch_7'):
                return self._m_output_voltage_switch_7 if hasattr(self, '_m_output_voltage_switch_7') else None
        ...
        def current_bcr8_connector_sa8a(self):
            if hasattr(self, '_m_current_bcr8_connector_sa8a'):
                return self._m_current_bcr8_connector_sa8a if hasattr(self, '_m_current_bcr8_connector_sa8a') else None
        ...
        def current_bcr8_connector_sa8b(self):
            if hasattr(self, '_m_current_bcr8_connector_sa8b'):
                return self._m_current_bcr8_connector_sa8b if hasattr(self, '_m_current_bcr8_connector_sa8b') else None
        ...
        def current_bcr6_connector_sa6b(self):
            if hasattr(self, '_m_current_bcr6_connector_sa6b'):
                return self._m_current_bcr6_connector_sa6b if hasattr(self, '_m_current_bcr6_connector_sa6b') else None
        ...
        def voltage_feeding_bcr7(self):
            if hasattr(self, '_m_voltage_feeding_bcr7'):
                return self._m_voltage_feeding_bcr7 if hasattr(self, '_m_voltage_feeding_bcr7') else None
        ...
        def current_bcr6_connector_sa6a(self):
            if hasattr(self, '_m_current_bcr6_connector_sa6a'):
                return self._m_current_bcr6_connector_sa6a if hasattr(self, '_m_current_bcr6_connector_sa6a') else None
