...
class Task:
    ...
    def __init__(self, name, query_definition=None, table_alias=None, query=None, is_qa=False, optional=False, stage=None, condition=None, include_html=False, python_callable=None, task_type='sql'):
        self.name = name
