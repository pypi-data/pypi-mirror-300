...
# from lino_xl.lib.accounting.accounts import *
...
def objects():
    ...
    # date = datetime.date(dd.plugins.accounting.start_year, 1, 4)
    date = datetime.date(dd.plugins.accounting.start_year, 1, 31)
