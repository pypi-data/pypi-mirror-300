...
help_texts = {
    ...
    'lino_xl.lib.vat.VatItemBase.get_peppol_vat_category' : _("""Return the PEPPOL category to be applied for this voucher item."""),
    ...
    'lino_xl.lib.tickets.Ticket.priority' : _("""An integer value used in the order’s backlog and in the worker’s to-do list."""),
