...
@pytest.mark.parametrize("input_text, expected_sidc", [
    ...
    # C2, КШМ
    ("02.08.23 неідентифікований КП ров, на північний захід від Червонопопівка (Взаємодія)", "10061000001100000000"), 
    ("Командно-спостережний пункт (КСП)", "10061000001100000000"),
    ...
    ("КОМАНДНО-СПОСТЕРЕЖНИЙ ПУНКТ", "10061000001100000000"),
...
def test_import_custom_patterns():
    patterns: List[PatternDict] = [
