...
template <typename _MatrixType> class HessenbergDecomposition
{
  public:
     ...
     *  - the upper part and lower sub-diagonal represent the Hessenberg matrix
     * H
     ...
     * Householder transformations \f$ H_i = (I - h_i v_i v_i^T) \f$ where \f$
     * h_i \f$ is the \f$ i \f$th Householder coefficient and \f$ v_i \f$ is the
