    ...
    class InnerIterator : public EvalIterator
    {
      ...
      public:
              ...
              m_containsDiag(Base::outer() < xprEval.m_arg.innerSize())
        {
            ...
            } else if (HasUnitDiag && ((!Base::operator bool()) ||
                                       Base::index() >= Base::outer())) {
        ...
        //       Base::outer() : this->index()); } inline Index col() const {
        //       return (ArgType::Flags&RowMajorBit ? this->index() :
        //       Base::outer()); }
