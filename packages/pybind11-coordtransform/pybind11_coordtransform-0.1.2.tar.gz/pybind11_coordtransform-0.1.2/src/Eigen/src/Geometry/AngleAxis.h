...
class AngleAxis : public RotationBase<AngleAxis<_Scalar>, 3>
{
  ...
  public:
    ...
    /** Constructs and initialize the angle-axis rotation from a quaternion \a
     * q. This function implicitly normalizes the quaternion \a q.
     */
    ...
    /** \returns the inverse rotation, i.e., an angle-axis with opposite
     * rotation angle */
