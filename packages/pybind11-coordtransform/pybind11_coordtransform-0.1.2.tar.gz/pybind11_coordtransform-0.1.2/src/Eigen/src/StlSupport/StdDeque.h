                       ...
                       EIGEN_WORKAROUND_MSVC_STL_SUPPORT(T)>>
{
    ...
    void resize(size_type new_size, const value_type &x)
    {
        if (deque_base::size() < new_size)
            deque_base::_Insert_n(deque_base::end(),
                                  new_size - deque_base::size(), x);
        else if (new_size < deque_base::size())
            deque_base::erase(deque_base::begin() + new_size,
                              deque_base::end());
    }
    ...
    void resize(size_type new_size, const value_type &x)
    {
        if (new_size < deque_base::size())
            ...
            deque_base::insert(deque_base::end(), new_size - deque_base::size(),
                               x);
    }
#endif
};
