            ...
            if (rs) {
                ...
                if (gamma != 0)
                    mat.col(j).tail(rs) =
                        ...
                        (nLjj * sigma * numext::conj(wj) / gamma) *
                            temp.tail(rs);
            }
        }
    }
...
template <typename MatrixType> struct LLT_Traits<MatrixType, Lower>
{
    ...
    {
        return llt_inplace<typename MatrixType::Scalar, Lower>::blocked(m) ==
               -1;
    }
};
...
template <typename MatrixType> struct LLT_Traits<MatrixType, Upper>
{
    ...
    static bool inplace_decomposition(MatrixType &m)
    {
        return llt_inplace<typename MatrixType::Scalar, Upper>::blocked(m) ==
               -1;
    }
};
