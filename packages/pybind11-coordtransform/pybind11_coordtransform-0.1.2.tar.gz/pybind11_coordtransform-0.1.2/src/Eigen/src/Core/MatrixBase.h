...
#undef EIGEN_DOC_UNARY_ADDONS
    ...
    typedef
        typename internal::add_const<Diagonal<const Derived, DynamicIndex>>::
            type ConstDiagonalDynamicIndexReturnType;
    ...
    /** \returns a const \link Eigen::ArrayBase Array \endlink expression of
     * this matrix \sa ArrayBase::matrix() */
    ...
    inline BDCSVD<PlainObject>
    bdcSvd(unsigned int computationOptions = 0) const;
    ...
    enum
    {
        HomogeneousReturnTypeDirection =
            ColsAtCompileTime == 1 && RowsAtCompileTime == 1
                ? ((internal::traits<Derived>::Flags & RowMajorBit) ==
                           RowMajorBit
                       ? Horizontal
                       : Vertical)
    ...
    template <typename EssentialPart>
    EIGEN_DEVICE_FUNC void
    applyHouseholderOnTheRight(const EssentialPart &essential,
