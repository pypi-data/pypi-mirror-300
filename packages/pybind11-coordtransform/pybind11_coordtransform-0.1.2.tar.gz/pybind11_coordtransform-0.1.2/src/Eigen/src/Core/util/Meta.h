...
template <typename T, std::size_t N> EIGEN_CONSTEXPR Index size(const T (&)[N])
{
    return N;
}
...
struct result_of<Func(ArgType0, ArgType1, ArgType2)>
{
    ...
    typedef typename ternary_result_of_select<Func, ArgType0, ArgType1,
                                              ArgType2, FunctorType>::type type;
};
