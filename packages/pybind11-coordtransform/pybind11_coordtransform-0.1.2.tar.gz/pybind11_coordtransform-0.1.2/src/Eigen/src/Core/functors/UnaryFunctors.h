...
template <typename Scalar> struct functor_traits<scalar_conjugate_op<Scalar>>
{
    ...
    {
        Cost = 0,
        // Yes the cost is zero even for complexes because in most cases for
        // which the cost is used, conjugation turns to be a no-op. Some
        // examples:
...
struct functor_traits<scalar_cast_op<Scalar, NewType>>
{
    ...
    {
        Cost =
            is_same<Scalar, NewType>::value ? 0 : NumTraits<NewType>::AddCost,
        PacketAccess = false
    };
};
...
template <typename Scalar> struct functor_traits<scalar_expm1_op<Scalar>>
{
    enum
    {
        ...
        Cost = functor_traits<scalar_exp_op<Scalar>>::Cost // TODO measure cost
                                                           // of expm1
    };
};
...
template <typename Scalar> struct functor_traits<scalar_log1p_op<Scalar>>
{
    enum
    {
        ...
        Cost = functor_traits<scalar_log_op<Scalar>>::Cost // TODO measure cost
                                                           // of log1p
    };
};
...
template <> struct scalar_logistic_op<float>
{
    ...
    packetOp(const Packet &_x) const
    {
        ...
        // The upper cut-off is the smallest x for which the rational
        // approximation evaluates to 1. Choosing this value saves us a few
        // instructions clamping the results at the end.
#ifdef EIGEN_VECTORIZE_FMA
