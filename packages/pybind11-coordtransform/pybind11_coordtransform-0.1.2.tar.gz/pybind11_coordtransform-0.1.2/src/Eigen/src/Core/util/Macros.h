...
{
    std::cerr << "assertion failed: " << condition << " in function "
...
#define EIGEN_GENERIC_PUBLIC_INTERFACE(Derived)                                \
    ...
    typedef typename Eigen::NumTraits<Scalar>::Real                            \
        RealScalar; /*!< \brief The underlying numeric type for composed       \
                       scalar types. \details In cases where Scalar is e.g.    \
    ...
    typedef                                                                    \
        typename Eigen::internal::traits<Derived>::StorageKind StorageKind;    \
    typedef                                                                    \
...
#define EIGEN_MAKE_CWISE_BINARY_OP(METHOD, OPNAME)                             \
    ...
    EIGEN_CWISE_BINARY_RETURN_TYPE(Derived, OtherDerived, OPNAME)(METHOD)(     \
...
#define EIGEN_MAKE_SCALAR_BINARY_OP_ONTHERIGHT(METHOD, OPNAME)                 \
        ...
        const EIGEN_EXPR_BINARYOP_SCALAR_RETURN_TYPE(                          \
            ...
            typename internal::promote_scalar_arg<                             \
                Scalar EIGEN_COMMA T EIGEN_COMMA                               \
                    EIGEN_SCALAR_BINARY_SUPPORTED(OPNAME, Scalar, T)>::type,   \
    ...
    {                                                                          \
        typedef typename internal::promote_scalar_arg<                         \
            ...
            PromotedT;                                                         \
        return EIGEN_EXPR_BINARYOP_SCALAR_RETURN_TYPE(Derived, PromotedT,      \
                                                      OPNAME)(                 \
            derived(),                                                         \
...
#define EIGEN_MAKE_SCALAR_BINARY_OP_ONTHELEFT(METHOD, OPNAME)                    \
    ...
    EIGEN_DEVICE_FUNC                                                            \
        EIGEN_STRONG_INLINE friend EIGEN_MSVC10_WORKAROUND_BINARYOP_RETURN_TYPE( \
            const EIGEN_SCALAR_BINARYOP_EXPR_RETURN_TYPE(                        \
                typename internal::promote_scalar_arg<                           \
                    Scalar EIGEN_COMMA T EIGEN_COMMA                             \
                        EIGEN_SCALAR_BINARY_SUPPORTED(OPNAME, T,                 \
                                                      Scalar)>::type,            \
    ...
    {                                                                            \
        typedef typename internal::promote_scalar_arg<                           \
            ...
            PromotedT;                                                           \
        return EIGEN_SCALAR_BINARYOP_EXPR_RETURN_TYPE(PromotedT, Derived,        \
                                                      OPNAME)(                   \
            typename internal::plain_constant_type<Derived, PromotedT>::type(    \
