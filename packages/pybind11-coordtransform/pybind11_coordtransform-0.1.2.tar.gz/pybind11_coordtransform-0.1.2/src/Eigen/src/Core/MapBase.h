    ...
    : public MapBase<Derived, ReadOnlyAccessors>
{
  ...
  public:
    ...
    EIGEN_DEVICE_FUNC inline MapBase(PointerType dataPtr, Index rows,
                                     Index cols)
    ...
    // In theory we could simply refer to Base:Base::operator=, but MSVC does
    // not like Base::Base, see bugs 821 and 920.
