...
template <typename Lhs, typename Rhs> struct product_type
{
    ...
    enum
    {
        ...
        MaxDepth =
            EIGEN_SIZE_MIN_PREFER_FIXED(traits<_Lhs>::MaxColsAtCompileTime,
...
struct gemv_static_vector_if<Scalar, Size, MaxSize, true>
{
    ...
    // => let's manually enforce alignment by allocating more data and return
    // the address of the first aligned element.
...
template <> struct gemv_dense_selector<OnTheRight, ColMajor, true>
{
                           ...
                           const typename Dest::Scalar &alpha)
    {
        ...
        enum
        {
            ...
            // anyways...
            EvalToDestAtCompileTime =
                (ActualDest::InnerStrideAtCompileTime == 1),
            ComplexByReal = (NumTraits<LhsScalar>::IsComplex) &&
                            (!NumTraits<RhsScalar>::IsComplex),
            MightCannotUseDest =
                ((!EvalToDestAtCompileTime) || ComplexByReal) &&
        ...
        if (!MightCannotUseDest) {
            ...
            // this ease the compiler to generate cleaner and more optimzized
            // code for most common cases
            ...
            const bool evalToDest =
                EvalToDestAtCompileTime && alphaIsCompatible;
                    ...
                    const typename Dest::Scalar &alpha)
    {
        ...
        general_matrix_vector_product<Index, LhsScalar, LhsMapper, RowMajor,
            ...
            run(actualLhs.rows(), actualLhs.cols(),
                ...
                dest.col(0)
                    .innerStride(), // NOTE  if dest is not a vector at
...
template <> struct gemv_dense_selector<OnTheRight, ColMajor, false>
{
                    ...
                    const typename Dest::Scalar &alpha)
    {
        ...
        // TODO if rhs is large enough it might be beneficial to make sure that
        // dest is sequentially stored in memory, otherwise use a temp
...
MatrixBase<Derived>::operator*(const MatrixBase<OtherDerived> &other) const
{
    ...
    enum
    {
        ...
        AreVectors = Derived::IsVectorAtCompileTime &&
