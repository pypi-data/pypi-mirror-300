  ...
  protected:
    ...
    typedef
        typename internal::conditional<internal::is_const<XprType>::value,
            ...
            other_iterator;
    // NOTE: in C++03 we cannot declare friend classes through typedefs because
    // we need to write friend class:
          ...
          generic_randaccess_stl_iterator<XprType>>
{
  ...
  protected:
    ...
    typedef indexed_based_stl_iterator_base<generic_randaccess_stl_iterator>
        Base;
    using Base::m_index;
    using Base::mp_xpr;
