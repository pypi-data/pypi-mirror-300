...
enum UpLoType
{
    ...
    Upper = 0x2,
    /** %Matrix has ones on the diagonal; to be used in combination with #Lower
       or #Upper. */
    UnitDiag = 0x4,
...
enum TraversalType
{
    ...
    /** \internal Vectorization path using a single loop plus scalar loops for
     * the unaligned boundaries */
...
enum DecompositionOptions
{
    ...
    /** \internal Not used (meant for LDLT?). */
    NoPivoting = 0x02,
    /** Used in JacobiSVD to indicate that the square matrix U is to be
       computed. */
    ComputeFullU = 0x04,
    /** Used in JacobiSVD to indicate that the thin matrix U is to be computed.
     */
    ComputeThinU = 0x08,
    /** Used in JacobiSVD to indicate that the square matrix V is to be
       computed. */
    ComputeFullV = 0x10,
    ...
    /** Used in SelfAdjointEigenSolver and GeneralizedSelfAdjointEigenSolver to
     * specify that both the eigenvalues and the eigenvectors are to be
     * computed. */
