...
struct traits<Reshaped<XprType, Rows, Cols, Order>> : traits<XprType>
{
    ...
    enum
    {
        ...
        XpxStorageOrder =
            ((int(traits<XprType>::Flags) & RowMajorBit) == RowMajorBit)
                ? RowMajor
                : ColMajor,
        ...
        HasSameStorageOrderAsXprType =
            (ReshapedStorageOrder == XpxStorageOrder),
        ...
        Flags = (Flags0 | FlagsLinearAccessBit | FlagsLvalueBit |
                 FlagsRowMajorBit | FlagsDirectAccessBit)
    };
};
    ...
    : public MapBase<Reshaped<XprType, Rows, Cols, Order>>
{
  ...
  public:
    ...
    {
        return ((Flags & RowMajorBit) == RowMajorBit) ? this->cols()
                                                      : this->rows();
    }
        ...
        FlagsLinearAccessBit =
            (traits<XprType>::RowsAtCompileTime == 1 ||
             traits<XprType>::ColsAtCompileTime == 1 || HasDirectAccess)
                ...
                : 0,
        FlagsRowMajorBit =
            (traits<XprType>::ReshapedStorageOrder == int(RowMajor))
                ? RowMajorBit
                : 0,
        FlagsDirectAccessBit = HasDirectAccess ? DirectAccessBit : 0,
