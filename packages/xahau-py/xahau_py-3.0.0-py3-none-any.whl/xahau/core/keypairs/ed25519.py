...
from xahau.core.keypairs.helpers import sha512_first_half
...
class ED25519(CryptoImplementation):
    ...
    def derive_keypair(
        ...
        """
        Derives a key pair in Ed25519 format for use with the XAH Ledger from a
        seed value.
        ...
        Raises:
            XAHLKeypairsException: If the keypair is a validator keypair.
        """
        if is_validator:
            raise XAHLKeypairsException("Validator key pairs cannot use Ed25519")
