...
from xahau.models.currencies import XAH as XAHModel
from xahau.models.currencies import IssuedCurrency as IssuedCurrencyModel
...
class Issue(SerializedType):
    ...
    def from_value(cls: Type[Self], value: Dict[str, str]) -> Self:
        ...
        Raises:
            XAHLBinaryCodecException: If the Issue representation is invalid.
        """
        if XAHModel.is_dict_of_model(value):
