...
from xahau.asyncio.clients.utils import request_to_websocket, websocket_to_response
...
class WebsocketBase(Client):
    ...
    def _set_up_future(self: Self, request: Request) -> None:
        ...
        Raises:
            XAHLWebsocketException: if there is already a request with this ID
                in progress.
        """
