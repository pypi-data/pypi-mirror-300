"""Collection of public constants for XAHL."""
import re
...
class XAHLException(Exception):
    """Base Exception for XAHL library."""
...
"""
Matches ISO currencies like "USD" or "EUR" in the format allowed by XAHL.
...
"""
Matches hex-encoded currencies in the format allowed by XAHL.
