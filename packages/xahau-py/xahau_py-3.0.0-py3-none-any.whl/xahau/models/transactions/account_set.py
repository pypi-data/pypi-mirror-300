...
class AccountSetAsfFlag(int, Enum):
    ...
    ASF_DISALLOW_XAH = 3
    """XAH should not be sent to this account. (Enforced by client applications)"""
...
class AccountSetFlag(int, Enum):
    ...
    TF_DISALLOW_XAH = 0x00100000
    """
    The same as SetFlag: asfDisallowXAH.
    """

    TF_ALLOW_XAH = 0x00200000
    """
...
class AccountSet(Transaction):
    ...
    which modifies the properties of an account in the XAH Ledger.
    """
    ...
    use `xahau.utils.str_to_hex` to convert a UTF-8 string to hex.
    """
