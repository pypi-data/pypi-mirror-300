...
from xahau.core.addresscodec import is_valid_classic_address
...
class XChainCreateClaimID(Transaction):
    ...
    """
    The amount, in XAH, to reward the witness servers for providing signatures.
    ...
    def _get_errors(self: Self) -> Dict[str, str]:
        ...
        if self.other_chain_source != REQUIRED and not is_valid_classic_address(
            ...
            errors[
                "other_chain_source"
            ] = "`other_chain_source` must be a valid XAHL address."
