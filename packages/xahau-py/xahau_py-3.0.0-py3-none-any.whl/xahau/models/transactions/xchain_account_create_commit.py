...
class XChainAccountCreateCommit(Transaction):
    """
    Represents a XChainAccountCreateCommit transaction on the XAH Ledger.
    ...
    """
    The amount, in XAH, to be used to reward the witness servers for providing
    ...
    """
    The amount, in XAH, to use for account creation. This must be greater than
