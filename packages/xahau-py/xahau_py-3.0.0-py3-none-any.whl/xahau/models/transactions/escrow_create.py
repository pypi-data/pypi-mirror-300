...
class EscrowCreate(Transaction):
    ...
    transaction, which locks up XAH until a specific time or condition is met.
    """

    amount: Amount = REQUIRED  # type: ignore
    """
    Amount of XAH, in drops, to deduct from the sender's balance and set
    ...
    """
    The address that should receive the escrowed XAH when the time or
    ...
    """
    The time, in seconds since the Ripple Epoch, when the escrowed XAH can
