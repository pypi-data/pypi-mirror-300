...
class PathStep(BaseModel):
    ...
    def _get_currency_error(self: Self) -> Optional[str]:
        ...
        if self.issuer is not None and self.currency.upper() == "XAH":
            return "Cannot set issuer if currency is XAH"
        return None
    ...
    def _get_issuer_error(self: Self) -> Optional[str]:
        ...
        if self.currency is not None and self.currency.upper() == "XAH":
            return "Cannot set issuer if currency is XAH"
        return None
