...
from xahau.models.transactions.types import PseudoTransactionType
...
class SetFee(PseudoTransaction):
    ...
    `XAHFees Amendment<https://xrpl.org/known-amendments.html#xrpfees>`_

    Before the XAHFees Amendment which was proposed in rippled 1.10.0
    base_fee, reference_fee_units, reserve_base, and reserve_increment
    were required fields.

    After the XAHFees Amendment, base_fee_drops, reserve_base_drops,
    and reserve_increment_drops are required fields.

    No SetFee Pseudo Transaction should contain fields from BOTH before
    and after the XAHFees amendment.
    """

    # Required BEFORE the XAHFees Amendment

    base_fee: Optional[str] = None
    """
    The charge, in drops of XAH, for the reference transaction, as hex. (This is the
    ...
    # Required AFTER the XAHFees Amendment
