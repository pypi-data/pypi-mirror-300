...
from xahau.core.binarycodec import decode, encode
from xahau.models.amounts import IssuedCurrencyAmount
from xahau.models.base_model import ABBREVIATIONS, BaseModel
from xahau.models.exceptions import XAHLModelException
from xahau.models.flags import check_false_flag_definition, interface_to_flag_list
from xahau.models.nested_model import NestedModel
from xahau.models.requests import PathStep
from xahau.models.required import REQUIRED
from xahau.models.transactions.types import PseudoTransactionType, TransactionType
from xahau.models.types import XAHL_VALUE_TYPE
...
def transaction_json_to_binary_codec_form(
    dictionary: Dict[str, XAHL_VALUE_TYPE]
) -> Dict[str, XAHL_VALUE_TYPE]:
    """
...
def _value_to_tx_json(value: XAHL_VALUE_TYPE) -> XAHL_VALUE_TYPE:
...
class Signer(NestedModel):
    ...
    """
    The address of the Signer. This can be a funded account in the XAH
...
class Transaction(BaseModel):
    ...
    """
    (Auto-fillable) The amount of XAH to destroy as a cost to send this
    ...
    def get_hash(self: Self) -> str:
        ...
        Raises:
            XAHLModelException: if the Transaction is unsigned.
        """
    ...
    def get_transaction_type(
        ...
        Raises:
            XAHLModelException: If `transaction_type` is not a valid Transaction type.
        """
        import xahau.models.transactions as transaction_models
        import xahau.models.transactions.pseudo_transactions as pseudo_transaction_models  # noqa: E501
        ...
        raise XAHLModelException(f"{transaction_type} is not a valid Transaction type")
    ...
    def from_xrpl(cls: Type[Self], value: Union[str, Dict[str, Any]]) -> Self:
        ...
        Raises:
            XAHLModelException: If Payment transactions have different values for
