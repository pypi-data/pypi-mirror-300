...
class PaymentChannelCreate(Transaction):
    ...
    XAH. The sender of this transaction is the "source address" of the payment
    channel.
    """

    amount: Amount = REQUIRED  # type: ignore
    """
    The amount of XAH, in drops, to set aside in this channel. This field is
    required.
    ...
    """
    The account that can receive XAH from this channel, also known as the
