"""Interface for cryptographic key pairs for use with the XAH Ledger."""
...
from xahau.core.keypairs.crypto_implementation import CryptoImplementation
from xahau.core.keypairs.ed25519 import ED25519
from xahau.core.keypairs.ed25519 import PREFIX as ED_PREFIX
from xahau.core.keypairs.exceptions import XAHLKeypairsException
from xahau.core.keypairs.helpers import get_account_id
from xahau.core.keypairs.secp256k1 import SECP256K1
...
def generate_seed(
    ...
    Raises:
        XAHLAddressCodecException: If entropy is not of length addresscodec.SEED_LENGTH,
...
def derive_keypair(
    ...
    Args:
        seed: Seed to derive the key pair from. Use
            :func:`generate_seed() <xahau.core.keypairs.generate_seed>` to generate an
            appropriate value.
    ...
    Raises:
        XAHLKeypairsException: If the derived keypair did not generate a
...
def derive_classic_address(public_key: str) -> str:
    """
    Derive the XAH Ledger classic address for a given public key. See
    `Address Derivation
