...
# max length that can be represented in 2 bytes per XAHL serialization encoding
...
# maximum length that can be encoded in a length prefix per XAHL serialization encoding
...
class BinarySerializer:
    """Serializes JSON to XAHL binary format."""
