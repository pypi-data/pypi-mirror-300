...
class PathStep(SerializedType):
    ...
    def from_value(cls: Type[Self], value: Dict[str, str]) -> Self:
        ...
        Raises:
            XAHLBinaryCodecException: If the supplied value is of the wrong type.
        """
...
class PathSet(SerializedType):
    ...
    def from_value(cls: Type[Self], value: List[List[Dict[str, str]]]) -> Self:
        ...
        Raises:
            XAHLBinaryCodecException: If the PathSet representation is invalid.
        """
        if not isinstance(value, list):
            raise XAHLBinaryCodecException(
        ...
        raise XAHLBinaryCodecException("Cannot construct PathSet from given value")
