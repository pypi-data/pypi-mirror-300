...
from xahau.core.binarycodec.definitions import (
    FieldInstance,
    get_field_instance,
...
def _handle_xaddress(field: str, xaddress: str) -> Dict[str, Union[str, int]]:
    ...
    Raises:
        XAHLBinaryCodecException: field-tag combo is invalid.
    """
    ...
    if field == _DESTINATION:
        ...
        raise XAHLBinaryCodecException(f"{field} cannot have an associated tag")
...
class STObject(SerializedType):
    ...
    def from_parser(
        ...
        """
        from xahau.core.binarycodec.binary_wrappers.binary_serializer import (
            BinarySerializer,
        )
    ...
    def from_value(
        ...
        Raises:
            XAHLBinaryCodecException: If the STObject can't be constructed
                from value.
        """
        from xahau.core.binarycodec.binary_wrappers.binary_serializer import (
            BinarySerializer,
        ...
        for field in sorted_keys:
            ...
            except XAHLBinaryCodecException as e:
