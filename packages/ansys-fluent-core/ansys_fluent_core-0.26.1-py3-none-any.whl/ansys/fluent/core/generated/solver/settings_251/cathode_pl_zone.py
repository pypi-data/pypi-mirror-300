...
from .cathode_pl_cp_udf import cathode_pl_cp_udf as cathode_pl_cp_udf_cls
...
class cathode_pl_zone(Group):
    ...
    child_names = \
        ['cathode_pl_zone_list', 'cathode_pl_update', 'cathode_pl_material',
         ...
         'cathode_pl_cp_udf', 'cathode_pl_angle', 'cathode_pl_a',
         'cathode_pl_b', 'cathode_pl_c']
    ...
    _child_classes = dict(
        ...
        cathode_pl_cp_udf=cathode_pl_cp_udf_cls,
