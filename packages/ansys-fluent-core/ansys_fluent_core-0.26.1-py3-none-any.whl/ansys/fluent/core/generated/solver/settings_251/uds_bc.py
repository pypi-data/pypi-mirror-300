...
class uds_bc(NamedObject[discrete_boundary_condition_child], CreatableNamedObjectMixin[discrete_boundary_condition_child]):
    """
    Specify user-defined scalar boundary condition.
    """
