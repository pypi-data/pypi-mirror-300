...
from .use_second_cell_off_a_wall_quantities import use_second_cell_off_a_wall_quantities as use_second_cell_off_a_wall_quantities_cls
...
class near_wall_treatment(Group):
    ...
    child_names = \
        ['wall_treatment', 'user_defined', 'enhanced_wall_treatment_options',
         'wall_omega_treatment', 'use_second_cell_off_a_wall_quantities']
    ...
    _child_classes = dict(
        ...
        use_second_cell_off_a_wall_quantities=use_second_cell_off_a_wall_quantities_cls,
    )
