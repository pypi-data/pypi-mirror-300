...
from .delete_all_3 import delete_all as delete_all_cls
from .clear_data import clear_data as clear_data_cls
...
class report_files(NamedObject[report_files_child], CreatableNamedObjectMixin[report_files_child]):
    ...
    command_names = \
        ['create', 'delete', 'rename', 'list', 'list_properties',
         'make_a_copy', 'delete_all', 'clear_data']
