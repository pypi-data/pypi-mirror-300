...
from .continuity_transient_term_linearization import continuity_transient_term_linearization as continuity_transient_term_linearization_cls
from .enthalpy_reference_temperature import enthalpy_reference_temperature as enthalpy_reference_temperature_cls
...
class advanced(Group):
    ...
    child_names = \
        ['multi_grid', 'multi_stage', 'expert', 'fast_transient_settings',
         ...
         'continuity_transient_term_linearization',
    ...
    _child_classes = dict(
        ...
        continuity_transient_term_linearization=continuity_transient_term_linearization_cls,
        enthalpy_reference_temperature=enthalpy_reference_temperature_cls,
    )
