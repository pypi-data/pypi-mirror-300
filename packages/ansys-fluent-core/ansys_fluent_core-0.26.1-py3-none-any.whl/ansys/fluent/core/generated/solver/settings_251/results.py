...
from .custom_field_functions_1 import custom_field_functions as custom_field_functions_cls
...
class results(Group):
    ...
    child_names = \
        ['custom_field_functions', 'custom_vectors', 'surfaces', 'graphics',
         'plot', 'scene', 'animations', 'report']
