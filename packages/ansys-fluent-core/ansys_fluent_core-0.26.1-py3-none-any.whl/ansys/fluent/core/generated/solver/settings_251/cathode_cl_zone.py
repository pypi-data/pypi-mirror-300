...
from .cathode_cl_cp_udf import cathode_cl_cp_udf as cathode_cl_cp_udf_cls
...
class cathode_cl_zone(Group):
    ...
    child_names = \
        ['cathode_cl_zone_list', 'cathode_cl_update', 'cathode_cl_material',
         ...
         'cathode_cl_cp_function', 'cathode_cl_cp_udf', 'cathode_cl_angle',
    ...
    _child_classes = dict(
        ...
        cathode_cl_cp_udf=cathode_cl_cp_udf_cls,
