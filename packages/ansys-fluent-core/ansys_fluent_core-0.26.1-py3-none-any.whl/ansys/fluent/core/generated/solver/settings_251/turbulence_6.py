...
from .roughness_model import roughness_model as roughness_model_cls
...
from .sand_grain_roughness import sand_grain_roughness as sand_grain_roughness_cls
...
class turbulence(Group):
    ...
    child_names = \
        ['roughness_model', 'rough_option', 'rough_nasa', 'rough_shin_et_al',
         'rough_data', 'sand_grain_roughness', 'roughness_height',
    ...
    _child_aliases = dict(
        api_sand_grain_rough_spec="sand_grain_roughness",
