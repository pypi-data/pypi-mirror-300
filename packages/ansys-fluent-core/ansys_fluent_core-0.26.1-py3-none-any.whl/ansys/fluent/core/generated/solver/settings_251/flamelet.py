...
class flamelet(Group):
    ...
    child_names = \
        ['flamelet_parameters', 'include_equilibrium_flamelet',
         'pdf_include_equilibrium_flamelet', 'automatic_refinement',
         'initial_number_grids_flamelet', 'maximum_number_grids_flamelet',
         'maximum_change_value_ratio', 'maximum_change_solve_ratio',
         'refine_based']
