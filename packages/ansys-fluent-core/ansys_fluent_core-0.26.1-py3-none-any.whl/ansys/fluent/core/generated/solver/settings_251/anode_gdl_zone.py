...
from .anode_gdl_brug_coeff import anode_gdl_brug_coeff as anode_gdl_brug_coeff_cls
...
class anode_gdl_zone(Group):
    ...
    child_names = \
        ['anode_gdl_zone_list', 'anode_gdl_update', 'anode_gdl_material',
         ...
         'anode_gdl_brug_coeff', 'anode_gdl_a', 'anode_gdl_b', 'anode_gdl_c',
    ...
    _child_classes = dict(
        ...
        anode_gdl_brug_coeff=anode_gdl_brug_coeff_cls,
