...
from .zonal_pbns_solution_controls import zonal_pbns_solution_controls as zonal_pbns_solution_controls_cls
...
class controls(Group):
    ...
    child_names = \
        ['courant_number', 'p_v_controls', 'relaxation_factor',
         ...
         'zonal_pbns_solution_controls', 'acoustics_wave_eqn_controls',
         'contact_solution_controls', 'equations', 'limits', 'advanced',
         'species_urf_together']
    ...
    _child_classes = dict(
        ...
        zonal_pbns_solution_controls=zonal_pbns_solution_controls_cls,
