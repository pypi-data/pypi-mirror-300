...
from .anode_tref import anode_tref as anode_tref_cls
...
from .cathode_tref import cathode_tref as cathode_tref_cls
...
class parameters(Group):
    ...
    child_names = \
        ['anode_jref', 'anode_jea', 'anode_tref', 'anode_cref', 'anode_exp',
         'anode_ex_a', 'anode_ex_c', 'cathode_jref', 'cathode_jea',
         'cathode_tref', 'cathode_cref', 'cathode_exp', 'cathode_ex_a',
         'cathode_ex_c', 'anode_stde', 'cathode_stde', 'std_tem', 'std_pre',
         'open_voltage', 'anode_entro', 'cathode_entro', 'evaporation_rate',
         'condensation_rate', 'osmoticdrag_coeff']

    _child_classes = dict(
        anode_jref=anode_jref_cls,
        anode_jea=anode_jea_cls,
        anode_tref=anode_tref_cls,
