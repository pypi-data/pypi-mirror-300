...
from .cathode_gdl_brug_coeff import cathode_gdl_brug_coeff as cathode_gdl_brug_coeff_cls
...
class cathode_gdl_zone(Group):
    ...
    child_names = \
        ['cathode_gdl_zone_list', 'cathode_gdl_update',
         ...
         'cathode_gdl_brug_coeff', 'cathode_gdl_waterremoval',
         'cathode_gdl_a', 'cathode_gdl_b', 'cathode_gdl_c',
         'cathode_gdl_condensation', 'cathode_gdl_evaporation',
         'cathode_gdl_poresize']
    ...
    _child_classes = dict(
        ...
        cathode_gdl_brug_coeff=cathode_gdl_brug_coeff_cls,
