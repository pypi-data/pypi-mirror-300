...
class mixture_child(Group):
    ...
    child_names = \
        ['name', 'chemical_formula', 'species', 'reactions', 'reaction_mechs',
         ...
         'refractive_index', 'mass_diffusivity', 'thermal_diffusivity',
         'tmelt', 'melting_heat', 'eutectic_temp', 'speed_of_sound',
         ...
         'collision_cross_section', 'uds_diffusivity']
