...
from .sun_direction_vector_definition import sun_direction_vector_definition as sun_direction_vector_definition_cls
...
class solar_load(Group):
    ...
    child_names = \
        ['solar_model', 'sun_direction_vector_definition',
         'illumination_parameters', 'quad_tree_parameters',
         'ground_reflectivity', 'scattering_fraction',
         'solar_on_adjacent_fluid', 'solar_load_frequency',
         'solar_calculator', 'apply_full_solar_irradiation',
         'autoread_solar_data', 'autosave_solar_data']
    ...
    _child_classes = dict(
        ...
        sun_direction_vector_definition=sun_direction_vector_definition_cls,
