...
class controls(Group):
    """
    Enter the adjoint controls menu.
    """

    fluent_name = "controls"

    child_names = \
        ['solution_based_initialization', 'auto_adjust',
         'show_advancement_controls', 'apply_precondition', 'advancement',
         'under_relaxation', 'amg', 'stabilization']
