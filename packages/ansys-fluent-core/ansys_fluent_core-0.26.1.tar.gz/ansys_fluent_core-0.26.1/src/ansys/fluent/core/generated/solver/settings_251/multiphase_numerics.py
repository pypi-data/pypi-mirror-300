...
from .interphase_interactions import interphase_interactions as interphase_interactions_cls
...
class multiphase_numerics(Group):
    ...
    child_names = \
        ['porous_media', 'compressible_flow', 'boiling_parameters',
         'viscous_flow', 'heat_mass_transfer', 'interphase_interactions',
         'advanced_stability_controls', 'default_controls',
         'face_pressure_controls', 'solution_stabilization', 'energy']
    ...
    _child_classes = dict(
        ...
        interphase_interactions=interphase_interactions_cls,
