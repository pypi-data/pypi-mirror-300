...
from .velocity_magnitude import velocity_magnitude as velocity_magnitude_cls
...
class momentum(Group):
    ...
    child_names = \
        ['system_coupling', 'velocity_specification_method',
         'reference_frame', 'velocity_magnitude', 'initial_gauge_pressure',
    ...
    _child_classes = dict(
        ...
        velocity_magnitude=velocity_magnitude_cls,
