...
from .anode_pl_cp_udf import anode_pl_cp_udf as anode_pl_cp_udf_cls
...
class anode_pl_zone(Group):
    ...
    child_names = \
        ['anode_pl_zone_list', 'anode_pl_update', 'anode_pl_material',
         ...
         'anode_pl_cp_udf', 'anode_pl_angle', 'anode_pl_a', 'anode_pl_b',
         'anode_pl_c']
    ...
    _child_classes = dict(
        ...
        anode_pl_cp_udf=anode_pl_cp_udf_cls,
