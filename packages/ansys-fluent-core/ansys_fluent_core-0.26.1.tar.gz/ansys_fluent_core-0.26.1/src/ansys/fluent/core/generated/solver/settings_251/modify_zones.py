...
class modify_zones(Group):
    ...
    command_names = \
        ['deactivate_cell_zone', 'delete_cell_zone', 'copy_move_cell_zone',
         'copy_cell_zones_by_offsets', 'copy_cell_zones_by_delta',
         ...
         'del_cell_by_id', 'del_cell_by_mark']
    ...
    _child_classes = dict(
        ...
        copy_cell_zones_by_offsets=copy_cell_zones_by_offsets_cls,
        copy_cell_zones_by_delta=copy_cell_zones_by_delta_cls,
        ...
        del_cell_by_id=del_cell_by_id_cls,
        del_cell_by_mark=del_cell_by_mark_cls,
    )
