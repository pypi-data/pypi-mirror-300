...
class fluxes(Group):
    ...
    query_names = \
        ['get_mass_flow', 'get_heat_transfer', 'get_heat_transfer_sensible',
         'get_radiation_heat_transfer', 'get_film_mass_flow',
         'get_film_heat_transfer', 'get_electric_current',
         'get_pressure_work', 'get_viscous_work']
    ...
    _child_classes = dict(
        ...
        get_mass_flow=get_mass_flow_cls,
        get_heat_transfer=get_heat_transfer_cls,
        get_heat_transfer_sensible=get_heat_transfer_sensible_cls,
        get_radiation_heat_transfer=get_radiation_heat_transfer_cls,
        get_film_mass_flow=get_film_mass_flow_cls,
        get_film_heat_transfer=get_film_heat_transfer_cls,
        get_electric_current=get_electric_current_cls,
        get_pressure_work=get_pressure_work_cls,
        get_viscous_work=get_viscous_work_cls,
    )
