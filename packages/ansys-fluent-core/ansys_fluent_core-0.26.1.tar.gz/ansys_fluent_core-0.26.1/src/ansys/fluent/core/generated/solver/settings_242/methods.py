...
class methods(Group):
    ...
    child_names = \
        ['axisymmetric', 'p_v_coupling', 'flux_type', 'discretization_scheme',
         'bcd_boundedness', 'pseudo_time_method', 'transient_formulation',
         ...
         'warped_face_gradient_correction', 'species_disc_together']
