...
class contour_child(Group):
    ...
    child_names = \
        ['name', 'field', 'surfaces_list', 'range_option', 'range_options',
         'options', 'filled', 'node_values', 'boundary_values',
         'contour_lines', 'coloring', 'colorings', 'color_map',
         'annotations_list', 'draw_mesh', 'mesh_object', 'display_state_name',
