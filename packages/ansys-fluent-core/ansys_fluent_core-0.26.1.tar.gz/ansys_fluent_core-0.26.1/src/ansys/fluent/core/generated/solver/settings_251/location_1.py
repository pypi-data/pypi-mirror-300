...
from .spatial_staggering import spatial_staggering as spatial_staggering_cls
...
class location(Group):
    ...
    child_names = \
        ['injection_surfaces', 'randomized_positions_enabled',
         'number_of_streams', 'x', 'x_2', 'y', 'y_2', 'z', 'z_2',
         'azimuthal_start_angle', 'azimuthal_stop_angle',
         'spatial_staggering']
    ...
    _child_classes = dict(
        ...
        spatial_staggering=spatial_staggering_cls,
    )
