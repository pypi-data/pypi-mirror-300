...
from .option_44 import option as option_cls
...
class pathline_child(Group):
    ...
    child_names = \
        ['name', 'velocity_domain', 'field', 'release_from_surfaces', 'range',
         'range_options', 'style_attribute', 'style_attributes', 'options',
         'accuracy_control', 'option', 'step', 'skip', 'coarsen', 'onzone',
         'plot', 'onphysics', 'color_map', 'annotations_list', 'draw_mesh',
