...
from .anode_cl_cp_udf import anode_cl_cp_udf as anode_cl_cp_udf_cls
...
class anode_cl_zone(Group):
    ...
    child_names = \
        ['anode_cl_zone_list', 'anode_cl_update', 'anode_cl_material',
         ...
         'anode_cl_cp_function', 'anode_cl_cp_udf', 'anode_cl_angle',
    ...
    _child_classes = dict(
        ...
        anode_cl_cp_udf=anode_cl_cp_udf_cls,
