...
class table_parameters(Group):
    ...
    child_names = \
        ['number_grid_points_progress_variable', 'number_grid_points_pdf',
         'number_grid_points_progress_variable_variance',
         'number_grid_points_mixture_fraction_variance',
         'initial_grid_points', 'maximum_grid_points',
         'maximum_change_value_ratio', 'maximum_change_slope_ratio',
         'maximum_species', 'mean_enthalpy_points', 'minimum_temperature',
         'automatic_grid_refinement']
