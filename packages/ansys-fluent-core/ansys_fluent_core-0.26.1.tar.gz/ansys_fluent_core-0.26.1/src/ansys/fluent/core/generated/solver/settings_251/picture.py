...
from .invert_normals_for_avz import invert_normals_for_avz as invert_normals_for_avz_cls
...
class picture(Group):
    ...
    child_names = \
        ['raytracer_image', 'color_mode', 'driver_options',
         ...
         'jpeg_hardcopy_quality', 'invert_normals_for_avz']
    ...
    _child_classes = dict(
        ...
        invert_normals_for_avz=invert_normals_for_avz_cls,
        preview=preview_cls,
