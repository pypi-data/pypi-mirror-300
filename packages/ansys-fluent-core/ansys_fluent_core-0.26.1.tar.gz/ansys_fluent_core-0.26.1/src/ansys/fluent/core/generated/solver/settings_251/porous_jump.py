...
class porous_jump(Group):
    ...
    child_names = \
        ['porous_jump_turb_wall_treatment', 'alpha', 'dm', 'c2',
         ...
         'v_trans', 'strength', 'jump_adhesion', 'adhesion_constrained',
         'contact_angles', 'x_disp_boundary_condition',
         'x_disp_boundary_value', 'y_disp_boundary_condition',
         'y_disp_boundary_value', 'z_disp_boundary_condition',
