...
class spring_settings(Group):
    ...
    child_names = \
        ['constant_factor', 'tolerance', 'max_iter', 'bnd_node_relax',
         'bnd_stiffness_factor', 'spring_on_all_elements',
         'spring_on_simplex_elements', 'laplace_node_relax',
         'skew_smooth_niter', 'skew_smooth_cell_skew_max',
         'skew_smooth_face_skew_max', 'skew_smooth_all_deforming_boundaries',
         'verbosity']
