...
FOOD_CATALOG = {
            ...
            "butterhead lettuce": ("vegetables", "leafy"),
            "mixed greens": ("vegetables", "leafy"),
            "arugula": ("vegetables", "leafy"),
            "endive": ("vegetables", "leafy"),
            "endives": ("vegetables", "leafy"),
            "little gem lettuce": ("vegetables", "leafy"),
            "little gem lettuces": ("vegetables", "leafy"),
            "little gem": ("vegetables", "leafy"),
            "little gems": ("vegetables", "leafy"),
            "watercress": ("vegetables", "leafy"),
            ...
            "squash": ("vegetables", "fruit"),
            "squashes": ("vegetables", "fruit"),
            "acorn squash": ("vegetables", "fruit"),
            "acorn squashes": ("vegetables", "fruit"),
            "butternut squash": ("vegetables", "fruit"),
            "butternut squashes": ("vegetables", "fruit"),
            "spaghetti squash": ("vegetables", "fruit"),
            "spaghetti squashes": ("vegetables", "fruit"),
            # "zucchini": ("vegetables", "fruit"),
            # "zucchinis": ("vegetables", "fruit"),
           
            "okra": ("vegetables", "fruit"),
            "okras": ("vegetables", "fruit"),
            "bok choy": ("vegetables", "leafy"),
