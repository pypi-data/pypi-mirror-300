...
from marlenv import DiscreteActionSpace, MOMARLEnv, DiscreteSpace
...
@dataclass
class MOLLE(MOMARLEnv[DiscreteActionSpace, npt.NDArray[np.float32], npt.NDArray[np.float32]]):
    """
