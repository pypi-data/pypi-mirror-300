...
async def get_document_by_id(service, document_id):
...
class GDoc:
    ...
    @classmethod
    async def get_by_id(
        cls, document_id, auth=None, service=None, return_raw: bool = False
    ):
        ...
        doc = await get_document_by_id(service=service, document_id=document_id)
