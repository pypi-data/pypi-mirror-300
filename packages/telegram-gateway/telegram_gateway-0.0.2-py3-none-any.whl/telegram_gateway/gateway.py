...
class TelegramGateway:
    ...
    def sendVerificationMessage(self, phone_number: str, code: str | int | None = None, code_length: int | None = None, sender_username: str | None = None, request_id: str | None = None, callback_url: str | None = None, payload: str | None = None, ttl: int | None = None) -> types.RequestStatus:
        ...
        actualResult = result.get('result')
        if actualResult.get('delivery_status'):
            actualResult['delivery_status'] = types.DeliveryStatus(**actualResult['delivery_status'])
        if actualResult.get('verification_status'):
            actualResult['verification_status'] = types.VerificationStatus(**actualResult['verification_status'])
        return types.RequestStatus(**actualResult)
    ...
    def checkVerificationStatus(self, request_id: str, code: str | int | None = None):
