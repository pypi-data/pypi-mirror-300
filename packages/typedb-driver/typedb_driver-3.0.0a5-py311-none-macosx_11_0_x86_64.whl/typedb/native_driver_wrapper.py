...
class DatetimeAndZoneId(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")

    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    datetime_in_nanos = property(native_driver_python.DatetimeAndZoneId_datetime_in_nanos_get, native_driver_python.DatetimeAndZoneId_datetime_in_nanos_set)
    zone_id = property(native_driver_python.DatetimeAndZoneId_zone_id_get, native_driver_python.DatetimeAndZoneId_zone_id_set)
    __swig_destroy__ = native_driver_python.delete_DatetimeAndZoneId

# Register DatetimeAndZoneId in native_driver_python:
native_driver_python.DatetimeAndZoneId_swigregister(DatetimeAndZoneId)
...
def query_answer_is_concept_rows_stream(query_answer):
    return native_driver_python.query_answer_is_concept_rows_stream(query_answer)

def query_answer_is_concept_trees_stream(query_answer):
    return native_driver_python.query_answer_is_concept_trees_stream(query_answer)
...
def attribute_type_is_untyped(attribute_type):
    return native_driver_python.attribute_type_is_untyped(attribute_type)

def attribute_type_is_boolean(attribute_type):
    return native_driver_python.attribute_type_is_boolean(attribute_type)

def attribute_type_is_long(attribute_type):
    return native_driver_python.attribute_type_is_long(attribute_type)

def attribute_type_is_double(attribute_type):
    return native_driver_python.attribute_type_is_double(attribute_type)

def attribute_type_is_decimal(attribute_type):
    return native_driver_python.attribute_type_is_decimal(attribute_type)

def attribute_type_is_string(attribute_type):
    return native_driver_python.attribute_type_is_string(attribute_type)

def attribute_type_is_date(attribute_type):
    return native_driver_python.attribute_type_is_date(attribute_type)

def attribute_type_is_datetime(attribute_type):
    return native_driver_python.attribute_type_is_datetime(attribute_type)

def attribute_type_is_datetime_tz(attribute_type):
    return native_driver_python.attribute_type_is_datetime_tz(attribute_type)

def attribute_type_is_duration(attribute_type):
    return native_driver_python.attribute_type_is_duration(attribute_type)

def attribute_type_is_struct(attribute_type):
    return native_driver_python.attribute_type_is_struct(attribute_type)
...
def value_is_decimal(value):
    return native_driver_python.value_is_decimal(value)

def value_is_string(value):
    return native_driver_python.value_is_string(value)

def value_is_date(value):
    return native_driver_python.value_is_date(value)

def value_is_datetime(value):
    return native_driver_python.value_is_datetime(value)

def value_is_datetime_tz(value):
    return native_driver_python.value_is_datetime_tz(value)

def value_is_duration(value):
    return native_driver_python.value_is_duration(value)

def value_is_struct(value):
    return native_driver_python.value_is_struct(value)
...
def value_get_decimal(value):
    return native_driver_python.value_get_decimal(value)

def value_get_string(value):
    return native_driver_python.value_get_string(value)

def value_get_date_as_seconds(value):
    return native_driver_python.value_get_date_as_seconds(value)

def value_get_datetime(value):
    return native_driver_python.value_get_datetime(value)

def value_get_datetime_tz(value):
    return native_driver_python.value_get_datetime_tz(value)

def value_get_duration(value):
    return native_driver_python.value_get_duration(value)

def value_get_struct(value):
    return native_driver_python.value_get_struct(value)

def value_get_value_type(value):
    return native_driver_python.value_get_value_type(value)
...
def entity_get_iid(thing):
    return native_driver_python.entity_get_iid(thing)

def relation_get_iid(thing):
    return native_driver_python.relation_get_iid(thing)
...
def entity_type_get_label(entity_type):
    return native_driver_python.entity_type_get_label(entity_type)

def relation_type_get_label(relation_type):
    return native_driver_python.relation_type_get_label(relation_type)

def attribute_type_get_label(attribute_type):
    return native_driver_python.attribute_type_get_label(attribute_type)

def role_type_get_label(role_type):
    return native_driver_python.role_type_get_label(role_type)

def attribute_type_get_value_type(attribute_type):
    return native_driver_python.attribute_type_get_value_type(attribute_type)

def driver_open_core(address, driver_lang):
    return native_driver_python.driver_open_core(address, driver_lang)
