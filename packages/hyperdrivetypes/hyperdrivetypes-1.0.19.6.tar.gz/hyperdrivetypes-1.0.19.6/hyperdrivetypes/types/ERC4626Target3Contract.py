...
class ERC4626Target3AddLiquidityContractFunction(ContractFunction):
    """ContractFunction for the addLiquidity method."""

    def __call__(self, contribution: int, minLpSharePrice: int, minApr: int, maxApr: int, options: IHyperdrive.Options) -> ERC4626Target3AddLiquidityContractFunction:  # type: ignore
...
class ERC4626Target3InitializeContractFunction(ContractFunction):
    """ContractFunction for the initialize method."""

    def __call__(self, contribution: int, apr: int, options: IHyperdrive.Options) -> ERC4626Target3InitializeContractFunction:  # type: ignore
        clone = super().__call__(
            dataclass_to_tuple(contribution),
...
class ERC4626Target3ContractEvents(ContractEvents):
    ...
    AddLiquidity: Type[ERC4626Target3AddLiquidityContractEvent]

    Approval: Type[ERC4626Target3ApprovalContractEvent]

    ApprovalForAll: Type[ERC4626Target3ApprovalForAllContractEvent]

    CloseLong: Type[ERC4626Target3CloseLongContractEvent]

    CloseShort: Type[ERC4626Target3CloseShortContractEvent]

    CollectGovernanceFee: Type[ERC4626Target3CollectGovernanceFeeContractEvent]

    CreateCheckpoint: Type[ERC4626Target3CreateCheckpointContractEvent]

    Initialize: Type[ERC4626Target3InitializeContractEvent]

    OpenLong: Type[ERC4626Target3OpenLongContractEvent]

    OpenShort: Type[ERC4626Target3OpenShortContractEvent]

    PauseStatusUpdated: Type[ERC4626Target3PauseStatusUpdatedContractEvent]

    RedeemWithdrawalShares: Type[
        ERC4626Target3RedeemWithdrawalSharesContractEvent
    ]

    RemoveLiquidity: Type[ERC4626Target3RemoveLiquidityContractEvent]

    Sweep: Type[ERC4626Target3SweepContractEvent]

    TransferSingle: Type[ERC4626Target3TransferSingleContractEvent]
    ...
    def __init__(
        ...
        self.AddLiquidity = cast(
            Type[ERC4626Target3AddLiquidityContractEvent],
            ERC4626Target3AddLiquidityContractEvent.factory(
                "AddLiquidity",
                w3=w3,
                contract_abi=abi,
                address=address,
        ...
        self.Approval = cast(
            Type[ERC4626Target3ApprovalContractEvent],
            ERC4626Target3ApprovalContractEvent.factory(
                "Approval",
                w3=w3,
                contract_abi=abi,
                address=address,
        ...
        self.ApprovalForAll = cast(
            Type[ERC4626Target3ApprovalForAllContractEvent],
            ERC4626Target3ApprovalForAllContractEvent.factory(
                "ApprovalForAll",
                w3=w3,
                contract_abi=abi,
                address=address,
        ...
        self.CloseLong = cast(
            Type[ERC4626Target3CloseLongContractEvent],
            ERC4626Target3CloseLongContractEvent.factory(
                "CloseLong",
                w3=w3,
                contract_abi=abi,
                address=address,
        ...
        self.CloseShort = cast(
            Type[ERC4626Target3CloseShortContractEvent],
            ERC4626Target3CloseShortContractEvent.factory(
                "CloseShort",
                w3=w3,
                contract_abi=abi,
                address=address,
        ...
        self.CollectGovernanceFee = cast(
            Type[ERC4626Target3CollectGovernanceFeeContractEvent],
        ...
        self.CreateCheckpoint = cast(
            Type[ERC4626Target3CreateCheckpointContractEvent],
        ...
        self.Initialize = cast(
            Type[ERC4626Target3InitializeContractEvent],
            ERC4626Target3InitializeContractEvent.factory(
                "Initialize",
                w3=w3,
                contract_abi=abi,
                address=address,
        ...
        self.OpenLong = cast(
            Type[ERC4626Target3OpenLongContractEvent],
            ERC4626Target3OpenLongContractEvent.factory(
                "OpenLong",
                w3=w3,
                contract_abi=abi,
                address=address,
        ...
        self.OpenShort = cast(
            Type[ERC4626Target3OpenShortContractEvent],
            ERC4626Target3OpenShortContractEvent.factory(
                "OpenShort",
                w3=w3,
                contract_abi=abi,
                address=address,
        ...
        self.PauseStatusUpdated = cast(
            Type[ERC4626Target3PauseStatusUpdatedContractEvent],
        ...
        self.RedeemWithdrawalShares = cast(
            Type[ERC4626Target3RedeemWithdrawalSharesContractEvent],
        ...
        self.RemoveLiquidity = cast(
            Type[ERC4626Target3RemoveLiquidityContractEvent],
        ...
        self.Sweep = cast(
            Type[ERC4626Target3SweepContractEvent],
            ERC4626Target3SweepContractEvent.factory(
                "Sweep",
                w3=w3,
                contract_abi=abi,
                address=address,
        ...
        self.TransferSingle = cast(
            Type[ERC4626Target3TransferSingleContractEvent],
            ERC4626Target3TransferSingleContractEvent.factory(
                "TransferSingle",
                w3=w3,
                contract_abi=abi,
                address=address,
...
class ERC4626Target3AddressEmptyCodeContractError:
    ...
    # pylint: disable=useless-parent-delegation
    def __init__(
        self: "ERC4626Target3AddressEmptyCodeContractError",
    ) -> None:
    ...
    def decode_error_data(
        ...
        error_abi = cast(
            ...
            [
                item
                for item in erc4626target3_abi
...
class ERC4626Target3AddressInsufficientBalanceContractError:
    ...
    # pylint: disable=useless-parent-delegation
    def __init__(
        self: "ERC4626Target3AddressInsufficientBalanceContractError",
    ) -> None:
...
class ERC4626Target3BelowMinimumContributionContractError:
    ...
    # pylint: disable=useless-parent-delegation
    def __init__(
        self: "ERC4626Target3BelowMinimumContributionContractError",
    ) -> None:
...
class ERC4626Target3CircuitBreakerTriggeredContractError:
    ...
    # pylint: disable=useless-parent-delegation
    def __init__(
        self: "ERC4626Target3CircuitBreakerTriggeredContractError",
    ) -> None:
...
class ERC4626Target3DecreasedPresentValueWhenAddingLiquidityContractError:
    ...
    # pylint: disable=useless-parent-delegation
    def __init__(
        self: "ERC4626Target3DecreasedPresentValueWhenAddingLiquidityContractError",
    ) -> None:
...
class ERC4626Target3DistributeExcessIdleFailedContractError:
    ...
    # pylint: disable=useless-parent-delegation
    def __init__(
        self: "ERC4626Target3DistributeExcessIdleFailedContractError",
    ) -> None:
...
class ERC4626Target3ExpInvalidExponentContractError:
    ...
    # pylint: disable=useless-parent-delegation
    def __init__(
        self: "ERC4626Target3ExpInvalidExponentContractError",
    ) -> None:
...
class ERC4626Target3FailedInnerCallContractError:
    ...
    # pylint: disable=useless-parent-delegation
    def __init__(
        self: "ERC4626Target3FailedInnerCallContractError",
    ) -> None:
...
class ERC4626Target3InsufficientLiquidityContractError:
    ...
    # pylint: disable=useless-parent-delegation
    def __init__(
        self: "ERC4626Target3InsufficientLiquidityContractError",
    ) -> None:
...
class ERC4626Target3InvalidAprContractError:
    ...
    # pylint: disable=useless-parent-delegation
    def __init__(
        self: "ERC4626Target3InvalidAprContractError",
    ) -> None:
...
class ERC4626Target3InvalidEffectiveShareReservesContractError:
    ...
    # pylint: disable=useless-parent-delegation
    def __init__(
        self: "ERC4626Target3InvalidEffectiveShareReservesContractError",
    ) -> None:
...
class ERC4626Target3InvalidTimestampContractError:
    ...
    # pylint: disable=useless-parent-delegation
    def __init__(
        self: "ERC4626Target3InvalidTimestampContractError",
    ) -> None:
...
class ERC4626Target3LnInvalidInputContractError:
    ...
    # pylint: disable=useless-parent-delegation
    def __init__(
        self: "ERC4626Target3LnInvalidInputContractError",
    ) -> None:
...
class ERC4626Target3MinimumTransactionAmountContractError:
    ...
    # pylint: disable=useless-parent-delegation
    def __init__(
        self: "ERC4626Target3MinimumTransactionAmountContractError",
    ) -> None:
...
class ERC4626Target3NotPayableContractError:
    ...
    # pylint: disable=useless-parent-delegation
    def __init__(
        self: "ERC4626Target3NotPayableContractError",
    ) -> None:
...
class ERC4626Target3OutputLimitContractError:
    ...
    # pylint: disable=useless-parent-delegation
    def __init__(
        self: "ERC4626Target3OutputLimitContractError",
    ) -> None:
...
class ERC4626Target3PoolAlreadyInitializedContractError:
    ...
    # pylint: disable=useless-parent-delegation
    def __init__(
        self: "ERC4626Target3PoolAlreadyInitializedContractError",
    ) -> None:
...
class ERC4626Target3PoolIsPausedContractError:
    ...
    # pylint: disable=useless-parent-delegation
    def __init__(
        self: "ERC4626Target3PoolIsPausedContractError",
    ) -> None:
...
class ERC4626Target3ReentrancyGuardReentrantCallContractError:
    ...
    # pylint: disable=useless-parent-delegation
    def __init__(
        self: "ERC4626Target3ReentrancyGuardReentrantCallContractError",
    ) -> None:
...
class ERC4626Target3RestrictedZeroAddressContractError:
    ...
    # pylint: disable=useless-parent-delegation
    def __init__(
        self: "ERC4626Target3RestrictedZeroAddressContractError",
    ) -> None:
...
class ERC4626Target3SafeERC20FailedOperationContractError:
    ...
    # pylint: disable=useless-parent-delegation
    def __init__(
        self: "ERC4626Target3SafeERC20FailedOperationContractError",
    ) -> None:
...
class ERC4626Target3TransferFailedContractError:
    ...
    # pylint: disable=useless-parent-delegation
    def __init__(
        self: "ERC4626Target3TransferFailedContractError",
    ) -> None:
...
class ERC4626Target3UnsafeCastToInt128ContractError:
    ...
    # pylint: disable=useless-parent-delegation
    def __init__(
        self: "ERC4626Target3UnsafeCastToInt128ContractError",
    ) -> None:
...
class ERC4626Target3UnsafeCastToInt256ContractError:
    ...
    # pylint: disable=useless-parent-delegation
    def __init__(
        self: "ERC4626Target3UnsafeCastToInt256ContractError",
    ) -> None:
...
class ERC4626Target3UnsafeCastToUint112ContractError:
    ...
    # pylint: disable=useless-parent-delegation
    def __init__(
        self: "ERC4626Target3UnsafeCastToUint112ContractError",
    ) -> None:
...
class ERC4626Target3UnsafeCastToUint128ContractError:
    ...
    # pylint: disable=useless-parent-delegation
    def __init__(
        self: "ERC4626Target3UnsafeCastToUint128ContractError",
    ) -> None:
...
class ERC4626Target3UpdateLiquidityFailedContractError:
    ...
    # pylint: disable=useless-parent-delegation
    def __init__(
        self: "ERC4626Target3UpdateLiquidityFailedContractError",
    ) -> None:
...
class ERC4626Target3ContractErrors:
    ...
    def decode_custom_error(self, data: str) -> tuple[Any, ...]:
        ...
        raise ValueError(
            f"ERC4626Target3 does not have a selector matching {selector}"
        )
