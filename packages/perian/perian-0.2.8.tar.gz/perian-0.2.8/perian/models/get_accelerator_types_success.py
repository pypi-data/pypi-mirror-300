...
class GetAcceleratorTypesSuccess(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["status", "message", "detail", "status_code", "no", "accelerator_types", "pagination"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetAcceleratorTypesSuccess from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetAcceleratorTypesSuccess from a dict"""
        if obj is None:
            return None
