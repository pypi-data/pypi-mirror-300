...
class CpuQueryInput(BaseModel):
    """
    Query for the CPU attribute.
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["operator", "options", "all", "no", "cores", "threads", "speed"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CpuQueryInput from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # and model_fields_set contains the field
        if self.cores is None and "cores" in self.model_fields_set:
            _dict['cores'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CpuQueryInput from a dict"""
        if obj is None:
            return None
