...
class InstanceTypeQueryOutput(BaseModel):
    """
    Query for the instance type attribute.
    """ # noqa: E501
    operator: Optional[Operator] = None
    options: Optional[QueryOptions] = None
    all: Optional[StrictBool] = False
    id: Optional[Id] = None
    region: Optional[RegionQueryOutput] = None
    zone: Optional[ZoneQueryOutput] = None
    name: Optional[StrictStr] = None
    cpu: Optional[CpuQueryOutput] = None
    accelerator: Optional[AcceleratorQueryOutput] = None
    ram: Optional[MemoryQueryOutput] = None
    storage: Optional[StorageQueryOutput] = None
    network: Optional[NetworkQueryOutput] = None
    price: Optional[PriceQueryOutput] = None
    availability: Optional[AvailabilityQueryOutput] = None
    type: Optional[StrictStr] = None
    provider: Optional[ProviderQueryOutput] = None
    reference_id: Optional[ReferenceIdQueryOutput] = None
    attributes_hash: Optional[AttributesHash] = None
    __properties: ClassVar[List[str]] = ["operator", "options", "all", "id", "region", "zone", "name", "cpu", "accelerator", "ram", "storage", "network", "price", "availability", "type", "provider", "reference_id", "attributes_hash"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of attributes_hash
        if self.attributes_hash:
            _dict['attributes_hash'] = self.attributes_hash.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "region": RegionQueryOutput.from_dict(obj["region"]) if obj.get("region") is not None else None,
            "zone": ZoneQueryOutput.from_dict(obj["zone"]) if obj.get("zone") is not None else None,
            "name": obj.get("name"),
            "cpu": CpuQueryOutput.from_dict(obj["cpu"]) if obj.get("cpu") is not None else None,
            "accelerator": AcceleratorQueryOutput.from_dict(obj["accelerator"]) if obj.get("accelerator") is not None else None,
            "ram": MemoryQueryOutput.from_dict(obj["ram"]) if obj.get("ram") is not None else None,
            "storage": StorageQueryOutput.from_dict(obj["storage"]) if obj.get("storage") is not None else None,
            "network": NetworkQueryOutput.from_dict(obj["network"]) if obj.get("network") is not None else None,
            "price": PriceQueryOutput.from_dict(obj["price"]) if obj.get("price") is not None else None,
            "availability": AvailabilityQueryOutput.from_dict(obj["availability"]) if obj.get("availability") is not None else None,
            "type": obj.get("type"),
            "provider": ProviderQueryOutput.from_dict(obj["provider"]) if obj.get("provider") is not None else None,
            "reference_id": ReferenceIdQueryOutput.from_dict(obj["reference_id"]) if obj.get("reference_id") is not None else None,
            "attributes_hash": AttributesHash.from_dict(obj["attributes_hash"]) if obj.get("attributes_hash") is not None else None
        })
        return _obj
