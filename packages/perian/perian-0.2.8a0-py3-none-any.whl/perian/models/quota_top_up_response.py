...
class QuotaTopUpResponse(BaseModel):
    """
    JSON schema for quota topup endpoint.
    """ # noqa: E501
    ...
    payment_url: StrictStr
    __properties: ClassVar[List[str]] = ["status", "message", "detail", "status_code", "payment_url"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of QuotaTopUpResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of QuotaTopUpResponse from a dict"""
        if obj is None:
            return None
