...
class RegionQueryOutput(BaseModel):
    """
    Subquery for the region attribute.
    """ # noqa: E501
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RegionQueryOutput from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if sustainable (nullable) is None
        # and model_fields_set contains the field
        if self.sustainable is None and "sustainable" in self.model_fields_set:
            _dict['sustainable'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RegionQueryOutput from a dict"""
        if obj is None:
            return None
