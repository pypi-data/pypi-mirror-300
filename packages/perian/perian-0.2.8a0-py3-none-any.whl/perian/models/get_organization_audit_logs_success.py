...
class GetOrganizationAuditLogsSuccess(BaseModel):
    """
    Module for defining the GetOrganizationAuditLogsSuccess class.
    """ # noqa: E501
    ...
    audit_logs: Optional[List[RequestLog]] = None
    __properties: ClassVar[List[str]] = ["status", "message", "detail", "status_code", "audit_logs"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetOrganizationAuditLogsSuccess from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetOrganizationAuditLogsSuccess from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "audit_logs": [RequestLog.from_dict(_item) for _item in obj["audit_logs"]] if obj.get("audit_logs") is not None else None
        })
        return _obj
