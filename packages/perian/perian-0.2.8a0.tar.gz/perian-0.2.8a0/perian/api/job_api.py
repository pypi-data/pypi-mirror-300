...
class JobApi:
    ...
    def cancel_job(
        ...
        Endpoint for Cancelling a Job by its id.  Args:     request(Request): HTTP request,     job_id(int): Job id to be cancelled.  Returns:     DefaultSuccess  Raises:     NoJobFoundError: if the requested Job is not found,     JobAlreadyDoneError: if the requested Job is already done.
    ...
    def create_job(
        ...
        Endpoint for creating a new Job.  Args:     job_request(CreateJobRequest): parameters of the Job needed to be created,     request(Request): HTTP request  Returns:     CreateJobSuccess: if the Job is created successfully  Raises:     IncorrectCreateJobParameterError: if there is a missing parameter,     InsufficientQuotaError: if organization's quota is insufficient,     InstanceTypeNotFoundError: if the Instance type is not found.
    ...
    def get_all_jobs(
        ...
        Endpoint for fetching all Jobs for an organization.  Args:     request(Request): HTTP request,     limit(int): page size limit for returned Jobs,     page(int): page number.  Returns:     GetJobsSuccess: a list of paginated Jobs.
    ...
    def get_job_by_id(
        ...
        Endpoint for fetching a Job by its id.  Args:     request(Request): HTTP request,     job_id(UUID): Job id to be fetched  Returns:     GetJobsSuccess: Job requested by user  Raises:     NoJobFoundError: if the job id is not found,     NoParameterError: if no job_id is provided.
