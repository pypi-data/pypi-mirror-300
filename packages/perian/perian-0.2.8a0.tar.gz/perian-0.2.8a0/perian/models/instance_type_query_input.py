...
class InstanceTypeQueryInput(BaseModel):
    ...
    provider: Optional[ProviderQueryInput] = None
    reference_id: Optional[ReferenceIdQueryInput] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "type": obj.get("type"),
            "provider": ProviderQueryInput.from_dict(obj["provider"]) if obj.get("provider") is not None else None,
            "reference_id": ReferenceIdQueryInput.from_dict(obj["reference_id"]) if obj.get("reference_id") is not None else None,
