...
class SrcApiRouterInstanceTypeInstanceTypeNotFoundError(BaseModel):
    """
    SrcApiRouterInstanceTypeInstanceTypeNotFoundError
    """ # noqa: E501
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SrcApiRouterInstanceTypeInstanceTypeNotFoundError from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SrcApiRouterInstanceTypeInstanceTypeNotFoundError from a dict"""
        if obj is None:
            return None
