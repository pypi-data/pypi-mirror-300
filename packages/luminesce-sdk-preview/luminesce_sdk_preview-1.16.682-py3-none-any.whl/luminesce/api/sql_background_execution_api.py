...
class SqlBackgroundExecutionApi(object):
    ...
    def cancel_query_with_http_info(self, execution_id, **kwargs):  # noqa: E501
        ...
        header_params['X-LUSID-SDK-Version'] = '1.16.682'
    ...
    def fetch_query_result_csv(self, execution_id, **kwargs):  # noqa: E501
        ...
        :type escape: str
        :param load_wait_milliseconds: Optional period to wait for results deserialization if in progress when this method is called.
