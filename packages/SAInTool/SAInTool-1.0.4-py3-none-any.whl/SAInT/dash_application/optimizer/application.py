    ...
    def create_output_container(self, outputs):
        return dbc.Container([
            ...
            dbc.Row([html.H6("Features"), outputs["features_output"]])
                ...
                "width": "100%",  # Ensures the div takes up the full width of the parent container
                "padding": "0px",  # Optional: remove padding if needed
                "margin": "0px",   # Optional: remove margin if needed
            }
        )
