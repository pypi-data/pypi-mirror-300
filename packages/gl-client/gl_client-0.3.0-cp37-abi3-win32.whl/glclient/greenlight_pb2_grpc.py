...
if _version_not_supported:
    warnings.warn(
        ...
        + f' but the generated code in glclient/greenlight_pb2_grpc.py depends on'
...
def add_NodeServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('greenlight.Node', rpc_method_handlers)
...
def add_HsmServicer_to_server(servicer, server):
    ...
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('greenlight.Hsm', rpc_method_handlers)
