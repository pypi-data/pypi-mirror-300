...
from mtmai.crud.curd_blog import create_blog_post, get_tags_by_post, update_post
...
@flow
async def article_creation_flow(title: str, content: str):
    # 文章创建逻辑
...
async def post_test1(
    *,
    ...
    result = await article_creation_flow("title1", "content1")
    return result
