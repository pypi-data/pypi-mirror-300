...
public:
  HeightmapSelector(Window* window, std::shared_ptr<Heightmap> selectedHeightmap);
  HeightmapSelector(Window* window, std::shared_ptr<Heightmap> selectedHeightmap, const glm::ivec2& size);
