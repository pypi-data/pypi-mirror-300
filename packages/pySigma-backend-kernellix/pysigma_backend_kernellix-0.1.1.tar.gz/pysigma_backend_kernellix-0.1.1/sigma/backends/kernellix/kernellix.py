...
class kernellixBackend(TextQueryBackend):
    ...
    startswith_expression : ClassVar[str] = '(!({field}==null) && (starts_with(string!({field}),{value})))'
    endswith_expression   : ClassVar[str] = '(!({field}==null) && (ends_with(string!({field}),{value})))'
    contains_expression   : ClassVar[str] = '(!({field}==null) && (contains(string!({field}),{value})))'
    cmdeq_expression      : ClassVar[str] = '(!({field}==null) && (cmdeq(string!({field}),{value})))'
