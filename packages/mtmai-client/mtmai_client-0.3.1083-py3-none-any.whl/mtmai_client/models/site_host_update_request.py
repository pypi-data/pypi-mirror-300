...
T = TypeVar("T", bound="SiteHostUpdateRequest")


@_attrs_define
class SiteHostUpdateRequest:
    """
    Attributes:
        domain (str):
        site_id (str):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        site_host_update_request.additional_properties = d
        return site_host_update_request
