...
def main() -> None:
    try:
        ...
        parser.add_argument('--game', type=str, help='The timeout for the server hole punch method keep alives')
        parser.add_argument('--hostname', type=str, help='The active network adapter to use.')
