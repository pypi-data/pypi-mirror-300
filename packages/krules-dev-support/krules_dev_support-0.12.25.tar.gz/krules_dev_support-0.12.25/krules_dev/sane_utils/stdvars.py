...
@inject
def get_project_number(target=None) -> str:
    return get_var_for_target("project_number", target, default=None)
...
@inject
def get_cluster_project_number(target=None) -> str:
    return get_var_for_target("cluster_project_number", target=target, default=get_project_number())
