...
from yta_general_utils.checker.type import is_class
...
class SegmentConfiguration:
    ...
    def __init__(self, type: SegmentType):
        self.type = type,
        self.modes = None, # By now we don't accept modes
        self.default_mode = None # By now we don't accept modes
        self.string_durations = None # By now we don't accept string durations here
    ...
    def is_valid_duration(duration: Union[float, int, str, SegmentStringDuration]):
        ...
        ElementParameterValidator.validate_numeric_positive_mandatory_parameter('duration', duration)
