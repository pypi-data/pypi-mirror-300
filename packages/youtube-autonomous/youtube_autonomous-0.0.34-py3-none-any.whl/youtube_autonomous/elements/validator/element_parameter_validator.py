...
class ElementParameterValidator(ParameterValidator):
    ...
    def validate_segment_type(cls, type: Union[SegmentType, str]):
        ...
        was ok.
        """
        return cls.validate_enum('type', type, SegmentType)
    ...
    def validate_enhancement_type(cls, type: Union[EnhancementType, str]):
        ...
        everything was ok.
        """
        return cls.validate_enum('type', type, EnhancementType)
    ...
    def validate_segment_status(cls, status: Union[SegmentStatus, str]):
        ...
        everything was ok.
        """
        return cls.validate_enum('status', status, SegmentStatus)
    ...
    def validate_project_status(cls, status: Union[ProjectStatus, str]):
        ...
        everything was ok.
        """
        return cls.validate_enum('status', status, ProjectStatus)
    ...
    def validate_edition_manual_term_mode(cls, mode: Union[EditionManualTermMode, str]):
        ...
        """
        return cls.validate_enum('mode', mode, EditionManualTermMode)
    ...
    def validate_edition_manual_term_context(cls, context: Union[EditionManualTermContext, str]):
        ...
        """
        return cls.validate_enum('context', context, EditionManualTermContext)
    ...
    def validate_transcription_parameter(cls, transcription: list[dict]):
        # for transcription_word in transcription:
        #     if not 'word' in transcription_word or not 'start' in transcription_word or not 'end' in transcription_word:
        #         raise Exception('At least one term of the provided "transciption" parameter has no "word", "start" or "end" field.')
        if any(not 'text' in transcription_word or not 'start' in transcription_word or not 'end' in transcription_word for transcription_word in transcription):
