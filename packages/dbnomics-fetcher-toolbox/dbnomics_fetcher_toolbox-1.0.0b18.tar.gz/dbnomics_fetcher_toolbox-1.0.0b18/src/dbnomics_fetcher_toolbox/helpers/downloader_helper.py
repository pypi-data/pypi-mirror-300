...
DEFAULT_UPDATES_FILE_NAME: Final = "updates.json"
    ...
    def __init__(
        ...
        *,
        ...
        if updates_file is None:
            updates_file = state_dir / DEFAULT_UPDATES_FILE_NAME
        self._update_repo = UpdateRepo(updates_file=updates_file)
