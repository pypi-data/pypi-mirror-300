...
class DocumentManager:
	...
	def __init__(self, project_name: str, project_description: str, repo_author: str, repo_name: str, project_root_dir: str, folders: List[DocumentFolder]):
		"""
		Constructs a new instance.
	...
	def generate_readme(self):
		...
		page = f'''# {self.repo_author}

<p align="center">{self.project_description}</p>
<br>
<p align="center">
		...
		for folder in self.folders:
			...
			for section in folder.sections:
				...
				for linked_subsection in section.linked_subsections:
					page += f' + {linked_subsection.title}\n'
...
class ProjectStructureGenerator:
	...
	def generate_structure(self):
		...
		for file in self.structure['.']['basic']:
			debug_message(f'[Structor Generator] {file} processing...')
			with open(os.path.join(self.project_root_dir, file), 'w') as file:
				file.write(f'# {file}\n')
