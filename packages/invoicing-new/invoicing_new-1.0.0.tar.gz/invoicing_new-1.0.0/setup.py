...
setup(
  name = 'invoicing-new',         #* Your package will have this name in pypi
  packages = ['invoicing'],   #* Name the package again in our directory
  ...
  author = 'Jonathan Marder',                   # Your name
  author_email = 'jjjcmar@comcast.net',  # Your email
