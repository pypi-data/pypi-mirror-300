...
class DivActionSetState(BaseDiv):
    ...
    state_id: typing.Union[Expr, str] = Field(
        description=(
            ...
            "activated. Set in`div_data_state_id/id/state_id` format. "
            "Can be "
            "hierarchical:`div_data_state_id/id_1/state_id_1/../id_n/sta"
            "te_id_n`. Consists of:`div_data_state_id` - `state_id` "
            "numeric value of the `state` object in`data`;`id` - `id` "
            "value of the `state` object;`state_id` - `state_id` value "
            "ofthe `state` object in `state`."
        ),
    )
    temporary: typing.Optional[typing.Union[Expr, bool]] = Field(
        description=(
            "Indicates a state change:`true`: The change is temporary "
            "and when the element isre-created, the state will change "
            "back to the initial one (default value).`false`- The state "
            "change is permanent."
        ),
    )
