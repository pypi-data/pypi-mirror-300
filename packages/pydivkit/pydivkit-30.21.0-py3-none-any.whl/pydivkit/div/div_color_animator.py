...
# Color animator.
class DivColorAnimator(BaseDiv):

    def __init__(
        self, *,
        type: str = "color_animator",
        ...
        end_value: typing.Optional[typing.Union[Expr, str]] = None,
        ...
        start_value: typing.Optional[typing.Union[Expr, str]] = None,
    ...
    type: str = Field(default="color_animator")
    ...
    end_value: typing.Union[Expr, str] = Field(
        format="color", 
    ...
    start_value: typing.Optional[typing.Union[Expr, str]] = Field(
        format="color", 
        description=(
