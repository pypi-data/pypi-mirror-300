...
class OpenAIClient(Client):
    ...
    def _get_params(
        self, messages: list[Message], system: str, tools: list[Tool]
    ) -> dict:
    ...
    @classmethod
    def format_content(cls, value: str | Message | list[MessageContent]) -> Any:
    ...
    @classmethod
    def load_content(
        cls, content: str | list[dict[str, str]]
