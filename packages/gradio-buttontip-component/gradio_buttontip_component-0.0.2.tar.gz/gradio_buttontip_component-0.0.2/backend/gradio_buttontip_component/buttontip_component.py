...
class buttontip_component(Component):
    """
    ...
    def __init__(
        ...
        *,
        ...
        tooltip: str = None,
        tooltip_color: str = "#fff",
        tooltip_background_color: str = "#000",
        x: int = None,
        y: int = None,
    ):
        """
        Parameters:
            ...
            interactive: If False, the ButtonTip will be in a disabled state.
