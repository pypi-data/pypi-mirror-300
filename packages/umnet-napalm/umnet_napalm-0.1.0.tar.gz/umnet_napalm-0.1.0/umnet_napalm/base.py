...
from .models import IPInterfaceDict, RouteDict, MPLSDict, VNIDict
...
class UMnetNapalm(NetworkDriver):
    """
    ...
    def _get_inventory_type(self, name: str) -> str:
        ...
        raise UMnetNapalmError(f"{self.hostname}: Unknown inventory item {name}")
