...
class FunctionApp(BaseModel):
    ...
    latest_version: Version = Field(description="The latest version of the function")
    ...
    __properties: ClassVar[List[str]] = ["name", "owner_name", "visibility", "title", "code_url", "description", "tags", "cover_image_url", "examples", "readme", "latest_version", "featured_key", "function_type", "webhooks", "restart_on_error"]
