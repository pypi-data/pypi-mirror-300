...
class ConfigModel(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "version", "inputs", "outputs", "gpu", "machine_type", "split", "private", "type", "is_iterator_input", "is_iterator_output", "env", "public_data", "restart_on_error"]
