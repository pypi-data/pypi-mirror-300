...
def ps_get_activigy_log(activity, start, end, url=None):
    ...
    header = {'authorization': 'Bearer ' + g_token}
    api_url = f'{g_api_url_base}activityLogs/search?activity={activity}&result=Success&offset=0&count=150000&includeDeviceUsage=true&startDateRange={start}&endDateRange={end}'
