import sys
import os
# sys.path.append(os.path.abspath("/Users/lmarchand/PycharmProjects/pypscloud/pypscloud"))
...
def test_changing_mp_name(ps):
    dominion = 252
    datacenters = 572
    #mps = ps.get_all_mp_from_account(datacenters, True)
    #print(mps)
    accountId = 8869
    siteId = 11284
    mpId = 86355902
