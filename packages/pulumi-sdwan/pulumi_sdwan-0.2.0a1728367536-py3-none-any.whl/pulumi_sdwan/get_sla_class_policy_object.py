...
class GetSlaClassPolicyObjectResult:
    ...
    def app_probe_class_id(self) -> str:
        """
    ...
    def app_probe_class_version(self) -> int:
        """
    ...
    def fallback_best_tunnel_jitter(self) -> int:
        """
    ...
    def fallback_best_tunnel_latency(self) -> int:
        """
    ...
    def fallback_best_tunnel_loss(self) -> int:
        """
...
def get_sla_class_policy_object(id: Optional[str] = None,
