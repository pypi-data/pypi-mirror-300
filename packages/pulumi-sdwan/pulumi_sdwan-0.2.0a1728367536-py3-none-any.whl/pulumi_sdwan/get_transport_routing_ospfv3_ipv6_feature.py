...
__all__ = [
    'GetTransportRoutingOspfv3Ipv6FeatureResult',
    'AwaitableGetTransportRoutingOspfv3Ipv6FeatureResult',
    'get_transport_routing_ospfv3_ipv6_feature',
    'get_transport_routing_ospfv3_ipv6_feature_output',
]

@pulumi.output_type
class GetTransportRoutingOspfv3Ipv6FeatureResult:
    """
    ...
    @property
    @pulumi.getter
    def areas(self) -> Sequence['outputs.GetTransportRoutingOspfv3Ipv6FeatureAreaResult']:
        """
    ...
    @property
    @pulumi.getter
    def redistributes(self) -> Sequence['outputs.GetTransportRoutingOspfv3Ipv6FeatureRedistributeResult']:
        """
        Redistribute routes
        """
...
class AwaitableGetTransportRoutingOspfv3Ipv6FeatureResult(GetTransportRoutingOspfv3Ipv6FeatureResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetTransportRoutingOspfv3Ipv6FeatureResult(
            areas=self.areas,
...
def get_transport_routing_ospfv3_ipv6_feature(feature_profile_id: Optional[str] = None,
                                              ...
                                              opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetTransportRoutingOspfv3Ipv6FeatureResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('sdwan:index/getTransportRoutingOspfv3Ipv6Feature:getTransportRoutingOspfv3Ipv6Feature', __args__, opts=opts, typ=GetTransportRoutingOspfv3Ipv6FeatureResult).value

    return AwaitableGetTransportRoutingOspfv3Ipv6FeatureResult(
...
@_utilities.lift_output_func(get_transport_routing_ospfv3_ipv6_feature)
