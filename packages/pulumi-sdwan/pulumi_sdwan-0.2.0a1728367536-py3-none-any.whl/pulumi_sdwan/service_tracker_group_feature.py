...
class ServiceTrackerGroupFeature(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        ```sh
        $ pulumi import sdwan:index/serviceTrackerGroupFeature:ServiceTrackerGroupFeature example "f6b2c44c-693c-4763-b010-895aa3d236bd"
        ```
    ...
    def get(resource_name: str,
            ...
            tracker_boolean_variable: Optional[pulumi.Input[str]] = None,
            tracker_elements: Optional[pulumi.Input[Sequence[pulumi.Input[Union['ServiceTrackerGroupFeatureTrackerElementArgs', 'ServiceTrackerGroupFeatureTrackerElementArgsDict']]]]] = None,
            version: Optional[pulumi.Input[int]] = None) -> 'ServiceTrackerGroupFeature':
        """
