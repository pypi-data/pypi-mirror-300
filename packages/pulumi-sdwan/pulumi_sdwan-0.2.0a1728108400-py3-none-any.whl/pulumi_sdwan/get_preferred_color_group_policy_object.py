...
class GetPreferredColorGroupPolicyObjectResult:
    ...
    def primary_color_preference(self) -> str:
        """
    ...
    def secondary_color_preference(self) -> str:
        """
        Color or space separated list of colors
        """
    ...
    def tertiary_color_preference(self) -> str:
        """
        Color or space separated list of colors
        """
...
def get_preferred_color_group_policy_object(id: Optional[str] = None,
