...
class GetPolicyObjectExpandedCommunityListResult:
    ...
    def expanded_community_lists(self) -> Sequence[str]:
        """
    ...
    def expanded_community_lists_variable(self) -> str:
        """
        Variable name
        """
...
def get_policy_object_expanded_community_list(feature_profile_id: Optional[str] = None,
...
@_utilities.lift_output_func(get_policy_object_expanded_community_list)
def get_policy_object_expanded_community_list_output(feature_profile_id: Optional[pulumi.Input[str]] = None,
                                                     id: Optional[pulumi.Input[str]] = None,
                                                     opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetPolicyObjectExpandedCommunityListResult]:
    """
    This data source can read the Policy Object Expanded Community List Policy_object.
