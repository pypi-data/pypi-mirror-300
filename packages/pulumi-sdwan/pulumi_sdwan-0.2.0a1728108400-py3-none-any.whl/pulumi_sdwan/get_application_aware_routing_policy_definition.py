...
__all__ = [
    ...
    'AwaitableGetApplicationAwareRoutingPolicyDefinitionResult',
    'get_application_aware_routing_policy_definition',
    'get_application_aware_routing_policy_definition_output',
]

@pulumi.output_type
class GetApplicationAwareRoutingPolicyDefinitionResult:
    """
    ...
    @property
    @pulumi.getter
    def sequences(self) -> Sequence['outputs.GetApplicationAwareRoutingPolicyDefinitionSequenceResult']:
        """
        List of sequences
        """
...
class AwaitableGetApplicationAwareRoutingPolicyDefinitionResult(GetApplicationAwareRoutingPolicyDefinitionResult):
...
def get_application_aware_routing_policy_definition(id: Optional[str] = None,
                                                    opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetApplicationAwareRoutingPolicyDefinitionResult:
    """
...
@_utilities.lift_output_func(get_application_aware_routing_policy_definition)
