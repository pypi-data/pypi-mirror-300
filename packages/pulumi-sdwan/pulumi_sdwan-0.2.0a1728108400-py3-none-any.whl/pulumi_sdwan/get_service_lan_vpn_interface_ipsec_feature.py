...
__all__ = [
    'GetServiceLanVpnInterfaceIpsecFeatureResult',
    'AwaitableGetServiceLanVpnInterfaceIpsecFeatureResult',
    'get_service_lan_vpn_interface_ipsec_feature',
    'get_service_lan_vpn_interface_ipsec_feature_output',
]

@pulumi.output_type
class GetServiceLanVpnInterfaceIpsecFeatureResult:
    """
...
class AwaitableGetServiceLanVpnInterfaceIpsecFeatureResult(GetServiceLanVpnInterfaceIpsecFeatureResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetServiceLanVpnInterfaceIpsecFeatureResult(
...
def get_service_lan_vpn_interface_ipsec_feature(feature_profile_id: Optional[str] = None,
                                                id: Optional[str] = None,
                                                service_lan_vpn_feature_id: Optional[str] = None,
                                                opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetServiceLanVpnInterfaceIpsecFeatureResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('sdwan:index/getServiceLanVpnInterfaceIpsecFeature:getServiceLanVpnInterfaceIpsecFeature', __args__, opts=opts, typ=GetServiceLanVpnInterfaceIpsecFeatureResult).value

    return AwaitableGetServiceLanVpnInterfaceIpsecFeatureResult(
