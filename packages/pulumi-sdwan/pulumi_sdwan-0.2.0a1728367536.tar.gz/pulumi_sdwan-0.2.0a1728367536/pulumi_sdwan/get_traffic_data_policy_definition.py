...
__all__ = [
    'GetTrafficDataPolicyDefinitionResult',
    'AwaitableGetTrafficDataPolicyDefinitionResult',
    'get_traffic_data_policy_definition',
    'get_traffic_data_policy_definition_output',
]

@pulumi.output_type
class GetTrafficDataPolicyDefinitionResult:
    """
    ...
    @property
    @pulumi.getter
    def sequences(self) -> Sequence['outputs.GetTrafficDataPolicyDefinitionSequenceResult']:
        """
        List of sequences
        """
...
class AwaitableGetTrafficDataPolicyDefinitionResult(GetTrafficDataPolicyDefinitionResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetTrafficDataPolicyDefinitionResult(
...
def get_traffic_data_policy_definition(id: Optional[str] = None,
                                       opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetTrafficDataPolicyDefinitionResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('sdwan:index/getTrafficDataPolicyDefinition:getTrafficDataPolicyDefinition', __args__, opts=opts, typ=GetTrafficDataPolicyDefinitionResult).value

    return AwaitableGetTrafficDataPolicyDefinitionResult(
