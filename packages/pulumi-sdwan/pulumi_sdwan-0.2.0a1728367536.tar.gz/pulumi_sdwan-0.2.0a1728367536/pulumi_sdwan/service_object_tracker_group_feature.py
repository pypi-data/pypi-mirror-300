...
class ServiceObjectTrackerGroupFeatureArgs:
    def __init__(__self__, *,
                 ...
                 reachable: Optional[pulumi.Input[str]] = None,
                 reachable_variable: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.Input[int] object_tracker_id: Object ID - Range: `1`-`1000`
        :param pulumi.Input[str] object_tracker_id_variable: Variable name
        :param pulumi.Input[str] reachable: tracker ref list criteria boolean and or - Choices: `and`, `or` - Default value: `or`
        :param pulumi.Input[str] reachable_variable: Variable name
    ...
    @property
    @pulumi.getter
    def reachable(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    @reachable.setter
    def reachable(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "reachable", value)

    @property
    @pulumi.getter(name="reachableVariable")
    def reachable_variable(self) -> Optional[pulumi.Input[str]]:
        """
        Variable name
        """
    ...
    def reachable_variable(self, value: Optional[pulumi.Input[str]]):
...
class ServiceObjectTrackerGroupFeature(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            reachable_variable: Optional[pulumi.Input[str]] = None,
            tracker_elements: Optional[pulumi.Input[Sequence[pulumi.Input[Union['ServiceObjectTrackerGroupFeatureTrackerElementArgs', 'ServiceObjectTrackerGroupFeatureTrackerElementArgsDict']]]]] = None,
            version: Optional[pulumi.Input[int]] = None) -> 'ServiceObjectTrackerGroupFeature':
        """
    ...
    @property
    @pulumi.getter
    def reachable(self) -> pulumi.Output[Optional[str]]:
        """
        tracker ref list criteria boolean and or - Choices: `and`, `or` - Default value: `or`
        """
        return pulumi.get(self, "reachable")
    ...
    @property
    @pulumi.getter(name="reachableVariable")
    def reachable_variable(self) -> pulumi.Output[Optional[str]]:
        """
        Variable name
        """
        return pulumi.get(self, "reachable_variable")
