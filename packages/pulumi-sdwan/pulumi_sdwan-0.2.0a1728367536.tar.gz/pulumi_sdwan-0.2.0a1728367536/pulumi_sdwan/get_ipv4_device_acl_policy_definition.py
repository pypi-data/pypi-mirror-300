...
__all__ = [
    'GetIpv4DeviceAclPolicyDefinitionResult',
    'AwaitableGetIpv4DeviceAclPolicyDefinitionResult',
    'get_ipv4_device_acl_policy_definition',
    'get_ipv4_device_acl_policy_definition_output',
]

@pulumi.output_type
class GetIpv4DeviceAclPolicyDefinitionResult:
    """
    ...
    @property
    @pulumi.getter
    def sequences(self) -> Sequence['outputs.GetIpv4DeviceAclPolicyDefinitionSequenceResult']:
        """
...
class AwaitableGetIpv4DeviceAclPolicyDefinitionResult(GetIpv4DeviceAclPolicyDefinitionResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetIpv4DeviceAclPolicyDefinitionResult(
...
def get_ipv4_device_acl_policy_definition(id: Optional[str] = None,
                                          opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetIpv4DeviceAclPolicyDefinitionResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('sdwan:index/getIpv4DeviceAclPolicyDefinition:getIpv4DeviceAclPolicyDefinition', __args__, opts=opts, typ=GetIpv4DeviceAclPolicyDefinitionResult).value

    return AwaitableGetIpv4DeviceAclPolicyDefinitionResult(
...
@_utilities.lift_output_func(get_ipv4_device_acl_policy_definition)
