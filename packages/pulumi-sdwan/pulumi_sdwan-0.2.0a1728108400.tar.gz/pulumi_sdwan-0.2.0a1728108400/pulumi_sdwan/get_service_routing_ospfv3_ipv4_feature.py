...
__all__ = [
    'GetServiceRoutingOspfv3Ipv4FeatureResult',
    'AwaitableGetServiceRoutingOspfv3Ipv4FeatureResult',
    'get_service_routing_ospfv3_ipv4_feature',
    'get_service_routing_ospfv3_ipv4_feature_output',
]

@pulumi.output_type
class GetServiceRoutingOspfv3Ipv4FeatureResult:
    """
    ...
    @property
    @pulumi.getter
    def areas(self) -> Sequence['outputs.GetServiceRoutingOspfv3Ipv4FeatureAreaResult']:
        """
    ...
    @property
    @pulumi.getter
    def redistributes(self) -> Sequence['outputs.GetServiceRoutingOspfv3Ipv4FeatureRedistributeResult']:
        """
        Redistribute routes
        """
...
class AwaitableGetServiceRoutingOspfv3Ipv4FeatureResult(GetServiceRoutingOspfv3Ipv4FeatureResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetServiceRoutingOspfv3Ipv4FeatureResult(
            areas=self.areas,
...
def get_service_routing_ospfv3_ipv4_feature(feature_profile_id: Optional[str] = None,
                                            ...
                                            opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetServiceRoutingOspfv3Ipv4FeatureResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('sdwan:index/getServiceRoutingOspfv3Ipv4Feature:getServiceRoutingOspfv3Ipv4Feature', __args__, opts=opts, typ=GetServiceRoutingOspfv3Ipv4FeatureResult).value

    return AwaitableGetServiceRoutingOspfv3Ipv4FeatureResult(
