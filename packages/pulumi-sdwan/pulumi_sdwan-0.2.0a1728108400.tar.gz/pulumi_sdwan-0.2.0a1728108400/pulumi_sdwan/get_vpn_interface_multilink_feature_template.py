...
class GetVpnInterfaceMultilinkFeatureTemplateResult:
    ...
    def __init__(__self__, access_lists=None, autonegotiate=None, autonegotiate_variable=None, bandwidth_downstream=None, bandwidth_downstream_variable=None, bandwidth_upstream=None, bandwidth_upstream_variable=None, chap_hostname=None, chap_hostname_variable=None, chap_ppp_auth_password=None, chap_ppp_auth_password_variable=None, clear_dont_fragment_bit=None, clear_dont_fragment_bit_variable=None, core_region=None, core_region_variable=None, description=None, device_types=None, disable_fragmentation=None, enable_core_region=None, enable_core_region_variable=None, fragment_max_delay=None, fragment_max_delay_variable=None, id=None, interface_description=None, interface_description_variable=None, interface_name=None, interface_name_variable=None, interleaving_fragment=None, ip_mtu=None, ip_mtu_variable=None, ipv4_address=None, ipv4_address_variable=None, ipv6_access_lists=None, ipv6_address=None, ipv6_address_variable=None, multilink_group_number=None, multilink_group_number_variable=None, multilink_interfaces=None, name=None, nim_interface_lists=None, pap_password=None, pap_ppp_auth_password=None, pap_ppp_auth_password_variable=None, pap_username=None, pap_username_variable=None, per_tunnel_qos=None, per_tunnel_qos_aggregator=None, per_tunnel_qos_aggregator_variable=None, per_tunnel_qos_variable=None, pmtu_discovery=None, pmtu_discovery_variable=None, ppp_authentication_protocol=None, ppp_authentication_protocol_pap=None, ppp_authentication_type=None, qos_map=None, qos_map_variable=None, qos_map_vpn=None, qos_map_vpn_variable=None, secondary_region=None, secondary_region_variable=None, shaping_rate=None, shaping_rate_variable=None, shutdown=None, shutdown_variable=None, static_ingress_qos=None, static_ingress_qos_variable=None, tcp_mss=None, tcp_mss_variable=None, template_type=None, tloc_extension=None, tloc_extension_variable=None, tunnel_interface_allow_all=None, tunnel_interface_allow_all_variable=None, tunnel_interface_allow_bgp=None, tunnel_interface_allow_bgp_variable=None, tunnel_interface_allow_dhcp=None, tunnel_interface_allow_dhcp_variable=None, tunnel_interface_allow_dns=None, tunnel_interface_allow_dns_variable=None, tunnel_interface_allow_https=None, tunnel_interface_allow_https_variable=None, tunnel_interface_allow_icmp=None, tunnel_interface_allow_icmp_variable=None, tunnel_interface_allow_netconf=None, tunnel_interface_allow_netconf_variable=None, tunnel_interface_allow_ntp=None, tunnel_interface_allow_ntp_variable=None, tunnel_interface_allow_ospf=None, tunnel_interface_allow_ospf_variable=None, tunnel_interface_allow_snmp=None, tunnel_interface_allow_snmp_variable=None, tunnel_interface_allow_ssh=None, tunnel_interface_allow_ssh_variable=None, tunnel_interface_allow_stun=None, tunnel_interface_allow_stun_variable=None, tunnel_interface_bind_loopback_tunnel=None, tunnel_interface_bind_loopback_tunnel_variable=None, tunnel_interface_border=None, tunnel_interface_border_variable=None, tunnel_interface_carrier=None, tunnel_interface_carrier_variable=None, tunnel_interface_clear_dont_fragment=None, tunnel_interface_clear_dont_fragment_variable=None, tunnel_interface_color=None, tunnel_interface_color_restrict=None, tunnel_interface_color_variable=None, tunnel_interface_control_connections=None, tunnel_interface_control_connections_variable=None, tunnel_interface_encapsulations=None, tunnel_interface_exclude_controller_group_list_variable=None, tunnel_interface_exclude_controller_group_lists=None, tunnel_interface_groups=None, tunnel_interface_groups_variable=None, tunnel_interface_hello_interval=None, tunnel_interface_hello_interval_variable=None, tunnel_interface_hello_tolerance=None, tunnel_interface_hello_tolerance_variable=None, tunnel_interface_last_resort_circuit=None, tunnel_interface_last_resort_circuit_variable=None, tunnel_interface_low_bandwidth_link=None, tunnel_interface_low_bandwidth_link_variable=None, tunnel_interface_max_control_connections=None, tunnel_interface_max_control_connections_variable=None, tunnel_interface_nat_refresh_interval=None, tunnel_interface_nat_refresh_interval_variable=None, tunnel_interface_network_broadcast=None, tunnel_interface_network_broadcast_variable=None, tunnel_interface_port_hop=None, tunnel_interface_port_hop_variable=None, tunnel_interface_tunnel_tcp_mss=None, tunnel_interface_tunnel_tcp_mss_variable=None, tunnel_interface_vbond_as_stun_server=None, tunnel_interface_vbond_as_stun_server_variable=None, tunnel_interface_vmanage_connection_preference=None, tunnel_interface_vmanage_connection_preference_variable=None, tunnel_qos_mode=None, tunnel_qos_mode_variable=None, version=None, write_rule=None, write_rule_variable=None):
        ...
        if disable_fragmentation and not isinstance(disable_fragmentation, bool):
            raise TypeError("Expected argument 'disable_fragmentation' to be a bool")
        ...
        if fragment_max_delay and not isinstance(fragment_max_delay, int):
            raise TypeError("Expected argument 'fragment_max_delay' to be a int")
        pulumi.set(__self__, "fragment_max_delay", fragment_max_delay)
        if fragment_max_delay_variable and not isinstance(fragment_max_delay_variable, str):
            raise TypeError("Expected argument 'fragment_max_delay_variable' to be a str")
        ...
        if interleaving_fragment and not isinstance(interleaving_fragment, bool):
            raise TypeError("Expected argument 'interleaving_fragment' to be a bool")
        ...
        if multilink_group_number and not isinstance(multilink_group_number, int):
            raise TypeError("Expected argument 'multilink_group_number' to be a int")
        pulumi.set(__self__, "multilink_group_number", multilink_group_number)
        if multilink_group_number_variable and not isinstance(multilink_group_number_variable, str):
            raise TypeError("Expected argument 'multilink_group_number_variable' to be a str")
        pulumi.set(__self__, "multilink_group_number_variable", multilink_group_number_variable)
        if multilink_interfaces and not isinstance(multilink_interfaces, list):
            raise TypeError("Expected argument 'multilink_interfaces' to be a list")
        pulumi.set(__self__, "multilink_interfaces", multilink_interfaces)
        if name and not isinstance(name, str):
            raise TypeError("Expected argument 'name' to be a str")
        pulumi.set(__self__, "name", name)
        if nim_interface_lists and not isinstance(nim_interface_lists, list):
            raise TypeError("Expected argument 'nim_interface_lists' to be a list")
...
class AwaitableGetVpnInterfaceMultilinkFeatureTemplateResult(GetVpnInterfaceMultilinkFeatureTemplateResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetVpnInterfaceMultilinkFeatureTemplateResult(
            ...
            disable_fragmentation=self.disable_fragmentation,
            enable_core_region=self.enable_core_region,
            enable_core_region_variable=self.enable_core_region_variable,
            fragment_max_delay=self.fragment_max_delay,
            fragment_max_delay_variable=self.fragment_max_delay_variable,
            id=self.id,
            ...
            interleaving_fragment=self.interleaving_fragment,
            ip_mtu=self.ip_mtu,
            ...
            multilink_group_number=self.multilink_group_number,
            multilink_group_number_variable=self.multilink_group_number_variable,
            multilink_interfaces=self.multilink_interfaces,
            name=self.name,
            nim_interface_lists=self.nim_interface_lists,
...
def get_vpn_interface_multilink_feature_template(id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('sdwan:index/getVpnInterfaceMultilinkFeatureTemplate:getVpnInterfaceMultilinkFeatureTemplate', __args__, opts=opts, typ=GetVpnInterfaceMultilinkFeatureTemplateResult).value

    return AwaitableGetVpnInterfaceMultilinkFeatureTemplateResult(
        ...
        disable_fragmentation=pulumi.get(__ret__, 'disable_fragmentation'),
        ...
        fragment_max_delay=pulumi.get(__ret__, 'fragment_max_delay'),
        fragment_max_delay_variable=pulumi.get(__ret__, 'fragment_max_delay_variable'),
        ...
        interleaving_fragment=pulumi.get(__ret__, 'interleaving_fragment'),
        ...
        multilink_group_number=pulumi.get(__ret__, 'multilink_group_number'),
        multilink_group_number_variable=pulumi.get(__ret__, 'multilink_group_number_variable'),
        multilink_interfaces=pulumi.get(__ret__, 'multilink_interfaces'),
        name=pulumi.get(__ret__, 'name'),
        nim_interface_lists=pulumi.get(__ret__, 'nim_interface_lists'),
...
@_utilities.lift_output_func(get_vpn_interface_multilink_feature_template)
def get_vpn_interface_multilink_feature_template_output(id: Optional[pulumi.Input[Optional[str]]] = None,
                                                        name: Optional[pulumi.Input[Optional[str]]] = None,
                                                        opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetVpnInterfaceMultilinkFeatureTemplateResult]:
    """
    This data source can read the VPN Interface Multilink feature template.
