...
__all__ = [
    'GetSiteListPolicyObjectResult',
    'AwaitableGetSiteListPolicyObjectResult',
    'get_site_list_policy_object',
    'get_site_list_policy_object_output',
]

@pulumi.output_type
class GetSiteListPolicyObjectResult:
    """
...
class AwaitableGetSiteListPolicyObjectResult(GetSiteListPolicyObjectResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetSiteListPolicyObjectResult(
...
def get_site_list_policy_object(id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('sdwan:index/getSiteListPolicyObject:getSiteListPolicyObject', __args__, opts=opts, typ=GetSiteListPolicyObjectResult).value

    return AwaitableGetSiteListPolicyObjectResult(
