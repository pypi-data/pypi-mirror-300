...
*UsersAndGroupsApi* | [**put_api_keys_id**](docs/UsersAndGroupsApi.md#put_api_keys_id) | **PUT** /api-keys/{id} | API Keys - Update API Key with the given ID
