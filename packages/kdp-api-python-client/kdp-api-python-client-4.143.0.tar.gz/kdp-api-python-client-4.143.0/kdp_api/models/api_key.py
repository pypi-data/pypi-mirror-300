...
class APIKey(BaseModel):
    ...
    group_names: List[StrictStr] = Field(description="Names of Groups which the API Key belongs to", alias="groupNames")
    attribute_names: List[StrictStr] = Field(description="Names of Attributes which the API Key has", alias="attributeNames")
    __properties: ClassVar[List[str]] = ["id", "name", "workspaceId", "description", "groupNames", "attributeNames"]
