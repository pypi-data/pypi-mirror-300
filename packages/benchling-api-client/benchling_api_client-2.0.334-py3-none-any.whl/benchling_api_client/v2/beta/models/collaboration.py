...
class Collaboration:
    ...
    _created_at: Union[Unset, None, str] = UNSET
    _id: Union[Unset, None, str] = UNSET
    _item_id: Union[Unset, None, str] = UNSET
    _item_type: Union[Unset, None, str] = UNSET
    _modified_at: Union[Unset, None, str] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_created_at() -> Union[Unset, None, str]:
        ...
        try:
            ...
            if strict:
                raise
            created_at = cast(Union[Unset, None, str], UNSET)

        def get_id() -> Union[Unset, None, str]:
            id = d.pop("id")
            return id
        ...
        try:
            ...
            if strict:
                raise
            id = cast(Union[Unset, None, str], UNSET)

        def get_item_id() -> Union[Unset, None, str]:
        ...
        try:
            ...
            if strict:
                raise
            item_id = cast(Union[Unset, None, str], UNSET)

        def get_item_type() -> Union[Unset, None, str]:
        ...
        try:
            ...
            if strict:
                raise
            item_type = cast(Union[Unset, None, str], UNSET)

        def get_modified_at() -> Union[Unset, None, str]:
        ...
        try:
            ...
            if strict:
                raise
            modified_at = cast(Union[Unset, None, str], UNSET)
    ...
    @modified_at.setter
    def modified_at(self, value: Optional[str]) -> None:
