...
from ...models.dna_sequences_find_matching_region import DnaSequencesFindMatchingRegion
...
def _get_kwargs(
    *,
    client: Client,
    json_body: DnaSequencesFindMatchingRegion,
) -> Dict[str, Any]:
    url = "{}/dna-sequences:find-matching-regions".format(client.base_url)
