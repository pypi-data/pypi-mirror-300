...
def _get_kwargs(
    *,
    ...
    url = "{}/dna-sequences:autofill-transcriptions".format(client.base_url)
...
def sync(
    *,
    ...
    """ Autofill DNA sequence transcriptions from RNA Sequences with matching schemas and bases """
