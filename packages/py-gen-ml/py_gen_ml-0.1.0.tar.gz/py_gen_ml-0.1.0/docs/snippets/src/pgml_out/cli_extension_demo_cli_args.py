...
class ProjectArgs(pgml.YamlBaseModel):
    ...
    train_path: typing.Annotated[typing.Optional[str], typer.Option(help="Path to the dataset. Maps to 'data.train_dataset.path'"), pydantic.Field(None), pgml.ArgRef("data.train_dataset.path")]
    """Path to the dataset"""

    test_path: typing.Annotated[typing.Optional[str], typer.Option(help="Path to the dataset. Maps to 'data.test_dataset.path'"), pydantic.Field(None), pgml.ArgRef("data.test_dataset.path")]
    """Path to the dataset"""
