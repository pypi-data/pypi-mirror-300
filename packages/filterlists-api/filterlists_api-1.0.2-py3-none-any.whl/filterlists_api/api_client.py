...
from filterlists_api.api_response import ApiResponse, T as ApiResponseT
import filterlists_api.models
from filterlists_api import rest
from filterlists_api.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(filterlists_api.models, klass)
