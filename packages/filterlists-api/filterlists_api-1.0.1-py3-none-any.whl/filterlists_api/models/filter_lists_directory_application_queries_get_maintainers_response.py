...
class FilterListsDirectoryApplicationQueriesGetMaintainersResponse(BaseModel):
    """
    ...
    twitter_handle: Optional[StrictStr] = Field(default=None, description="The Twitter handle.", alias="twitterHandle")
    filter_list_ids: Optional[List[StrictInt]] = Field(default=None, description="The identifiers of the FilterLists maintained by this Maintainer.", alias="filterListIds")
    __properties: ClassVar[List[str]] = ["id", "name", "url", "emailAddress", "twitterHandle", "filterListIds"]
