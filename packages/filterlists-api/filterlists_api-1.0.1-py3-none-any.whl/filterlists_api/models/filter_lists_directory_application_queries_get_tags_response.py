...
class FilterListsDirectoryApplicationQueriesGetTagsResponse(BaseModel):
    """
    ...
    filter_list_ids: Optional[List[StrictInt]] = Field(default=None, description="The identifiers of the FilterLists to which this Tag is applied.", alias="filterListIds")
    __properties: ClassVar[List[str]] = ["id", "name", "description", "filterListIds"]
