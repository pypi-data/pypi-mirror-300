...
class FilterListsDirectoryApplicationQueriesGetSyntaxesResponse(BaseModel):
    """
    ...
    filter_list_ids: Optional[List[StrictInt]] = Field(default=None, description="The identifiers of the FilterLists implementing this Syntax.", alias="filterListIds")
    software_ids: Optional[List[StrictInt]] = Field(default=None, description="The identifiers of the Software that supports this Syntax.", alias="softwareIds")
    __properties: ClassVar[List[str]] = ["id", "name", "description", "url", "filterListIds", "softwareIds"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if software_ids (nullable) is None
        # and model_fields_set contains the field
        if self.software_ids is None and "software_ids" in self.model_fields_set:
            _dict['softwareIds'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "softwareIds": obj.get("softwareIds")
        })
        return _obj
