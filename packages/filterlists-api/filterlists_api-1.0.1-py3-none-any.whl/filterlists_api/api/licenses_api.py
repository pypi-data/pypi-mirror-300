...
class LicensesApi:
    ...
    def get_licenses(
    ...
    ) -> List[FilterListsDirectoryApplicationQueriesGetLicensesResponse]:
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "List[FilterListsDirectoryApplicationQueriesGetLicensesResponse]",
        }
    ...
    def get_licenses_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[FilterListsDirectoryApplicationQueriesGetLicensesResponse]]:
        """Gets the licenses applied to the FilterLists.
