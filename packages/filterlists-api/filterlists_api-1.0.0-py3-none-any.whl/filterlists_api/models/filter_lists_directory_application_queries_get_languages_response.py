...
class FilterListsDirectoryApplicationQueriesGetLanguagesResponse(BaseModel):
    """
    ...
    iso6391: Optional[StrictStr] = Field(default=None, description="The unique ISO 639-1 code.")
    name: Optional[StrictStr] = Field(default=None, description="The unique ISO name.")
    filter_list_ids: Optional[List[StrictInt]] = Field(default=None, description="The identifiers of the FilterLists targeted by this Language.", alias="filterListIds")
    __properties: ClassVar[List[str]] = ["id", "iso6391", "name", "filterListIds"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if iso6391 (nullable) is None
        # and model_fields_set contains the field
        if self.iso6391 is None and "iso6391" in self.model_fields_set:
            _dict['iso6391'] = None
