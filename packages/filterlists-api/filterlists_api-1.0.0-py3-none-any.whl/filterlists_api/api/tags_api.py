...
class TagsApi:
    ...
    def get_tags(
    ...
    ) -> List[FilterListsDirectoryApplicationQueriesGetTagsResponse]:
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "List[FilterListsDirectoryApplicationQueriesGetTagsResponse]",
        }
    ...
    def get_tags_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[FilterListsDirectoryApplicationQueriesGetTagsResponse]]:
        """Gets the tags of the FilterLists.
