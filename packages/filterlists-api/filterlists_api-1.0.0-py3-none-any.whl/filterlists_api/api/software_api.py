...
class SoftwareApi:
    ...
    def get_software(
    ...
    ) -> List[FilterListsDirectoryApplicationQueriesGetSoftwareResponse]:
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "List[FilterListsDirectoryApplicationQueriesGetSoftwareResponse]",
        }
    ...
    def get_software_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[FilterListsDirectoryApplicationQueriesGetSoftwareResponse]]:
        """Gets the software that subscribes to the FilterLists.
