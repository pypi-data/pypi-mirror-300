...
class LanguagesApi:
    ...
    def get_languages(
    ...
    ) -> List[FilterListsDirectoryApplicationQueriesGetLanguagesResponse]:
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "List[FilterListsDirectoryApplicationQueriesGetLanguagesResponse]",
        }
    ...
    def get_languages_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[FilterListsDirectoryApplicationQueriesGetLanguagesResponse]]:
        """Gets the languages targeted by the FilterLists.
