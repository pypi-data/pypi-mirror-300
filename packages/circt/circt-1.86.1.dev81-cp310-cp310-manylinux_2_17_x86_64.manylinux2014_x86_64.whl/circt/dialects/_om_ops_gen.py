...
def class_extern(sym_name, formal_param_names, field_names, field_types, *, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(ClassExternOp(sym_name=sym_name, formalParamNames=formal_param_names, fieldNames=field_names, fieldTypes=field_types, loc=loc, ip=ip))
...
class ClassFieldsOp(_ods_ir.OpView):
  ...
  def __init__(self, fields, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
def class_fields(fields, *, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(ClassFieldsOp(fields=fields, loc=loc, ip=ip))
...
def class_(sym_name, formal_param_names, field_names, field_types, *, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(ClassOp(sym_name=sym_name, formalParamNames=formal_param_names, fieldNames=field_names, fieldTypes=field_types, loc=loc, ip=ip))
...
def list_concat(sub_lists, *, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(ListConcatOp(subLists=sub_lists, loc=loc, ip=ip))
