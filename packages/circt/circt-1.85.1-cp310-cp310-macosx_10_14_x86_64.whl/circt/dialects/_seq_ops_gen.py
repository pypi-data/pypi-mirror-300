...
def clock_div(input, pow2, *, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(ClockDividerOp(input=input, pow2=pow2, loc=loc, ip=ip))
...
class CompRegClockEnabledOp(_ods_ir.OpView):
  ...
  def __init__(self, input, clk, clockEnable, *, name=None, reset=None, resetValue=None, initialValue=None, inner_sym=None, loc=None, ip=None):
    ...
    operands.append(_get_op_result_or_value(initialValue) if initialValue is not None else None)
    _ods_context = _ods_get_default_loc_context(loc)
...
def compreg_ce(input, clk, clock_enable, *, name=None, reset=None, reset_value=None, initial_value=None, inner_sym=None, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(CompRegClockEnabledOp(input=input, clk=clk, clockEnable=clock_enable, name=name, reset=reset, resetValue=reset_value, initialValue=initial_value, inner_sym=inner_sym, loc=loc, ip=ip))
...
def compreg(input, clk, *, name=None, reset=None, reset_value=None, initial_value=None, inner_sym=None, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(CompRegOp(input=input, clk=clk, name=name, reset=reset, resetValue=reset_value, initialValue=initial_value, inner_sym=inner_sym, loc=loc, ip=ip))
...
def fifo(output, full, empty, almost_full, almost_empty, input, rd_en, wr_en, clk, rst, depth, *, almost_full_threshold=None, almost_empty_threshold=None, loc=None, ip=None) -> _Sequence[_ods_ir.Value]:
...
def hlmem(handle, clk, rst, name, *, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(HLMemOp(handle=handle, clk=clk, rst=rst, name=name, loc=loc, ip=ip))
...
def initial(result, *, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(InitialOp(result=result, loc=loc, ip=ip))
