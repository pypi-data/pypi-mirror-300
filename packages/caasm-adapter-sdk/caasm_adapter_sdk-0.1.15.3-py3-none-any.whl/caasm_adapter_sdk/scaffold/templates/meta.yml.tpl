# 需要根据实际情况进行修改的是必须要改的，具体怎么改参考https://e.gitee.com/weilansec/projects/433637/docs?directory=1188256&page=1&program_id=433637&scope=root&sub_id=7656957
...
fetch_setting:
  ...
  context_point: "${adapter_name}.fetch:build_query_context"
