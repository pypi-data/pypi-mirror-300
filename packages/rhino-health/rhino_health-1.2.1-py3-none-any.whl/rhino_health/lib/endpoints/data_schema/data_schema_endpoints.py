...
class LTSDataSchemaEndpoints(Endpoint):
    """
    @autoapi False
    """
    ...
    @rhino_error_wrapper
    def get_data_schemas(self, data_schema_uids: Optional[List[str]] = None) -> List[LTSDataSchema]:
        """
        @autoapi True
...
class DataSchemaEndpoints(LTSDataSchemaEndpoints):
    """
    @hide_parent_class
    """
    ...
    @rhino_error_wrapper
    def remove_data_schema(self, data_schema_uid: str):
        """
        Removes a DataSchema with the DATASCHAMA_UID from the system

        .. warning:: This feature is under development and incomplete
        """
        return self.session.post(f"/data_schemas/{data_schema_uid}/remove")
