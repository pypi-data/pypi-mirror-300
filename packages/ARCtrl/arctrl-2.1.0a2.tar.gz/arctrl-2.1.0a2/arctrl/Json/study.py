...
def encoder(study: ArcStudy) -> IEncodable:
    ...
    def _arrow2584(__unit: None=None, study: Any=study) -> IEncodable:
        value: str = study.Identifier
        class ObjectExpr2583(IEncodable):
            def Encode(self, helpers: IEncoderHelpers_1[Any]) -> Any:
                return helpers.encode_string(value)

        return ObjectExpr2583()

    def _arrow2586(value_1: str, study: Any=study) -> IEncodable:
    ...
    def _arrow2588(value_3: str, study: Any=study) -> IEncodable:
    ...
    def _arrow2590(value_5: str, study: Any=study) -> IEncodable:
    ...
    def _arrow2592(value_7: str, study: Any=study) -> IEncodable:
    ...
    def _arrow2593(oa: Publication, study: Any=study) -> IEncodable:
        return encoder_5(oa)

    def _arrow2594(person: Person, study: Any=study) -> IEncodable:
        return encoder_6(person)

    def _arrow2595(oa_1: OntologyAnnotation, study: Any=study) -> IEncodable:
        return OntologyAnnotation_encoder(oa_1)

    def _arrow2596(table: ArcTable, study: Any=study) -> IEncodable:
        return encoder_7(table)

    def _arrow2597(dm: DataMap, study: Any=study) -> IEncodable:
        return encoder_8(dm)

    def _arrow2599(value_9: str, study: Any=study) -> IEncodable:
    ...
    def _arrow2600(comment: Comment, study: Any=study) -> IEncodable:
        return encoder_9(comment)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("Identifier", _arrow2584()), try_include("Title", _arrow2586, study.Title), try_include("Description", _arrow2588, study.Description), try_include("SubmissionDate", _arrow2590, study.SubmissionDate), try_include("PublicReleaseDate", _arrow2592, study.PublicReleaseDate), try_include_seq("Publications", _arrow2593, study.Publications), try_include_seq("Contacts", _arrow2594, study.Contacts), try_include_seq("StudyDesignDescriptors", _arrow2595, study.StudyDesignDescriptors), try_include_seq("Tables", _arrow2596, study.Tables), try_include("DataMap", _arrow2597, study.DataMap), try_include_seq("RegisteredAssayIdentifiers", _arrow2599, study.RegisteredAssayIdentifiers), try_include_seq("Comments", _arrow2600, study.Comments)]))
...
def _arrow2614(get: IGetters) -> ArcStudy:
    def _arrow2602(__unit: None=None) -> str:
    ...
    return ArcStudy(_arrow2602(), _arrow2603(), _arrow2604(), _arrow2605(), _arrow2606(), _arrow2607(), _arrow2608(), _arrow2609(), _arrow2610(), _arrow2611(), _arrow2612(), _arrow2613())


decoder: Decoder_1[ArcStudy] = object(_arrow2614)
...
def encoder_compressed(string_table: Any, oa_table: Any, cell_table: Any, study: ArcStudy) -> IEncodable:
    ...
    def _arrow2618(__unit: None=None, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> IEncodable:
        value: str = study.Identifier
    ...
    def _arrow2620(value_1: str, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> IEncodable:
    ...
    def _arrow2622(value_3: str, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> IEncodable:
    ...
    def _arrow2624(value_5: str, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> IEncodable:
    ...
    def _arrow2626(value_7: str, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> IEncodable:
    ...
    def _arrow2627(oa: Publication, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> IEncodable:
        return encoder_5(oa)

    def _arrow2628(person: Person, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> IEncodable:
        return encoder_6(person)

    def _arrow2629(oa_1: OntologyAnnotation, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> IEncodable:
        return OntologyAnnotation_encoder(oa_1)

    def _arrow2630(table: ArcTable, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> IEncodable:
        return encoder_compressed_1(string_table, oa_table, cell_table, table)

    def _arrow2631(dm: DataMap, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> IEncodable:
        return encoder_compressed_2(string_table, oa_table, cell_table, dm)

    def _arrow2633(value_9: str, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> IEncodable:
    ...
    def _arrow2634(comment: Comment, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> IEncodable:
        return encoder_9(comment)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("Identifier", _arrow2618()), try_include("Title", _arrow2620, study.Title), try_include("Description", _arrow2622, study.Description), try_include("SubmissionDate", _arrow2624, study.SubmissionDate), try_include("PublicReleaseDate", _arrow2626, study.PublicReleaseDate), try_include_seq("Publications", _arrow2627, study.Publications), try_include_seq("Contacts", _arrow2628, study.Contacts), try_include_seq("StudyDesignDescriptors", _arrow2629, study.StudyDesignDescriptors), try_include_seq("Tables", _arrow2630, study.Tables), try_include("DataMap", _arrow2631, study.DataMap), try_include_seq("RegisteredAssayIdentifiers", _arrow2633, study.RegisteredAssayIdentifiers), try_include_seq("Comments", _arrow2634, study.Comments)]))
    class ObjectExpr2635(IEncodable):
...
def decoder_compressed(string_table: Array[str], oa_table: Array[OntologyAnnotation], cell_table: Array[CompositeCell]) -> Decoder_1[ArcStudy]:
    def _arrow2648(get: IGetters, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table) -> ArcStudy:
        def _arrow2636(__unit: None=None) -> str:
            object_arg: IRequiredGetter = get.Required
            return object_arg.Field("Identifier", string)
        ...
        def _arrow2639(__unit: None=None) -> str | None:
            object_arg_3: IOptionalGetter = get.Optional
            return object_arg_3.Field("SubmissionDate", string)

        def _arrow2640(__unit: None=None) -> str | None:
            object_arg_4: IOptionalGetter = get.Optional
            return object_arg_4.Field("PublicReleaseDate", string)

        def _arrow2641(__unit: None=None) -> Array[Publication] | None:
            arg_11: Decoder_1[Array[Publication]] = resize_array(decoder_2)
            object_arg_5: IOptionalGetter = get.Optional
            return object_arg_5.Field("Publications", arg_11)
        ...
        def _arrow2643(__unit: None=None) -> Array[OntologyAnnotation] | None:
            arg_15: Decoder_1[Array[OntologyAnnotation]] = resize_array(OntologyAnnotation_decoder)
            object_arg_7: IOptionalGetter = get.Optional
            return object_arg_7.Field("StudyDesignDescriptors", arg_15)

        def _arrow2644(__unit: None=None) -> Array[ArcTable] | None:
            arg_17: Decoder_1[Array[ArcTable]] = resize_array(decoder_compressed_1(string_table, oa_table, cell_table))
            object_arg_8: IOptionalGetter = get.Optional
            return object_arg_8.Field("Tables", arg_17)

        def _arrow2645(__unit: None=None) -> DataMap | None:
            arg_19: Decoder_1[DataMap] = decoder_compressed_2(string_table, oa_table, cell_table)
            object_arg_9: IOptionalGetter = get.Optional
            return object_arg_9.Field("DataMap", arg_19)

        def _arrow2646(__unit: None=None) -> Array[str] | None:
            arg_21: Decoder_1[Array[str]] = resize_array(string)
            object_arg_10: IOptionalGetter = get.Optional
            return object_arg_10.Field("RegisteredAssayIdentifiers", arg_21)

        def _arrow2647(__unit: None=None) -> Array[Comment] | None:
            arg_23: Decoder_1[Array[Comment]] = resize_array(decoder_6)
            object_arg_11: IOptionalGetter = get.Optional
            return object_arg_11.Field("Comments", arg_23)

        return ArcStudy(_arrow2636(), _arrow2637(), _arrow2638(), _arrow2639(), _arrow2640(), _arrow2641(), _arrow2642(), _arrow2643(), _arrow2644(), _arrow2645(), _arrow2646(), _arrow2647())

    return object(_arrow2648)
...
def ROCrate_encoder(assays: FSharpList[ArcAssay] | None, s: ArcStudy) -> IEncodable:
    ...
    def _arrow2652(__unit: None=None, assays: Any=assays, s: Any=s) -> IEncodable:
    ...
    def _arrow2656(__unit: None=None, assays: Any=assays, s: Any=s) -> IEncodable:
    ...
    def _arrow2658(value_4: str, assays: Any=assays, s: Any=s) -> IEncodable:
    ...
    def _arrow2660(value_6: str, assays: Any=assays, s: Any=s) -> IEncodable:
    ...
    def _arrow2662(value_8: str, assays: Any=assays, s: Any=s) -> IEncodable:
    ...
    def _arrow2663(oa: OntologyAnnotation, assays: Any=assays, s: Any=s) -> IEncodable:
        return OntologyAnnotation_ROCrate_encoderDefinedTerm(oa)

    def _arrow2665(value_10: str, assays: Any=assays, s: Any=s) -> IEncodable:
    ...
    def _arrow2667(value_12: str, assays: Any=assays, s: Any=s) -> IEncodable:
    ...
    def _arrow2668(oa_1: Publication, assays: Any=assays, s: Any=s) -> IEncodable:
        return ROCrate_encoder_1(oa_1)

    def _arrow2669(oa_2: Person, assays: Any=assays, s: Any=s) -> IEncodable:
        return ROCrate_encoder_2(oa_2)

    def _arrow2671(__unit: None=None, assays: Any=assays, s: Any=s) -> Callable[[Process], IEncodable]:
        study_name: str | None = s.Identifier
        def _arrow2670(oa_3: Process) -> IEncodable:
            return ROCrate_encoder_3(study_name, None, oa_3)

        return _arrow2670

    def _arrow2673(__unit: None=None, assays: Any=assays, s: Any=s) -> Callable[[ArcAssay], IEncodable]:
        study_name_1: str | None = s.Identifier
        def _arrow2672(a_1: ArcAssay) -> IEncodable:
            return ROCrate_encoder_4(study_name_1, a_1)

        return _arrow2672

    def _arrow2674(comment: Comment, assays: Any=assays, s: Any=s) -> IEncodable:
        return ROCrate_encoder_5(comment)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@id", _arrow2652()), ("@type", list_1_1(singleton(ObjectExpr2653()))), ("additionalType", ObjectExpr2654()), ("identifier", _arrow2656()), try_include("filename", _arrow2658, file_name), try_include("title", _arrow2660, s.Title), try_include("description", _arrow2662, s.Description), try_include_seq("studyDesignDescriptors", _arrow2663, s.StudyDesignDescriptors), try_include("submissionDate", _arrow2665, s.SubmissionDate), try_include("publicReleaseDate", _arrow2667, s.PublicReleaseDate), try_include_seq("publications", _arrow2668, s.Publications), try_include_seq("people", _arrow2669, s.Contacts), try_include_list("processSequence", _arrow2671(), processes), try_include_seq("assays", _arrow2673(), assays_1), try_include_seq("comments", _arrow2674, s.Comments), ("@context", context_jsonvalue)]))
...
def _arrow2686(get: IGetters) -> tuple[ArcStudy, FSharpList[ArcAssay]]:
    def _arrow2676(__unit: None=None) -> str | None:
        object_arg: IOptionalGetter = get.Optional
        return object_arg.Field("filename", string)

    identifier: str = default_arg(bind(Study_tryIdentifierFromFileName, _arrow2676()), create_missing_identifier())
    ...
    def _arrow2685(__unit: None=None) -> Array[Comment] | None:
        arg_22: Decoder_1[Array[Comment]] = resize_array(ROCrate_decoder_5)
        object_arg_10: IOptionalGetter = get.Optional
        return object_arg_10.Field("comments", arg_22)

    return (ArcStudy(identifier, _arrow2678(), _arrow2679(), _arrow2680(), _arrow2681(), _arrow2682(), _arrow2683(), _arrow2684(), tables, None, assay_identifiers, _arrow2685()), default_arg(assays, empty()))


ROCrate_decoder: Decoder_1[tuple[ArcStudy, FSharpList[ArcAssay]]] = object(_arrow2686)
...
def ISAJson_encoder(id_map: Any | None, assays: FSharpList[ArcAssay] | None, s: ArcStudy) -> IEncodable:
    def f(s_1: ArcStudy, id_map: Any=id_map, assays: Any=assays, s: Any=s) -> IEncodable:
        ...
        def _arrow2687(ps: FSharpList[Process], s_1: Any=s_1) -> IEncodable:
            return encoder_12(id_map, ps)

        encoded_materials: tuple[str, IEncodable | None] = try_include("materials", _arrow2687, Option_fromValueWithDefault(empty(), processes))
        encoded_protocols: tuple[str, IEncodable | None]
        value_5: FSharpList[Protocol] = get_protocols(processes)
        def _arrow2693(__unit: None=None, s_1: Any=s_1) -> Callable[[Protocol], IEncodable]:
            study_name: str | None = s_1.Identifier
            def _arrow2692(oa_1: Protocol) -> IEncodable:
                return ISAJson_encoder_1(study_name, None, None, id_map, oa_1)

            return _arrow2692

        encoded_protocols = try_include_list("protocols", _arrow2693(), value_5)
        ...
        def _arrow2701(__unit: None=None, s_1: Any=s_1) -> IEncodable:
            value_6: str = ROCrate_genID(study)
            class ObjectExpr2700(IEncodable):
                def Encode(self, helpers: IEncoderHelpers_1[Any]) -> Any:
                    return helpers.encode_string(value_6)

            return ObjectExpr2700()
        ...
        def _arrow2705(__unit: None=None, s_1: Any=s_1) -> IEncodable:
        ...
        def _arrow2707(value_9: str, s_1: Any=s_1) -> IEncodable:
            class ObjectExpr2706(IEncodable):
                def Encode(self, helpers_3: IEncoderHelpers_1[Any]) -> Any:
                    return helpers_3.encode_string(value_9)

            return ObjectExpr2706()

        def _arrow2709(value_11: str, s_1: Any=s_1) -> IEncodable:
        ...
        def _arrow2711(value_13: str, s_1: Any=s_1) -> IEncodable:
            class ObjectExpr2710(IEncodable):
                def Encode(self, helpers_5: IEncoderHelpers_1[Any]) -> Any:
                    return helpers_5.encode_string(value_13)

            return ObjectExpr2710()

        def _arrow2713(value_15: str, s_1: Any=s_1) -> IEncodable:
        ...
        def _arrow2714(oa_2: Publication, s_1: Any=s_1) -> IEncodable:
            return ISAJson_encoder_2(id_map, oa_2)

        def _arrow2715(person_2: Person, s_1: Any=s_1) -> IEncodable:
            return ISAJson_encoder_3(id_map, person_2)

        def _arrow2716(oa_3: OntologyAnnotation, s_1: Any=s_1) -> IEncodable:
            return OntologyAnnotation_ISAJson_encoder(id_map, oa_3)

        def _arrow2718(__unit: None=None, s_1: Any=s_1) -> Callable[[Process], IEncodable]:
            study_name_1: str | None = s_1.Identifier
            def _arrow2717(oa_4: Process) -> IEncodable:
                return ISAJson_encoder_4(study_name_1, None, id_map, oa_4)

            return _arrow2717

        def _arrow2720(__unit: None=None, s_1: Any=s_1) -> Callable[[ArcAssay], IEncodable]:
            study_name_2: str | None = s_1.Identifier
            def _arrow2719(a_2: ArcAssay) -> IEncodable:
                return ISAJson_encoder_5(study_name_2, id_map, a_2)

            return _arrow2719

        def _arrow2721(comment: Comment, s_1: Any=s_1) -> IEncodable:
            return ISAJson_encoder_6(id_map, comment)

        values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@id", _arrow2701()), ("filename", ObjectExpr2703()), ("identifier", _arrow2705()), try_include("title", _arrow2707, study.Title), try_include("description", _arrow2709, study.Description), try_include("submissionDate", _arrow2711, study.SubmissionDate), try_include("publicReleaseDate", _arrow2713, study.PublicReleaseDate), try_include_seq("publications", _arrow2714, study.Publications), try_include_seq("people", _arrow2715, study.Contacts), try_include_seq("studyDesignDescriptors", _arrow2716, study.StudyDesignDescriptors), encoded_protocols, encoded_materials, try_include_list("processSequence", _arrow2718(), processes), try_include_seq("assays", _arrow2720(), assays_1), encoded_factors, encoded_characteristics, encoded_units, try_include_seq("comments", _arrow2721, study.Comments)]))
    ...
    if id_map is not None:
        def _arrow2723(s_2: ArcStudy, id_map: Any=id_map, assays: Any=assays, s: Any=s) -> str:
            return ROCrate_genID(s_2)

        return encode(_arrow2723, f, s, id_map)
...
def _arrow2734(get: IGetters) -> tuple[ArcStudy, FSharpList[ArcAssay]]:
    ...
    def def_thunk(__unit: None=None) -> str:
        ...
        return default_arg(bind(Study_tryIdentifierFromFileName, _arrow2725()), create_missing_identifier())

    identifier: str = default_arg_with(_arrow2724(), def_thunk)
    ...
    def _arrow2727(__unit: None=None) -> str | None:
        object_arg_5: IOptionalGetter = get.Optional
    ...
    def _arrow2731(__unit: None=None) -> Array[Publication] | None:
        arg_21: Decoder_1[Array[Publication]] = resize_array(ISAJson_decoder_4)
        object_arg_9: IOptionalGetter = get.Optional
        return object_arg_9.Field("publications", arg_21)

    def _arrow2732(__unit: None=None) -> Array[OntologyAnnotation] | None:
    ...
    def _arrow2733(__unit: None=None) -> Array[Comment] | None:
        arg_25: Decoder_1[Array[Comment]] = resize_array(ISAJson_decoder_5)
        object_arg_11: IOptionalGetter = get.Optional
        return object_arg_11.Field("comments", arg_25)

    return (ArcStudy(identifier, _arrow2727(), _arrow2728(), _arrow2729(), _arrow2730(), _arrow2731(), None if (len(persons) == 0) else persons, _arrow2732(), tables, None, assay_identifiers, _arrow2733()), default_arg(assays, empty()))


ISAJson_decoder: Decoder_1[tuple[ArcStudy, FSharpList[ArcAssay]]] = Decode_objectNoAdditionalProperties(ISAJson_allowedFields, _arrow2734)
