...
def encoder(comment: Comment) -> IEncodable:
    ...
    def _arrow1579(value: str, comment: Any=comment) -> IEncodable:
    ...
    def _arrow1581(value_2: str, comment: Any=comment) -> IEncodable:
    ...
    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include("name", _arrow1579, comment.Name), try_include("value", _arrow1581, comment.Value)]))
...
def _arrow1585(get: IGetters) -> Comment:
    def _arrow1583(__unit: None=None) -> str | None:
        object_arg: IOptionalGetter = get.Optional
        return object_arg.Field("name", string)

    def _arrow1584(__unit: None=None) -> str | None:
        object_arg_1: IOptionalGetter = get.Optional
        return object_arg_1.Field("value", string)

    return Comment(_arrow1583(), _arrow1584())


decoder: Decoder_1[Comment] = object(_arrow1585)
...
def ROCrate_encoder(comment: Comment) -> IEncodable:
    ...
    def _arrow1589(__unit: None=None, comment: Any=comment) -> IEncodable:
    ...
    def _arrow1592(value_2: str, comment: Any=comment) -> IEncodable:
        class ObjectExpr1591(IEncodable):
            def Encode(self, helpers_2: IEncoderHelpers_1[Any]) -> Any:
                return helpers_2.encode_string(value_2)

        return ObjectExpr1591()

    def _arrow1594(value_4: str, comment: Any=comment) -> IEncodable:
        class ObjectExpr1593(IEncodable):
            def Encode(self, helpers_3: IEncoderHelpers_1[Any]) -> Any:
                return helpers_3.encode_string(value_4)

        return ObjectExpr1593()

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@id", _arrow1589()), ("@type", ObjectExpr1590()), try_include("name", _arrow1592, comment.Name), try_include("value", _arrow1594, comment.Value), ("@context", context_jsonvalue)]))
...
def _arrow1598(get: IGetters) -> Comment:
    ...
    return Comment(_arrow1596(), _arrow1597())


ROCrate_decoder: Decoder_1[Comment] = object(_arrow1598)
...
def ISAJson_encoder(id_map: Any | None, comment: Comment) -> IEncodable:
    def f(comment_1: Comment, id_map: Any=id_map, comment: Any=comment) -> IEncodable:
        ...
        def _arrow1603(value: str, comment_1: Any=comment_1) -> IEncodable:
            class ObjectExpr1602(IEncodable):
                def Encode(self, helpers: IEncoderHelpers_1[Any]) -> Any:
                    return helpers.encode_string(value)

            return ObjectExpr1602()

        def _arrow1605(value_2: str, comment_1: Any=comment_1) -> IEncodable:
            class ObjectExpr1604(IEncodable):
                def Encode(self, helpers_1: IEncoderHelpers_1[Any]) -> Any:
                    return helpers_1.encode_string(value_2)

            return ObjectExpr1604()

        def _arrow1607(value_4: str, comment_1: Any=comment_1) -> IEncodable:
        ...
        values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include("@id", _arrow1603, ROCrate_genID(comment_1)), try_include("name", _arrow1605, comment_1.Name), try_include("value", _arrow1607, comment_1.Value)]))
        ...
        return ObjectExpr1608()

    if id_map is None:
        return f(comment)

    else: 
        def _arrow1609(c: Comment, id_map: Any=id_map, comment: Any=comment) -> str:
            return ROCrate_genID(c)

        return encode(_arrow1609, f, comment, id_map)
