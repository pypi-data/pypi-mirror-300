...
IContext_reflection = _expr1500

def _arrow1510(__unit: None=None) -> IEncodable:
    class ObjectExpr1501(IEncodable):
    ...
    class ObjectExpr1503(IEncodable):
        def Encode(self, helpers_2: IEncoderHelpers_1[Any]) -> Any:
            return helpers_2.encode_string("sdo:url")

    class ObjectExpr1504(IEncodable):
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1501()), ("Publication", ObjectExpr1502()), ("pubMedID", ObjectExpr1503()), ("doi", ObjectExpr1504()), ("title", ObjectExpr1505()), ("status", ObjectExpr1506()), ("authorList", ObjectExpr1507()), ("comments", ObjectExpr1508())])
    ...
    return ObjectExpr1509()


context_jsonvalue: IEncodable = _arrow1510()
