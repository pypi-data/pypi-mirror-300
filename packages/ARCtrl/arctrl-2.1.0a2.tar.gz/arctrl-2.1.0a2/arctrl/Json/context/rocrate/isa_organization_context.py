...
IContext_reflection = _expr1424

def _arrow1429(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1425()), ("Organization", ObjectExpr1426()), ("name", ObjectExpr1427())])
    ...
    return ObjectExpr1428()


context_jsonvalue: IEncodable = _arrow1429()
