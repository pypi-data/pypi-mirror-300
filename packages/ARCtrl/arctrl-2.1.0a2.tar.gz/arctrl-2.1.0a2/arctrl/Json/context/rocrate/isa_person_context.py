...
IContext_reflection = _expr1430

def _arrow1445(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1431()), ("Person", ObjectExpr1432()), ("orcid", ObjectExpr1433()), ("firstName", ObjectExpr1434()), ("lastName", ObjectExpr1435()), ("midInitials", ObjectExpr1436()), ("email", ObjectExpr1437()), ("address", ObjectExpr1438()), ("phone", ObjectExpr1439()), ("fax", ObjectExpr1440()), ("comments", ObjectExpr1441()), ("roles", ObjectExpr1442()), ("affiliation", ObjectExpr1443())])
    class ObjectExpr1444(IEncodable):
    ...
    return ObjectExpr1444()


context_jsonvalue: IEncodable = _arrow1445()

def _arrow1450(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1446()), ("Person", ObjectExpr1447()), ("name", ObjectExpr1448())])
    class ObjectExpr1449(IEncodable):
        def Encode(self, helpers_3: IEncoderHelpers_1[Any]) -> Any:
            def mapping(tupled_arg: tuple[str, IEncodable]) -> tuple[str, __A_]:
    ...
    return ObjectExpr1449()


context_minimal_json_value: IEncodable = _arrow1450()
