...
IContext_reflection = _expr1405

def _arrow1413(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1406()), ("OntologyAnnotation", ObjectExpr1407()), ("annotationValue", ObjectExpr1408()), ("termSource", ObjectExpr1409()), ("termAccession", ObjectExpr1410()), ("comments", ObjectExpr1411())])
    class ObjectExpr1412(IEncodable):
    ...
    return ObjectExpr1412()


context_jsonvalue: IEncodable = _arrow1413()
