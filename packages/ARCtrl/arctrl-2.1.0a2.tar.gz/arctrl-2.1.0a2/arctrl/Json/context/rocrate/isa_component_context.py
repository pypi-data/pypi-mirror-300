...
IContext_reflection = _expr1315

def _arrow1325(__unit: None=None) -> IEncodable:
    ...
    class ObjectExpr1318(IEncodable):
        def Encode(self, helpers_2: IEncoderHelpers_1[Any]) -> Any:
            return helpers_2.encode_string("sdo:name")

    class ObjectExpr1319(IEncodable):
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1316()), ("Component", ObjectExpr1317()), ("category", ObjectExpr1318()), ("categoryCode", ObjectExpr1319()), ("value", ObjectExpr1320()), ("valueCode", ObjectExpr1321()), ("unit", ObjectExpr1322()), ("unitCode", ObjectExpr1323())])
    ...
    return ObjectExpr1324()


context_jsonvalue: IEncodable = _arrow1325()
