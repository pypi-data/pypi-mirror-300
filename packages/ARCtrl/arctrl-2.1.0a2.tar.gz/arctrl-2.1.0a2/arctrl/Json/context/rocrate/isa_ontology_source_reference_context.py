...
IContext_reflection = _expr1414

def _arrow1423(__unit: None=None) -> IEncodable:
    class ObjectExpr1415(IEncodable):
        def Encode(self, helpers: IEncoderHelpers_1[Any]) -> Any:
            return helpers.encode_string("http://schema.org/")

    class ObjectExpr1416(IEncodable):
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1415()), ("OntologySourceReference", ObjectExpr1416()), ("description", ObjectExpr1417()), ("name", ObjectExpr1418()), ("file", ObjectExpr1419()), ("version", ObjectExpr1420()), ("comments", ObjectExpr1421())])
    ...
    return ObjectExpr1422()


context_jsonvalue: IEncodable = _arrow1423()
