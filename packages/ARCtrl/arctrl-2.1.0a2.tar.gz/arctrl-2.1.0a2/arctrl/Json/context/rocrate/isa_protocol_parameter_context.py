...
IContext_reflection = _expr1492

def _arrow1499(__unit: None=None) -> IEncodable:
    class ObjectExpr1493(IEncodable):
    ...
    class ObjectExpr1495(IEncodable):
        def Encode(self, helpers_2: IEncoderHelpers_1[Any]) -> Any:
            return helpers_2.encode_string("sdo:Thing")

    class ObjectExpr1496(IEncodable):
        def Encode(self, helpers_3: IEncoderHelpers_1[Any]) -> Any:
            return helpers_3.encode_string("arc:ARC#ARC_00000063")

    class ObjectExpr1497(IEncodable):
        def Encode(self, helpers_4: IEncoderHelpers_1[Any]) -> Any:
            return helpers_4.encode_string("arc:ARC#ARC_00000100")

    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1493()), ("arc", ObjectExpr1494()), ("ProtocolParameter", ObjectExpr1495()), ("ArcProtocolParameter", ObjectExpr1496()), ("parameterName", ObjectExpr1497())])
...
context_jsonvalue: IEncodable = _arrow1499()
