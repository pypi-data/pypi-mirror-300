...
IContext_reflection = _expr1308

def _arrow1314(__unit: None=None) -> IEncodable:
    class ObjectExpr1309(IEncodable):
        def Encode(self, helpers: IEncoderHelpers_1[Any]) -> Any:
            return helpers.encode_string("http://schema.org/")

    class ObjectExpr1310(IEncodable):
        def Encode(self, helpers_1: IEncoderHelpers_1[Any]) -> Any:
            return helpers_1.encode_string("sdo:Comment")

    class ObjectExpr1311(IEncodable):
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1309()), ("Comment", ObjectExpr1310()), ("name", ObjectExpr1311()), ("value", ObjectExpr1312())])
    ...
    return ObjectExpr1313()


context_jsonvalue: IEncodable = _arrow1314()
