...
def _arrow1518(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1512()), ("bio", ObjectExpr1513()), ("Sample", ObjectExpr1514()), ("name", ObjectExpr1515()), ("additionalProperties", ObjectExpr1516())])
