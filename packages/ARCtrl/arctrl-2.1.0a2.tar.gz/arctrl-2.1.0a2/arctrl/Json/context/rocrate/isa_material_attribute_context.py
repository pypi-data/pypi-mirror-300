...
IContext_reflection = _expr1376

def _arrow1383(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1377()), ("arc", ObjectExpr1378()), ("MaterialAttribute", ObjectExpr1379()), ("ArcMaterialAttribute", ObjectExpr1380()), ("characteristicType", ObjectExpr1381())])
    class ObjectExpr1382(IEncodable):
    ...
    return ObjectExpr1382()


context_jsonvalue: IEncodable = _arrow1383()
