...
IContext_reflection = _expr1346

def _arrow1358(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1347()), ("FactorValue", ObjectExpr1348()), ("additionalType", ObjectExpr1349()), ("category", ObjectExpr1350()), ("categoryName", ObjectExpr1351()), ("categoryCode", ObjectExpr1352()), ("value", ObjectExpr1353()), ("valueCode", ObjectExpr1354()), ("unit", ObjectExpr1355()), ("unitCode", ObjectExpr1356())])
    class ObjectExpr1357(IEncodable):
    ...
    return ObjectExpr1357()


context_jsonvalue: IEncodable = _arrow1358()
