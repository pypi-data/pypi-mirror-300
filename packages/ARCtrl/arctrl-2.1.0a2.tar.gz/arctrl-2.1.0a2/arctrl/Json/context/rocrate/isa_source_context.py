...
IContext_reflection = _expr1519

def _arrow1526(__unit: None=None) -> IEncodable:
    class ObjectExpr1520(IEncodable):
        def Encode(self, helpers: IEncoderHelpers_1[Any]) -> Any:
            return helpers.encode_string("http://schema.org/")

    class ObjectExpr1521(IEncodable):
        def Encode(self, helpers_1: IEncoderHelpers_1[Any]) -> Any:
            return helpers_1.encode_string("https://bioschemas.org/")

    class ObjectExpr1522(IEncodable):
        def Encode(self, helpers_2: IEncoderHelpers_1[Any]) -> Any:
            return helpers_2.encode_string("bio:Sample")

    class ObjectExpr1523(IEncodable):
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1520()), ("bio", ObjectExpr1521()), ("Source", ObjectExpr1522()), ("name", ObjectExpr1523()), ("characteristics", ObjectExpr1524())])
    class ObjectExpr1525(IEncodable):
    ...
    return ObjectExpr1525()


context_jsonvalue: IEncodable = _arrow1526()
