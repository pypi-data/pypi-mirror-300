...
IContext_reflection = _expr1545

def _arrow1548(__unit: None=None) -> IEncodable:
    class ObjectExpr1546(IEncodable):
        def Encode(self, helpers: IEncoderHelpers_1[Any]) -> Any:
            return helpers.encode_string("https://w3id.org/ro/crate/1.1")

    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("@id", ObjectExpr1546())])
...
conforms_to_jsonvalue: IEncodable = _arrow1548()

def _arrow1556(__unit: None=None) -> IEncodable:
    class ObjectExpr1549(IEncodable):
        def Encode(self, helpers: IEncoderHelpers_1[Any]) -> Any:
            return helpers.encode_string("http://schema.org/")

    class ObjectExpr1551(IEncodable):
        def Encode(self, helpers_1: IEncoderHelpers_1[Any]) -> Any:
            return helpers_1.encode_string("http://purl.org/nfdi4plants/ontology/")

    class ObjectExpr1552(IEncodable):
        def Encode(self, helpers_2: IEncoderHelpers_1[Any]) -> Any:
            return helpers_2.encode_string("sdo:CreativeWork")

    class ObjectExpr1553(IEncodable):
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1549()), ("arc", ObjectExpr1551()), ("CreativeWork", ObjectExpr1552()), ("about", ObjectExpr1553()), ("conformsTo", ObjectExpr1554())])
    ...
    return ObjectExpr1555()


context_jsonvalue: IEncodable = _arrow1556()
