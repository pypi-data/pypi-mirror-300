...
def ROCrate_encoder(study_name: str | None, assay_name: str | None, process_name: str | None, oa: Protocol) -> IEncodable:
    ...
    def _arrow2097(__unit: None=None, study_name: Any=study_name, assay_name: Any=assay_name, process_name: Any=process_name, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2100(value_2: str, study_name: Any=study_name, assay_name: Any=assay_name, process_name: Any=process_name, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2101(oa_1: OntologyAnnotation, study_name: Any=study_name, assay_name: Any=assay_name, process_name: Any=process_name, oa: Any=oa) -> IEncodable:
        return OntologyAnnotation_ROCrate_encoderDefinedTerm(oa_1)

    def _arrow2103(value_4: str, study_name: Any=study_name, assay_name: Any=assay_name, process_name: Any=process_name, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2105(value_6: str, study_name: Any=study_name, assay_name: Any=assay_name, process_name: Any=process_name, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2107(value_8: str, study_name: Any=study_name, assay_name: Any=assay_name, process_name: Any=process_name, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2108(comment: Comment, study_name: Any=study_name, assay_name: Any=assay_name, process_name: Any=process_name, oa: Any=oa) -> IEncodable:
        return ROCrate_encoder_2(comment)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@id", _arrow2097()), ("@type", list_1_1(singleton(ObjectExpr2098()))), try_include("name", _arrow2100, oa.Name), try_include("protocolType", _arrow2101, oa.ProtocolType), try_include("description", _arrow2103, oa.Description), try_include("uri", _arrow2105, oa.Uri), try_include("version", _arrow2107, oa.Version), try_include_list_opt("components", ROCrate_encoder_1, oa.Components), try_include_list_opt("comments", _arrow2108, oa.Comments), ("@context", context_jsonvalue)]))
...
def _arrow2121(get: IGetters) -> Protocol:
    def _arrow2113(__unit: None=None) -> FSharpList[Component]:
        list_4: FSharpList[Component]
        def _arrow2110(__unit: None=None) -> FSharpList[Component] | None:
            arg_1: Decoder_1[FSharpList[Component]] = list_1_2(ROCrate_decoder_1)
            object_arg: IOptionalGetter = get.Optional
            return object_arg.Field("components", arg_1)

        list_2: FSharpList[Component] = default_arg(_arrow2110(), empty())
        def _arrow2111(__unit: None=None) -> FSharpList[Component] | None:
            arg_3: Decoder_1[FSharpList[Component]] = list_1_2(ROCrate_decoder_1)
            object_arg_1: IOptionalGetter = get.Optional
            return object_arg_1.Field("reagents", arg_3)

        list_4 = append(default_arg(_arrow2111(), empty()), list_2)
        def _arrow2112(__unit: None=None) -> FSharpList[Component] | None:
        ...
        return append(default_arg(_arrow2112(), empty()), list_4)

    components: FSharpList[Component] | None = Option_fromValueWithDefault(empty(), _arrow2113())
    ...
    def _arrow2120(__unit: None=None) -> FSharpList[Comment] | None:
        arg_19: Decoder_1[FSharpList[Comment]] = list_1_2(ROCrate_decoder_2)
        object_arg_9: IOptionalGetter = get.Optional
        return object_arg_9.Field("comments", arg_19)

    return Protocol(_arrow2114(), _arrow2115(), _arrow2116(), _arrow2117(), _arrow2118(), _arrow2119(), None, components, _arrow2120())


ROCrate_decoder: Decoder_1[Protocol] = object(_arrow2121)
...
def ISAJson_encoder(study_name: str | None, assay_name: str | None, process_name: str | None, id_map: Any | None, oa: Protocol) -> IEncodable:
    def f(oa_1: Protocol, study_name: Any=study_name, assay_name: Any=assay_name, process_name: Any=process_name, id_map: Any=id_map, oa: Any=oa) -> IEncodable:
        ...
        def _arrow2125(value: str, oa_1: Any=oa_1) -> IEncodable:
        ...
        def _arrow2127(value_2: str, oa_1: Any=oa_1) -> IEncodable:
        ...
        def _arrow2128(oa_2: OntologyAnnotation, oa_1: Any=oa_1) -> IEncodable:
            return OntologyAnnotation_ISAJson_encoder(id_map, oa_2)

        def _arrow2130(value_4: str, oa_1: Any=oa_1) -> IEncodable:
        ...
        def _arrow2132(value_6: str, oa_1: Any=oa_1) -> IEncodable:
        ...
        def _arrow2134(value_8: str, oa_1: Any=oa_1) -> IEncodable:
        ...
        def _arrow2135(value_10: ProtocolParameter, oa_1: Any=oa_1) -> IEncodable:
            return encoder(id_map, value_10)

        def _arrow2136(c: Component, oa_1: Any=oa_1) -> IEncodable:
            return ISAJson_encoder_1(id_map, c)

        def _arrow2137(comment: Comment, oa_1: Any=oa_1) -> IEncodable:
            return ISAJson_encoder_2(id_map, comment)

        values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include("@id", _arrow2125, ROCrate_genID(study_name, assay_name, process_name, oa_1)), try_include("name", _arrow2127, oa_1.Name), try_include("protocolType", _arrow2128, oa_1.ProtocolType), try_include("description", _arrow2130, oa_1.Description), try_include("uri", _arrow2132, oa_1.Uri), try_include("version", _arrow2134, oa_1.Version), try_include_list_opt("parameters", _arrow2135, oa_1.Parameters), try_include_list_opt("components", _arrow2136, oa_1.Components), try_include_list_opt("comments", _arrow2137, oa_1.Comments)]))
    ...
    if id_map is not None:
        def _arrow2139(p_1: Protocol, study_name: Any=study_name, assay_name: Any=assay_name, process_name: Any=process_name, id_map: Any=id_map, oa: Any=oa) -> str:
            return ROCrate_genID(study_name, assay_name, process_name, p_1)

        return encode(_arrow2139, f, oa, id_map)
...
def _arrow2149(get: IGetters) -> Protocol:
    ...
    def _arrow2142(__unit: None=None) -> OntologyAnnotation | None:
        object_arg_2: IOptionalGetter = get.Optional
    ...
    def _arrow2146(__unit: None=None) -> FSharpList[ProtocolParameter] | None:
        arg_13: Decoder_1[FSharpList[ProtocolParameter]] = list_1_2(decoder)
        object_arg_6: IOptionalGetter = get.Optional
        return object_arg_6.Field("parameters", arg_13)

    def _arrow2147(__unit: None=None) -> FSharpList[Component] | None:
        arg_15: Decoder_1[FSharpList[Component]] = list_1_2(ISAJson_decoder_1)
        object_arg_7: IOptionalGetter = get.Optional
        return object_arg_7.Field("components", arg_15)

    def _arrow2148(__unit: None=None) -> FSharpList[Comment] | None:
        arg_17: Decoder_1[FSharpList[Comment]] = list_1_2(ISAJson_decoder_2)
        object_arg_8: IOptionalGetter = get.Optional
        return object_arg_8.Field("comments", arg_17)

    return Protocol(_arrow2140(), _arrow2141(), _arrow2142(), _arrow2143(), _arrow2144(), _arrow2145(), _arrow2146(), _arrow2147(), _arrow2148())


ISAJson_decoder: Decoder_1[Protocol] = object(_arrow2149)
