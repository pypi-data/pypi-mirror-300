...
def encode(encoder: Callable[[Any, Any, Any, _A], IEncodable], obj: Any) -> IEncodable:
    ...
    oa_table: Any = Dictionary([], ObjectExpr3031())
    class ObjectExpr3032:
        @property
    ...
    cell_table: Any = Dictionary([], ObjectExpr3032())
...
def decode(decoder: Callable[[Array[str], Array[OntologyAnnotation], Array[CompositeCell]], __A]) -> Decoder_1[Any]:
    def _arrow3035(get: IGetters, decoder: Any=decoder) -> __B:
        ...
        def _arrow3034(__unit: None=None) -> Array[CompositeCell]:
