...
def Process_getInputCharacteristicValues_763471FF(p: Process) -> FSharpList[MaterialAttributeValue]:
    ...
    if match_value is None:
        ...
        return List_distinct(collect(mapping, match_value), ObjectExpr582())
...
def Process_getOutputCharacteristicValues_763471FF(p: Process) -> FSharpList[MaterialAttributeValue]:
    ...
    if match_value is None:
        ...
        return List_distinct(collect(mapping, match_value), ObjectExpr587())
...
def Process_getCharacteristicValues_763471FF(p: Process) -> FSharpList[MaterialAttributeValue]:
    ...
    return List_distinct(append(Process_getInputCharacteristicValues_763471FF(p), Process_getOutputCharacteristicValues_763471FF(p)), ObjectExpr590())
...
def Process_getCharacteristics_763471FF(p: Process) -> FSharpList[MaterialAttribute]:
    ...
    return List_distinct(choose(chooser, Process_getCharacteristicValues_763471FF(p)), ObjectExpr591())
...
def Process_getFactorValues_763471FF(p: Process) -> FSharpList[FactorValue]:
    ...
    return List_distinct(collect(mapping, default_arg(p.Outputs, empty())), ObjectExpr594())
...
def Process_getFactors_763471FF(p: Process) -> FSharpList[Factor]:
    ...
    return List_distinct(choose(chooser, Process_getFactorValues_763471FF(p)), ObjectExpr596())
...
def Process_getSamples_763471FF(p: Process) -> FSharpList[Sample]:
    ...
    return List_distinct(append(choose(chooser, default_arg(p.Inputs, empty())), choose(chooser_1, default_arg(p.Outputs, empty()))), ObjectExpr602())
...
def Process_getMaterials_763471FF(p: Process) -> FSharpList[Material]:
    ...
    return List_distinct(append(choose(chooser, default_arg(p.Inputs, empty())), choose(chooser_1, default_arg(p.Outputs, empty()))), ObjectExpr604())
