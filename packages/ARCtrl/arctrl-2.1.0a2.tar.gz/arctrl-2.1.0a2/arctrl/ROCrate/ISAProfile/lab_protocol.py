...
def _expr1272() -> TypeInfo:
    return class_type("ARCtrl.ROCrate.LabProtocol", None, LabProtocol, ROCrateObject_reflection())


class LabProtocol(ROCrateObject):
...
LabProtocol_reflection = _expr1272
