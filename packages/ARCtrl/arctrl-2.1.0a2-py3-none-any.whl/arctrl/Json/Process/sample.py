...
def ROCrate_encoder(oa: Sample) -> IEncodable:
    ...
    def _arrow2232(__unit: None=None, oa: Any=oa) -> IEncodable:
    ...
    class ObjectExpr2233(IEncodable):
        def Encode(self, helpers_1: IEncoderHelpers_1[Any], oa: Any=oa) -> Any:
            return helpers_1.encode_string("Sample")

    def _arrow2235(value_4: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2236(x: IEncodable, oa: Any=oa) -> IEncodable:
        return x

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@id", _arrow2232()), ("@type", list_1_2(singleton(ObjectExpr2233()))), try_include("name", _arrow2235, oa.Name), try_include_list("additionalProperties", _arrow2236, additional_properties), ("@context", context_jsonvalue)]))
...
class ObjectExpr2239(Decoder_1[tuple[MaterialAttributeValue | None, FactorValue | None]]):
    def Decode(self, s: IDecoderHelpers_1[Any], json: Any) -> FSharpResult_2[tuple[MaterialAttributeValue | None, FactorValue | None], tuple[str, ErrorReason_1[__A_]]]:
        def _arrow2238(__unit: None=None) -> str:
        ...
        if (_arrow2238() if s.has_property("additionalType", json) else "") == "FactorValue":
...
ROCrate_additionalPropertyDecoder: Decoder_1[tuple[MaterialAttributeValue | None, FactorValue | None]] = ObjectExpr2239()

def _arrow2243(get: IGetters) -> Sample:
    additional_properties: FSharpList[tuple[MaterialAttributeValue | None, FactorValue | None]] | None
    arg_1: Decoder_1[FSharpList[tuple[MaterialAttributeValue | None, FactorValue | None]]] = list_1_3(ROCrate_additionalPropertyDecoder)
    ...
    def _arrow2242(__unit: None=None) -> FSharpList[Source] | None:
        arg_7: Decoder_1[FSharpList[Source]] = list_1_3(ROCrate_decoder_3)
        object_arg_3: IOptionalGetter = get.Optional
        return object_arg_3.Field("derivesFrom", arg_7)

    return Sample(_arrow2240(), _arrow2241(), pattern_input[0], pattern_input[1], _arrow2242())


ROCrate_decoder: Decoder_1[Sample] = object(_arrow2243)
...
def ISAJson_encoder(id_map: Any | None, oa: Sample) -> IEncodable:
    def f(oa_1: Sample, id_map: Any=id_map, oa: Any=oa) -> IEncodable:
        ...
        def _arrow2247(value: str, oa_1: Any=oa_1) -> IEncodable:
        ...
        def _arrow2249(value_2: str, oa_1: Any=oa_1) -> IEncodable:
        ...
        def _arrow2250(oa_2: MaterialAttributeValue, oa_1: Any=oa_1) -> IEncodable:
            return ISAJson_encoder_1(id_map, oa_2)

        def _arrow2251(fv: FactorValue, oa_1: Any=oa_1) -> IEncodable:
            return ISAJson_encoder_2(id_map, fv)

        def _arrow2252(oa_3: Source, oa_1: Any=oa_1) -> IEncodable:
            return ISAJson_encoder_3(id_map, oa_3)

        values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include("@id", _arrow2247, ROCrate_genID(oa_1)), try_include("name", _arrow2249, oa_1.Name), try_include_list_opt("characteristics", _arrow2250, oa_1.Characteristics), try_include_list_opt("factorValues", _arrow2251, oa_1.FactorValues), try_include_list_opt("derivesFrom", _arrow2252, oa_1.DerivesFrom)]))
    ...
    if id_map is not None:
        def _arrow2254(s_1: Sample, id_map: Any=id_map, oa: Any=oa) -> str:
            return ROCrate_genID(s_1)

        return encode(_arrow2254, f, oa, id_map)
...
def _arrow2260(get: IGetters) -> Sample:
    def _arrow2255(__unit: None=None) -> str | None:
        object_arg: IOptionalGetter = get.Optional
        return object_arg.Field("@id", Decode_uri)

    def _arrow2256(__unit: None=None) -> str | None:
        object_arg_1: IOptionalGetter = get.Optional
        return object_arg_1.Field("name", string)

    def _arrow2257(__unit: None=None) -> FSharpList[MaterialAttributeValue] | None:
    ...
    def _arrow2258(__unit: None=None) -> FSharpList[FactorValue] | None:
        arg_7: Decoder_1[FSharpList[FactorValue]] = list_1_3(ISAJson_decoder_2)
        object_arg_3: IOptionalGetter = get.Optional
        return object_arg_3.Field("factorValues", arg_7)

    def _arrow2259(__unit: None=None) -> FSharpList[Source] | None:
        arg_9: Decoder_1[FSharpList[Source]] = list_1_3(ISAJson_decoder_3)
        object_arg_4: IOptionalGetter = get.Optional
        return object_arg_4.Field("derivesFrom", arg_9)

    return Sample(_arrow2255(), _arrow2256(), _arrow2257(), _arrow2258(), _arrow2259())


ISAJson_decoder: Decoder_1[Sample] = Decode_objectNoAdditionalProperties(ISAJson_allowedFields, _arrow2260)
