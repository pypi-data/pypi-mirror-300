...
from .sample import (ROCrate_encoder as ROCrate_encoder_1, ROCrate_decoder as ROCrate_decoder_2, ISAJson_encoder as ISAJson_encoder_1, ISAJson_decoder as ISAJson_decoder_2)
from .source import (ROCrate_encoder as ROCrate_encoder_4, ROCrate_decoder as ROCrate_decoder_1, ISAJson_encoder as ISAJson_encoder_4, ISAJson_decoder as ISAJson_decoder_1)
...
def _arrow2220(Item: Source) -> ProcessInput:
    return ProcessInput(0, Item)


def _arrow2221(Item_1: Sample) -> ProcessInput:
    return ProcessInput(1, Item_1)


def _arrow2222(Item_2: Data) -> ProcessInput:
    return ProcessInput(2, Item_2)


def _arrow2223(Item_3: Material) -> ProcessInput:
    return ProcessInput(3, Item_3)


ROCrate_decoder: Decoder_1[ProcessInput] = one_of(of_array([map(_arrow2220, ROCrate_decoder_1), map(_arrow2221, ROCrate_decoder_2), map(_arrow2222, ROCrate_decoder_3), map(_arrow2223, ROCrate_decoder_4)]))
...
def _arrow2225(Item: Source) -> ProcessInput:
    return ProcessInput(0, Item)


def _arrow2226(Item_1: Sample) -> ProcessInput:
    return ProcessInput(1, Item_1)


def _arrow2227(Item_2: Data) -> ProcessInput:
    return ProcessInput(2, Item_2)


def _arrow2228(Item_3: Material) -> ProcessInput:
    return ProcessInput(3, Item_3)


ISAJson_decoder: Decoder_1[ProcessInput] = one_of(of_array([map(_arrow2225, ISAJson_decoder_1), map(_arrow2226, ISAJson_decoder_2), map(_arrow2227, ISAJson_decoder_3), map(_arrow2228, ISAJson_decoder_4)]))
