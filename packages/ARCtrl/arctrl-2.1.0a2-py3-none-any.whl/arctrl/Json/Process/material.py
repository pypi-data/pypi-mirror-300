...
def ROCrate_encoder(oa: Material) -> IEncodable:
    ...
    def _arrow2153(__unit: None=None, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2156(value_2: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2157(value_4: MaterialType, oa: Any=oa) -> IEncodable:
        return ROCrate_encoder_1(value_4)

    def _arrow2158(oa_1: Material, oa: Any=oa) -> IEncodable:
        return ROCrate_encoder(oa_1)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@id", _arrow2153()), ("@type", list_1_1(singleton(ObjectExpr2154()))), try_include("name", _arrow2156, oa.Name), try_include("type", _arrow2157, oa.MaterialType), try_include_list_opt("characteristics", ROCrate_encoder_2, oa.Characteristics), try_include_list_opt("derivesFrom", _arrow2158, oa.DerivesFrom), ("@context", context_jsonvalue)]))
...
def _arrow2166(__unit: None=None) -> Decoder_1[Material]:
    def decode(__unit: None=None) -> Decoder_1[Material]:
        def _arrow2165(get: IGetters) -> Material:
            def _arrow2160(__unit: None=None) -> str | None:
                object_arg: IOptionalGetter = get.Optional
                return object_arg.Field("@id", Decode_uri)

            def _arrow2161(__unit: None=None) -> str | None:
                object_arg_1: IOptionalGetter = get.Optional
                return object_arg_1.Field("name", string)

            def _arrow2162(__unit: None=None) -> MaterialType | None:
                object_arg_2: IOptionalGetter = get.Optional
                return object_arg_2.Field("type", ROCrate_decoder_1)

            def _arrow2163(__unit: None=None) -> FSharpList[MaterialAttributeValue] | None:
            ...
            def _arrow2164(__unit: None=None) -> FSharpList[Material] | None:
                arg_9: Decoder_1[FSharpList[Material]] = list_1_2(decode(None))
                object_arg_4: IOptionalGetter = get.Optional
                return object_arg_4.Field("derivesFrom", arg_9)

            return Material(_arrow2160(), _arrow2161(), _arrow2162(), _arrow2163(), _arrow2164())

        return object(_arrow2165)

    return decode(None)


ROCrate_decoder: Decoder_1[Material] = _arrow2166()
...
def ISAJson_encoder(id_map: Any | None, c: Material) -> IEncodable:
    def f(oa: Material, id_map: Any=id_map, c: Any=c) -> IEncodable:
        ...
        def _arrow2170(value: str, oa: Any=oa) -> IEncodable:
        ...
        def _arrow2172(value_2: str, oa: Any=oa) -> IEncodable:
        ...
        def _arrow2173(oa_1: MaterialAttributeValue, oa: Any=oa) -> IEncodable:
            return ISAJson_encoder_2(id_map, oa_1)

        def _arrow2174(c_1: Material, oa: Any=oa) -> IEncodable:
            return ISAJson_encoder(id_map, c_1)

        values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include("@id", _arrow2170, ROCrate_genID(oa)), try_include("name", _arrow2172, oa.Name), try_include("type", ISAJson_encoder_1, oa.MaterialType), try_include_list_opt("characteristics", _arrow2173, oa.Characteristics), try_include_list_opt("derivesFrom", _arrow2174, oa.DerivesFrom)]))
    ...
    if id_map is not None:
        def _arrow2176(m_1: Material, id_map: Any=id_map, c: Any=c) -> str:
            return ROCrate_genID(m_1)

        return encode(_arrow2176, f, c, id_map)
...
def _arrow2183(__unit: None=None) -> Decoder_1[Material]:
    def decode(__unit: None=None) -> Decoder_1[Material]:
        def _arrow2182(get: IGetters) -> Material:
            ...
            def _arrow2179(__unit: None=None) -> MaterialType | None:
                object_arg_2: IOptionalGetter = get.Optional
                return object_arg_2.Field("type", ISAJson_decoder_1)

            def _arrow2180(__unit: None=None) -> FSharpList[MaterialAttributeValue] | None:
                arg_7: Decoder_1[FSharpList[MaterialAttributeValue]] = list_1_2(ISAJson_decoder_2)
                object_arg_3: IOptionalGetter = get.Optional
                return object_arg_3.Field("characteristics", arg_7)

            def _arrow2181(__unit: None=None) -> FSharpList[Material] | None:
                arg_9: Decoder_1[FSharpList[Material]] = list_1_2(decode(None))
                object_arg_4: IOptionalGetter = get.Optional
                return object_arg_4.Field("derivesFrom", arg_9)

            return Material(_arrow2177(), _arrow2178(), _arrow2179(), _arrow2180(), _arrow2181())

        return Decode_objectNoAdditionalProperties(ISAJson_allowedFields, _arrow2182)

    return decode(None)


ISAJson_decoder: Decoder_1[Material] = _arrow2183()
