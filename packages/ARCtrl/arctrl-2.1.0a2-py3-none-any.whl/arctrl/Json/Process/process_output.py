...
def _arrow2262(Item: Sample) -> ProcessOutput:
    return ProcessOutput(0, Item)


def _arrow2263(Item_1: Data) -> ProcessOutput:
    return ProcessOutput(1, Item_1)


def _arrow2264(Item_2: Material) -> ProcessOutput:
    return ProcessOutput(2, Item_2)


ROCrate_decoder: Decoder_1[ProcessOutput] = one_of(of_array([map(_arrow2262, ROCrate_decoder_1), map(_arrow2263, ROCrate_decoder_2), map(_arrow2264, ROCrate_decoder_3)]))
...
def _arrow2266(Item: Sample) -> ProcessOutput:
    return ProcessOutput(0, Item)


def _arrow2267(Item_1: Data) -> ProcessOutput:
    return ProcessOutput(1, Item_1)


def _arrow2268(Item_2: Material) -> ProcessOutput:
    return ProcessOutput(2, Item_2)


ISAJson_decoder: Decoder_1[ProcessOutput] = one_of(of_array([map(_arrow2266, ISAJson_decoder_1), map(_arrow2267, ISAJson_decoder_2), map(_arrow2268, ISAJson_decoder_3)]))
