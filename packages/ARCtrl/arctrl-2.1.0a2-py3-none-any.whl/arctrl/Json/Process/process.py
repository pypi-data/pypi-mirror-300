...
def ROCrate_encoder(study_name: str | None, assay_name: str | None, oa: Process) -> IEncodable:
    ...
    def _arrow2281(__unit: None=None, study_name: Any=study_name, assay_name: Any=assay_name, oa: Any=oa) -> IEncodable:
    ...
    class ObjectExpr2282(IEncodable):
    ...
    def _arrow2284(value_2: str, study_name: Any=study_name, assay_name: Any=assay_name, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2285(oa_1: Protocol, study_name: Any=study_name, assay_name: Any=assay_name, oa: Any=oa) -> IEncodable:
        return ROCrate_encoder_1(study_name, assay_name, oa.Name, oa_1)

    def _arrow2286(author_list: str, study_name: Any=study_name, assay_name: Any=assay_name, oa: Any=oa) -> IEncodable:
        return ROCrate_encodeAuthorListString(author_list)

    def _arrow2288(value_4: str, study_name: Any=study_name, assay_name: Any=assay_name, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2289(value_6: ProcessInput, study_name: Any=study_name, assay_name: Any=assay_name, oa: Any=oa) -> IEncodable:
        return ROCrate_encoder_3(value_6)

    def _arrow2290(value_7: ProcessOutput, study_name: Any=study_name, assay_name: Any=assay_name, oa: Any=oa) -> IEncodable:
        return ROCrate_encoder_4(value_7)

    def _arrow2291(comment: Comment, study_name: Any=study_name, assay_name: Any=assay_name, oa: Any=oa) -> IEncodable:
        return ROCrate_encoder_5(comment)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@id", _arrow2281()), ("@type", list_1_1(singleton(ObjectExpr2282()))), try_include("name", _arrow2284, oa.Name), try_include("executesProtocol", _arrow2285, oa.ExecutesProtocol), try_include_list_opt("parameterValues", ROCrate_encoder_2, oa.ParameterValues), try_include("performer", _arrow2286, oa.Performer), try_include("date", _arrow2288, oa.Date), try_include_list_opt("inputs", _arrow2289, oa.Inputs), try_include_list_opt("outputs", _arrow2290, oa.Outputs), try_include_list_opt("comments", _arrow2291, oa.Comments), ("@context", context_jsonvalue)]))
...
def _arrow2304(get: IGetters) -> Process:
    def _arrow2293(__unit: None=None) -> str | None:
    ...
    def _arrow2296(__unit: None=None) -> Protocol | None:
        object_arg_2: IOptionalGetter = get.Optional
        return object_arg_2.Field("executesProtocol", ROCrate_decoder_1)

    def _arrow2297(__unit: None=None) -> FSharpList[ProcessParameterValue] | None:
    ...
    def _arrow2300(__unit: None=None) -> FSharpList[ProcessInput] | None:
        arg_13: Decoder_1[FSharpList[ProcessInput]] = list_1_2(ROCrate_decoder_3)
        object_arg_6: IOptionalGetter = get.Optional
        return object_arg_6.Field("inputs", arg_13)

    def _arrow2302(__unit: None=None) -> FSharpList[ProcessOutput] | None:
        arg_15: Decoder_1[FSharpList[ProcessOutput]] = list_1_2(ROCrate_decoder_4)
        object_arg_7: IOptionalGetter = get.Optional
        return object_arg_7.Field("outputs", arg_15)

    def _arrow2303(__unit: None=None) -> FSharpList[Comment] | None:
        arg_17: Decoder_1[FSharpList[Comment]] = list_1_2(ROCrate_decoder_5)
        object_arg_8: IOptionalGetter = get.Optional
        return object_arg_8.Field("comments", arg_17)

    return Process(_arrow2293(), _arrow2295(), _arrow2296(), _arrow2297(), _arrow2298(), _arrow2299(), None, None, _arrow2300(), _arrow2302(), _arrow2303())


ROCrate_decoder: Decoder_1[Process] = object(_arrow2304)
...
def ISAJson_encoder(study_name: str | None, assay_name: str | None, id_map: Any | None, oa: Process) -> IEncodable:
    def f(oa_1: Process, study_name: Any=study_name, assay_name: Any=assay_name, id_map: Any=id_map, oa: Any=oa) -> IEncodable:
        ...
        def _arrow2309(value: str, oa_1: Any=oa_1) -> IEncodable:
        ...
        def _arrow2312(value_2: str, oa_1: Any=oa_1) -> IEncodable:
        ...
        def _arrow2313(oa_2: Protocol, oa_1: Any=oa_1) -> IEncodable:
            return ISAJson_encoder_1(study_name, assay_name, oa_1.Name, id_map, oa_2)

        def _arrow2314(oa_3: ProcessParameterValue, oa_1: Any=oa_1) -> IEncodable:
            return ISAJson_encoder_2(id_map, oa_3)

        def _arrow2317(value_4: str, oa_1: Any=oa_1) -> IEncodable:
        ...
        def _arrow2319(value_6: str, oa_1: Any=oa_1) -> IEncodable:
        ...
        def _arrow2320(oa_4: Process, oa_1: Any=oa_1) -> IEncodable:
            return ISAJson_encoder(study_name, assay_name, id_map, oa_4)

        def _arrow2321(oa_5: Process, oa_1: Any=oa_1) -> IEncodable:
            return ISAJson_encoder(study_name, assay_name, id_map, oa_5)

        def _arrow2322(value_8: ProcessInput, oa_1: Any=oa_1) -> IEncodable:
            return ISAJson_encoder_3(id_map, value_8)

        def _arrow2323(value_9: ProcessOutput, oa_1: Any=oa_1) -> IEncodable:
            return ISAJson_encoder_4(id_map, value_9)

        def _arrow2324(comment: Comment, oa_1: Any=oa_1) -> IEncodable:
            return ISAJson_encoder_5(id_map, comment)

        values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include("@id", _arrow2309, ROCrate_genID(oa_1)), try_include("name", _arrow2312, oa_1.Name), try_include("executesProtocol", _arrow2313, oa_1.ExecutesProtocol), try_include_list_opt("parameterValues", _arrow2314, oa_1.ParameterValues), try_include("performer", _arrow2317, oa_1.Performer), try_include("date", _arrow2319, oa_1.Date), try_include("previousProcess", _arrow2320, oa_1.PreviousProcess), try_include("nextProcess", _arrow2321, oa_1.NextProcess), try_include_list_opt("inputs", _arrow2322, oa_1.Inputs), try_include_list_opt("outputs", _arrow2323, oa_1.Outputs), try_include_list_opt("comments", _arrow2324, oa_1.Comments)]))
    ...
    if id_map is not None:
        def _arrow2326(p: Process, study_name: Any=study_name, assay_name: Any=assay_name, id_map: Any=id_map, oa: Any=oa) -> str:
            return ROCrate_genID(p)

        return encode(_arrow2326, f, oa, id_map)
...
def _arrow2339(__unit: None=None) -> Decoder_1[Process]:
    def decode(__unit: None=None) -> Decoder_1[Process]:
        def _arrow2338(get: IGetters) -> Process:
            def _arrow2327(__unit: None=None) -> str | None:
                object_arg: IOptionalGetter = get.Optional
                return object_arg.Field("@id", Decode_uri)
            ...
            def _arrow2329(__unit: None=None) -> Protocol | None:
                object_arg_2: IOptionalGetter = get.Optional
                return object_arg_2.Field("executesProtocol", ISAJson_decoder_1)

            def _arrow2330(__unit: None=None) -> FSharpList[ProcessParameterValue] | None:
...
ISAJson_decoder: Decoder_1[Process] = _arrow2339()
