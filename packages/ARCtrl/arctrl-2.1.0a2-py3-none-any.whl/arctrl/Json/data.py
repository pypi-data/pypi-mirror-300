...
def encoder(d: Data) -> IEncodable:
    ...
    def _arrow1773(value: str, d: Any=d) -> IEncodable:
    ...
    def _arrow1775(value_2: str, d: Any=d) -> IEncodable:
    ...
    def _arrow1777(value_4: str, d: Any=d) -> IEncodable:
    ...
    def _arrow1779(value_6: str, d: Any=d) -> IEncodable:
    ...
    def _arrow1780(comment: Comment, d: Any=d) -> IEncodable:
        return encoder_1(comment)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include("@id", _arrow1773, d.ID), try_include("name", _arrow1775, d.Name), try_include("dataType", ISAJson_encoder_1, d.DataType), try_include("format", _arrow1777, d.Format), try_include("selectorFormat", _arrow1779, d.SelectorFormat), try_include_seq("comments", _arrow1780, d.Comments)]))
...
def _arrow1788(get: IGetters) -> Data:
    ...
    def _arrow1784(__unit: None=None) -> DataFile | None:
    ...
    def _arrow1787(__unit: None=None) -> Array[Comment] | None:
        arg_11: Decoder_1[Array[Comment]] = resize_array(decoder_1)
        object_arg_5: IOptionalGetter = get.Optional
        return object_arg_5.Field("comments", arg_11)

    return Data(_arrow1782(), _arrow1783(), _arrow1784(), _arrow1785(), _arrow1786(), _arrow1787())


decoder: Decoder_1[Data] = object(_arrow1788)
...
def compressed_encoder(string_table: Any, d: Data) -> IEncodable:
    ...
    def _arrow1790(s: str, string_table: Any=string_table, d: Any=d) -> IEncodable:
        return encode_string(string_table, s)

    def _arrow1791(s_1: str, string_table: Any=string_table, d: Any=d) -> IEncodable:
        return encode_string(string_table, s_1)

    def _arrow1792(s_2: str, string_table: Any=string_table, d: Any=d) -> IEncodable:
        return encode_string(string_table, s_2)

    def _arrow1793(s_3: str, string_table: Any=string_table, d: Any=d) -> IEncodable:
        return encode_string(string_table, s_3)

    def _arrow1794(comment: Comment, string_table: Any=string_table, d: Any=d) -> IEncodable:
        return encoder_1(comment)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include("i", _arrow1790, d.ID), try_include("n", _arrow1791, d.Name), try_include("d", ISAJson_encoder_1, d.DataType), try_include("f", _arrow1792, d.Format), try_include("s", _arrow1793, d.SelectorFormat), try_include_seq("c", _arrow1794, d.Comments)]))
...
def compressed_decoder(string_table: Array[str]) -> Decoder_1[Data]:
    def _arrow1802(get: IGetters, string_table: Any=string_table) -> Data:
        ...
        def _arrow1798(__unit: None=None) -> DataFile | None:
            object_arg_2: IOptionalGetter = get.Optional
        ...
        def _arrow1801(__unit: None=None) -> Array[Comment] | None:
            arg_11: Decoder_1[Array[Comment]] = resize_array(decoder_1)
            object_arg_5: IOptionalGetter = get.Optional
            return object_arg_5.Field("c", arg_11)

        return Data(_arrow1796(), _arrow1797(), _arrow1798(), _arrow1799(), _arrow1800(), _arrow1801())
...
def ROCrate_encoder(oa: Data) -> IEncodable:
    ...
    def _arrow1806(__unit: None=None, oa: Any=oa) -> IEncodable:
    ...
    def _arrow1809(value_2: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow1810(value_4: DataFile, oa: Any=oa) -> IEncodable:
        return ROCrate_encoder_1(value_4)

    def _arrow1812(value_5: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow1814(value_7: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow1815(comment: Comment, oa: Any=oa) -> IEncodable:
        return ROCrate_encoder_2(comment)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@id", _arrow1806()), ("@type", list_1_1(singleton(ObjectExpr1807()))), try_include("name", _arrow1809, oa.Name), try_include("type", _arrow1810, oa.DataType), try_include("encodingFormat", _arrow1812, oa.Format), try_include("usageInfo", _arrow1814, oa.SelectorFormat), try_include_seq("comments", _arrow1815, oa.Comments), ("@context", context_jsonvalue)]))
...
def _arrow1823(get: IGetters) -> Data:
    def _arrow1817(__unit: None=None) -> str | None:
        object_arg: IOptionalGetter = get.Optional
        return object_arg.Field("@id", Decode_uri)

    def _arrow1818(__unit: None=None) -> str | None:
        object_arg_1: IOptionalGetter = get.Optional
        return object_arg_1.Field("name", string)

    def _arrow1819(__unit: None=None) -> DataFile | None:
        object_arg_2: IOptionalGetter = get.Optional
    ...
    def _arrow1821(__unit: None=None) -> str | None:
        object_arg_4: IOptionalGetter = get.Optional
        return object_arg_4.Field("usageInfo", Decode_uri)

    def _arrow1822(__unit: None=None) -> Array[Comment] | None:
        arg_11: Decoder_1[Array[Comment]] = resize_array(ROCrate_decoder_2)
        object_arg_5: IOptionalGetter = get.Optional
        return object_arg_5.Field("comments", arg_11)

    return Data(_arrow1817(), _arrow1818(), _arrow1819(), _arrow1820(), _arrow1821(), _arrow1822())


ROCrate_decoder: Decoder_1[Data] = object(_arrow1823)
...
def ISAJson_encoder(id_map: Any | None, oa: Data) -> IEncodable:
    def f(oa_1: Data, id_map: Any=id_map, oa: Any=oa) -> IEncodable:
        ...
        def _arrow1827(value: str, oa_1: Any=oa_1) -> IEncodable:
        ...
        def _arrow1829(value_2: str, oa_1: Any=oa_1) -> IEncodable:
            class ObjectExpr1828(IEncodable):
                def Encode(self, helpers_1: IEncoderHelpers_1[Any]) -> Any:
                    return helpers_1.encode_string(value_2)

            return ObjectExpr1828()

        def _arrow1830(comment: Comment, oa_1: Any=oa_1) -> IEncodable:
            return ISAJson_encoder_2(id_map, comment)

        values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include("@id", _arrow1827, ROCrate_genID(oa_1)), try_include("name", _arrow1829, oa_1.Name), try_include("type", ISAJson_encoder_1, oa_1.DataType), try_include_seq("comments", _arrow1830, oa_1.Comments)]))
    ...
    if id_map is not None:
        def _arrow1832(d_1: Data, id_map: Any=id_map, oa: Any=oa) -> str:
            return ROCrate_genID(d_1)

        return encode(_arrow1832, f, oa, id_map)
...
def _arrow1837(get: IGetters) -> Data:
    ...
    def _arrow1835(__unit: None=None) -> DataFile | None:
        object_arg_2: IOptionalGetter = get.Optional
        return object_arg_2.Field("type", ISAJson_decoder_1)

    def _arrow1836(__unit: None=None) -> Array[Comment] | None:
        arg_7: Decoder_1[Array[Comment]] = resize_array(ISAJson_decoder_2)
        object_arg_3: IOptionalGetter = get.Optional
        return object_arg_3.Field("comments", arg_7)

    return Data(_arrow1833(), _arrow1834(), _arrow1835(), None, None, _arrow1836())


ISAJson_decoder: Decoder_1[Data] = Decode_objectNoAdditionalProperties(ISAJson_allowedFields, _arrow1837)
