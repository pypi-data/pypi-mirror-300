...
def OntologyAnnotation_encoder(oa: OntologyAnnotation) -> IEncodable:
    ...
    def _arrow1613(value: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow1615(value_2: str, oa: Any=oa) -> IEncodable:
        class ObjectExpr1614(IEncodable):
            def Encode(self, helpers_1: IEncoderHelpers_1[Any]) -> Any:
                return helpers_1.encode_string(value_2)

        return ObjectExpr1614()

    def _arrow1617(value_4: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow1618(comment: Comment, oa: Any=oa) -> IEncodable:
        return encoder(comment)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include("annotationValue", _arrow1613, oa.Name), try_include("termSource", _arrow1615, oa.TermSourceREF), try_include("termAccession", _arrow1617, oa.TermAccessionNumber), try_include_seq("comments", _arrow1618, oa.Comments)]))
    ...
    return ObjectExpr1619()


def _arrow1624(get: IGetters) -> OntologyAnnotation:
    def _arrow1620(__unit: None=None) -> str | None:
        object_arg: IOptionalGetter = get.Optional
        return object_arg.Field("annotationValue", AnnotationValue_decoder)

    def _arrow1621(__unit: None=None) -> str | None:
        object_arg_1: IOptionalGetter = get.Optional
        return object_arg_1.Field("termSource", string)

    def _arrow1622(__unit: None=None) -> str | None:
        object_arg_2: IOptionalGetter = get.Optional
        return object_arg_2.Field("termAccession", string)

    def _arrow1623(__unit: None=None) -> Array[Comment] | None:
        arg_7: Decoder_1[Array[Comment]] = resize_array(decoder)
        object_arg_3: IOptionalGetter = get.Optional
        return object_arg_3.Field("comments", arg_7)

    return OntologyAnnotation.create(_arrow1620(), _arrow1621(), _arrow1622(), _arrow1623())


OntologyAnnotation_decoder: Decoder_1[OntologyAnnotation] = object(_arrow1624)
...
def OntologyAnnotation_compressedEncoder(string_table: Any, oa: OntologyAnnotation) -> IEncodable:
    ...
    def _arrow1626(s: str, string_table: Any=string_table, oa: Any=oa) -> IEncodable:
        return encode_string(string_table, s)

    def _arrow1627(s_1: str, string_table: Any=string_table, oa: Any=oa) -> IEncodable:
        return encode_string(string_table, s_1)

    def _arrow1628(s_2: str, string_table: Any=string_table, oa: Any=oa) -> IEncodable:
        return encode_string(string_table, s_2)

    def _arrow1629(comment: Comment, string_table: Any=string_table, oa: Any=oa) -> IEncodable:
        return encoder(comment)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include("a", _arrow1626, oa.Name), try_include("ts", _arrow1627, oa.TermSourceREF), try_include("ta", _arrow1628, oa.TermAccessionNumber), try_include_seq("comments", _arrow1629, oa.Comments)]))
...
def OntologyAnnotation_ROCrate_encoderDefinedTerm(oa: OntologyAnnotation) -> IEncodable:
    ...
    def _arrow1639(__unit: None=None, oa: Any=oa) -> IEncodable:
        value: str = OntologyAnnotation_ROCrate_genID(oa)
        class ObjectExpr1638(IEncodable):
            def Encode(self, helpers: IEncoderHelpers_1[Any]) -> Any:
                return helpers.encode_string(value)

        return ObjectExpr1638()

    class ObjectExpr1640(IEncodable):
        def Encode(self, helpers_1: IEncoderHelpers_1[Any], oa: Any=oa) -> Any:
            return helpers_1.encode_string("OntologyAnnotation")

    def _arrow1642(value_2: str, oa: Any=oa) -> IEncodable:
        class ObjectExpr1641(IEncodable):
            def Encode(self, helpers_2: IEncoderHelpers_1[Any]) -> Any:
                return helpers_2.encode_string(value_2)

        return ObjectExpr1641()

    def _arrow1644(value_4: str, oa: Any=oa) -> IEncodable:
        class ObjectExpr1643(IEncodable):
            def Encode(self, helpers_3: IEncoderHelpers_1[Any]) -> Any:
                return helpers_3.encode_string(value_4)

        return ObjectExpr1643()

    def _arrow1646(value_6: str, oa: Any=oa) -> IEncodable:
        class ObjectExpr1645(IEncodable):
            def Encode(self, helpers_4: IEncoderHelpers_1[Any]) -> Any:
                return helpers_4.encode_string(value_6)

        return ObjectExpr1645()

    def _arrow1647(comment: Comment, oa: Any=oa) -> IEncodable:
        return ROCrate_encoderDisambiguatingDescription(comment)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@id", _arrow1639()), ("@type", ObjectExpr1640()), try_include("annotationValue", _arrow1642, oa.Name), try_include("termSource", _arrow1644, oa.TermSourceREF), try_include("termAccession", _arrow1646, oa.TermAccessionNumber), try_include_seq("comments", _arrow1647, oa.Comments), ("@context", context_jsonvalue)]))
...
def _arrow1653(get: IGetters) -> OntologyAnnotation:
    ...
    def _arrow1651(__unit: None=None) -> str | None:
        object_arg_2: IOptionalGetter = get.Optional
        return object_arg_2.Field("termAccession", string)

    def _arrow1652(__unit: None=None) -> Array[Comment] | None:
        arg_7: Decoder_1[Array[Comment]] = resize_array(ROCrate_decoderDisambiguatingDescription)
        object_arg_3: IOptionalGetter = get.Optional
        return object_arg_3.Field("comments", arg_7)

    return OntologyAnnotation.create(_arrow1649(), _arrow1650(), _arrow1651(), _arrow1652())


OntologyAnnotation_ROCrate_decoderDefinedTerm: Decoder_1[OntologyAnnotation] = object(_arrow1653)
...
def OntologyAnnotation_ROCrate_encoderPropertyValue(oa: OntologyAnnotation) -> IEncodable:
    ...
    def _arrow1657(__unit: None=None, oa: Any=oa) -> IEncodable:
        value: str = OntologyAnnotation_ROCrate_genID(oa)
    ...
    def _arrow1660(value_2: str, oa: Any=oa) -> IEncodable:
        class ObjectExpr1659(IEncodable):
            def Encode(self, helpers_2: IEncoderHelpers_1[Any]) -> Any:
                return helpers_2.encode_string(value_2)

        return ObjectExpr1659()

    def _arrow1662(value_4: str, oa: Any=oa) -> IEncodable:
        class ObjectExpr1661(IEncodable):
            def Encode(self, helpers_3: IEncoderHelpers_1[Any]) -> Any:
                return helpers_3.encode_string(value_4)

        return ObjectExpr1661()

    def _arrow1663(comment: Comment, oa: Any=oa) -> IEncodable:
        return ROCrate_encoderDisambiguatingDescription(comment)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@id", _arrow1657()), ("@type", ObjectExpr1658()), try_include("category", _arrow1660, oa.Name), try_include("categoryCode", _arrow1662, oa.TermAccessionNumber), try_include_seq("comments", _arrow1663, oa.Comments), ("@context", context_jsonvalue_1)]))
...
def _arrow1668(get: IGetters) -> OntologyAnnotation:
    def _arrow1665(__unit: None=None) -> str | None:
        object_arg: IOptionalGetter = get.Optional
        return object_arg.Field("category", string)

    def _arrow1666(__unit: None=None) -> str | None:
        object_arg_1: IOptionalGetter = get.Optional
        return object_arg_1.Field("categoryCode", string)

    def _arrow1667(__unit: None=None) -> Array[Comment] | None:
    ...
    return OntologyAnnotation.create(_arrow1665(), None, _arrow1666(), _arrow1667())


OntologyAnnotation_ROCrate_decoderPropertyValue: Decoder_1[OntologyAnnotation] = object(_arrow1668)
...
def OntologyAnnotation_ISAJson_encoder(id_map: Any | None, oa: OntologyAnnotation) -> IEncodable:
    def f(oa_1: OntologyAnnotation, id_map: Any=id_map, oa: Any=oa) -> IEncodable:
        ...
        def _arrow1672(value: str, oa_1: Any=oa_1) -> IEncodable:
        ...
        def _arrow1674(value_2: str, oa_1: Any=oa_1) -> IEncodable:
        ...
        def _arrow1676(value_4: str, oa_1: Any=oa_1) -> IEncodable:
        ...
        def _arrow1678(value_6: str, oa_1: Any=oa_1) -> IEncodable:
            class ObjectExpr1677(IEncodable):
                def Encode(self, helpers_3: IEncoderHelpers_1[Any]) -> Any:
                    return helpers_3.encode_string(value_6)

            return ObjectExpr1677()

        def _arrow1679(comment: Comment, oa_1: Any=oa_1) -> IEncodable:
            return encoder(comment)

        values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include("@id", _arrow1672, OntologyAnnotation_ROCrate_genID(oa_1)), try_include("annotationValue", _arrow1674, oa_1.Name), try_include("termSource", _arrow1676, oa_1.TermSourceREF), try_include("termAccession", _arrow1678, oa_1.TermAccessionNumber), try_include_seq("comments", _arrow1679, comments)]))
    ...
    if id_map is not None:
        def _arrow1681(o: OntologyAnnotation, id_map: Any=id_map, oa: Any=oa) -> str:
            return OntologyAnnotation_ROCrate_genID(o)

        return encode(_arrow1681, f, oa, id_map)
