...
def _arrow2414(arg: Organisation) -> IEncodable:
...
Template_Organisation_encoder: Callable[[Organisation], IEncodable] = _arrow2414
...
def Template_encoder(template: Template) -> IEncodable:
    def _arrow2421(__unit: None=None, template: Any=template) -> IEncodable:
        value_1: str
    ...
    def _arrow2425(__unit: None=None, template: Any=template) -> IEncodable:
    ...
    def _arrow2429(__unit: None=None, template: Any=template) -> IEncodable:
    ...
    def _arrow2433(__unit: None=None, template: Any=template) -> IEncodable:
    ...
    values_3: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("id", _arrow2421()), ("table", encoder(template.Table)), ("name", _arrow2425()), ("description", _arrow2429()), ("organisation", Template_Organisation_encoder(template.Organisation)), ("version", _arrow2433()), ("authors", seq(map(mapping, template.Authors))), ("endpoint_repositories", seq(map(mapping_1, template.EndpointRepositories))), ("tags", seq(map(mapping_2, template.Tags))), ("last_updated", date_time(template.LastUpdated))])
...
def _arrow2452(get: IGetters) -> Template:
    def _arrow2440(__unit: None=None) -> str:
        object_arg: IRequiredGetter = get.Required
        return object_arg.Field("id", guid)

    def _arrow2441(__unit: None=None) -> ArcTable:
        object_arg_1: IRequiredGetter = get.Required
        return object_arg_1.Field("table", decoder_1)

    def _arrow2442(__unit: None=None) -> str:
    ...
    def _arrow2444(__unit: None=None) -> Organisation:
    ...
    def _arrow2447(__unit: None=None) -> Array[Person] | None:
        arg_13: Decoder_1[Array[Person]] = resize_array(decoder_2)
        object_arg_6: IOptionalGetter = get.Optional
        return object_arg_6.Field("authors", arg_13)

    def _arrow2449(__unit: None=None) -> Array[OntologyAnnotation] | None:
    ...
    def _arrow2451(__unit: None=None) -> Any:
        object_arg_9: IRequiredGetter = get.Required
        return object_arg_9.Field("last_updated", Decode_datetime)

    return Template.create(_arrow2440(), _arrow2441(), _arrow2442(), _arrow2443(), _arrow2444(), _arrow2446(), _arrow2447(), _arrow2449(), _arrow2450(), _arrow2451())


Template_decoder: Decoder_1[Template] = object(_arrow2452)

def Template_encoderCompressed(string_table: Any, oa_table: Any, cell_table: Any, template: Template) -> IEncodable:
    def _arrow2454(__unit: None=None, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, template: Any=template) -> IEncodable:
        value_1: str
        copy_of_struct: str = template.Id
        value_1 = str(copy_of_struct)
    ...
    def _arrow2461(__unit: None=None, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, template: Any=template) -> IEncodable:
        value_4: str = template.Description
    ...
    def _arrow2465(__unit: None=None, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, template: Any=template) -> IEncodable:
        value_5: str = template.Version
    ...
    def _arrow2472(__unit: None=None, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, template: Any=template) -> IEncodable:
        value_1_1: str = to_string_1(template.LastUpdated, "O", {})
        class ObjectExpr2471(IEncodable):
            def Encode(self, helpers_4: IEncoderHelpers_1[Any]) -> Any:
                return helpers_4.encode_string(value_1_1)

        return ObjectExpr2471()

    values_3: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("id", _arrow2454()), ("table", encoder_compressed(string_table, oa_table, cell_table, template.Table)), ("name", _arrow2458()), ("description", _arrow2461()), ("organisation", Template_Organisation_encoder(template.Organisation)), ("version", _arrow2465()), ("authors", seq(map(mapping, template.Authors))), ("endpoint_repositories", seq(map(mapping_1, template.EndpointRepositories))), ("tags", seq(map(mapping_2, template.Tags))), ("last_updated", _arrow2472())])
...
def Template_decoderCompressed(string_table: Array[str], oa_table: Array[OntologyAnnotation], cell_table: Array[CompositeCell]) -> Decoder_1[Template]:
    def _arrow2490(get: IGetters, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table) -> Template:
        def _arrow2479(__unit: None=None) -> str:
            object_arg: IRequiredGetter = get.Required
            return object_arg.Field("id", guid)

        def _arrow2481(__unit: None=None) -> ArcTable:
        ...
        def _arrow2483(__unit: None=None) -> str:
            object_arg_3: IRequiredGetter = get.Required
            return object_arg_3.Field("description", string)

        def _arrow2484(__unit: None=None) -> Organisation:
            object_arg_4: IRequiredGetter = get.Required
            return object_arg_4.Field("organisation", Template_Organisation_decoder)

        def _arrow2485(__unit: None=None) -> str:
            object_arg_5: IRequiredGetter = get.Required
            return object_arg_5.Field("version", string)

        def _arrow2486(__unit: None=None) -> Array[Person] | None:
            arg_13: Decoder_1[Array[Person]] = resize_array(decoder_2)
            object_arg_6: IOptionalGetter = get.Optional
            return object_arg_6.Field("authors", arg_13)
        ...
        def _arrow2488(__unit: None=None) -> Array[OntologyAnnotation] | None:
            arg_17: Decoder_1[Array[OntologyAnnotation]] = resize_array(OntologyAnnotation_decoder)
            object_arg_8: IOptionalGetter = get.Optional
            return object_arg_8.Field("tags", arg_17)

        def _arrow2489(__unit: None=None) -> Any:
            object_arg_9: IRequiredGetter = get.Required
            return object_arg_9.Field("last_updated", datetime_local)

        return Template.create(_arrow2479(), _arrow2481(), _arrow2482(), _arrow2483(), _arrow2484(), _arrow2485(), _arrow2486(), _arrow2487(), _arrow2488(), _arrow2489())

    return object(_arrow2490)
