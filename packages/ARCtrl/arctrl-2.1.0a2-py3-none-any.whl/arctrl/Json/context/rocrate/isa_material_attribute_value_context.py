...
IContext_reflection = _expr1384

def _arrow1395(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1385()), ("MaterialAttributeValue", ObjectExpr1386()), ("additionalType", ObjectExpr1387()), ("category", ObjectExpr1388()), ("categoryCode", ObjectExpr1389()), ("value", ObjectExpr1390()), ("valueCode", ObjectExpr1391()), ("unit", ObjectExpr1392()), ("unitCode", ObjectExpr1393())])
    class ObjectExpr1394(IEncodable):
    ...
    return ObjectExpr1394()


context_jsonvalue: IEncodable = _arrow1395()
