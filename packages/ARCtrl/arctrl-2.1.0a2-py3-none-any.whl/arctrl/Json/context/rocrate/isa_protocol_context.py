...
IContext_reflection = _expr1477

def _arrow1491(__unit: None=None) -> IEncodable:
    ...
    class ObjectExpr1480(IEncodable):
    ...
    class ObjectExpr1483(IEncodable):
        def Encode(self, helpers_5: IEncoderHelpers_1[Any]) -> Any:
            return helpers_5.encode_string("sdo:description")

    class ObjectExpr1484(IEncodable):
    ...
    class ObjectExpr1486(IEncodable):
        def Encode(self, helpers_8: IEncoderHelpers_1[Any]) -> Any:
            return helpers_8.encode_string("bio:reagent")

    class ObjectExpr1487(IEncodable):
    ...
    class ObjectExpr1489(IEncodable):
        def Encode(self, helpers_11: IEncoderHelpers_1[Any]) -> Any:
            return helpers_11.encode_string("sdo:comment")

    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1478()), ("bio", ObjectExpr1479()), ("Protocol", ObjectExpr1480()), ("name", ObjectExpr1481()), ("protocolType", ObjectExpr1482()), ("description", ObjectExpr1483()), ("version", ObjectExpr1484()), ("components", ObjectExpr1485()), ("reagents", ObjectExpr1486()), ("computationalTools", ObjectExpr1487()), ("uri", ObjectExpr1488()), ("comments", ObjectExpr1489())])
...
context_jsonvalue: IEncodable = _arrow1491()
