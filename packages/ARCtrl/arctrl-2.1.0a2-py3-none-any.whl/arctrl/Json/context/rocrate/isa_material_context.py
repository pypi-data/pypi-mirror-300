...
IContext_reflection = _expr1396

def _arrow1404(__unit: None=None) -> IEncodable:
    class ObjectExpr1397(IEncodable):
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1397()), ("bio", ObjectExpr1398()), ("Material", ObjectExpr1399()), ("type", ObjectExpr1400()), ("name", ObjectExpr1401()), ("characteristics", ObjectExpr1402())])
    ...
    return ObjectExpr1403()


context_jsonvalue: IEncodable = _arrow1404()
