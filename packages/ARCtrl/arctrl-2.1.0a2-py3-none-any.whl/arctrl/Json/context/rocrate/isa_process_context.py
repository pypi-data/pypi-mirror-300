...
IContext_reflection = _expr1451

def _arrow1464(__unit: None=None) -> IEncodable:
    class ObjectExpr1452(IEncodable):
        def Encode(self, helpers: IEncoderHelpers_1[Any]) -> Any:
            return helpers.encode_string("http://schema.org/")

    class ObjectExpr1453(IEncodable):
    ...
    class ObjectExpr1455(IEncodable):
    ...
    class ObjectExpr1457(IEncodable):
        def Encode(self, helpers_5: IEncoderHelpers_1[Any]) -> Any:
            return helpers_5.encode_string("bio:parameterValue")

    class ObjectExpr1458(IEncodable):
    ...
    class ObjectExpr1461(IEncodable):
        def Encode(self, helpers_9: IEncoderHelpers_1[Any]) -> Any:
            return helpers_9.encode_string("sdo:result")

    class ObjectExpr1462(IEncodable):
        def Encode(self, helpers_10: IEncoderHelpers_1[Any]) -> Any:
            return helpers_10.encode_string("sdo:disambiguatingDescription")

    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1452()), ("bio", ObjectExpr1453()), ("Process", ObjectExpr1454()), ("name", ObjectExpr1455()), ("executesProtocol", ObjectExpr1456()), ("parameterValues", ObjectExpr1457()), ("performer", ObjectExpr1458()), ("date", ObjectExpr1459()), ("inputs", ObjectExpr1460()), ("outputs", ObjectExpr1461()), ("comments", ObjectExpr1462())])
    class ObjectExpr1463(IEncodable):
...
context_jsonvalue: IEncodable = _arrow1464()
