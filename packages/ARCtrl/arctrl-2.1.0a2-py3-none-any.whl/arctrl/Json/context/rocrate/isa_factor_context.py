...
IContext_reflection = _expr1336

def _arrow1345(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1337()), ("Factor", ObjectExpr1338()), ("factorName", ObjectExpr1339()), ("annotationValue", ObjectExpr1340()), ("termSource", ObjectExpr1341()), ("termAccession", ObjectExpr1342()), ("comments", ObjectExpr1343())])
    class ObjectExpr1344(IEncodable):
    ...
    return ObjectExpr1344()


context_jsonvalue: IEncodable = _arrow1345()
