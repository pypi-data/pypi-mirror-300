...
IContext_reflection = _expr1527

def _arrow1544(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1528()), ("Study", ObjectExpr1529()), ("identifier", ObjectExpr1530()), ("title", ObjectExpr1531()), ("additionalType", ObjectExpr1532()), ("description", ObjectExpr1533()), ("submissionDate", ObjectExpr1534()), ("publicReleaseDate", ObjectExpr1535()), ("publications", ObjectExpr1536()), ("people", ObjectExpr1537()), ("assays", ObjectExpr1538()), ("filename", ObjectExpr1539()), ("comments", ObjectExpr1540()), ("processSequence", ObjectExpr1541()), ("studyDesignDescriptors", ObjectExpr1542())])
    ...
    return ObjectExpr1543()


context_jsonvalue: IEncodable = _arrow1544()
