...
def encoder(pv: IPropertyValue) -> IEncodable:
    ...
    if match_value_1 is None:
        ...
        if v.tag == 1:
            ...
            pattern_input_1 = (ObjectExpr1682(), None)
            ...
            pattern_input_1 = (ObjectExpr1683(), None)

        elif v.tag == 0:
            oa_1: OntologyAnnotation = v.fields[0]
            def _arrow1685(value_3: str, pv: Any=pv) -> IEncodable:
                class ObjectExpr1684(IEncodable):
                    def Encode(self, helpers_3: IEncoderHelpers_1[Any]) -> Any:
                        return helpers_3.encode_string(value_3)

                return ObjectExpr1684()

            def _arrow1687(value_5: str, pv: Any=pv) -> IEncodable:
            ...
            pattern_input_1 = (map(_arrow1685, oa_1.Name), map(_arrow1687, oa_1.TermAccessionNumber))
            ...
            pattern_input_1 = (ObjectExpr1688(), None)
    ...
    def _arrow1692(__unit: None=None, pv: Any=pv) -> IEncodable:
    ...
    def _arrow1695(__unit: None=None, pv: Any=pv) -> IEncodable:
    ...
    def _arrow1697(value_11: str, pv: Any=pv) -> IEncodable:
    ...
    def _arrow1699(value_13: str, pv: Any=pv) -> IEncodable:
    ...
    def _arrow1701(value_15: str, pv: Any=pv) -> IEncodable:
    ...
    def _arrow1703(value_17: str, pv: Any=pv) -> IEncodable:
    ...
    def _arrow1705(value_19: str, pv: Any=pv) -> IEncodable:
    ...
    def _arrow1706(x: IEncodable, pv: Any=pv) -> IEncodable:
        return x

    def _arrow1707(x_1: IEncodable, pv: Any=pv) -> IEncodable:
        return x_1

    def _arrow1709(value_21: str, pv: Any=pv) -> IEncodable:
    ...
    def _arrow1711(value_23: str, pv: Any=pv) -> IEncodable:
    ...
    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@id", _arrow1692()), ("@type", ObjectExpr1693()), ("additionalType", _arrow1695()), try_include("alternateName", _arrow1697, pv.AlternateName()), try_include("measurementMethod", _arrow1699, pv.MeasurementMethod()), try_include("description", _arrow1701, pv.Description()), try_include("category", _arrow1703, pattern_input[0]), try_include("categoryCode", _arrow1705, pattern_input[1]), try_include("value", _arrow1706, pattern_input_1[0]), try_include("valueCode", _arrow1707, pattern_input_1[1]), try_include("unit", _arrow1709, pattern_input_2[0]), try_include("unitCode", _arrow1711, pattern_input_2[1]), ("@context", context_jsonvalue)]))
...
def decoder(create: Callable[[str | None, str | None, str | None, OntologyAnnotation | None, Value_4 | None, OntologyAnnotation | None], _T]) -> Decoder_1[Any]:
    def _arrow1718(get: IGetters, create: Any=create) -> _T:
        ...
        def _arrow1717(__unit: None=None) -> Value_4 | None:
            value: str | None
        ...
        return create(alternate_name, measurement_method, description, category, _arrow1717(), unit)

    return object(_arrow1718)
