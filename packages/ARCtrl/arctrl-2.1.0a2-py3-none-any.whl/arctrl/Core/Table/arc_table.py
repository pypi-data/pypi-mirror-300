...
from ...fable_modules.fable_library.array_ import (map as map_1, initialize, iterate_indexed, iterate as iterate_1, sort_descending, map_indexed, indexed, sort_by)
...
class ArcTable:
    ...
    def init(name: str) -> ArcTable:
        ...
        return ArcTable(name, [], Dictionary([], ObjectExpr667()))
    ...
    def create_from_headers(name: str, headers: Array[CompositeHeader]) -> ArcTable:
        ...
        return ArcTable.create(name, headers, Dictionary([], ObjectExpr668()))
    ...
    def validate(raise_exception: bool | None=None) -> Callable[[ArcTable], bool]:
        def _arrow670(table: ArcTable) -> bool:
    ...
    def Columns(self, __unit: None=None) -> Array[CompositeColumn]:
        this: ArcTable = self
        def _arrow673(__unit: None=None) -> IEnumerable_1[CompositeColumn]:
            def _arrow672(i: int) -> CompositeColumn:
                return this.GetColumn(i)

            return map(_arrow672, range_big_int(0, 1, this.ColumnCount - 1))

        return to_array(delay(_arrow673))
    ...
    def Copy(self, __unit: None=None) -> ArcTable:
        ...
        return ArcTable.create(this.Name, list(this.Headers), Dictionary(this.Values, ObjectExpr674()))
    ...
    def try_get_cell_at(column: int, row: int) -> Callable[[ArcTable], CompositeCell | None]:
        def _arrow675(table: ArcTable) -> CompositeCell | None:
    ...
    def get_cell_at(column: int, row: int) -> Callable[[ArcTable], CompositeCell]:
        def _arrow676(table: ArcTable) -> CompositeCell:
    ...
    def iter_columns(action: Callable[[CompositeColumn], None]) -> Callable[[ArcTable], ArcTable]:
        def _arrow678(table: ArcTable) -> ArcTable:
    ...
    def iteri_columns(action: Callable[[int, CompositeColumn], None]) -> Callable[[ArcTable], ArcTable]:
        def _arrow679(table: ArcTable) -> ArcTable:
            copy: ArcTable = table.Copy()
    ...
    def update_cell_at(column_index: int, row_index: int, cell: CompositeCell, skip_validation: bool | None=None) -> Callable[[ArcTable], ArcTable]:
        def _arrow684(table: ArcTable) -> ArcTable:
    ...
    def set_cell_at(column_index: int, row_index: int, cell: CompositeCell, skip_validation: bool | None=None) -> Callable[[ArcTable], ArcTable]:
        def _arrow685(table: ArcTable) -> ArcTable:
            new_table: ArcTable = table.Copy()
    ...
    def update_cells_by(f: Callable[[int, int, CompositeCell], CompositeCell], skip_validation: bool | None=None) -> Callable[[ArcTable], None]:
        def _arrow688(table: ArcTable) -> None:
            new_table: ArcTable = table.Copy()
    ...
    def update_header(index: int, header: CompositeHeader) -> Callable[[ArcTable], ArcTable]:
        def _arrow690(table: ArcTable) -> ArcTable:
            new_table: ArcTable = table.Copy()
    ...
    def add_column(header: CompositeHeader, cells: Array[CompositeCell] | None=None, index: int | None=None, force_replace: bool | None=None) -> Callable[[ArcTable], ArcTable]:
        def _arrow691(table: ArcTable) -> ArcTable:
            new_table: ArcTable = table.Copy()
    ...
    def AddColumnFill(self, header: CompositeHeader, cell: CompositeCell, index: int | None=None, force_replace: bool | None=None) -> None:
        this: ArcTable = self
        def _arrow692(_arg: int) -> CompositeCell:
            return cell.Copy()

        cells: Array[CompositeCell] = initialize(this.RowCount, _arrow692, None)
    ...
    def add_column_fill(header: CompositeHeader, cell: CompositeCell, index: int | None=None, force_replace: bool | None=None) -> Callable[[ArcTable], ArcTable]:
        def _arrow693(table: ArcTable) -> ArcTable:
            new_table: ArcTable = table.Copy()
    ...
    def update_column(column_index: int, header: CompositeHeader, cells: Array[CompositeCell] | None=None) -> Callable[[ArcTable], ArcTable]:
        def _arrow694(table: ArcTable) -> ArcTable:
            new_table: ArcTable = table.Copy()
    ...
    def insert_column(index: int, header: CompositeHeader, cells: Array[CompositeCell] | None=None) -> Callable[[ArcTable], ArcTable]:
        def _arrow695(table: ArcTable) -> ArcTable:
            new_table: ArcTable = table.Copy()
    ...
    def append_column(header: CompositeHeader, cells: Array[CompositeCell] | None=None) -> Callable[[ArcTable], ArcTable]:
        def _arrow696(table: ArcTable) -> ArcTable:
            new_table: ArcTable = table.Copy()
    ...
    def add_columns(columns: Array[CompositeColumn], index: int | None=None, skip_fill_missing: bool | None=None) -> Callable[[ArcTable], ArcTable]:
        def _arrow697(table: ArcTable) -> ArcTable:
            new_table: ArcTable = table.Copy()
    ...
    def remove_column(index: int) -> Callable[[ArcTable], ArcTable]:
        def _arrow698(table: ArcTable) -> ArcTable:
            new_table: ArcTable = table.Copy()
    ...
    def RemoveColumns(self, index_arr: Array[int]) -> None:
        this: ArcTable = self
        def _arrow699(index: int) -> None:
            SanityChecks_validateColumnIndex(index, this.ColumnCount, False)

        iterate_1(_arrow699, index_arr)
        def _arrow700(index_1: int) -> None:
        ...
        iterate_1(_arrow700, sort_descending(index_arr, ObjectExpr701()))

    @staticmethod
    def remove_columns(index_arr: Array[int]) -> Callable[[ArcTable], ArcTable]:
        def _arrow702(table: ArcTable) -> ArcTable:
            new_table: ArcTable = table.Copy()
    ...
    def GetColumn(self, column_index: int) -> CompositeColumn:
        ...
        def _arrow704(__unit: None=None) -> IEnumerable_1[CompositeCell]:
            def _arrow703(i: int) -> IEnumerable_1[CompositeCell]:
            ...
            return collect(_arrow703, range_big_int(0, 1, this.RowCount - 1))

        cells: Array[CompositeCell] = to_array(delay(_arrow704))
        return CompositeColumn.create(h, cells)

    @staticmethod
    def get_column(index: int) -> Callable[[ArcTable], CompositeColumn]:
        def _arrow705(table: ArcTable) -> CompositeColumn:
    ...
    def try_get_column_by_header(header: CompositeHeader) -> Callable[[ArcTable], CompositeColumn | None]:
        def _arrow706(table: ArcTable) -> CompositeColumn | None:
    ...
    def try_get_column_by_header_by(header_predicate: Callable[[CompositeHeader], bool]) -> Callable[[ArcTable], CompositeColumn | None]:
        def _arrow707(table: ArcTable) -> CompositeColumn | None:
    ...
    def get_column_by_header(header: CompositeHeader) -> Callable[[ArcTable], CompositeColumn]:
        def _arrow708(table: ArcTable) -> CompositeColumn:
    ...
    def try_get_input_column(__unit: None=None) -> Callable[[ArcTable], CompositeColumn | None]:
        def _arrow709(table: ArcTable) -> CompositeColumn | None:
    ...
    def get_input_column(__unit: None=None) -> Callable[[ArcTable], CompositeColumn]:
        def _arrow710(table: ArcTable) -> CompositeColumn:
    ...
    def try_get_output_column(__unit: None=None) -> Callable[[ArcTable], CompositeColumn | None]:
        def _arrow711(table: ArcTable) -> CompositeColumn | None:
    ...
    def get_output_column(__unit: None=None) -> Callable[[ArcTable], CompositeColumn]:
        def _arrow712(table: ArcTable) -> CompositeColumn:
    ...
    def AddRow(self, cells: Array[CompositeCell] | None=None, index: int | None=None) -> None:
        ...
        def _arrow715(__unit: None=None) -> IEnumerable_1[CompositeCell]:
            def _arrow714(column_index: int) -> IEnumerable_1[CompositeCell]:
            ...
            return collect(_arrow714, range_big_int(0, 1, this.ColumnCount - 1))

        cells_1: Array[CompositeCell] = to_array(delay(_arrow715)) if (cells is None) else value_3(cells)
    ...
    def append_row(cells: Array[CompositeCell] | None=None) -> Callable[[ArcTable], ArcTable]:
        def _arrow718(table: ArcTable) -> ArcTable:
            new_table: ArcTable = table.Copy()
    ...
    def AddRowsEmpty(self, row_count: int, index: int | None=None) -> None:
        this: ArcTable = self
        def _arrow722(__unit: None=None) -> IEnumerable_1[CompositeCell]:
            def _arrow721(column_index: int) -> IEnumerable_1[CompositeCell]:
                return singleton(Unchecked_getEmptyCellForHeader(this.Headers[column_index], Unchecked_tryGetCellAt(column_index, 0, this.Values)))

            return collect(_arrow721, range_big_int(0, 1, this.ColumnCount - 1))

        row: Array[CompositeCell] = to_array(delay(_arrow722))
        def _arrow723(_arg: int) -> Array[CompositeCell]:
            return row

        rows: Array[Array[CompositeCell]] = initialize(row_count, _arrow723, None)
    ...
    def remove_row(index: int) -> Callable[[ArcTable], ArcTable]:
        def _arrow725(table: ArcTable) -> ArcTable:
            new_table: ArcTable = table.Copy()
    ...
    def RemoveRows(self, index_arr: Array[int]) -> None:
        this: ArcTable = self
        def _arrow726(index: int) -> None:
            SanityChecks_validateRowIndex(index, this.RowCount, False)

        iterate_1(_arrow726, index_arr)
        def _arrow727(index_1: int) -> None:
        ...
        iterate_1(_arrow727, sort_descending(index_arr, ObjectExpr728()))

    @staticmethod
    def remove_rows(index_arr: Array[int]) -> Callable[[ArcTable], ArcTable]:
        def _arrow729(table: ArcTable) -> ArcTable:
            new_table: ArcTable = table.Copy()
            new_table.RemoveColumns(index_arr)
            return new_table
    ...
    def GetRow(self, row_index: int, SkipValidation: bool | None=None) -> Array[CompositeCell]:
        ...
        def _arrow731(__unit: None=None) -> IEnumerable_1[CompositeCell]:
            def _arrow730(column_index: int) -> CompositeCell:
                return value_3(this.TryGetCellAt(column_index, row_index))

            return map(_arrow730, range_big_int(0, 1, this.ColumnCount - 1))

        return to_array(delay(_arrow731))

    @staticmethod
    def get_row(index: int) -> Callable[[ArcTable], Array[CompositeCell]]:
        def _arrow732(table: ArcTable) -> Array[CompositeCell]:
    ...
    def join(table: ArcTable, index: int | None=None, join_options: str | None=None, force_replace: bool | None=None) -> Callable[[ArcTable], ArcTable]:
        def _arrow733(this: ArcTable) -> ArcTable:
    ...
    def SplitByColumnValues(column_index: int) -> Callable[[ArcTable], Array[ArcTable]]:
        def _arrow735(table: ArcTable) -> Array[ArcTable]:
            ...
            return map_indexed(mapping_3, map_1(mapping_1, Array_groupBy(projection, indexed(table.GetColumn(column_index).Cells), ObjectExpr734()), None), None)

        return _arrow735

    @staticmethod
    def SplitByColumnValuesByHeader(header: CompositeHeader) -> Callable[[ArcTable], Array[ArcTable]]:
        def _arrow736(table: ArcTable) -> Array[ArcTable]:
            def predicate(x: CompositeHeader) -> bool:
                return equals(x, header)
    ...
    def SplitByProtocolREF() -> Callable[[ArcTable], Array[ArcTable]]:
        def _arrow737(table: ArcTable) -> Array[ArcTable]:
    ...
    def append(table1: ArcTable, table2: ArcTable) -> ArcTable:
        def get_list(t: ArcTable) -> FSharpList[FSharpList[tuple[CompositeHeader, CompositeCell]]]:
            def _arrow741(__unit: None=None, t: Any=t) -> IEnumerable_1[FSharpList[tuple[CompositeHeader, CompositeCell]]]:
                def _arrow740(row: int) -> FSharpList[tuple[CompositeHeader, CompositeCell]]:
                    def _arrow739(__unit: None=None) -> IEnumerable_1[tuple[CompositeHeader, CompositeCell]]:
                        def _arrow738(col: int) -> tuple[CompositeHeader, CompositeCell]:
                            return (t.Headers[col], get_item_from_dict(t.Values, (col, row)))

                        return map(_arrow738, range_big_int(0, 1, t.ColumnCount - 1))

                    return to_list(delay(_arrow739))

                return map(_arrow740, range_big_int(0, 1, t.RowCount - 1))

            return to_list(delay(_arrow741))
    ...
    def __str__(self, __unit: None=None) -> str:
        ...
        def _arrow750(__unit: None=None) -> IEnumerable_1[str]:
            def _arrow749(__unit: None=None) -> IEnumerable_1[str]:
                def _arrow748(__unit: None=None) -> IEnumerable_1[str]:
                    def _arrow747(__unit: None=None) -> IEnumerable_1[str]:
                        def _arrow742(row_i: int) -> str:
                            return join("\t|\t", map(to_string, this.GetRow(row_i)))

                        def _arrow745(__unit: None=None) -> IEnumerable_1[str]:
                            def _arrow744(__unit: None=None) -> IEnumerable_1[str]:
                                def _arrow743(row_i_1: int) -> str:
                                    return join("\t|\t", map(to_string, this.GetRow(row_i_1)))

                                return map(_arrow743, range_big_int(row_count - 20, 1, row_count - 1))

                            return append_1(singleton("..."), delay(_arrow744))

                        def _arrow746(row_i_2: int) -> str:
                            return join("\t|\t", map(to_string, this.GetRow(row_i_2)))

                        return append_1(map(_arrow742, range_big_int(0, 1, 19)), delay(_arrow745)) if (row_count > 50) else (singleton("No rows") if (row_count == 0) else map(_arrow746, range_big_int(0, 1, row_count - 1)))

                    return append_1(singleton(join("\t|\t", map(to_string, this.Headers))), delay(_arrow747))

                return append_1(singleton("-------------"), delay(_arrow748))

            return append_1(singleton(("Table: " + this.Name) + ""), delay(_arrow749))

        return join("\n", to_list(delay(_arrow750)))
    ...
    def StructurallyEquals(self, other: ArcTable) -> bool:
        ...
        def sort(arg: Any) -> Array[Any]:
            ...
            return sort_by(projection, list(arg), ObjectExpr751())
        ...
        def _arrow754(__unit: None=None) -> bool:
            ...
            def _arrow753(__unit: None=None) -> IEnumerable_1[bool]:
                def _arrow752(i: int) -> bool:
                    return equals(item(i, a), item(i, b))

                return map(_arrow752, range_big_int(0, 1, length(a) - 1))

            return fold(folder, True, to_list(delay(_arrow753))) if (length(a) == length(b)) else False

        if _arrow754() if (this.Name == other.Name) else False:
            ...
            def _arrow756(__unit: None=None) -> IEnumerable_1[bool]:
                def _arrow755(i_1: int) -> bool:
                    return equals(item(i_1, a_1), item(i_1, b_1))

                return map(_arrow755, range_big_int(0, 1, length(a_1) - 1))

            return fold(folder_1, True, to_list(delay(_arrow756))) if (length(a_1) == length(b_1)) else False
