...
from .fable_modules.fable_library.option import (default_arg, value as value_2, map as map_1, bind)
from .fable_modules.fable_library.reflection import (TypeInfo, class_type)
from .fable_modules.fable_library.result import FSharpResult_2
from .fable_modules.fable_library.seq import (to_array, contains, to_list, delay, append, singleton, collect, try_find, find, iterate as iterate_1, empty)
...
from .Contract.arc_assay import (ARCtrl_ArcAssay__ArcAssay_tryFromReadContract_Static_7570923F, ARCtrl_ArcAssay__ArcAssay_ToDeleteContract, ARCtrl_ArcAssay__ArcAssay_ToCreateContract_66CF920, ARCtrl_ArcAssay__ArcAssay_ToUpdateContract_6FCE9E49)
...
from .Contract.arc_study import (ARCtrl_ArcStudy__ArcStudy_tryFromReadContract_Static_7570923F, ARCtrl_ArcStudy__ArcStudy_ToUpdateContract_6FCE9E49, ARCtrl_ArcStudy__ArcStudy_ToCreateContract_66CF920)
from .Contract.contract import (Contract, DTOType, DTO)
from .Contract.datamap import (ARCtrl_DataMap__DataMap_tryFromReadContractForAssay_Static, ARCtrl_DataMap__DataMap_tryFromReadContractForStudy_Static)
...
class ARC:
    ...
    def RemoveAssay(self, assay_identifier: str) -> Array[Contract]:
        ...
        if match_value is None:
            ...
            def _arrow3120(__unit: None=None) -> bool:
                i: ArcInvestigation = match_value
                class ObjectExpr3119:
                    @property
                    def Equals(self) -> Callable[[str, str], bool]:
                        def _arrow3118(x: str, y: str) -> bool:
                            return x == y
                ...
                return contains(assay_identifier, i.AssayIdentifiers, ObjectExpr3119())
        ...
        def _arrow3123(__unit: None=None) -> IEnumerable_1[Contract]:
            def _arrow3122(__unit: None=None) -> IEnumerable_1[Contract]:
                def _arrow3121(__unit: None=None) -> IEnumerable_1[Contract]:
                    return collect(ARCtrl_ArcStudy__ArcStudy_ToUpdateContract_6FCE9E49, studies)

                return append(singleton(ARCtrl_ArcInvestigation__ArcInvestigation_ToUpdateContract(isa)), delay(_arrow3121))

            return append(singleton(ARCtrl_ArcAssay__ArcAssay_ToDeleteContract(assay)), delay(_arrow3122))

        return list(to_list(delay(_arrow3123)))
    ...
    def RenameAssay(self, old_assay_identifier: str, new_assay_identifier: str) -> Array[Contract]:
        ...
        if match_value is None:
            ...
            def _arrow3126(__unit: None=None) -> bool:
                i: ArcInvestigation = match_value
                class ObjectExpr3125:
                    @property
                    def Equals(self) -> Callable[[str, str], bool]:
                        def _arrow3124(x: str, y: str) -> bool:
                            return x == y
                ...
                return contains(old_assay_identifier, i.AssayIdentifiers, ObjectExpr3125())
        ...
        def _arrow3128(__unit: None=None) -> IEnumerable_1[Contract]:
            def _arrow3127(__unit: None=None) -> IEnumerable_1[Contract]:
                return this.GetUpdateContracts()

            return append(singleton(Contract.create_rename(old_assay_folder_path, new_assay_folder_path)), delay(_arrow3127))

        return list(to_list(delay(_arrow3128)))
    ...
    def RenameStudy(self, old_study_identifier: str, new_study_identifier: str) -> Array[Contract]:
        ...
        if match_value is None:
            ...
            def _arrow3131(__unit: None=None) -> bool:
                i: ArcInvestigation = match_value
                class ObjectExpr3130:
                    @property
                    def Equals(self) -> Callable[[str, str], bool]:
                        def _arrow3129(x: str, y: str) -> bool:
                            return x == y
                ...
                return contains(old_study_identifier, i.StudyIdentifiers, ObjectExpr3130())
        ...
        renamed_paths: Array[str] = map(mapping, paths, None)
        this.SetFilePaths(renamed_paths)
        def _arrow3133(__unit: None=None) -> IEnumerable_1[Contract]:
            def _arrow3132(__unit: None=None) -> IEnumerable_1[Contract]:
                return this.GetUpdateContracts()

            return append(singleton(Contract.create_rename(old_study_folder_path, new_study_folder_path)), delay(_arrow3132))

        return list(to_list(delay(_arrow3133)))
    ...
    def GetWriteContracts(self, datamap_as_file: bool | None=None) -> Array[Contract]:
        this: ARC = self
        ...
        if match_value is None:
            ...
            def action(s: ArcStudy) -> None:
                ...
                add_to_dict(workbooks, Study_fileNameFromIdentifier(s.Identifier), (DTOType(1), ARCtrl_ArcStudy__ArcStudy_toFsWorkbook_Static_Z4CEFA522(s, None, not datamap_as_file_1)))
                if datamap_as_file_1 if (s.DataMap is not None) else False:
            ...
            def action_1(a: ArcAssay) -> None:
                ...
                add_to_dict(workbooks, Assay_fileNameFromIdentifier(a.Identifier), (DTOType(0), ARCtrl_ArcAssay__ArcAssay_toFsWorkbook_Static_Z2508BE4F(a, not datamap_as_file_1)))
                if datamap_as_file_1 if (a.DataMap is not None) else False:
    ...
    def GetUpdateContracts(self, datamap_as_file: bool | None=None) -> Array[Contract]:
        this: ARC = self
        match_value: ArcInvestigation | None = this.ISA
        def _arrow3134(__unit: None=None) -> bool:
            inv: ArcInvestigation = match_value
            return inv.StaticHash == 0

        def _arrow3135(__unit: None=None) -> Array[Contract]:
            inv_1: ArcInvestigation = match_value
            return this.GetWriteContracts()

        def _arrow3143(__unit: None=None) -> Array[Contract]:
            inv_2: ArcInvestigation = match_value
            def _arrow3142(__unit: None=None) -> IEnumerable_1[Contract]:
                hash_1: int = inv_2.GetLightHashCode() or 0
                def _arrow3141(__unit: None=None) -> IEnumerable_1[Contract]:
                    inv_2.StaticHash = hash_1 or 0
                    def _arrow3137(s: ArcStudy) -> IEnumerable_1[Contract]:
                        hash_2: int = s.GetLightHashCode() or 0
                        def _arrow3136(__unit: None=None) -> IEnumerable_1[Contract]:
                            s.StaticHash = hash_2 or 0
                            return empty()

                        return append(ARCtrl_ArcStudy__ArcStudy_ToCreateContract_66CF920(s, True, datamap_as_file) if (s.StaticHash == 0) else ARCtrl_ArcStudy__ArcStudy_ToUpdateContract_6FCE9E49(s, datamap_as_file), delay(_arrow3136))

                    def _arrow3140(__unit: None=None) -> IEnumerable_1[Contract]:
                        def _arrow3139(a: ArcAssay) -> IEnumerable_1[Contract]:
                            hash_3: int = a.GetLightHashCode() or 0
                            def _arrow3138(__unit: None=None) -> IEnumerable_1[Contract]:
                                a.StaticHash = hash_3 or 0
                                return empty()

                            return append(ARCtrl_ArcAssay__ArcAssay_ToCreateContract_66CF920(a, True, datamap_as_file) if (a.StaticHash == 0) else ARCtrl_ArcAssay__ArcAssay_ToUpdateContract_6FCE9E49(a, datamap_as_file), delay(_arrow3138))

                        return collect(_arrow3139, inv_2.Assays)

                    return append(collect(_arrow3137, inv_2.Studies), delay(_arrow3140))

                return append(singleton(ARCtrl_ArcInvestigation__ArcInvestigation_ToUpdateContract(inv_2)) if (inv_2.StaticHash != hash_1) else empty(), delay(_arrow3141))

            return to_array(delay(_arrow3142))

        return (_arrow3135() if _arrow3134() else _arrow3143()) if (match_value is not None) else this.GetWriteContracts()
    ...
    def GetGitInitContracts(self, branch: str | None=None, repository_address: str | None=None, default_gitignore: bool | None=None) -> Array[Contract]:
        ...
        def _arrow3147(__unit: None=None) -> IEnumerable_1[Contract]:
            def _arrow3146(__unit: None=None) -> IEnumerable_1[Contract]:
                def _arrow3145(__unit: None=None) -> IEnumerable_1[Contract]:
                    def _arrow3144(__unit: None=None) -> IEnumerable_1[Contract]:
                    ...
                    return append(singleton(gitignore_contract) if default_gitignore_1 else empty(), delay(_arrow3144))

                return append(singleton(gitattributes_contract), delay(_arrow3145))

            return append(singleton(Init_createInitContract_6DFDD678(branch)), delay(_arrow3146))

        return to_array(delay(_arrow3147))
    ...
    def Copy(self, __unit: None=None) -> ARC:
        ...
        isa_copy: ArcInvestigation | None = map_1(mapping, this._isa)
    ...
    def GetRegisteredPayload(self, IgnoreHidden: bool | None=None) -> FileSystemTree:
        ...
        registered_studies: Array[ArcStudy] = default_arg(map_1(mapping_1, map_1(mapping, this._isa)), [])
        ...
        def mapping_3(s_1: ArcStudy) -> Any:
            ...
            def _arrow3155(__unit: None=None, s_1: Any=s_1) -> IEnumerable_1[str]:
                def _arrow3154(__unit: None=None) -> IEnumerable_1[str]:
                    def _arrow3153(__unit: None=None) -> IEnumerable_1[str]:
                        def _arrow3152(table: ArcTable) -> IEnumerable_1[str]:
                            def _arrow3151(kv: Any) -> IEnumerable_1[str]:
                                text_value: str = kv[1].ToFreeTextCell().AsFreeText
                                def _arrow3150(__unit: None=None) -> IEnumerable_1[str]:
                                    def _arrow3149(__unit: None=None) -> IEnumerable_1[str]:
                                        return singleton(((((("" + study_foldername) + "/") + "protocols") + "/") + text_value) + "")

                                    return append(singleton(((((("" + study_foldername) + "/") + "resources") + "/") + text_value) + ""), delay(_arrow3149))

                                return append(singleton(text_value), delay(_arrow3150))

                            return collect(_arrow3151, table.Values)

                        return collect(_arrow3152, s_1.Tables)

                    return append(singleton(((("" + study_foldername) + "/") + "README.md") + ""), delay(_arrow3153))

                return append(singleton(((("" + study_foldername) + "/") + "isa.study.xlsx") + ""), delay(_arrow3154))

            class ObjectExpr3156:
                @property
                def Compare(self) -> Callable[[str, str], int]:
                    return compare_primitives

            return of_seq(to_list(delay(_arrow3155)), ObjectExpr3156())

        class ObjectExpr3157:
            @property
            def Compare(self) -> Callable[[str, str], int]:
                return compare_primitives
        ...
        def mapping_4(a: ArcAssay) -> Any:
            ...
            def _arrow3164(__unit: None=None, a: Any=a) -> IEnumerable_1[str]:
                def _arrow3163(__unit: None=None) -> IEnumerable_1[str]:
                    def _arrow3162(__unit: None=None) -> IEnumerable_1[str]:
                        def _arrow3161(table_1: ArcTable) -> IEnumerable_1[str]:
                            def _arrow3160(kv_1: Any) -> IEnumerable_1[str]:
                                text_value_1: str = kv_1[1].ToFreeTextCell().AsFreeText
                                def _arrow3159(__unit: None=None) -> IEnumerable_1[str]:
                                    def _arrow3158(__unit: None=None) -> IEnumerable_1[str]:
                                        return singleton(((((("" + assay_foldername) + "/") + "protocols") + "/") + text_value_1) + "")

                                    return append(singleton(((((("" + assay_foldername) + "/") + "dataset") + "/") + text_value_1) + ""), delay(_arrow3158))

                                return append(singleton(text_value_1), delay(_arrow3159))

                            return collect(_arrow3160, table_1.Values)

                        return collect(_arrow3161, a.Tables)

                    return append(singleton(((("" + assay_foldername) + "/") + "README.md") + ""), delay(_arrow3162))

                return append(singleton(((("" + assay_foldername) + "/") + "isa.assay.xlsx") + ""), delay(_arrow3163))

            class ObjectExpr3165:
                @property
                def Compare(self) -> Callable[[str, str], int]:
                    return compare_primitives

            return of_seq(to_list(delay(_arrow3164)), ObjectExpr3165())

        class ObjectExpr3166:
            @property
            def Compare(self) -> Callable[[str, str], int]:
                return compare_primitives

        class ObjectExpr3167:
            @property
            def Compare(self) -> Callable[[str, str], int]:
                return compare_primitives

        include_files: Any = union_many(to_enumerable([of_seq(to_enumerable(["isa.investigation.xlsx", "README.md"]), ObjectExpr3148()), union_many(map(mapping_3, registered_studies, None), ObjectExpr3157()), union_many(map(mapping_4, registered_assays, None), ObjectExpr3166())]), ObjectExpr3167())
        ignore_hidden: bool = default_arg(IgnoreHidden, True)
        fs_copy: FileSystem = this._fs.Copy()
        def binder(tree_1: FileSystemTree) -> FileSystemTree | None:
            if ignore_hidden:
                def _arrow3168(n_1: str, tree_1: Any=tree_1) -> bool:
                    return not (n_1.find(".") == 0)

                return FileSystemTree.filter_folders(_arrow3168)(tree_1)

            else: 
                return tree_1


        def _arrow3170(__unit: None=None) -> FileSystemTree | None:
            tree: FileSystemTree
            def predicate(p: str) -> bool:
            ...
            def _arrow3169(n: str) -> bool:
                return not (n.find(".") == 0)

            return FileSystemTree.filter_files(_arrow3169)(tree) if ignore_hidden else tree

        return default_arg(bind(binder, _arrow3170()), FileSystemTree.from_file_paths([]))

    def GetAdditionalPayload(self, IgnoreHidden: bool | None=None) -> FileSystemTree:
        this: ARC = self
        ignore_hidden: bool = default_arg(IgnoreHidden, True)
        class ObjectExpr3171:
            @property
            def Compare(self) -> Callable[[str, str], int]:
                return compare_primitives

        registered_payload: Any = of_seq(FileSystemTree.to_file_paths()(this.GetRegisteredPayload()), ObjectExpr3171())
        def binder(tree_1: FileSystemTree) -> FileSystemTree | None:
            if ignore_hidden:
                def _arrow3172(n_1: str, tree_1: Any=tree_1) -> bool:
                    return not (n_1.find(".") == 0)

                return FileSystemTree.filter_folders(_arrow3172)(tree_1)

            else: 
                return tree_1


        def _arrow3174(__unit: None=None) -> FileSystemTree | None:
            tree: FileSystemTree
            def predicate(p: str) -> bool:
            ...
            tree = FileSystemTree.from_file_paths(paths)
            def _arrow3173(n: str) -> bool:
                return not (n.find(".") == 0)

            return FileSystemTree.filter_files(_arrow3173)(tree) if ignore_hidden else tree

        return default_arg(bind(binder, _arrow3174()), FileSystemTree.from_file_paths([]))

    @staticmethod
    def DefaultContracts() -> Any:
        class ObjectExpr3175:
            @property
            def Compare(self) -> Callable[[str, str], int]:
                return compare_primitives

        return of_seq_1(to_enumerable([(".gitignore", gitignore_contract), (".gitattributes", gitattributes_contract)]), ObjectExpr3175())

    @staticmethod
    def from_rocrate_json_string(s: str) -> ARC:
        def _arrow3176(__unit: None=None) -> ArcInvestigation | None:
    ...
    def GetValidationPackagesConfigWriteContract(self, vpc: ValidationPackagesConfig) -> Contract:
        this: ARC = self
        paths: Array[str] = this.FileSystem.Tree.ToFilePaths()
        class ObjectExpr3179:
            @property
            def Equals(self) -> Callable[[str, str], bool]:
                def _arrow3178(x: str, y: str) -> bool:
                    return x == y
        ...
        if not contains_1(ValidationPackagesConfigHelper_ConfigFilePath, paths, ObjectExpr3179()):
    ...
    def GetValidationPackagesConfigDeleteContract(self, vpc: ValidationPackagesConfig) -> Contract:
        this: ARC = self
        paths: Array[str] = this.FileSystem.Tree.ToFilePaths()
        class ObjectExpr3181:
            @property
            def Equals(self) -> Callable[[str, str], bool]:
                def _arrow3180(x: str, y: str) -> bool:
                    return x == y
        ...
        if contains_1(ValidationPackagesConfigHelper_ConfigFilePath, paths, ObjectExpr3181()):
            def predicate(p: str) -> bool:
