...
class ObjectExpr54(Decoder_1[str]):
...
string: Decoder_1[str] = ObjectExpr54()

class ObjectExpr56(Decoder_1[str]):
    def Decode(self, helpers: IDecoderHelpers_1[Any], value_1: Any) -> FSharpResult_2[str, tuple[str, ErrorReason_1[__A_]]]:
...
char: Decoder_1[str] = ObjectExpr56()

class ObjectExpr59(Decoder_1[str]):
    def Decode(self, helpers: IDecoderHelpers_1[Any], value_1: Any) -> FSharpResult_2[str, tuple[str, ErrorReason_1[__A_]]]:
        if helpers.is_string(value_1):
            match_value: tuple[bool, str]
            out_arg: str = "00000000-0000-0000-0000-000000000000"
            def _arrow57(__unit: None=None) -> str:
                return out_arg

            def _arrow58(v: str) -> None:
                nonlocal out_arg
                out_arg = v

            match_value = (try_parse_1(helpers.as_string(value_1), FSharpRef(_arrow57, _arrow58)), out_arg)
...
guid: Decoder_1[str] = ObjectExpr59()

class ObjectExpr60(Decoder_1[None]):
...
unit: Decoder_1[None] = ObjectExpr60()

class ObjectExpr63(Decoder_1[int8]):
    def Decode(self, helpers: IDecoderHelpers_1[Any], value_2: Any) -> FSharpResult_2[int8, tuple[str, ErrorReason_1[__A_]]]:
        if helpers.is_number(value_2):
            ...
            def _arrow61(__unit: None=None) -> int8:
                return out_arg

            def _arrow62(v: int8) -> None:
                nonlocal out_arg
                out_arg = v or 0

            match_value = (try_parse_2(helpers.as_string(value_2), 511, False, 8, FSharpRef(_arrow61, _arrow62)), out_arg)
...
sbyte: Decoder_1[int8] = ObjectExpr63()

class ObjectExpr66(Decoder_1[uint8]):
    def Decode(self, helpers: IDecoderHelpers_1[Any], value_2: Any) -> FSharpResult_2[uint8, tuple[str, ErrorReason_1[__A_]]]:
        if helpers.is_number(value_2):
            ...
            def _arrow64(__unit: None=None) -> uint8:
                return out_arg

            def _arrow65(v: uint8) -> None:
                nonlocal out_arg
                out_arg = v

            match_value = (try_parse_2(helpers.as_string(value_2), 511, True, 8, FSharpRef(_arrow64, _arrow65)), out_arg)
...
byte: Decoder_1[uint8] = ObjectExpr66()

class ObjectExpr69(Decoder_1[int16_1]):
    def Decode(self, helpers: IDecoderHelpers_1[Any], value_2: Any) -> FSharpResult_2[int16_1, tuple[str, ErrorReason_1[__A_]]]:
        if helpers.is_number(value_2):
            ...
            def _arrow67(__unit: None=None) -> int16_1:
                return out_arg

            def _arrow68(v: int16_1) -> None:
                nonlocal out_arg
                out_arg = v or 0

            match_value = (try_parse_2(helpers.as_string(value_2), 511, False, 16, FSharpRef(_arrow67, _arrow68)), out_arg)
...
int16: Decoder_1[int16_1] = ObjectExpr69()

class ObjectExpr72(Decoder_1[uint16_1]):
    def Decode(self, helpers: IDecoderHelpers_1[Any], value_2: Any) -> FSharpResult_2[uint16_1, tuple[str, ErrorReason_1[__A_]]]:
        if helpers.is_number(value_2):
            ...
            def _arrow70(__unit: None=None) -> uint16_1:
                return out_arg

            def _arrow71(v: uint16_1) -> None:
                nonlocal out_arg
                out_arg = v

            match_value = (try_parse_2(helpers.as_string(value_2), 511, True, 16, FSharpRef(_arrow70, _arrow71)), out_arg)
...
uint16: Decoder_1[uint16_1] = ObjectExpr72()

class ObjectExpr75(Decoder_1[int]):
    def Decode(self, helpers: IDecoderHelpers_1[Any], value_2: Any) -> FSharpResult_2[int, tuple[str, ErrorReason_1[__A_]]]:
        if helpers.is_number(value_2):
            ...
            def _arrow74(v: int) -> None:
                nonlocal out_arg
                out_arg = v or 0

            match_value = (try_parse_2(helpers.as_string(value_2), 511, False, 32, FSharpRef(_arrow73, _arrow74)), out_arg)
...
int_1: Decoder_1[int] = ObjectExpr75()

class ObjectExpr78(Decoder_1[uint32_1]):
    def Decode(self, helpers: IDecoderHelpers_1[Any], value_2: Any) -> FSharpResult_2[uint32_1, tuple[str, ErrorReason_1[__A_]]]:
        if helpers.is_number(value_2):
            ...
            def _arrow76(__unit: None=None) -> uint32_1:
                return out_arg

            def _arrow77(v: uint32_1) -> None:
                nonlocal out_arg
                out_arg = v

            match_value = (try_parse_2(helpers.as_string(value_2), 511, True, 32, FSharpRef(_arrow76, _arrow77)), out_arg)
...
uint32: Decoder_1[uint32_1] = ObjectExpr78()

class ObjectExpr81(Decoder_1[int64_1]):
    def Decode(self, helpers: IDecoderHelpers_1[Any], value_2: Any) -> FSharpResult_2[int64_1, tuple[str, ErrorReason_1[__A_]]]:
        if helpers.is_number(value_2):
            ...
            def _arrow79(__unit: None=None) -> int64_1:
                return out_arg

            def _arrow80(v: int64_1) -> None:
                nonlocal out_arg
                out_arg = v

            match_value = (try_parse_3(helpers.as_string(value_2), 511, False, 64, FSharpRef(_arrow79, _arrow80)), out_arg)
...
int64: Decoder_1[int64_1] = ObjectExpr81()

class ObjectExpr84(Decoder_1[uint64_1]):
    def Decode(self, helpers: IDecoderHelpers_1[Any], value_2: Any) -> FSharpResult_2[uint64_1, tuple[str, ErrorReason_1[__A_]]]:
        if helpers.is_number(value_2):
            ...
            def _arrow82(__unit: None=None) -> uint64_1:
                return out_arg

            def _arrow83(v: uint64_1) -> None:
                nonlocal out_arg
                out_arg = v

            match_value = (try_parse_3(helpers.as_string(value_2), 511, True, 64, FSharpRef(_arrow82, _arrow83)), out_arg)
...
uint64: Decoder_1[uint64_1] = ObjectExpr84()

class ObjectExpr87(Decoder_1[int]):
    def Decode(self, helpers: IDecoderHelpers_1[Any], value_1: Any) -> FSharpResult_2[int, tuple[str, ErrorReason_1[__A_]]]:
        if helpers.is_number(value_1):
            ...
            def _arrow85(__unit: None=None) -> int:
                return out_arg

            def _arrow86(v: int) -> None:
                nonlocal out_arg
                out_arg = v

            parse_result = (try_parse_4(helpers.as_string(value_1), FSharpRef(_arrow85, _arrow86)), out_arg)
...
bigint: Decoder_1[int] = ObjectExpr87()

class ObjectExpr88(Decoder_1[bool]):
...
bool_1: Decoder_1[bool] = ObjectExpr88()

class ObjectExpr89(Decoder_1[float]):
...
float_1: Decoder_1[float] = ObjectExpr89()

class ObjectExpr90(Decoder_1[float32_1]):
...
float32: Decoder_1[float32_1] = ObjectExpr90()

class ObjectExpr93(Decoder_1[Decimal]):
    def Decode(self, helpers: IDecoderHelpers_1[Any], value_1: Any) -> FSharpResult_2[Decimal, tuple[str, ErrorReason_1[__A_]]]:
        if helpers.is_number(value_1):
            ...
            def _arrow91(__unit: None=None) -> Decimal:
                return out_arg

            def _arrow92(v: Decimal) -> None:
                nonlocal out_arg
                out_arg = v

            match_value = (try_parse_5(helpers.as_string(value_1), FSharpRef(_arrow91, _arrow92)), out_arg)
...
decimal: Decoder_1[Decimal] = ObjectExpr93()

class ObjectExpr96(Decoder_1[Any]):
    def Decode(self, helpers: IDecoderHelpers_1[Any], value_1: Any) -> FSharpResult_2[Any, tuple[str, ErrorReason_1[__A_]]]:
        if helpers.is_string(value_1):
            ...
            def _arrow94(__unit: None=None) -> Any:
                return out_arg

            def _arrow95(v: Any) -> None:
                nonlocal out_arg
                out_arg = v

            match_value = (try_parse_6(helpers.as_string(value_1), FSharpRef(_arrow94, _arrow95)), out_arg)
...
datetime_local: Decoder_1[Any] = ObjectExpr96()

class ObjectExpr99(Decoder_1[Any]):
    def Decode(self, helpers: IDecoderHelpers_1[Any], value_1: Any) -> FSharpResult_2[Any, tuple[str, ErrorReason_1[__A_]]]:
        if helpers.is_string(value_1):
            match_value: tuple[bool, Any]
            out_arg: Any = create(0)
            def _arrow97(__unit: None=None) -> Any:
                return out_arg

            def _arrow98(v: Any) -> None:
                nonlocal out_arg
                out_arg = v

            match_value = (try_parse_7(helpers.as_string(value_1), FSharpRef(_arrow97, _arrow98)), out_arg)
...
timespan: Decoder_1[Any] = ObjectExpr99()
...
def decode_maybe_null(helpers: IDecoderHelpers_1[Any], path: str, decoder: Decoder_1[Any], value_1: Any) -> FSharpResult_2[Any | None, tuple[str, ErrorReason_1[_JSONVALUE]]]:
    if helpers.is_null_value(value_1):
        ...
        if match_value.tag == 1:
            def _arrow100(__unit: None=None, helpers: Any=helpers, path: Any=path, decoder: Any=decoder, value_1: Any=value_1) -> tuple[str, ErrorReason_1[_JSONVALUE]]:
            ...
            return FSharpResult_2(1, _arrow100())
...
def optional(field_name: str, decoder: Decoder_1[Any]) -> Decoder_1[Any | None]:
    class ObjectExpr101(Decoder_1[_VALUE_ | None]):
...
def optional_at(field_names: FSharpList[str], decoder: Decoder_1[Any]) -> Decoder_1[Any | None]:
    class ObjectExpr103(Decoder_1[_VALUE_ | None]):
...
def field(field_name: str, decoder: Decoder_1[Any]) -> Decoder_1[Any]:
    class ObjectExpr104(Decoder_1[_VALUE_]):
...
def at(field_names: FSharpList[str], decoder: Decoder_1[Any]) -> Decoder_1[Any]:
    class ObjectExpr105(Decoder_1[_VALUE_]):
...
def option(decoder: Decoder_1[Any]) -> Decoder_1[Any | None]:
    class ObjectExpr107(Decoder_1[_VALUE_ | None]):
...
def list_1(decoder: Decoder_1[Any]) -> Decoder_1[FSharpList[Any]]:
    class ObjectExpr109(Decoder_1[FSharpList[_VALUE_]]):
        def Decode(self, helpers: IDecoderHelpers_1[Any], value_1: Any, decoder: Any=decoder) -> FSharpResult_2[FSharpList[_VALUE_], tuple[str, ErrorReason_1[__A_]]]:
            if helpers.is_array(value_1):
                ...
                while (error is None) if (i < len(tokens)) else False:
                    ...
                    if match_value.tag == 1:
                        def _arrow108(__unit: None=None) -> tuple[str, ErrorReason_1[__A_]]:
                        ...
                        x: tuple[str, ErrorReason_1[__A_]] | None = _arrow108()
                        error = x
...
def resize_array(decoder: Decoder_1[Any]) -> Decoder_1[Array[Any]]:
    class ObjectExpr111(Decoder_1[Array[_VALUE_]]):
        def Decode(self, helpers: IDecoderHelpers_1[Any], value_1: Any, decoder: Any=decoder) -> FSharpResult_2[Array[_VALUE_], tuple[str, ErrorReason_1[__A_]]]:
            if helpers.is_array(value_1):
                ...
                while (error is None) if (i < len(tokens)) else False:
                    ...
                    match_value: FSharpResult_2[_VALUE_, tuple[str, ErrorReason_1[__A_]]] = decoder.Decode(helpers, value_2)
                    if match_value.tag == 1:
                        def _arrow110(__unit: None=None) -> tuple[str, ErrorReason_1[__A_]]:
                            tupled_arg: tuple[str, ErrorReason_1[__A_]] = match_value.fields[0]
                            return Helpers_prependPath((".[" + int32_to_string(i)) + "]", tupled_arg[0], tupled_arg[1])
    ...
    return ObjectExpr111()


def seq(decoder: Decoder_1[Any]) -> Decoder_1[IEnumerable_1[Any]]:
    class ObjectExpr113(Decoder_1[IEnumerable_1[_VALUE_]]):
                ...
                def folder(acc: FSharpResult_2[IEnumerable_1[_VALUE_], tuple[str, ErrorReason_1[__A_]]], value_2: __A_) -> FSharpResult_2[IEnumerable_1[_VALUE_], tuple[str, ErrorReason_1[__A_]]]:
                    ...
                    if acc.tag == 0:
                        ...
                        if match_value.tag == 0:
                            ...
                            def _arrow112(__unit: None=None, acc: Any=acc, value_2: Any=value_2) -> tuple[str, ErrorReason_1[__A_]]:
                                tupled_arg: tuple[str, ErrorReason_1[__A_]] = match_value.fields[0]
                                return Helpers_prependPath((".[" + int32_to_string(i)) + "]", tupled_arg[0], tupled_arg[1])
...
def array(decoder: Decoder_1[Any]) -> Decoder_1[Array[Any]]:
    class ObjectExpr115(Decoder_1[Array[_VALUE_]]):
        def Decode(self, helpers: IDecoderHelpers_1[Any], value_1: Any, decoder: Any=decoder) -> FSharpResult_2[Array[_VALUE_], tuple[str, ErrorReason_1[__A_]]]:
            if helpers.is_array(value_1):
                i: int = -1
                tokens: Array[__A_] = helpers.as_array(value_1)
                def folder(acc: FSharpResult_2[Array[_VALUE_], tuple[str, ErrorReason_1[__A_]]], value_2: __A_) -> FSharpResult_2[Array[_VALUE_], tuple[str, ErrorReason_1[__A_]]]:
                    ...
                    if acc.tag == 0:
                        ...
                        if match_value.tag == 0:
                            ...
                            def _arrow114(__unit: None=None, acc: Any=acc, value_2: Any=value_2) -> tuple[str, ErrorReason_1[__A_]]:
                                tupled_arg: tuple[str, ErrorReason_1[__A_]] = match_value.fields[0]
                                return Helpers_prependPath((".[" + int32_to_string(i)) + "]", tupled_arg[0], tupled_arg[1])

                            return FSharpResult_2(1, _arrow114())
...
class ObjectExpr116(Decoder_1[FSharpList[str]]):
...
keys: Decoder_1[FSharpList[str]] = ObjectExpr116()

def key_value_pairs(decoder: Decoder_1[Any]) -> Decoder_1[FSharpList[tuple[str, _VALUE]]]:
    class ObjectExpr117(Decoder_1[FSharpList[tuple[str, _VALUE_]]]):
...
def nil(output: Any | None=None) -> Decoder_1[Any]:
    class ObjectExpr119(Decoder_1[_A_]):
...
def succeed(output: Any | None=None) -> Decoder_1[Any]:
    class ObjectExpr120(Decoder_1[_A_]):
    ...
    return ObjectExpr120()


def fail(msg: str) -> Decoder_1[Any]:
    class ObjectExpr121(Decoder_1[_A_]):
...
def and_then(cb: Callable[[_A], Decoder_1[_B]], decoder: Decoder_1[Any]) -> Decoder_1[Any]:
    class ObjectExpr122(Decoder_1[_B_]):
...
def map3(ctor: Callable[[_A, _B, _C], _OUTPUT], d1: Decoder_1[Any], d2: Decoder_1[Any], d3: Decoder_1[Any]) -> Decoder_1[Any]:
    class ObjectExpr125(Decoder_1[_OUTPUT_]):
...
def map4(ctor: Callable[[_A, _B, _C, _D], _OUTPUT], d1: Decoder_1[Any], d2: Decoder_1[Any], d3: Decoder_1[Any], d4: Decoder_1[Any]) -> Decoder_1[Any]:
    class ObjectExpr126(Decoder_1[_OUTPUT_]):
...
def map5(ctor: Callable[[_A, _B, _C, _D, _E], _OUTPUT], d1: Decoder_1[Any], d2: Decoder_1[Any], d3: Decoder_1[Any], d4: Decoder_1[Any], d5: Decoder_1[Any]) -> Decoder_1[Any]:
    class ObjectExpr127(Decoder_1[_OUTPUT_]):
...
def map6(ctor: Callable[[_A, _B, _C, _D, _E, _F], _OUTPUT], d1: Decoder_1[Any], d2: Decoder_1[Any], d3: Decoder_1[Any], d4: Decoder_1[Any], d5: Decoder_1[Any], d6: Decoder_1[Any]) -> Decoder_1[Any]:
    class ObjectExpr128(Decoder_1[_OUTPUT_]):
...
def map7(ctor: Callable[[_A, _B, _C, _D, _E, _F, _G], _OUTPUT], d1: Decoder_1[Any], d2: Decoder_1[Any], d3: Decoder_1[Any], d4: Decoder_1[Any], d5: Decoder_1[Any], d6: Decoder_1[Any], d7: Decoder_1[Any]) -> Decoder_1[Any]:
    class ObjectExpr129(Decoder_1[_OUTPUT_]):
...
def map8(ctor: Callable[[_A, _B, _C, _D, _E, _F, _G, _H], _OUTPUT], d1: Decoder_1[Any], d2: Decoder_1[Any], d3: Decoder_1[Any], d4: Decoder_1[Any], d5: Decoder_1[Any], d6: Decoder_1[Any], d7: Decoder_1[Any], d8: Decoder_1[Any]) -> Decoder_1[Any]:
    class ObjectExpr130(Decoder_1[_OUTPUT_]):
...
def and_map(__unit: None=None) -> Callable[[Decoder_1[_A], Decoder_1[Callable[[_A], _B]]], Decoder_1[_B]]:
    def _arrow132(d: Decoder_1[_A]) -> Callable[[Decoder_1[Callable[[_A], _B]]], Decoder_1[_B]]:
        def _arrow131(d_1: Decoder_1[Callable[[_A], _B]]) -> Decoder_1[_B]:
...
def _expr137(gen0: TypeInfo, gen1: TypeInfo) -> TypeInfo:
...
class Getters_2(Generic[_JSONVALUE, _T]):
    def __init__(self, helpers: IDecoderHelpers_1[Any], value_1: Any) -> None:
        ...
        def _arrow134(__unit: None=None) -> IRequiredGetter:
            _this: Any = self
            class ObjectExpr133(IRequiredGetter):
        ...
        self.required: IRequiredGetter = _arrow134()
        def _arrow136(__unit: None=None) -> IOptionalGetter:
            _this_1: Any = self
            class ObjectExpr135(IOptionalGetter):
        ...
        self.optional: IOptionalGetter = _arrow136()
...
def object(builder: Callable[[IGetters], _VALUE]) -> Decoder_1[Any]:
    class ObjectExpr138(Decoder_1[_VALUE_]):
...
def dict_1(decoder: Decoder_1[Any]) -> Decoder_1[Any]:
    def _arrow140(elements: FSharpList[tuple[str, _VALUE]], decoder: Any=decoder) -> Any:
        class ObjectExpr139:
            @property
            def Compare(self) -> Callable[[str, str], int]:
                return compare_primitives

        return of_list(elements, ObjectExpr139())

    return map(_arrow140, key_value_pairs(decoder))


def map_0027(key_decoder: Decoder_1[Any], value_decoder: Decoder_1[Any]) -> Decoder_1[Any]:
    def _arrow142(elements: Array[tuple[_KEY, _VALUE]], key_decoder: Any=key_decoder, value_decoder: Any=value_decoder) -> Any:
        class ObjectExpr141:
            @property
            def Compare(self) -> Callable[[_KEY_, _KEY_], int]:
                return compare

        return of_seq_1(elements, ObjectExpr141())

    return map(_arrow142, array(tuple2(key_decoder, value_decoder)))
