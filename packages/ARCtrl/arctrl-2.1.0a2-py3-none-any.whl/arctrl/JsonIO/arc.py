...
def encoder(isa: ArcInvestigation) -> IEncodable:
    ...
    def _arrow3068(value: str, isa: Any=isa) -> IEncodable:
    ...
    def _arrow3070(value_2: str, isa: Any=isa) -> IEncodable:
    ...
    def _arrow3071(oa: ArcInvestigation, isa: Any=isa) -> IEncodable:
        return ROCrate_encoder(oa)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include("@type", _arrow3068, "CreativeWork"), try_include("@id", _arrow3070, "ro-crate-metadata.json"), try_include("about", _arrow3071, isa), ("conformsTo", conforms_to_jsonvalue), ("@context", context_jsonvalue)]))
...
def _arrow3073(get: IGetters) -> ArcInvestigation | None:
    object_arg: IOptionalGetter = get.Optional
    return object_arg.Field("about", ROCrate_decoder)


decoder: Decoder_1[ArcInvestigation | None] = object(_arrow3073)
