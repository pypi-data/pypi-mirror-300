import { c as create_ssr_component, v as validate_component, a as createEventDispatcher, e as escape, f as each, b as add_attribute, d as add_styles } from './ssr-Cz1f32Mr.js';
import { B as Block, S as Static, h as BlockTitle } from './2-DZ7yOGfp.js';
export { default as BaseExample } from './Example13-B7Euy4ah.js';
...
const Remove = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M19 6.41L17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12z"></path></svg>`;
});
const css$2 = {
...
const Multiselect = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<label class="${["svelte-1scun43", container ? "container" : ""].join(" ").trim()}">${validate_component(BlockTitle, "BlockTitle").$$render($$result, { show_label, info }, {}, {
    default: () => {
      return `${escape(label)}`;
    }
...
const Dropdown = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="${["svelte-1sk0pyu", container ? "container" : ""].join(" ").trim()}">${validate_component(BlockTitle, "BlockTitle").$$render($$result, { show_label, info }, {}, {
    default: () => {
      return `${escape(label)}`;
    }
  })} <div class="wrap svelte-1sk0pyu"><div class="${["wrap-inner svelte-1sk0pyu", show_options ? "show_options" : ""].join(" ").trim()}"><div class="secondary-wrap svelte-1sk0pyu"><input role="listbox" aria-controls="dropdown-options"${add_attribute("aria-expanded", show_options, 0)}${add_attribute("aria-label", label, 0)} class="${[
    "border-none svelte-1sk0pyu",
    !choices_names.includes(input_text) && !allow_custom_value ? "subdued" : ""
  ].join(" ").trim()}" ${disabled ? "disabled" : ""} autocomplete="off" ${!filterable ? "readonly" : ""}${add_attribute("value", input_text, 0)}${add_attribute("this", filter_input, 0)}> ${!disabled ? `<div class="icon-wrap svelte-1sk0pyu">${validate_component(DropdownArrow, "DropdownArrow").$$render($$result, {}, {}, {})}</div>` : ``}</div></div> ${validate_component(DropdownOptions, "DropdownOptions").$$render(
    $$result,
    {
      show_options,
      choices,
...
//# sourceMappingURL=Index54-BzIox9gu.js.map
