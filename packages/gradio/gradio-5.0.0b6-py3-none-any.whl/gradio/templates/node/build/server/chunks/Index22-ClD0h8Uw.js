  ...
  return `  ${validate_component(Block, "Block").$$render(
    ...
    {},
    {
      default: () => {
        ...
        })} <div class="wrap svelte-zhoq0k" data-testid="checkbox-group">${each(choices, ([display_value, internal_value], i) => {
          return `<label class="${[
            "svelte-zhoq0k",
            (disabled ? "disabled" : "") + " " + (value.includes(internal_value) ? "selected" : "")
          ].join(" ").trim()}"><input ${disabled ? "disabled" : ""} ${value.includes(internal_value) ? "checked" : ""} type="checkbox"${add_attribute("name", internal_value?.toString(), 0)}${add_attribute("title", internal_value?.toString(), 0)} class="svelte-zhoq0k"> <span class="ml-2 svelte-zhoq0k">${escape(display_value)}</span> </label>`;
        })}</div>`;
      }
    }
  )}`;
...
//# sourceMappingURL=Index22-ClD0h8Uw.js.map
