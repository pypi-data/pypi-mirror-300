...
import { B as Block, S as Static, h as BlockTitle, l as Clear, x as Send, y as Square } from './2-BZ3PdVP1.js';
...
export { default as BaseExample } from './Example18-xJ_iqXka.js';
...
const MultimodalTextbox = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    $$rendered = `<div class="${["full-container svelte-2pfrqb", dragging ? "dragging" : ""].join(" ").trim()}" role="group" aria-label="Multimedia input field"${add_attribute("this", full_container, 0)}> <label${add_classes((container ? "container" : "").trim())}>${validate_component(BlockTitle, "BlockTitle").$$render($$result, { show_label, info }, {}, {
      default: () => {
        return `${escape(label)}`;
      }
...
//# sourceMappingURL=Index46-jecchJ-X.js.map
