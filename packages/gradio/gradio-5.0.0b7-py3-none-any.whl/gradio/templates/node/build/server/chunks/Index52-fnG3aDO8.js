import { B as Block, S as Static, d as Button, t as tick } from './2-BZ3PdVP1.js';
import { c as create_ssr_component, v as validate_component, a as createEventDispatcher, e as escape, b as add_attribute, f as each, d as add_styles, h as merge_ssr_styles } from './ssr-Cz1f32Mr.js';
import { d as dequal } from './index8-sfNUnwRZ.js';
import { U as Upload } from './Upload3-BmQdD1Di.js';
import { M as MarkdownCode$1 } from './Example.svelte_svelte_type_style_lang4-2iPtMMme.js';
export { default as BaseExample } from './Example12-DslN28pl.js';
import './index4-D_FyJKAV.js';
import './prism-python-DFFFX4oS.js';
...
const Table = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    $$rendered = ` <div class="${["svelte-12bw0e2", label && label.length !== 0 ? "label" : ""].join(" ").trim()}">${label && label.length !== 0 && show_label ? `<p class="svelte-12bw0e2">${escape(label)}</p>` : ``} <div class="${[
      "table-wrap svelte-12bw0e2",
      (dragging ? "dragging" : "") + " " + (!wrap ? "no-wrap" : "")
    ].join(" ").trim()}" style="${"height:" + escape(table_height, true) + "px"}" role="grid" tabindex="0"${add_attribute("this", parent, 0)}><table class="${["svelte-12bw0e2", column_widths.length != 0 ? "fixed-layout" : ""].join(" ").trim()}"${add_attribute("this", table, 0)}>${label && label.length !== 0 ? `<caption class="sr-only">${escape(label)}</caption>` : ``} <thead class="svelte-12bw0e2"><tr class="svelte-12bw0e2">${each(_headers, ({ value, id }, i) => {
      return `<th${add_attribute("aria-sort", get_sort_status(), 0)} class="${["svelte-12bw0e2", header_edit === i ? "editing" : ""].join(" ").trim()}"${add_styles({
        "width": column_widths.length ? column_widths[i] : void 0
      })}><div class="cell-wrap svelte-12bw0e2">${validate_component(EditableCell, "EditableCell").$$render(
        $$result,
        {
          value,
          latex_delimiters,
        ...
        "sort-button " + escape(sort_direction, true) + " svelte-12bw0e2",
        (sort_by === i ? "sorted" : "") + " " + (sort_by === i && sort_direction === "des" ? "des" : "")
      ].join(" ").trim()}"><svg width="1em" height="1em" viewBox="0 0 9 7" fill="none" xmlns="http://www.w3.org/2000/svg" class="svelte-12bw0e2"><path d="M4.49999 0L8.3971 6.75H0.602875L4.49999 0Z"></path></svg> </div></div> </th>`;
    })}</tr></thead> <tbody><tr class="svelte-12bw0e2">${each(max, ({ value, id }, j) => {
      return `<td tabindex="-1" class="svelte-12bw0e2"${add_attribute("this", cells[j], 0)}><div class="cell-wrap svelte-12bw0e2">${validate_component(EditableCell, "EditableCell").$$render(
        $$result,
        {
          value,
          latex_delimiters,
      ...
      },
      {
        default: () => {
          return `${validate_component(VirtualTable, "VirtualTable").$$render(
            ...
            {
              tbody: ({ index, item }) => {
                return `<tr slot="tbody" class="${["svelte-12bw0e2", index % 2 === 0 ? "row_odd" : ""].join(" ").trim()}">${each(item, ({ value, id }, j) => {
                  return `<td tabindex="0"${add_styles(merge_ssr_styles(escape(styling?.[index]?.[j] || "", true), { "width": `var(--cell-width-${j})` }))} class="${["svelte-12bw0e2", dequal(selected, [index, j]) ? "focus" : ""].join(" ").trim()}"><div class="cell-wrap svelte-12bw0e2">${validate_component(EditableCell, "EditableCell").$$render(
                    $$result,
                    {
                      display_value: display_value?.[index]?.[j],
                      latex_delimiters,
              ...
              thead: () => {
                return `<tr slot="thead" class="svelte-12bw0e2">${each(_headers, ({ value, id }, i) => {
                  ...
                  ].join(" ").trim()}"><div class="cell-wrap svelte-12bw0e2">${validate_component(EditableCell, "EditableCell").$$render(
                    $$result,
                    {
                      latex_delimiters,
                      line_breaks,
    ...
    )}</div> ${editable ? `<div class="controls-wrap svelte-12bw0e2">${row_count[1] === "dynamic" ? `<span class="button-wrap svelte-12bw0e2">${validate_component(Button, "BaseButton").$$render($$result, { variant: "secondary", size: "sm" }, {}, {
      default: () => {
        return `<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img" width="1em" height="1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 32 32" class="svelte-12bw0e2"><path fill="currentColor" d="M24.59 16.59L17 24.17V4h-2v20.17l-7.59-7.58L6 18l10 10l10-10l-1.41-1.41z"></path></svg> ${escape(i18n("dataframe.new_row"))}`;
      }
    })}</span>` : ``} ${col_count[1] === "dynamic" ? `<span class="button-wrap svelte-12bw0e2">${validate_component(Button, "BaseButton").$$render($$result, { variant: "secondary", size: "sm" }, {}, {
      default: () => {
        return `<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img" width="1em" height="1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 32 32" class="svelte-12bw0e2"><path fill="currentColor" d="m18 6l-1.43 1.393L24.15 15H4v2h20.15l-7.58 7.573L18 26l10-10L18 6z"></path></svg> ${escape(i18n("dataframe.new_column"))}`;
      }
    })}</span>` : ``}</div>` : ``} </div>`;
  } while (!$$settled);
  return $$rendered;
...
//# sourceMappingURL=Index52-fnG3aDO8.js.map
