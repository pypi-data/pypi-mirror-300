import { c as create_ssr_component, v as validate_component, e as escape, a as createEventDispatcher, b as add_attribute } from './ssr-Cz1f32Mr.js';
import { B as Block, S as Static, e as Info } from './2-BZ3PdVP1.js';
...
const Index = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    $$rendered = `${validate_component(Block, "Block").$$render(
      ...
      {
        default: () => {
          return `${validate_component(Static, "StatusTracker").$$render($$result, Object.assign({}, { autoscroll: gradio.autoscroll }, { i18n: gradio.i18n }, loading_status), {}, {})} ${info ? `${validate_component(Info, "Info").$$render($$result, {}, {}, {
            default: () => {
              return `${escape(info)}`;
            }
          })}` : ``} ${validate_component(BaseCheckbox, "BaseCheckbox").$$render(
            $$result,
...
//# sourceMappingURL=Index38-B2PW3Tf1.js.map
