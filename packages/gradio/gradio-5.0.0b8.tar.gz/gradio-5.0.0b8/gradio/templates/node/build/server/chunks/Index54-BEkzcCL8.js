...
import { B as Block, S as Static, h as BlockTitle } from './2-B44WpJir.js';
...
const Dropdown = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="${["svelte-1sk0pyu", container ? "container" : ""].join(" ").trim()}">${validate_component(BlockTitle, "BlockTitle").$$render($$result, { root, show_label, info }, {}, {
    default: () => {
      return `${escape(label)}`;
    }
...
//# sourceMappingURL=Index54-BEkzcCL8.js.map
