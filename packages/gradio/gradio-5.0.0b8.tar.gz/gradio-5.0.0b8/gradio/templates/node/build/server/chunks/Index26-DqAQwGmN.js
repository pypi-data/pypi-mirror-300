...
import { r as css_units, c as IconButton, C as Copy, M as MarkdownCode, B as Block, S as Static } from './2-B44WpJir.js';
import { I as IconButtonWrapper } from './IconButtonWrapper-B4nOVFkQ.js';
export { default as BaseExample } from './Example5-IOUGqfHx.js';
...
const Index = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(Block, "Block").$$render(
    ...
    {
      default: () => {
        return `${validate_component(Static, "StatusTracker").$$render($$result, Object.assign({}, { autoscroll: gradio.autoscroll }, { i18n: gradio.i18n }, loading_status, { variant: "center" }), {}, {})} <div class="${["svelte-1ed2p3z", loading_status?.status === "pending" ? "pending" : ""].join(" ").trim()}">${validate_component(Markdown, "Markdown").$$render(
          $$result,
          {
            value,
            elem_classes,
...
export { Markdown as BaseMarkdown, MarkdownCode, Index as default };
//# sourceMappingURL=Index26-DqAQwGmN.js.map
