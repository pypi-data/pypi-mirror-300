import { B as Block, S as StatusTracker, e as BlockLabel, a3 as TextHighlight, g as Empty, a4 as globals, a5 as colors } from './2-B1kq23UX.js';
...
import { g as get_next_color } from './color-Dakw_xO3.js';
...
const Index = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    $$rendered = `${!interactive ? `${validate_component(Block, "Block").$$render(
      ...
      {
        default: () => {
          return `${validate_component(StatusTracker, "StatusTracker").$$render($$result, Object_1.assign({}, { autoscroll: gradio.autoscroll }, { i18n: gradio.i18n }, loading_status), {}, {})} ${label ? `${validate_component(BlockLabel, "BlockLabel").$$render(
            $$result,
            {
              Icon: TextHighlight,
              label,
      ...
      {
        default: () => {
          return `${validate_component(StatusTracker, "StatusTracker").$$render($$result, Object_1.assign({}, { autoscroll: gradio.autoscroll }, loading_status, { i18n: gradio.i18n }), {}, {})} ${label ? `${validate_component(BlockLabel, "BlockLabel").$$render(
            $$result,
            {
              Icon: TextHighlight,
              label,
...
//# sourceMappingURL=Index51-DOhnn3Dr.js.map
