...
import { e as BlockLabel, f as Image, g as Empty, h as IconButtonWrapper$1, i as IconButton$1, M as Maximize, D as Download, o as ShareButton, u as uploadToHuggingFace } from './2-B1kq23UX.js';
...
const ImagePreview = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  })}` : `<div class="image-container svelte-1kpcxni"${add_attribute("this", image_container, 0)}>${validate_component(IconButtonWrapper$1, "IconButtonWrapper").$$render($$result, {}, {}, {
    default: () => {
...
//# sourceMappingURL=ImagePreview-B1bQtJfJ.js.map
