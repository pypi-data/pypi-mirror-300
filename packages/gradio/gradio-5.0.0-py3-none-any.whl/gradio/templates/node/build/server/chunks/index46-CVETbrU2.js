...
import { e as BlockLabel, ao as Video$1, k as SelectSource, B as Block, S as StatusTracker, U as UploadText } from './2-B1kq23UX.js';
import { Webcam as Webcam$1 } from './Index22-BcN6Mtby.js';
import { P as Player$1, V as VideoPreview } from './VideoPreview-CqdBMXXx.js';
export { l as loaded, a as playable, p as prettyBytes } from './VideoPreview-CqdBMXXx.js';
export { default as BaseExample } from './Example22-cCxrHAsd.js';
...
import 'url';
import 'fs';
import './ImagePreview-B1bQtJfJ.js';
...
const Index = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    $$rendered = `  ${!interactive ? `${validate_component(Block, "Block").$$render(
      ...
      {
        default: () => {
          return `${validate_component(StatusTracker, "StatusTracker").$$render($$result, Object.assign({}, { autoscroll: gradio.autoscroll }, { i18n: gradio.i18n }, loading_status), {}, {})} ${validate_component(VideoPreview, "StaticVideo").$$render(
            $$result,
            {
              value: _video,
              subtitle: _subtitle,
      ...
      {
        default: () => {
          return `${validate_component(StatusTracker, "StatusTracker").$$render($$result, Object.assign({}, { autoscroll: gradio.autoscroll }, { i18n: gradio.i18n }, loading_status), {}, {})} ${validate_component(Video, "Video").$$render(
            $$result,
            {
              value: _video,
              subtitle: _subtitle,
...
//# sourceMappingURL=index46-CVETbrU2.js.map
