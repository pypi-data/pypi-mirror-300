...
import { B as Block, S as StatusTracker, e as BlockLabel, f as Image, g as Empty, h as IconButtonWrapper$1, i as IconButton$1, M as Maximize } from './2-B1kq23UX.js';
...
const Index = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(Block, "Block").$$render(
    ...
    {
      default: () => {
        return `${validate_component(StatusTracker, "StatusTracker").$$render($$result, Object.assign({}, { autoscroll: gradio.autoscroll }, { i18n: gradio.i18n }, loading_status), {}, {})} ${validate_component(BlockLabel, "BlockLabel").$$render(
          $$result,
          {
            show_label,
            Icon: Image,
        ...
        })}` : `<div class="image-container svelte-303fln"${add_attribute("this", image_container, 0)}>${validate_component(IconButtonWrapper$1, "IconButtonWrapper").$$render($$result, {}, {}, {
          default: () => {
            return `${show_fullscreen_button ? `${validate_component(IconButton$1, "IconButton").$$render(
              $$result,
              {
                Icon: Maximize,
                label: "View in full screen"
...
//# sourceMappingURL=Index14-BJ4tn7vs.js.map
