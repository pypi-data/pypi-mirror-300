...
import { B as Block, S as StatusTracker, e as BlockLabel, a1 as File$1, g as Empty, U as UploadText, h as IconButtonWrapper$1, i as IconButton$1, v as Undo, D as Download } from './2-B1kq23UX.js';
import { U as Upload, M as ModifyUpload } from './ModifyUpload-D1AmP-fT.js';
export { default as BaseExample } from './Example16-CcyZAx20.js';
...
async function loadCanvas3D$1() {
  const module = await import('./Canvas3D-Diuv2PYK.js');
  return module.default;
}
...
const Model3D = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    $$rendered = `${validate_component(BlockLabel, "BlockLabel").$$render(
      ...
      {},
      {}
    )} ${value ? `<div class="model3D svelte-1mxwah3">${validate_component(IconButtonWrapper$1, "IconButtonWrapper").$$render($$result, {}, {}, {
      default: () => {
        return `${!use_3dgs ? ` ${validate_component(IconButton$1, "IconButton").$$render(
          $$result,
          {
            Icon: Undo,
            label: "Undo",
...
const Index = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    $$rendered = `${!interactive ? `${validate_component(Block, "Block").$$render(
      ...
      {
        default: () => {
          return `${validate_component(StatusTracker, "StatusTracker").$$render($$result, Object.assign({}, { autoscroll: gradio.autoscroll }, { i18n: gradio.i18n }, loading_status), {}, {})} ${value && is_browser ? `${validate_component(Model3D$1, "Model3D").$$render(
            $$result,
            {
              value,
              i18n: gradio.i18n,
      ...
      {
        default: () => {
          return `${validate_component(StatusTracker, "StatusTracker").$$render($$result, Object.assign({}, { autoscroll: gradio.autoscroll }, { i18n: gradio.i18n }, loading_status), {}, {})} ${validate_component(Model3DUpload$1, "Model3DUpload").$$render(
            $$result,
            {
              label,
              show_label,
...
//# sourceMappingURL=Index49-Co_yNLHG.js.map
