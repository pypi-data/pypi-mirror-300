...
import { B as Block, S as StatusTracker, e as BlockLabel, an as LineChart, g as Empty } from './2-B1kq23UX.js';
...
const Index = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(Block, "Block").$$render(
    ...
    {
      default: () => {
        return `${validate_component(StatusTracker, "StatusTracker").$$render($$result, Object.assign({}, { autoscroll: gradio.autoscroll }, { i18n: gradio.i18n }, loading_status), {}, {})} ${show_label ? `${validate_component(BlockLabel, "BlockLabel").$$render(
          $$result,
          {
            Icon: LineChart,
            label,
...
//# sourceMappingURL=Index37-yUzqYMOv.js.map
