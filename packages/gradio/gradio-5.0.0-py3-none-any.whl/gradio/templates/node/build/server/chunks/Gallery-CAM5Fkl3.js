...
import { e as BlockLabel, f as Image, g as Empty, h as IconButtonWrapper$1, i as IconButton$1, D as Download, M as Maximize, a2 as Minimize, Z as Clear, o as ShareButton, u as uploadToHuggingFace, t as Play } from './2-B1kq23UX.js';
import { M as ModifyUpload } from './ModifyUpload-D1AmP-fT.js';
...
const Gallery = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  })}` : `<div class="gallery-container"${add_attribute("this", gallery_container, 0)}>${selected_media && allow_preview ? `<button class="${["preview svelte-17j4qub", mode === "minimal" ? "minimal" : ""].join(" ").trim()}">${validate_component(IconButtonWrapper$1, "IconButtonWrapper").$$render($$result, {}, {}, {
    default: () => {
      return `${show_download_button ? `${validate_component(IconButton$1, "IconButton").$$render(
        $$result,
        {
          Icon: Download,
          label: i18n("common.download")
        ...
        {},
        {}
      )}` : ``} ${show_fullscreen_button && !is_full_screen ? `${validate_component(IconButton$1, "IconButton").$$render(
        $$result,
        {
          Icon: Maximize,
        ...
        {},
        {}
      )}` : ``} ${`${validate_component(IconButton$1, "IconButton").$$render($$result, { Icon: Clear, label: "Close" }, {}, {})}` }`;
    }
  ...
  ].join(" ").trim()}"><div class="${["grid-container svelte-17j4qub", show_label ? "pt-6" : ""].join(" ").trim()}" style="${"--grid-cols:" + escape(columns, true) + "; --grid-rows:" + escape(rows, true) + "; --object-fit: " + escape(object_fit, true) + "; height: " + escape(height, true) + ";"}">${interactive ? `<div class="icon-button svelte-17j4qub">${validate_component(ModifyUpload, "ModifyUpload").$$render($$result, { i18n }, {}, {})}</div>` : ``} ${validate_component(IconButtonWrapper$1, "IconButtonWrapper").$$render($$result, {}, {}, {
    default: () => {
...
//# sourceMappingURL=Gallery-CAM5Fkl3.js.map
