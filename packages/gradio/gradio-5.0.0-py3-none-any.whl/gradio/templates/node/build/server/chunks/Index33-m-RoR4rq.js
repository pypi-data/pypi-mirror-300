import { c as create_ssr_component, v as validate_component, e as escape, d as add_styles } from './ssr-RaXq3SJh.js';
import { B as Block, S as StatusTracker, I as Index$1 } from './2-B1kq23UX.js';
...
const Index = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    $$rendered = `${validate_component(Block, "Block").$$render($$result, { elem_id, elem_classes, visible }, {}, {
      default: () => {
        return `${validate_component(StatusTracker, "StatusTracker").$$render($$result, Object.assign({}, { autoscroll: gradio.autoscroll }, { i18n: gradio.i18n }, loading_status), {}, {})} ${validate_component(Accordion, "Accordion").$$render(
          $$result,
          { label, open },
          {
            open: ($$value) => {
...
//# sourceMappingURL=Index33-m-RoR4rq.js.map
