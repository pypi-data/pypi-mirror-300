...
import { A as AudioPlayer$1, S as StaticAudio } from './StaticAudio-DyW7qq9b.js';
import { M as ModifyUpload, U as Upload } from './ModifyUpload-D1AmP-fT.js';
import { e as BlockLabel, j as Music, b as StreamingBar, k as SelectSource, B as Block, S as StatusTracker, U as UploadText, l as Spinner, n as prepare_files } from './2-B1kq23UX.js';
...
const Index = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    $$rendered = `  ${!interactive ? `${validate_component(Block, "Block").$$render(
      ...
      {
        default: () => {
          return `${validate_component(StatusTracker, "StatusTracker").$$render($$result, Object.assign({}, { autoscroll: gradio.autoscroll }, { i18n: gradio.i18n }, loading_status), {}, {})} ${validate_component(StaticAudio, "StaticAudio").$$render(
            $$result,
            {
              i18n: gradio.i18n,
              show_label,
      ...
      {
        default: () => {
          return `${validate_component(StatusTracker, "StatusTracker").$$render($$result, Object.assign({}, { autoscroll: gradio.autoscroll }, { i18n: gradio.i18n }, loading_status), {}, {})} ${validate_component(InteractiveAudio$1, "InteractiveAudio").$$render(
            $$result,
            {
              label,
              show_label,
...
//# sourceMappingURL=index54-BFvCjBuc.js.map
