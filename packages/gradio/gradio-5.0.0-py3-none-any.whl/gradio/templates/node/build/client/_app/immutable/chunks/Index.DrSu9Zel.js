...
import { a as TABS } from "./Tabs.BJ6qDt1q.js";
import { n as Index$1 } from "./2.Tbxs5yBc.js";
...
function instance$1($$self, $$props, $$invalidate) {
  ...
  $$self.$$.update = () => {
    if ($$self.$$.dirty & /*name, id, elem_id, visible, interactive*/
    397) {
      $$invalidate(9, tab_index = register_tab({ name, id, elem_id, visible, interactive }));
    }
    if ($$self.$$.dirty & /*$selected_tab_index, tab_index, name*/
    1664) {
