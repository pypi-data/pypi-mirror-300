...
import { B as Block, S as Static, f as BlockTitle } from "./2.Tbxs5yBc.js";
...
function create_default_slot(ctx) {
  ...
  return {
    ...
    h() {
      ...
      ctx[18];
      attr(input0, "class", "svelte-dmzn34");
      attr(button, "class", "reset-button svelte-dmzn34");
      button.disabled = /*disabled*/
      ctx[18];
      attr(button, "aria-label", "Reset to default value");
      attr(div0, "class", "tab-like-container svelte-dmzn34");
      attr(div1, "class", "head svelte-dmzn34");
      attr(span0, "class", "min_value svelte-dmzn34");
      ...
      ctx[5]}`);
      attr(input1, "class", "svelte-dmzn34");
      attr(span1, "class", "max_value svelte-dmzn34");
      attr(div2, "class", "slider_input_container svelte-dmzn34");
      attr(div3, "class", "wrap svelte-dmzn34");
    },
    m(target, anchor) {
