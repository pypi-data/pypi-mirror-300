...
import { B as Block, h as BlockTitle } from './2-B44WpJir.js';
...
const Index = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(Block, "Block").$$render(
    ...
    {
      default: () => {
        return `<div class="label-content svelte-pqkws9">${validate_component(BlockTitle, "BlockTitle").$$render($$result, { root, show_label, info }, {}, {
          default: () => {
            return `${escape(label)}`;
          }
        })}</div> <div class="timebox svelte-pqkws9"><input class="${["time svelte-pqkws9", !valid ? "invalid" : ""].join(" ").trim()}"${add_attribute("value", entered_value, 0)}> ${include_time ? `<input type="datetime-local" class="datetime svelte-pqkws9" step="1"${add_attribute("this", datetime, 0)}${add_attribute("value", datevalue, 0)}>` : `<input type="date" class="datetime svelte-pqkws9" step="1"${add_attribute("this", datetime, 0)}${add_attribute("value", datevalue, 0)}>`} <button class="calendar svelte-pqkws9">${validate_component(Calendar, "Calendar").$$render($$result, {}, {}, {})}</button></div>`;
      }
    }
  )}`;
});
...
//# sourceMappingURL=Index39-PR2vU_D0.js.map
