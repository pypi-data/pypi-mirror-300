import { c as create_ssr_component, s as subscribe, a as createEventDispatcher, o as onDestroy, b as add_attribute, v as validate_component, m as missing_component } from './ssr-Cz1f32Mr.js';
import { Embed } from './index19-CLhataOU.js';
import { $ as $format, s as setupi18n, b as browser } from './2-B44WpJir.js';
import { w as writable } from './index4-D_FyJKAV.js';
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  let { version = "5-0-0-beta-8" } = $$props;
  ...
  do {
    ...
    $$rendered = `${$$result.head += `<!-- HEAD_svelte-16qbiij_START --><link rel="stylesheet"${add_attribute("href", "./theme.css?v=" + config?.theme_hash, 0)}><style data-svelte-h="svelte-hcwpkc"></style><!-- HEAD_svelte-16qbiij_END -->`, ""} ${validate_component(Embed, "Embed").$$render(
      $$result,
      {
...
//# sourceMappingURL=_page.svelte-t0quE55R.js.map
