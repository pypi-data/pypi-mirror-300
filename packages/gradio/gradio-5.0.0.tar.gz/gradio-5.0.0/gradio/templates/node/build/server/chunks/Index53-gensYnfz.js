...
import { B as Block, S as StatusTracker, e as BlockLabel, a1 as File$1 } from './2-B1kq23UX.js';
...
const Index = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    $$rendered = `  ${validate_component(Block, "Block").$$render(
      ...
      {
        default: () => {
          return `${validate_component(StatusTracker, "StatusTracker").$$render($$result, Object.assign({}, loading_status, { autoscroll: gradio.autoscroll }, { i18n: gradio.i18n }), {}, {})} ${validate_component(BlockLabel, "BlockLabel").$$render(
            $$result,
            {
              show_label,
              Icon: File$1,
...
//# sourceMappingURL=Index53-gensYnfz.js.map
