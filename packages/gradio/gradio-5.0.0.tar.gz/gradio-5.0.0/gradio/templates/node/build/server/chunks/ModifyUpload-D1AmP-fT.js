...
import { h as IconButtonWrapper$1, i as IconButton$1, Y as Edit, v as Undo, D as Download, Z as Clear, n as prepare_files } from './2-B1kq23UX.js';
...
const Upload = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${filetype === "clipboard" ? `<button${add_attribute("tabindex", hidden ? -1 : 0, 0)} class="${[
    "svelte-1x5qevo",
    (hidden ? "hidden" : "") + " " + (center ? "center" : "") + " " + (boundedheight ? "boundedheight" : "") + " " + (flex ? "flex" : "")
  ].join(" ").trim()}"${add_styles({ "height": `100%` })}>${slots.default ? slots.default({}) : ``}</button>` : `${uploading && show_progress ? `${!hidden ? `${validate_component(UploadProgress, "UploadProgress").$$render(
    $$result,
    {
      root,
      upload_id,
    ...
    "svelte-1x5qevo",
    (hidden ? "hidden" : "") + " " + (center ? "center" : "") + " " + (boundedheight ? "boundedheight" : "") + " " + (flex ? "flex" : "") + " " + (disable_click ? "disable_click" : "")
  ].join(" ").trim()}"${add_styles({ "height": `100%` })}>${slots.default ? slots.default({}) : ``} <input aria-label="file upload" data-testid="file-upload" type="file"${add_attribute("accept", accept_file_types || void 0, 0)} ${file_count === "multiple" || void 0 ? "multiple" : ""}${add_attribute("webkitdirectory", file_count === "directory" || void 0, 0)}${add_attribute("mozdirectory", file_count === "directory" || void 0, 0)} class="svelte-1x5qevo"></button>`}`}`;
});
const ModifyUpload = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.i18n === void 0 && $$bindings.i18n && i18n !== void 0)
    $$bindings.i18n(i18n);
  return `${validate_component(IconButtonWrapper$1, "IconButtonWrapper").$$render($$result, {}, {}, {
    default: () => {
      return `${editable ? `${validate_component(IconButton$1, "IconButton").$$render($$result, { Icon: Edit, label: i18n("common.edit") }, {}, {})}` : ``} ${undoable ? `${validate_component(IconButton$1, "IconButton").$$render($$result, { Icon: Undo, label: i18n("common.undo") }, {}, {})}` : ``} ${download ? `${validate_component(DownloadLink, "DownloadLink").$$render($$result, { href: download, download: true }, {}, {
        default: () => {
      ...
      })}` : ``} ${slots.default ? slots.default({}) : ``} ${validate_component(IconButton$1, "IconButton").$$render($$result, { Icon: Clear, label: i18n("common.clear") }, {}, {})}`;
    }
  })}`;
});

export { ModifyUpload as M, Upload as U };
//# sourceMappingURL=ModifyUpload-D1AmP-fT.js.map
