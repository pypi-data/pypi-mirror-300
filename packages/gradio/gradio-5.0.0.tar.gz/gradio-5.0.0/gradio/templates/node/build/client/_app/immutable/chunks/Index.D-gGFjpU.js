...
import { P as Plot, a as Plot$1 } from "./Plot.CkvnjJNx.js";
  ...
  return {
    ...
    p(ctx2, [dirty]) {
      ...
      512)
        ...
        ctx2[9];
      if (dirty & /*$$scope, value, theme_mode, caption, bokeh_version, show_actions_button, gradio, _selectable, x_lim, loading_status, show_label, label*/
      1178737) {
