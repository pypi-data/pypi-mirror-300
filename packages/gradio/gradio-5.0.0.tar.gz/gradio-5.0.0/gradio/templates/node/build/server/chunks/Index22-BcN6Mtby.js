...
import ImagePreview from './ImagePreview-B1bQtJfJ.js';
import { B as Block, S as StatusTracker, U as UploadText, g as Empty, f as Image, b as StreamingBar, e as BlockLabel, k as SelectSource, a8 as Webcam$2, h as IconButtonWrapper$1, i as IconButton$1, Z as Clear } from './2-B1kq23UX.js';
...
const ClearImage = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(IconButtonWrapper$1, "IconButtonWrapper").$$render($$result, {}, {}, {
    default: () => {
      return `${validate_component(IconButton$1, "IconButton").$$render($$result, { Icon: Clear, label: "Remove Image" }, {}, {})}`;
    }
  })}`;
});
const css = {
...
const Index = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    $$rendered = `   ${!interactive ? `${validate_component(Block, "Block").$$render(
      ...
      {
        default: () => {
          return `${validate_component(StatusTracker, "StatusTracker").$$render($$result, Object.assign({}, { autoscroll: gradio.autoscroll }, { i18n: gradio.i18n }, loading_status), {}, {})} ${validate_component(ImagePreview, "StaticImage").$$render(
            $$result,
            {
              value,
              label,
      ...
      {
        default: () => {
          return `${validate_component(StatusTracker, "StatusTracker").$$render($$result, Object.assign({}, { autoscroll: gradio.autoscroll }, { i18n: gradio.i18n }, loading_status), {}, {})} ${validate_component(ImageUploader$1, "ImageUploader").$$render(
            $$result,
            {
              selectable: _selectable,
              root,
...
//# sourceMappingURL=Index22-BcN6Mtby.js.map
