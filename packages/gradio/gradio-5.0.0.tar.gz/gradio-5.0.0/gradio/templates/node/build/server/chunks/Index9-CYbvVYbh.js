...
import Plot$1 from './Plot-BIOPbO3Y.js';
import { B as Block, e as BlockLabel, at as Plot, S as StatusTracker } from './2-B1kq23UX.js';
    ...
    {},
    {
      default: () => {
        return `${validate_component(BlockLabel, "BlockLabel").$$render(
          ...
          {},
          {}
        )} ${validate_component(StatusTracker, "StatusTracker").$$render($$result, Object.assign({}, { autoscroll: gradio.autoscroll }, { i18n: gradio.i18n }, loading_status), {}, {})} ${validate_component(Plot$1, "Plot").$$render(
          $$result,
          {
            value,
            theme_mode,
...
//# sourceMappingURL=Index9-CYbvVYbh.js.map
