...
import { B as Block, S as StatusTracker, e as BlockLabel, C as Chat, h as IconButtonWrapper$1, i as IconButton$1, z as Community, A as Trash, G as MarkdownCode, H as Copy, J as ScrollDownArrow, R as Retry, v as Undo } from './2-B1kq23UX.js';
...
const ButtonPanel = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${show ? `<div class="${"message-buttons-" + escape(position, true) + " " + escape(layout, true) + " message-buttons " + escape(avatar !== null && "with-avatar", true) + " svelte-1ibfe7l"}">${validate_component(IconButtonWrapper$1, "IconButtonWrapper").$$render($$result, { top_panel: false }, {}, {
    default: () => {
      ...
      )}` : ``} ${show_retry ? `${validate_component(IconButton$1, "IconButton").$$render($$result, { Icon: Retry, disabled: disable }, {}, {})}` : ``} ${show_undo ? `${validate_component(IconButton$1, "IconButton").$$render($$result, { Icon: Undo, disabled: disable }, {}, {})}` : ``} ${likeable ? `${validate_component(LikeDislike, "LikeDislike").$$render($$result, { handle_action }, {}, {})}` : ``}`;
    }
  })}</div>` : ``}`;
});
const css$3 = {
...
//# sourceMappingURL=Index55-Gz6RwE4T.js.map
