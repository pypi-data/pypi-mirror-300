...
import { f as BlockTitle, C as Clear, v as Send, w as Square, B as Block, S as Static } from "./2.Tbxs5yBc.js";
import { F as File } from "./File.DqOJDDoa.js";
import { M as Music } from "./Music.BKn1BNLT.js";
import { V as Video } from "./Video.CzEOFOtQ.js";
import { U as Upload } from "./Upload.Cmo_vDM6.js";
/* empty css                                                    */
import { I as Image } from "./Image.eJ_qOnkr.js";
/* empty css                                                    */
import { default as default2 } from "./Example.CevPfWsK.js";
function create_fragment$2(ctx) {
  ...
  return {
    ...
    l(nodes) {
      svg = claim_svg_element(nodes, "svg", { fill: true, viewBox: true, xmlns: true });
...
function create_if_block_4(ctx) {
  ...
  return {
    ...
    h() {
      attr(div, "class", "thumbnails scroll-hide svelte-1tt7gi3");
...
function create_each_block(ctx) {
  ...
  return {
    ...
    h() {
      attr(button0, "class", "delete-button svelte-1tt7gi3");
      toggle_class(
        button0,
        "disabled",
        /*disabled*/
      ...
      attr(button1, "class", "thumbnail-item thumbnail-small svelte-1tt7gi3");
...
function create_if_block_5(ctx) {
  ...
  return {
    ...
    h() {
      attr(div, "class", "loader svelte-1tt7gi3");
...
function create_if_block_2(ctx) {
  ...
  return {
    ...
    h() {
      attr(button, "class", "submit-button svelte-1tt7gi3");
      button.disabled = button_disabled_value = !/*can_submit*/
      ctx[26];
      toggle_class(
        button,
        "padded-button",
    ...
    p(ctx2, dirty) {
      ...
      if (!current || dirty[0] & /*can_submit*/
      67108864 && button_disabled_value !== (button_disabled_value = !/*can_submit*/
      ctx2[26])) {
...
function create_if_block$1(ctx) {
  ...
  return {
    ...
    h() {
      attr(button, "class", "stop-button svelte-1tt7gi3");
      toggle_class(
        button,
        "padded-button",
        /*stop_btn*/
...
function create_fragment$1(ctx) {
  ...
  return {
    ...
    h() {
      ...
      attr(button, "class", "upload-button svelte-1tt7gi3");
      attr(textarea, "data-testid", "textbox");
      attr(textarea, "class", "scroll-hide svelte-1tt7gi3");
      ...
      ctx[7]);
      attr(div0, "class", "input-container svelte-1tt7gi3");
      toggle_class(
        label_1,
        "container",
        /*container*/
      ...
      attr(div1, "class", "full-container svelte-1tt7gi3");
...
function instance$1($$self, $$props, $$invalidate) {
  ...
  afterUpdate(() => {
    ...
    $$invalidate(39, value_is_output = false);
  });
  ...
  $$self.$$set = ($$props2) => {
    ...
    if ("value_is_output" in $$props2)
      $$invalidate(39, value_is_output = $$props2.value_is_output);
    if ("lines" in $$props2)
    ...
    if ("autoscroll" in $$props2)
      $$invalidate(40, autoscroll = $$props2.autoscroll);
    if ("root" in $$props2)
  ...
  $$self.$$.update = () => {
    ...
    if ($$self.$$.dirty[0] & /*value*/
    1) {
      $$invalidate(26, can_submit = value.text !== "" || value.files.length > 0);
    }
  };
  return [
    value,
