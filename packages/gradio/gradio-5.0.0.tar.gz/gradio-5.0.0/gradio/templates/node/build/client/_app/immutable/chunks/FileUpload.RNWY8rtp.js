...
function create_if_block_1(ctx) {
  ...
  downloadlink = new DownloadLink({
    props: {
      ...
      download: (
        /*is_browser*/
        ctx[6] && window.__is_colab__ ? null : (
          /*file*/
          ctx[12].orig_name
        )
      ),
  ...
  return {
    ...
    p(ctx2, dirty) {
      ...
      8)
        ...
        ctx2[6] && window.__is_colab__ ? null : (
          /*file*/
          ctx2[12].orig_name
        );
...
function create_fragment$2(ctx) {
  ...
  return {
    ...
    p(ctx2, [dirty]) {
      if (dirty & /*selectable, handle_row_click, normalized_files, remove_file, is_browser, window, i18n*/
      125) {
...
function instance$2($$self, $$props, $$invalidate) {
  ...
  function remove_file(index) {
    ...
    $$invalidate(7, value = normalized_files);
