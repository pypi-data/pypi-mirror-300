...
import { B as Block, S as StatusTracker, U as UploadText } from './2-B1kq23UX.js';
import Gallery from './Gallery-CAM5Fkl3.js';
import { BaseFileUpload } from './Index8-CUfopBhR.js';
...
import './ModifyUpload-D1AmP-fT.js';
...
const Index = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    $$rendered = `${validate_component(Block, "Block").$$render(
      ...
      {
        default: () => {
          return `${validate_component(StatusTracker, "StatusTracker").$$render($$result, Object.assign({}, { autoscroll: gradio.autoscroll }, { i18n: gradio.i18n }, loading_status), {}, {})} ${interactive && no_value ? `${validate_component(BaseFileUpload, "BaseFileUpload").$$render(
            $$result,
            {
              value: null,
              root,
...
//# sourceMappingURL=Index7-CHVEJ9AN.js.map
