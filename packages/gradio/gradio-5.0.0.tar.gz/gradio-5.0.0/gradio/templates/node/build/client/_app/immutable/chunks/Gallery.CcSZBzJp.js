import { SvelteComponent, init, safe_not_equal, add_render_callback, space, empty, claim_space, insert_hydration, listen, transition_in, group_outros, transition_out, check_outros, detach, createEventDispatcher, onMount, globals, create_component, claim_component, mount_component, destroy_component, tick, binding_callbacks, bubble, ensure_array_like, element, claim_element, children, attr, set_style, toggle_class, append_hydration, destroy_each, is_function, run_all, text, claim_text, set_data, noop } from "../../../svelte/svelte.js";
import "../../../svelte/svelte-submodules.js";
import { u as uploadToHuggingFace, I as IconButton, C as Clear } from "./2.Tbxs5yBc.js";
import { D as Download } from "./Download.BLM_J5wv.js";
import { a as Minimize, M as Maximize } from "./Minimize.xNbeii-5.js";
import { I as Image } from "./Image.CMPoCWop.js";
import { P as Play } from "./Play.wmWinRDD.js";
import { B as BlockLabel } from "./BlockLabel.DyAJefCY.js";
import { E as Empty } from "./Empty.Bv8Z952E.js";
import { S as ShareButton } from "./ShareButton.DXtYlDtQ.js";
import { I as IconButtonWrapper } from "./IconButtonWrapper.BrLWOik7.js";
/* empty css                                              */
import { M as ModifyUpload } from "./ModifyUpload.D9zBg8Rr.js";
...
function create_else_block(ctx) {
  ...
  return {
    ...
    l(nodes) {
      ...
      claim_component(iconbuttonwrapper.$$.fragment, div0_nodes);
    ...
    m(target, anchor) {
      ...
      mount_component(iconbuttonwrapper, div0, null);
    ...
    p(ctx2, dirty) {
      ...
      if (dirty[0] & /*i18n, resolved_value, show_share_button*/
      35328 | dirty[1] & /*$$scope*/
      2097152) {
...
function create_if_block_5(ctx) {
  ...
  let if_block1 = (
    /*selected_media*/
    ((_a = ctx[21]) == null ? void 0 : _a.caption) && create_if_block_7(ctx)
  );
  ...
  return {
    ...
    p(new_ctx, dirty) {
      ...
      ctx = new_ctx;
      const iconbuttonwrapper_changes = {};
      if (dirty[0] & /*selected_index, is_full_screen, show_fullscreen_button, i18n, selected_media, show_download_button*/
      2182146 | dirty[1] & /*$$scope*/
      2097152) {
