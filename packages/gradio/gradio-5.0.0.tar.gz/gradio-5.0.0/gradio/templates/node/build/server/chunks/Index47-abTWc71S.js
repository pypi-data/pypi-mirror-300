...
import { B as Block, e as BlockLabel, am as JSON$1$1, S as StatusTracker, h as IconButtonWrapper$1, i as IconButton$1, H as Copy, g as Empty } from './2-B1kq23UX.js';
...
const JSON_1 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$result.css.add(css);
  json_max_height = `calc(100% - ${label_height}px)`;
  return `${value && value !== '""' && !is_empty(value) ? `${validate_component(IconButtonWrapper$1, "IconButtonWrapper").$$render($$result, {}, {}, {
    default: () => {
    ...
    {},
    {
      default: () => {
        return `<div>${label ? `${validate_component(BlockLabel, "BlockLabel").$$render(
          ...
          {},
          {}
        )}` : ``}</div> ${validate_component(StatusTracker, "StatusTracker").$$render($$result, Object.assign({}, { autoscroll: gradio.autoscroll }, { i18n: gradio.i18n }, loading_status), {}, {})} ${validate_component(JSON$1, "JSON").$$render(
          $$result,
          {
            value,
            open,
...
//# sourceMappingURL=Index47-abTWc71S.js.map
