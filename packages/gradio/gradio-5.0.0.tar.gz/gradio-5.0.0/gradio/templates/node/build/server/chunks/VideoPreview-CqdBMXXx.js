...
import { e as BlockLabel, ao as Video, g as Empty, h as IconButtonWrapper$1, i as IconButton$1, D as Download, o as ShareButton, u as uploadToHuggingFace, v as Undo, t as Play, P as Pause, q as format_time, au as Maximise, w as Trim, n as prepare_files } from './2-B1kq23UX.js';
...
const VideoControls = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    $$rendered = `<div class="${["container svelte-7yrr5f", mode !== "edit" ? "hidden" : ""].join(" ").trim()}">${mode === "edit" ? `<div class="timeline-wrapper svelte-7yrr5f">${validate_component(VideoTimeline, "VideoTimeline").$$render(
      ...
      {
        default: () => {
          return `${showRedo && mode === "" ? `${validate_component(IconButton$1, "IconButton").$$render(
            $$result,
            {
              Icon: Undo,
              label: "Reset video to initial value",
            ...
            {},
            {}
          )}` : ``} ${interactive && mode === "" ? `${validate_component(IconButton$1, "IconButton").$$render(
            $$result,
            {
              Icon: Trim,
              label: "Trim video to selection",
...
const VideoPreview = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(BlockLabel, "BlockLabel").$$render(
    ...
    {},
    {}
  )} <div data-testid="download-div">${validate_component(IconButtonWrapper$1, "IconButtonWrapper").$$render($$result, {}, {}, {
    default: () => {
      return `${show_download_button ? `${validate_component(DownloadLink, "DownloadLink").$$render(
        ...
        {
          default: () => {
            return `${validate_component(IconButton$1, "IconButton").$$render($$result, { Icon: Download, label: "Download" }, {}, {})}`;
          }
        }
...
//# sourceMappingURL=VideoPreview-CqdBMXXx.js.map
