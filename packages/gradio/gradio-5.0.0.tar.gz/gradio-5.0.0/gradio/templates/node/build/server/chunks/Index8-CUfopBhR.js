...
import { B as Block, S as StatusTracker, U as UploadText, e as BlockLabel, a1 as File$1, g as Empty } from './2-B1kq23UX.js';
...
const Index = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    $$rendered = `   ${validate_component(Block, "Block").$$render(
      ...
      {
        default: () => {
          return `${validate_component(StatusTracker, "StatusTracker").$$render(
            $$result,
...
//# sourceMappingURL=Index8-CUfopBhR.js.map
