...
import { B as Block, S as StatusTracker, N as BlockTitle, _ as Remove, a0 as DropdownArrow } from './2-B1kq23UX.js';
...
const Index = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    $$rendered = `${validate_component(Block, "Block").$$render(
      ...
      {
        default: () => {
          return `${validate_component(StatusTracker, "StatusTracker").$$render($$result, Object.assign({}, { autoscroll: gradio.autoscroll }, { i18n: gradio.i18n }, loading_status), {}, {})} ${multiselect ? `${validate_component(Multiselect$1, "Multiselect").$$render(
            $$result,
            {
              choices,
              max_choices,
...
//# sourceMappingURL=Index50-DwYZfyx4.js.map
