const __vite__fileDeps=["./vega-embed.module.BzIMullW.js","./2.Tbxs5yBc.js","./preload-helper.DpQnamwV.js","./stores.DZ7niM6O.js","./client.o4CP9lyB.js","../assets/2.DVPcWs1q.css","./dsv.CKxpOsHB.js"],__vite__mapDeps=i=>i.map(i=>__vite__fileDeps[i]);
...
import { B as Block, f as BlockTitle, S as Static } from "./2.Tbxs5yBc.js";
import { E as Empty } from "./Empty.Bv8Z952E.js";
...
function instance($$self, $$props, $$invalidate) {
  ...
  async function load_chart() {
    ...
    if (!vegaEmbed) {
      vegaEmbed = (await __vitePreload(() => import("./vega-embed.module.BzIMullW.js"), true ? __vite__mapDeps([0,1,2,3,4,5,6]) : void 0, import.meta.url)).default;
    }
  ...
  $$self.$$set = ($$props2) => {
    ...
    if ("_selectable" in $$props2)
      $$invalidate(31, _selectable = $$props2._selectable);
    if ("gradio" in $$props2)
  ...
  $$self.$$.update = () => {
    ...
    1) {
      $$invalidate(32, _data = value ? reformat_data(value) : []);
    }
    ...
    32769) {
      $$invalidate(37, x_temporal = value && value.datatypes[x] === "temporal");
    }
    ...
    4194304) {
      $$invalidate(33, _x_bin = x_bin ? typeof x_bin === "string" ? 1e3 * parseInt(x_bin.substring(0, x_bin.length - 1)) * SUFFIX_DURATION[x_bin[x_bin.length - 1]] : x_bin : void 0);
    }
    ...
    20) {
      {
        if (value) {
          if (value.mark === "point") {
            $$invalidate(35, aggregating = _x_bin !== void 0);
            $$invalidate(34, _y_aggregate = y_aggregate || aggregating ? "sum" : void 0);
          } else {
            $$invalidate(35, aggregating = _x_bin !== void 0 || value.datatypes[x] === "nominal");
            $$invalidate(34, _y_aggregate = y_aggregate ? y_aggregate : "sum");
          }
        }
      }
    }
    ...
    8192) {
      $$invalidate(38, computed_style = chart_element ? window.getComputedStyle(chart_element) : null);
    }
