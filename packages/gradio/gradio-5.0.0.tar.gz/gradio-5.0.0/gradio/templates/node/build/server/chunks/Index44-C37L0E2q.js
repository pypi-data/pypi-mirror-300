...
import { B as Block, e as BlockLabel, O as Code, S as StatusTracker, a7 as css_units } from './2-B1kq23UX.js';
    ...
    {},
    {
      default: () => {
        return `${show_label ? `<span class="label-container svelte-uqf9ro">${validate_component(BlockLabel, "BlockLabel").$$render(
          ...
          {},
          {}
        )}</span>` : ``} ${validate_component(StatusTracker, "StatusTracker").$$render($$result, Object.assign({}, { autoscroll: gradio.autoscroll }, { i18n: gradio.i18n }, loading_status, { variant: "center" }), {}, {})} <div class="${["svelte-uqf9ro", loading_status?.status === "pending" ? "pending" : ""].join(" ").trim()}"${add_styles({
...
//# sourceMappingURL=Index44-C37L0E2q.js.map
