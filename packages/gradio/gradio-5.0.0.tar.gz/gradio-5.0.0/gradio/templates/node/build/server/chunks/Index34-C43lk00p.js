...
import { B as Block, S as StatusTracker, K as Info } from './2-B1kq23UX.js';
...
const Index = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    $$rendered = `${validate_component(Block, "Block").$$render(
      ...
      {
        default: () => {
          return `${validate_component(StatusTracker, "StatusTracker").$$render($$result, Object.assign({}, { autoscroll: gradio.autoscroll }, { i18n: gradio.i18n }, loading_status), {}, {})} ${info ? `${validate_component(Info, "Info").$$render($$result, { root, info }, {}, {})}` : ``} ${validate_component(BaseCheckbox, "BaseCheckbox").$$render(
            $$result,
...
//# sourceMappingURL=Index34-C43lk00p.js.map
