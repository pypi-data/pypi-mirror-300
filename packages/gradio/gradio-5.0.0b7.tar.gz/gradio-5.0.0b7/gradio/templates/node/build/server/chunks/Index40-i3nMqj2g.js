...
import { B as Block, h as BlockTitle } from './2-BZ3PdVP1.js';
...
const Index = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(Block, "Block").$$render(
    ...
    {
      default: () => {
        return `<div class="label-content svelte-pqkws9">${validate_component(BlockTitle, "BlockTitle").$$render($$result, { show_label, info }, {}, {
          default: () => {
            return `${escape(label)}`;
          }
...
//# sourceMappingURL=Index40-i3nMqj2g.js.map
