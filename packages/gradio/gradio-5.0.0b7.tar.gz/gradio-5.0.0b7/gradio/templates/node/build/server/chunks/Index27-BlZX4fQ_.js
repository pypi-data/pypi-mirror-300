import { B as Block, S as Static, h as BlockTitle, o as globals } from './2-BZ3PdVP1.js';
...
import { L as LineChart } from './LineChart-Cwb1Ein3.js';
...
const Index = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  async function load_chart() {
    ...
    if (!vegaEmbed) {
      vegaEmbed = (await import('./vega-embed.module-CnGJytac.js')).default;
    }
    vegaEmbed(chart_element, spec, { actions: false }).then(function(result) {
      view = result.view;
      resizeObserver.observe(chart_element);
  ...
  return `${validate_component(Block, "Block").$$render(
    ...
    {
      default: () => {
        return `${loading_status ? `${validate_component(Static, "StatusTracker").$$render($$result, Object_1.assign({}, { autoscroll: gradio.autoscroll }, { i18n: gradio.i18n }, loading_status), {}, {})}` : ``} ${validate_component(BlockTitle, "BlockTitle").$$render($$result, { show_label, info: void 0 }, {}, {
          default: () => {
            return `${escape(label)}`;
          }
...
//# sourceMappingURL=Index27-BlZX4fQ_.js.map
