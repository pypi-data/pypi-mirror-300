import { c as create_ssr_component, v as validate_component, b as add_attribute, m as missing_component, a as createEventDispatcher } from './ssr-Cz1f32Mr.js';
import { B as Block, S as Static, c as IconButton } from './2-BZ3PdVP1.js';
...
export { default as BaseExample } from './Example17-DMxPV5yN.js';
...
async function loadCanvas3D$1() {
  const module = await import('./Canvas3D-DsMvcpYv.js');
  return module.default;
}
async function loadCanvas3DGS$1() {
  const module = await import('./Canvas3DGS-B2nBXYJ-.js');
  return module.default;
}
...
//# sourceMappingURL=Index51-BYuIVTlN.js.map
