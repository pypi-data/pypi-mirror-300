...
import { B as Block, S as StatusTracker, e as BlockLabel, C as Chat, h as IconButtonWrapper$1, i as IconButton$1, z as Community, A as Trash, G as MarkdownCode, H as Copy, J as ScrollDownArrow, R as Retry, v as Undo } from './2-C003e5Zs.js';
...
const LikeDislike = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(IconButton$1, "IconButton").$$render(
    $$result,
    {
    ...
    {},
    {}
  )} ${validate_component(IconButton$1, "IconButton").$$render(
    $$result,
    {
      Icon: ThumbUpDefault,
      label: "like",
...
const ButtonPanel = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  show_copy = show_copy_button && message && is_all_text(message);
  show_download = !Array.isArray(message) && is_component_message(message) && message.content.value?.url;
  return `${show ? `<div class="${"message-buttons-" + escape(position, true) + " " + escape(layout, true) + " message-buttons " + escape(avatar !== null && "with-avatar", true) + " svelte-1ibfe7l"}">${validate_component(IconButtonWrapper$1, "IconButtonWrapper").$$render($$result, { top_panel: false }, {}, {
    default: () => {
...
const Message = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="${[
    "message-row " + escape(layout, true) + " " + escape(role, true) + "-row svelte-1x5p6hu",
    (avatar_img !== null ? "with_avatar" : "") + " " + (opposite_avatar_img !== null ? "with_opposite_avatar" : "")
  ].join(" ").trim()}">${avatar_img !== null ? `<div class="avatar-container svelte-1x5p6hu">${validate_component(Image$1, "Image").$$render(
    $$result,
    {
      class: "avatar-image",
      src: avatar_img?.url,
    ...
    return `<div class="${[
      ...
      {},
      {}
    )}` : `${message.type === "component" && message.content.component === "file" ? `<a data-testid="chatbot-file" class="file-pil svelte-1x5p6hu"${add_attribute("href", message.content.value.url, 0)} target="_blank"${add_attribute(
      "download",
      window.__is_colab__ ? null : message.content.value?.orig_name || message.content.value?.path.split("/").pop() || "file",
      0
    )}>${escape(message.content.value?.orig_name || message.content.value?.path.split("/").pop() || "file")} </a>` : ``}`}`} </button></div> ${layout === "panel" ? `${validate_component(ButtonPanel, "ButtonPanel").$$render($$result, Object.assign({}, get_button_panel_props()), {}, {})}` : ``}`;
  })}</div></div> ${layout === "bubble" ? `${validate_component(ButtonPanel, "ButtonPanel").$$render($$result, Object.assign({}, get_button_panel_props()), {}, {})}` : ``}`;
});
const css$2 = {
...
const ChatBot = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  groupedMessages = value && group_messages(value, msg_format);
  return `${value !== null && value.length > 0 ? `${validate_component(IconButtonWrapper$1, "IconButtonWrapper").$$render($$result, {}, {}, {
    default: () => {
      return `${show_share_button ? `${validate_component(IconButton$1, "IconButton").$$render($$result, { Icon: Community }, {}, {
        default: () => {
          return `${validate_component(Community, "Community").$$render($$result, {}, {}, {})}`;
        }
      })}` : ``} ${validate_component(IconButton$1, "IconButton").$$render($$result, { Icon: Trash }, {}, {})} ${show_copy_all_button ? `${validate_component(CopyAll, "CopyAll").$$render($$result, { value }, {}, {})}` : ``}`;
    }
  })}` : ``} <div class="${escape(null_to_empty(layout === "bubble" ? "bubble-wrap" : "panel-wrap"), true) + " svelte-1r2lqkc"}" role="log" aria-label="chatbot conversation" aria-live="polite"${add_attribute("this", div, 0)}>${value !== null && value.length > 0 && groupedMessages !== null ? `<div class="message-wrap svelte-1r2lqkc">${each(groupedMessages, (messages, i) => {
  ...
  })} ${pending_message ? `${validate_component(Pending, "Pending").$$render($$result, { layout }, {}, {})}` : ``}</div>` : `<div class="placeholder-content svelte-1r2lqkc">${placeholder !== null ? `<div class="placeholder svelte-1r2lqkc">${validate_component(MarkdownCode, "Markdown").$$render(
    $$result,
    {
      message: placeholder,
      latex_delimiters,
    ...
    {},
    {}
  )}</div>` : ``} ${examples !== null ? `<div class="examples svelte-1r2lqkc">${each(examples, (example, i) => {
    return `<button class="example svelte-1r2lqkc">${example.icon !== void 0 ? `<div class="example-icon-container svelte-1r2lqkc">${validate_component(Image$1, "Image").$$render(
      $$result,
      {
        class: "example-icon",
        src: example.icon.url,
      ...
      {},
      {}
    )} </div>` : ``} ${example.display_text !== void 0 ? `<span class="example-display-text svelte-1r2lqkc">${escape(example.display_text)}</span>` : `<span class="example-text svelte-1r2lqkc">${escape(example.text)}</span>`} ${example.files !== void 0 && example.files.length > 1 ? `<span class="example-file svelte-1r2lqkc"><em>${escape(example.files.length)} Files</em></span>` : `${example.files !== void 0 && example.files[0] !== void 0 && example.files[0].mime_type?.includes("image") ? `<div class="example-image-container svelte-1r2lqkc">${validate_component(Image$1, "Image").$$render(
      $$result,
      {
        class: "example-image",
        src: example.files[0].url,
      ...
      {},
      {}
    )} </div>` : `${example.files !== void 0 && example.files[0] !== void 0 ? `<span class="example-file svelte-1r2lqkc"><em>${escape(example.files[0].orig_name)}</em></span>` : ``}`}`} </button>`;
  })}</div>` : ``}</div>`}</div> ${show_scroll_button ? `<div class="scroll-down-button-container svelte-1r2lqkc">${validate_component(IconButton$1, "IconButton").$$render(
    $$result,
    {
      Icon: ScrollDownArrow,
      label: "Scroll down",
...
const Index = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(Block, "Block").$$render(
    ...
    {
      default: () => {
        return `${loading_status ? `${validate_component(StatusTracker, "StatusTracker").$$render(
          $$result,
...
//# sourceMappingURL=Index55-xOhahp46.js.map
