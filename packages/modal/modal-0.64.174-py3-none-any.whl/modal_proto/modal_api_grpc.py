...
class ModalClientModal:
    ...
    def __init__(self, grpclib_stub: modal_proto.api_grpc.ModalClientStub, client: "modal.client._Client") -> None:
        ...
        self.AppDeploySingleObject = modal.client.UnaryUnaryWrapper(grpclib_stub.AppDeploySingleObject, client)
        ...
        self.AppLookupObject = modal.client.UnaryUnaryWrapper(grpclib_stub.AppLookupObject, client)
        ...
        self.ProxyIpDelete = modal.client.UnaryUnaryWrapper(grpclib_stub.ProxyIpDelete, client)
        self.ProxyIpGetOrCreate = modal.client.UnaryUnaryWrapper(grpclib_stub.ProxyIpGetOrCreate, client)
        self.ProxyIpList = modal.client.UnaryUnaryWrapper(grpclib_stub.ProxyIpList, client)
