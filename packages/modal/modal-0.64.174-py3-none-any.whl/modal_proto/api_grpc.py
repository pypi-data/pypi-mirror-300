...
class ModalClientBase(abc.ABC):
    ...
    @abc.abstractmethod
    async def ProxyIpDelete(self, stream: 'grpclib.server.Stream[modal_proto.api_pb2.ProxyIpDeleteRequest, google.protobuf.empty_pb2.Empty]') -> None:
        pass

    @abc.abstractmethod
    async def ProxyIpGetOrCreate(self, stream: 'grpclib.server.Stream[modal_proto.api_pb2.ProxyIpGetOrCreateRequest, modal_proto.api_pb2.ProxyIpGetOrCreateResponse]') -> None:
        pass

    @abc.abstractmethod
    async def ProxyIpList(self, stream: 'grpclib.server.Stream[google.protobuf.empty_pb2.Empty, modal_proto.api_pb2.ProxyIpListResponse]') -> None:
        pass
    ...
    def __mapping__(self) -> typing.Dict[str, grpclib.const.Handler]:
        return {
            ...
            '/modal.client.ModalClient/ProxyIpDelete': grpclib.const.Handler(
                self.ProxyIpDelete,
                grpclib.const.Cardinality.UNARY_UNARY,
                modal_proto.api_pb2.ProxyIpDeleteRequest,
                google.protobuf.empty_pb2.Empty,
            ),
            '/modal.client.ModalClient/ProxyIpGetOrCreate': grpclib.const.Handler(
                self.ProxyIpGetOrCreate,
                grpclib.const.Cardinality.UNARY_UNARY,
                modal_proto.api_pb2.ProxyIpGetOrCreateRequest,
                modal_proto.api_pb2.ProxyIpGetOrCreateResponse,
            ),
            '/modal.client.ModalClient/ProxyIpList': grpclib.const.Handler(
                self.ProxyIpList,
                grpclib.const.Cardinality.UNARY_UNARY,
                google.protobuf.empty_pb2.Empty,
                modal_proto.api_pb2.ProxyIpListResponse,
            ),
...
class ModalClientStub:
    ...
    def __init__(self, channel: grpclib.client.Channel) -> None:
        ...
        self.ProxyIpDelete = grpclib.client.UnaryUnaryMethod(
            channel,
            '/modal.client.ModalClient/ProxyIpDelete',
            modal_proto.api_pb2.ProxyIpDeleteRequest,
            google.protobuf.empty_pb2.Empty,
        )
        self.ProxyIpGetOrCreate = grpclib.client.UnaryUnaryMethod(
            channel,
            '/modal.client.ModalClient/ProxyIpGetOrCreate',
            modal_proto.api_pb2.ProxyIpGetOrCreateRequest,
            modal_proto.api_pb2.ProxyIpGetOrCreateResponse,
        )
        self.ProxyIpList = grpclib.client.UnaryUnaryMethod(
            channel,
