...
class FleetAppsManagementOperationsClient(object):
    ...
    def create_scheduler_definition(self, create_scheduler_definition_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.135.2/fleetappsmanagement/create_scheduler_definition.py.html>`__ to see an example of how to use create_scheduler_definition API.
        """
    ...
    def delete_scheduler_definition(self, scheduler_definition_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.135.2/fleetappsmanagement/delete_scheduler_definition.py.html>`__ to see an example of how to use delete_scheduler_definition API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def delete_scheduler_job(self, scheduler_job_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.135.2/fleetappsmanagement/delete_scheduler_job.py.html>`__ to see an example of how to use delete_scheduler_job API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def get_execution(self, scheduler_job_id, job_activity_id, resource_id, execution_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.135.2/fleetappsmanagement/get_execution.py.html>`__ to see an example of how to use get_execution API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def get_job_activity(self, scheduler_job_id, job_activity_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.135.2/fleetappsmanagement/get_job_activity.py.html>`__ to see an example of how to use get_job_activity API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def get_scheduler_definition(self, scheduler_definition_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.135.2/fleetappsmanagement/get_scheduler_definition.py.html>`__ to see an example of how to use get_scheduler_definition API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['schedulerDefinitionId']
        resource_path = "/schedulerDefinitions/{schedulerDefinitionId}"
    ...
    def get_scheduler_job(self, scheduler_job_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.135.2/fleetappsmanagement/get_scheduler_job.py.html>`__ to see an example of how to use get_scheduler_job API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['schedulerJobId']
        resource_path = "/schedulerJobs/{schedulerJobId}"
