...
T = TypeVar("T", bound="PlaylistSearchResponse")
...
class PlaylistSearchResponse:
    """
    Attributes:
        docs (Union[Unset, List['PlaylistFull']]):
    """

    docs: Union[Unset, List["PlaylistFull"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for docs_item_data in _docs or []:
            docs_item = PlaylistFull.from_dict(docs_item_data)

            docs.append(docs_item)

        playlist_search_response = cls(
            docs=docs,
        )

        playlist_search_response.additional_properties = d
        return playlist_search_response
