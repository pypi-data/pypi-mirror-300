...
if TYPE_CHECKING:
    from ..models.compact_leaderboard_response import CompactLeaderboardResponse
...
T = TypeVar("T", bound="ScoreResponseWithMyScore")


@_attrs_define
class ScoreResponseWithMyScore:
    """
    Attributes:
        ...
        valid_contexts (Union[Unset, LeaderboardContexts]):
        leaderboard (Union[Unset, CompactLeaderboardResponse]):
    """
    ...
    valid_contexts: Union[Unset, LeaderboardContexts] = UNSET
    leaderboard: Union[Unset, "CompactLeaderboardResponse"] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        valid_contexts: Union[Unset, str] = UNSET
        if not isinstance(self.valid_contexts, Unset):
            valid_contexts = self.valid_contexts.value
        ...
        if valid_contexts is not UNSET:
            field_dict["validContexts"] = valid_contexts
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        _valid_contexts = d.pop("validContexts", UNSET)
        valid_contexts: Union[Unset, LeaderboardContexts]
        if isinstance(_valid_contexts, Unset):
            valid_contexts = UNSET
        else:
            valid_contexts = LeaderboardContexts(_valid_contexts)
        ...
        if isinstance(_leaderboard, Unset):
            ...
            leaderboard = CompactLeaderboardResponse.from_dict(_leaderboard)

        score_response_with_my_score = cls(
            id=id,
        ...
        return score_response_with_my_score
