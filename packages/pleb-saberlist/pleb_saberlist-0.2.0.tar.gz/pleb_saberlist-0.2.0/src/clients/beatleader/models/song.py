...
class Song:
    ...
    Attributes:
        ...
        mappers (Union[List['Mapper'], None, Unset]):
        ...
        difficulties (Union[List['DifficultyDescription'], None, Unset]):
        leaderboards (Union[List['Leaderboard'], None, Unset]):
    ...
    mappers: Union[List["Mapper"], None, Unset] = UNSET
    ...
    difficulties: Union[List["DifficultyDescription"], None, Unset] = UNSET
    leaderboards: Union[List["Leaderboard"], None, Unset] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        leaderboards: Union[List[Dict[str, Any]], None, Unset]
        if isinstance(self.leaderboards, Unset):
            leaderboards = UNSET
        elif isinstance(self.leaderboards, list):
            leaderboards = []
            for leaderboards_type_0_item_data in self.leaderboards:
                leaderboards_type_0_item = leaderboards_type_0_item_data.to_dict()
                leaderboards.append(leaderboards_type_0_item)
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_mappers(data: object) -> Union[List["Mapper"], None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for mappers_type_0_item_data in _mappers_type_0:
                    mappers_type_0_item = Mapper.from_dict(mappers_type_0_item_data)
                ...
                pass
            return cast(Union[List["Mapper"], None, Unset], data)
        ...
        def _parse_difficulties(data: object) -> Union[List["DifficultyDescription"], None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for difficulties_type_0_item_data in _difficulties_type_0:
                    difficulties_type_0_item = DifficultyDescription.from_dict(difficulties_type_0_item_data)
                ...
                pass
            return cast(Union[List["DifficultyDescription"], None, Unset], data)

        difficulties = _parse_difficulties(d.pop("difficulties", UNSET))

        def _parse_leaderboards(data: object) -> Union[List["Leaderboard"], None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, list):
                    raise TypeError()
                leaderboards_type_0 = []
                _leaderboards_type_0 = data
                for leaderboards_type_0_item_data in _leaderboards_type_0:
                    leaderboards_type_0_item = Leaderboard.from_dict(leaderboards_type_0_item_data)

                    leaderboards_type_0.append(leaderboards_type_0_item)

                return leaderboards_type_0
            except:  # noqa: E722
                pass
            return cast(Union[List["Leaderboard"], None, Unset], data)

        leaderboards = _parse_leaderboards(d.pop("leaderboards", UNSET))
