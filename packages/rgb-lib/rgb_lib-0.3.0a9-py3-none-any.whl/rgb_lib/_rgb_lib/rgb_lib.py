...
def _uniffi_check_api_checksums(lib):
    ...
    if lib.uniffi_rgblibuniffi_checksum_method_wallet_blind_receive() != 26641:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_rgblibuniffi_checksum_method_wallet_create_utxos() != 11536:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_rgblibuniffi_checksum_method_wallet_create_utxos_begin() != 62842:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_rgblibuniffi_checksum_method_wallet_delete_transfers() != 43847:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_rgblibuniffi_checksum_method_wallet_drain_to() != 26199:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_rgblibuniffi_checksum_method_wallet_drain_to_begin() != 18017:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_rgblibuniffi_checksum_method_wallet_go_online() != 46399:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_rgblibuniffi_checksum_method_wallet_issue_asset_cfa() != 32318:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_rgblibuniffi_checksum_method_wallet_issue_asset_nia() != 45243:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_rgblibuniffi_checksum_method_wallet_issue_asset_uda() != 52344:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_rgblibuniffi_checksum_method_wallet_refresh() != 45223:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_rgblibuniffi_checksum_method_wallet_send() != 60683:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_rgblibuniffi_checksum_method_wallet_send_begin() != 896:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_rgblibuniffi_checksum_method_wallet_send_btc() != 16543:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_rgblibuniffi_checksum_method_wallet_send_btc_begin() != 20079:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
...
class WalletProtocol(typing.Protocol):
    ...
    def blind_receive(self, asset_id: "typing.Optional[str]",amount: "typing.Optional[int]",duration_seconds: "typing.Optional[int]",transport_endpoints: "typing.List[str]",min_confirmations: "int"):
        raise NotImplementedError
    def create_utxos(self, online: "Online",up_to: "bool",num: "typing.Optional[int]",size: "typing.Optional[int]",fee_rate: "float",skip_sync: "bool"):
        raise NotImplementedError
    def create_utxos_begin(self, online: "Online",up_to: "bool",num: "typing.Optional[int]",size: "typing.Optional[int]",fee_rate: "float",skip_sync: "bool"):
        raise NotImplementedError
    ...
    def refresh(self, online: "Online",asset_id: "typing.Optional[str]",filter: "typing.List[RefreshFilter]",skip_sync: "bool"):
        raise NotImplementedError
    def send(self, online: "Online",recipient_map: "dict[str, typing.List[Recipient]]",donation: "bool",fee_rate: "float",min_confirmations: "int",skip_sync: "bool"):
        raise NotImplementedError
    def send_begin(self, online: "Online",recipient_map: "dict[str, typing.List[Recipient]]",donation: "bool",fee_rate: "float",min_confirmations: "int"):
        raise NotImplementedError
    def send_btc(self, online: "Online",address: "str",amount: "int",fee_rate: "float",skip_sync: "bool"):
        raise NotImplementedError
    def send_btc_begin(self, online: "Online",address: "str",amount: "int",fee_rate: "float",skip_sync: "bool"):
        raise NotImplementedError
...
class Wallet:
    ...
    def create_utxos(self, online: "Online",up_to: "bool",num: "typing.Optional[int]",size: "typing.Optional[int]",fee_rate: "float",skip_sync: "bool") -> "int":
    ...
    def create_utxos_begin(self, online: "Online",up_to: "bool",num: "typing.Optional[int]",size: "typing.Optional[int]",fee_rate: "float",skip_sync: "bool") -> "str":
        _UniffiConverterTypeOnline.check_lower(online)
    ...
    def send(self, online: "Online",recipient_map: "dict[str, typing.List[Recipient]]",donation: "bool",fee_rate: "float",min_confirmations: "int",skip_sync: "bool") -> "SendResult":
        _UniffiConverterTypeOnline.check_lower(online)
    ...
    def send_btc(self, online: "Online",address: "str",amount: "int",fee_rate: "float",skip_sync: "bool") -> "str":
        _UniffiConverterTypeOnline.check_lower(online)
    ...
    def send_btc_begin(self, online: "Online",address: "str",amount: "int",fee_rate: "float",skip_sync: "bool") -> "str":
        _UniffiConverterTypeOnline.check_lower(online)
