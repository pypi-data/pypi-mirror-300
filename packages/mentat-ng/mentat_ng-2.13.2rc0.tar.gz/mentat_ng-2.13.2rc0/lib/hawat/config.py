...
import mentat.const
from mentat.datatype.sqldb import UserModel, GroupModel, EventClassModel, ItemChangeLogModel

import hawat.const


def _get_cleanup_threshold() -> Optional[datetime]:
    """
    Extract the smallest event cleanup threshold from cleanup module configuration.
    If module not present, return None
    """
    try:
        from mentat.module.cleanup import THRESHOLDS, MentatCleanupScript  # pylint: disable=locally-disabled,import-outside-toplevel
