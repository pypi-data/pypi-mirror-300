...
from sqlalchemy import or_, nullslast, nullsfirst
...
from hawat.blueprints.users.forms import CreateUserAccountForm, UpdateUserAccountForm, AdminUpdateUserAccountForm, \
    UserSearchForm
