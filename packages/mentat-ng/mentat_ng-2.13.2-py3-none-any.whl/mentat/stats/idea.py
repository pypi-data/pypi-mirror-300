...
from typing import Dict, Iterator, List, NamedTuple, Optional, Tuple, TypeVar, Union, cast, Type
...
DataWideType = List[Tuple[datetime.datetime, StatisticsDataType]]  # In reality List of Lists, but this makes typing easier
...
class TimelineCFG:
    ...
    def _calculate_timeline_steps(
        ...
        step_count = math.ceil((time_to - first_step) / step)

        if step_count == max_count and first_step != time_from:
