...
class Settings(BaseSettings):
    ...
    OPENAPI_JSON_PATH: str = "mtmai/mtmai/openapi.json"

    vercel_token: str | None = None

    PROJECT_NAME: str = "mtmflow"
    ...
    DOCKER_IMAGE_TAG: str | None = "docker.io/gitgit188/tmpboai"
    ...
    # langflow
    LANGFLOW_DATABASE_URL: str | None = os.environ.get(
