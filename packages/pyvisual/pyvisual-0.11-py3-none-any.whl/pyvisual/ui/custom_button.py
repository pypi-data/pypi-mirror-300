...
class CustomButton(Image):
    def __init__(self, window, x, y, idle_image=None, hover_image=None, clicked_image=None, scale=1.0,
                 text=None, text_anchor='center', text_color=(1, 1, 1, 1), text_font="Roboto", text_size=14,
                 click_callback=None, release_callback=None, hover_callback=None, access_text =None):
        ...
        self.access_text = access_text  # Set the hidden access text for buttons without visible labels
