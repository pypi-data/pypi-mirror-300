...
class BasicTextInput(Widget):
    def __init__(self, window, x, y, width=200, height=40,
                 text_color=(0.3, 0.3, 0.3, 1), background_color=(1, 1, 1, 1),
                 border_color=(0.6, 0.6, 0.6, 1), border_thickness=1,
                 font_size=None, font_name="Roboto", text_callback=None,
                 placeholder="Enter your text here...", default_text="",
                 border_style=("bottom","top","right","left"), input_type="text",
                 padding_left=10, padding_right=10, padding_top=0, padding_bottom=10):
        super().__init__()
        ...
        self.text_input = TextInput(
            ...
            padding=[self.padding_left, self.padding_bottom, self.padding_right, self.padding_top],
        )
