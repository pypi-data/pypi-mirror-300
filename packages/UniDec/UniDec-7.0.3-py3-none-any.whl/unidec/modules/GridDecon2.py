...
class GridDeconWindow(wx.Frame):
    def __init__(self, parent, data, config=None, directory=None):
        ...
        if self.config.griddecon is None:
            self.params = [22746, 20159, 0, 30, 0, 30, 0, 20, 1, 1]
        else:
        ...
        controlsizer1.Add(wx.StaticText(panel, label="Monomer 1"), 0, wx.ALIGN_CENTER_VERTICAL)
        controlsizer1.Add(self.ctlm0, 0, wx.EXPAND)
        controlsizer1.Add(wx.StaticText(panel, label="Monomer 2"), 0, wx.ALIGN_CENTER_VERTICAL)
        ...
        controlsizer1.Add(wx.StaticText(panel, label="Monomer 1 Min #"), 0, wx.ALIGN_CENTER_VERTICAL)
        controlsizer1.Add(self.ctlm1min, 0, wx.EXPAND)
        controlsizer1.Add(wx.StaticText(panel, label="Monomer 1 Max #"), 0, wx.ALIGN_CENTER_VERTICAL)
        controlsizer1.Add(self.ctlm1max, 0, wx.EXPAND)
        controlsizer1.Add(wx.StaticText(panel, label="Monomer 2 Min #"), 0, wx.ALIGN_CENTER_VERTICAL)
        controlsizer1.Add(self.ctlm2min, 0, wx.EXPAND)
        controlsizer1.Add(wx.StaticText(panel, label="Monomer 2 Max #"), 0, wx.ALIGN_CENTER_VERTICAL)
        ...
        controlsizer1.Add(wx.StaticText(panel, label="Monomer 1 Filter Width"), 0, wx.ALIGN_CENTER_VERTICAL)
        controlsizer1.Add(self.ctlmsig, 0, wx.EXPAND)
        controlsizer1.Add(wx.StaticText(panel, label="Monomer 2 Filter Width"), 0, wx.ALIGN_CENTER_VERTICAL)
    ...
    def makegrids(self):
        ...
        self.mzgrid = (self.params[0] * self.mgrid + self.params[1] * self.zgrid)
        print(self.params[0], self.params[1], self.params[6])
    ...
    def makeplot(self, title="Extracted Data"):
        ...
        try:
            self.plot2.contourplot(dat, self.config, xlab="Monomer 1 Number", ylab="Monomer 2 Number", title=title,
                                   normflag=True,
                                   normrange=[0, 1])
...
if __name__ == "__main__":
    ...
    # dir_name = "C:\Data\Others\Miranda\sample_data\MC_20170904_1to1_aB_C137S_11000_520_HCD300_CAL_unidecfiles"
    # dir_name = "C:\Data\Others\Miranda\sample_data\MC_20170904_1to1_aB_C137S_9000_520_HCD300_CAL_unidecfiles"
    # file_name = "CorrectedMassData.txt"
    # file_name = "MC_20170904_1to1_aB_C137S_11000_520_HCD300_CAL_extracted_intensities1.txt"
