...
def main_stats():  # pragma: no cover
    ...
    main_parser.add_argument(
        ...
        help='output file name of the results. The output format is selected '
             ...
             'map is generated, otherwise if .[geo]json results are returned'
             ' into GeoJSON format')
    main_parser.add_argument(
    ...
    main_parser.add_argument(
        '-r', action='store_true',
        help='flag to execute reworking before optimization')
    main_parser.add_argument(
    ...
    main_parser.add_argument(
        ...
        help='the simlify tolerance value')
    ...
    if args.a == 'simplify':
        if args.t:
            ...
            stats = _compute_simplify(orig_footprint, tolerance=args.t)
