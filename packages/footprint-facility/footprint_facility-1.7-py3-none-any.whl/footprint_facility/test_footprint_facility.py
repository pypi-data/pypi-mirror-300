...
class TestFootprintFacility(TestCase):
    ...
    def test_degree_to_meter_and_rev(self):
        ...
        self.assertAlmostEqual(new_point.x, 20037508, delta=1)
        self.assertAlmostEqual(new_point.y, 10018754, delta=1)

        point = Point(20037508, 10018754)
        ...
        point = Point(2, 48)
        new_point = footprint_facility.geodetic_to_cartesian(point)
        self.assertAlmostEqual(new_point.x, 222639, delta=1)
        self.assertAlmostEqual(new_point.y, 5343336, delta=1)

        point = Point(222639, 5343336)
        new_point = footprint_facility.cartesian_to_geodetic(point)
