...
def import_file_with_data_and_metadata_from_cloud_storage(
    ...
    try:
        with pipelinemon.context("importing_data"):
            try:
                json_data = read_json_from_cloud_storage_extended(pipelinemon=pipelinemon, cloud_storage=cloud_storage, storage_client=storage_client, file_name=file_name, bucket_name=source_bucket_name)
