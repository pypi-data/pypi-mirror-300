"""The methods for loading Vioneta Agro integrations.
...
BLOCKED_CUSTOM_INTEGRATIONS: dict[str, BlockedIntegration] = {
    ...
    "start_time": BlockedIntegration(AwesomeVersion("1.1.7"), "breaks Vioneta Agro"),
...
CUSTOM_WARNING = (
    ...
    "been tested by Vioneta Agro. This component might "
    "cause stability problems, be sure to disable it if you "
    "experience issues with Vioneta Agro"
)
...
class Integration:
    """An integration in Vioneta Agro."""
    ...
    def __getattr__(self, comp_name: str) -> ModuleWrapper:
        ...
        report(
            (
                ...
                " This is deprecated and will stop working in Vioneta Agro 2024.9, it"
    ...
    def __getattr__(self, helper_name: str) -> ModuleWrapper:
        ...
        report(
            (
                ...
                " This is deprecated and will stop working in Vioneta Agro 2024.11, it"
