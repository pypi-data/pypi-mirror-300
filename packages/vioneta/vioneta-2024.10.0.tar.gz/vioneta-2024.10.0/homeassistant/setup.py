"""All methods needed to bootstrap a Vioneta Agro instance."""
...
async def async_setup_component(
    ...
    try:
        ...
        for future in futures:
            ...
            # Vioneta Agro is shutting down so the future might
...
async def _async_setup_component(
    ...
    """Set up a component for Vioneta Agro.
...
def async_start_setup(
    ...
    :param hass: Vioneta Agro instance
