"""Config flow for the Vioneta Agro Green integration."""
...
class HomeAssistantGreenConfigFlow(ConfigFlow, domain=DOMAIN):
    """Handle a config flow for Vioneta Agro Green."""
    ...
    async def async_step_system(
        ...
        return self.async_create_entry(title="Vioneta Agro Green", data={})


class HomeAssistantGreenOptionsFlow(OptionsFlow):
    """Handle an option flow for Vioneta Agro Green."""
