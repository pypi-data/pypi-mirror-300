...
class AlexaEntity:
    ...
    def description(self) -> str:
        ...
        return f"{description} via Vioneta Agro".translate(TRANSLATION_TABLE)
    ...
    def default_display_categories(self) -> list[str] | None:
        ...
        This can be overridden by the user in the Vioneta Agro configuration.
