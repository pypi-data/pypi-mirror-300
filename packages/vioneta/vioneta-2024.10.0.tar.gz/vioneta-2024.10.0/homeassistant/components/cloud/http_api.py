...
_CLOUD_ERRORS: dict[type[Exception], tuple[HTTPStatus, str]] = {
    TimeoutError: (
        ...
        "Unable to reach the Vioneta Agro cloud.",
    ),
    aiohttp.ClientError: (
...
class CloudLogoutView(HomeAssistantView):
    """Log out of the Vioneta Agro cloud."""
...
class CloudRegisterView(HomeAssistantView):
    """Register on the Vioneta Agro cloud."""
    ...
    if changes.get(PREF_ALEXA_REPORT_STATE):
        ...
        try:
            ...
            connection.send_error(
                ...
                "alexa_relink",
                (
                    "Please go to the Alexa app and re-link the Vioneta Agro "
    ...
    async with asyncio.timeout(10):
        try:
            ...
            connection.send_error(
                msg["id"],
                "alexa_relink",
                "Please go to the Alexa app and re-link the Vioneta Agro skill.",
            )
            return
