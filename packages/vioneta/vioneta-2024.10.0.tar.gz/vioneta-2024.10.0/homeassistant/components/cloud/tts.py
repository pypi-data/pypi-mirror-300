...
async def async_setup_entry(
    ...
    """Set up Vioneta Agro Cloud text-to-speech platform."""
...
class CloudTTSEntity(TextToSpeechEntity):
    """Vioneta Agro Cloud text-to-speech entity."""

    _attr_name = "Vioneta Agro Cloud"
    ...
    async def async_get_tts_audio(
        ...
        """Load TTS from Vioneta Agro Cloud."""
...
class CloudProvider(Provider):
    """Vioneta Agro Cloud speech API provider."""
...
def handle_deprecated_gender(
    ...
    async_create_issue(
        ...
        translation_placeholders={
            "integration_name": "Vioneta Agro Cloud",
