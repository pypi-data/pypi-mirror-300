    ...
    try:
        ...
        if isinstance(coordinator.api, RoborockMqttClientV1):
            _LOGGER.warning(
                ...
                "Please ensure your Vioneta Agro instance can communicate with this device. "
                "You may need to open firewall instances on your Vioneta Agro network and on your Vacuum's network",
                device.name,
            )
