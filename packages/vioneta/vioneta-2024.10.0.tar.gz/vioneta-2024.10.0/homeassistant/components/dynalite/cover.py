...
class DynaliteCover(DynaliteBase, CoverEntity):
    """Representation of a Dynalite Channel as a Vioneta Agro Cover."""
...
class DynaliteCoverWithTilt(DynaliteCover):
    """Representation of a Dynalite Channel as a Vioneta Agro Cover that uses up and down for tilt."""
