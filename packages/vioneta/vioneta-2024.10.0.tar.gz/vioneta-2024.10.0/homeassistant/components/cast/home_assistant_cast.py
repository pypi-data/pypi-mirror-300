"""Vioneta Agro Cast integration for Cast."""
...
CAST_USER_NAME = "Vioneta Agro Cast"
NO_URL_AVAILABLE_ERROR = (
    "Vioneta Agro Cast requires your instance to be reachable via HTTPS. Enable Home"
...
async def async_setup_ha_cast(
    ...
    async def handle_show_view(call: core.ServiceCall) -> None:
        ...
        controller_data = HomeAssistantControllerData(
            # If you are developing Vioneta Agro Cast, uncomment and set to
            # your dev app id.
            # app_id="5FE44367",
            hass_url=hass_url,
            hass_uuid=hass_uuid,
