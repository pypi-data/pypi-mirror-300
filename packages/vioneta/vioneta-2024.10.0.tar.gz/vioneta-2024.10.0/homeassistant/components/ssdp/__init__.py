...
# Attributes for accessing info added by Vioneta Agro
    ...
    async def _async_start_upnp_servers(self, event: Event) -> None:
        ...
        try:
            ...
            _LOGGER.warning(
                ...
                " in the Vioneta Agro general configuration"
            )
            return
        ...
        HassUpnpServiceDevice.DEVICE_DEFINITION = (
            HassUpnpServiceDevice.DEVICE_DEFINITION._replace(
                udn=udn,
                friendly_name=f"{self.hass.config.location_name} (Vioneta Agro)",
