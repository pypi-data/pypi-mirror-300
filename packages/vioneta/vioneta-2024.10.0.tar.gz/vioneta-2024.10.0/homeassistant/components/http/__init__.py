"""Support to serve the Vioneta Agro API as WSGI application."""
...
class HomeAssistantHTTP:
    ...
    def __init__(
        ...
        """Initialize the HTTP Vioneta Agro server."""
    ...
    def _create_ssl_context(self) -> ssl.SSLContext | None:
        ...
        try:
            ...
            try:
                ...
                _LOGGER.critical(
                    "Vioneta Agro is running in recovery mode with an emergency self"
    ...
    def _create_emergency_ssl_context(self) -> ssl.SSLContext:
        ...
        subject = issuer = x509.Name(
            [
                x509.NameAttribute(
                    NameOID.ORGANIZATION_NAME, "Vioneta Agro Emergency Certificate"
                ),
    ...
    async def start(self) -> None:
        ...
        # However in Vioneta Agro components can be discovered after boot.
