...
# These SUPPORT_* constants are deprecated as of Vioneta Agro 2022.5.
...
# These COLOR_MODE_* constants are deprecated as of Vioneta Agro 2022.5.
# Please use the LightEntityFeature enum instead.
...
async def async_setup(hass: HomeAssistant, config: ConfigType) -> bool:  # noqa: C901
    ...
    async def async_handle_light_on_service(  # noqa: C901
        ...
        # Add a warning in Vioneta Agro Core 2024.3 if the brightness is set to an
        # integer.
            ...
            if not self.__color_mode_reported and self.__should_report_light_issue():
                ...
                _LOGGER.warning(
                    (
                        ...
                        "in Vioneta Agro Core 2025.3, please %s"
                    ),
                    self.entity_id,
                    type(self),
                    report_issue,
            ...
            if not self.__color_mode_reported and self.__should_report_light_issue():
                ...
                _LOGGER.warning(
                    (
                        ...
                        "this will stop working in Vioneta Agro Core 2025.3, "
                        "please %s"
                    ),
                    self.entity_id,
                    type(self),
        ...
        if not self.__color_mode_reported and self.__should_report_light_issue():
            ...
            _LOGGER.warning(
                (
                    ...
                    " expected one of %s, this will stop working in Vioneta Agro "
            ...
            if not self.__color_mode_reported and self.__should_report_light_issue():
                ...
                _LOGGER.warning(
                    (
                        ...
                        "working in Vioneta Agro Core 2025.3, please %s"
                    ),
                    self.entity_id,
                    type(self),
                    supported_color_modes,
