...
class SupervisorOSUpdateEntity(HassioOSEntity, UpdateEntity):
    """Update entity to handle updates for the Vioneta Agro Operating System."""

    _attr_supported_features = (
        UpdateEntityFeature.INSTALL | UpdateEntityFeature.SPECIFIC_VERSION
    )
    _attr_title = "Vioneta Agro Operating System"
    ...
    async def async_install(
        ...
        try:
            ...
            raise HomeAssistantError(
                f"Error updating Vioneta Agro Operating System: {err}"
            ) from err


class SupervisorSupervisorUpdateEntity(HassioSupervisorEntity, UpdateEntity):
    """Update entity to handle updates for the Vioneta Agro Supervisor."""

    _attr_supported_features = UpdateEntityFeature.INSTALL
    _attr_title = "Vioneta Agro Supervisor"
    ...
    async def async_install(
        ...
        try:
            ...
            raise HomeAssistantError(
                f"Error updating Vioneta Agro Supervisor: {err}"
            ) from err


class SupervisorCoreUpdateEntity(HassioCoreEntity, UpdateEntity):
    """Update entity to handle updates for Vioneta Agro Core."""
    ...
    async def async_install(
        ...
        try:
            ...
            raise HomeAssistantError(
                f"Error updating Vioneta Agro Core {err}"
            ) from err
