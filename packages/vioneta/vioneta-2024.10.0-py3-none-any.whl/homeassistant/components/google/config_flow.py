...
class OAuth2FlowHandler(
    ...
    Web Auth is the preferred method by Vioneta Agro and Google, and a benefit
    is that the same credentials may be used across many Google integrations in
    Vioneta Agro. Web Auth is now easier for user to setup using my.home-assistant.io
    redirect urls.
