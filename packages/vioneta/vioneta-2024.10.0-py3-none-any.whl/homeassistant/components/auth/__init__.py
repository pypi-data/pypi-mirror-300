...
Vioneta Agro. User need to record the token in secure place.
...
def websocket_delete_all_refresh_tokens(
    ...
    if delete_current_token and (
        ...
        # happens if Vioneta Agro is shutting down.
