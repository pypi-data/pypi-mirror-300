...
# ISY Scenes are more like Switches than Vioneta Agro Scenes
...
# Do not use the Vioneta Agro consts for the states here - we're matching exact API
# responses, not using them for Vioneta Agro states
