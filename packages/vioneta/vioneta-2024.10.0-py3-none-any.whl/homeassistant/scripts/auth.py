"""Script to manage users for the Vioneta Agro auth provider."""
...
def run(args):
    """Handle Vioneta Agro auth provider script."""
    parser = argparse.ArgumentParser(description="Manage Vioneta Agro users")
