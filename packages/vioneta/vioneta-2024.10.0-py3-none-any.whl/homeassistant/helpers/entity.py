...
class EntityDescription(metaclass=FrozenOrThawed, frozen_or_thawed=True):
    """A class that describes Vioneta Agro entities."""
...
class Entity(
    ...
    """An abstract class for Vioneta Agro entities."""
    ...
    # DO NOT OVERWRITE
    # These properties and methods are either managed by Vioneta Agro or they
    ...
    async def async_update_ha_state(self, force_refresh: bool = False) -> None:
        """Update Vioneta Agro with current state of entity.
    ...
    async def async_remove(self, *, force_remove: bool = False) -> None:
        """Remove entity from Vioneta Agro.
...
class ToggleEntity(
    ...
    def toggle(self, **kwargs: Any) -> None:
        ...
        This method will never be called by Vioneta Agro and should not be implemented
        by integrations.
        """
