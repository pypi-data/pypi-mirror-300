...
class NoURLAvailableError(HomeAssistantError):
    """An URL to the Vioneta Agro instance is not available."""
...
def is_hass_url(hass: HomeAssistant, url: str) -> bool:
    """Return if the URL points at this Vioneta Agro instance."""
    parsed = yarl.URL(url)
...
def _get_cloud_url(hass: HomeAssistant, require_current_request: bool = False) -> str:
    """Get external Vioneta Agro Cloud URL of this instance."""
