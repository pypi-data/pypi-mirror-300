...
class Select():
  ...
  def get(self,target_CS_WE,parent_CS_WE=None):
    '''
  ...
  def get_options(self,target_CS_WE,parent_CS_WE=None):
    '''
    ...
    '''
    options = self.__get_options(target_CS_WE,parent_CS_WE)
    return self.__get_option_items(options)
      
  @SelectDeco('geted_options')
  def get_selected_options(self,target_CS_WE,parent_CS_WE=None):
    '''
    @returns {list<dict>}
      [{'value': 'volvo', 'label': '沃尔沃'}]
    '''
    options = self.__get_options(target_CS_WE,parent_CS_WE,'all_selected_options')
    return self.__get_option_items(options)

  @SelectDeco('get_frist_selected_option')
  def get_first_selected_option(self,target_CS_WE,parent_CS_WE=None):
    '''
    @returns {dict}
      {'value': 'volvo', 'label': '沃尔沃'}
    '''
    options = self.__get_options(target_CS_WE,parent_CS_WE,'first_selected_option')
    return self.__get_option_items(options)

  def __get_options(self,target_CS_WE,parent_CS_WE=None,stat=None):
    select = self.get(target_CS_WE,parent_CS_WE)
    if not select:
      return None
  ...
  def select_by_index(self,target_CS_WE,index,parent_CS_WE=None):
    '''
  ...
  def select_by_value(self,target_CS_WE,value,parent_CS_WE=None):
    '''
    Selet multi values
    '''
    select = self.get(target_CS_WE,parent_CS_WE)
  ...
  def select_by_value_or_text(self,target_CS_WE,value,parent_CS_WE=None):
    '''
    Selet multi values
    '''
    web_element = self.__querier.query(target_CS_WE,parent_CS_WE)
  ...
  def select_by_text(self,target_CS_WE,text,parent_CS_WE=None):
    '''
    Returns:
      {None}
    '''
  ...
  def deselect_all(self,target_CS_WE,parent_CS_WE=None):
    '''
  ...
  def deselect_by_index(self,target_CS_WE,index,parent_CS_WE=None):
    '''
    Returns:
      {None}
    '''
  ...
  def deselect_by_value(self,target_CS_WE,value,parent_CS_WE=None):
    '''
    Returns:
      {None}
    '''
  ...
  def deselect_by_text(self,target_CS_WE,text,parent_CS_WE=None):
    '''
    Returns:
      {None}
    '''
  ...
  def is_multiple(self,target_CS_WE,parent_CS_WE=None):
    '''
    Returns:
      {true|None}
    '''
