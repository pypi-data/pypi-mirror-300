...
class Dragger():
  ...
  def move_to_offset(self,target_CS_WE,offset_x,offset_y,parent_CS_WE=None):
    '''
  ...
  def drag_in(self,draggable_target_CS_WE,droppable_target_CS_WE):
    '''
    ...
    '''
    droppable = self.__querier.query(droppable_target_CS_WE)
    draggable = self.__querier.query(draggable_target_CS_WE)
    if droppable and draggable:
      self.__chains.drag_and_drop(draggable,droppable).perform()

  def drag_in_offset(self,draggable_target_CS_WE,droppable_target_CS_WE,offset_x,offset_y):
    '''
  ...
  def drag_to_offset(self,target_CS_WE,offset_x,offset_y,parent_CS_WE=None):
    '''
    Move relative to the current position
    Parameter:
      target_CS_WE {str|WebElement} : The element being moved
  ...
  def drag_to(self,target_CS_WE,x,y,parent_CS_WE=None):
    '''
    ...
    '''
    draggable = self.__querier.query(target_CS_WE,parent_CS_WE)
  ...
  def get_coordinate(self,target_CS_WE):
    '''
