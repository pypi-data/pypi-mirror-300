...
class Mouse():
  ...
  def click(self,target_CS_WE,parent_CS_WE=None):
    '''
    Click and release
    Parameter:
  ...
  def right_click(self,target_CS_WE,parent_CS_WE=None):
    '''
  ...
  def double_click(self,target_CS_WE,parent_CS_WE=None):
    '''
    Double left click
    Parameter:
      target_CS_WE {str | WebElement}
  ...
  def hold(self,target_CS_WE,parent_CS_WE=None):
    '''
    Click and hold
    Parameter:
      target_CS_WE {str | WebElement}
  ...
  def release(self,target_CS_WE,parent_CS_WE=None):
    '''
    Release the hold
    Parameter:
      target_CS_WE {str | WebElement}
  ...
  def move_in(self,target_CS_WE,parent_CS_WE=None):
    '''
  ...
  def move_in_offset(self,target_CS_WE,offset_x=0,offset_y=0,parent_CS_WE=None):
    '''
