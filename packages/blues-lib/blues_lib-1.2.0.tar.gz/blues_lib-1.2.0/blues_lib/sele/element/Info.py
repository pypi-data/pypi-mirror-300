...
class Info():
  ...
  def get_attr(self,target_CS_WE,key,parent_CS_WE=None):
    '''
  ...
  @InfoDeco('get_value')
  def get_value(self,target_CS_WE,parent_CS_WE=None):
    '''
  ...
  @InfoDeco('get_html')
  def get_html(self,target_CS_WE,parent_CS_WE=None):
    '''
  ...
  def get_outer_html(self,target_CS_WE,parent_CS_WE=None):
    web_element = self.__querier.query(target_CS_WE,parent_CS_WE)
    if not web_element:
      return None
  ...
  @InfoDeco('get_text')
  def get_text(self,target_CS_WE,parent_CS_WE=None):
    '''
    Fetching element's text node value
    Parameter:
      target_CS_WE {str|WebElement} : css selector or web_element
  ...
  def get_tag_name(self,target_CS_WE,parent_CS_WE=None):
    '''
  ...
  @InfoKeyDeco('get_css')
  def get_css(self,target_CS_WE,key,parent_CS_WE=None):
    '''
  ...
  @InfoDeco('get_size')
  def get_size(self,target_CS_WE,parent_CS_WE=None):
    '''
  ...
  def get_position(self,target_CS_WE,parent_CS_WE=None):
    '''
