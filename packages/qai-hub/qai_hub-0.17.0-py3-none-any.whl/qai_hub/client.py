...
def _api_call(api_func, *args, **kwargs) -> Any:
    ...
    try:
        ...
        if str(e.args[0].reason) == "too many 503 error responses":
            _raise_internal_api_failure(
                "Qualcomm AI Hub is unavailable right now.", url
            )
        else:
            _raise_internal_api_failure(
                "Qualcomm AI Hub reported errors. "
...
class LinkJob(Job):
    ...
    def modify_sharing(
        ...
        # TODO (#12492)
        raise NotImplementedError("Sharing link jobs is currently not supported.")
...
class Client:
    ...
    def submit_link_job(
        ...
        options:
            Cli-like flag options. This is currently unused.
        ...
        # TODO (#12493): Early-exit on too many models.
