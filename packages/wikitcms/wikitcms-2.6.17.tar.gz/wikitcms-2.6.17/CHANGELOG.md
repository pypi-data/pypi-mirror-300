...
*   [wikitcms-2.6.17.tar.gz](https://files.pythonhosted.org/packages/source/w/wikitcms/wikitcms-2.6.17.tar.gz)

1.  Adapt AMI download page generation for change to message topics
