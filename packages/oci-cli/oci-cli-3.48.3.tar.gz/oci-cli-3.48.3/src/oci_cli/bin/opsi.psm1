...
function GetOciCommandsToLongParams_opsi() {
    $ociCommandsToLongParams = @{
        ...
        'opsi news-reports create' = 'are-child-compartments-included compartment-id content-types day-of-week defined-tags description freeform-tags from-json help locale max-wait-seconds name news-frequency ons-topic-id status wait-for-state wait-interval-seconds'
        ...
        'opsi news-reports update' = 'are-child-compartments-included content-types day-of-week defined-tags description force freeform-tags from-json help if-match locale max-wait-seconds name news-frequency news-report-id ons-topic-id status wait-for-state wait-interval-seconds'
