...
class Configuration:
    ...
    def __init__(
        ...
        *,
        ...
        """Constructor"""
        self._base_path = "https://api.useartifact.ai" if host is None else host
        """Default Base url
        """
    ...
    def to_debug_report(self):
        ...
        return (
            ...
            "SDK Package Version: 2.4.5".format(env=sys.platform, pyversion=sys.version)
        )
