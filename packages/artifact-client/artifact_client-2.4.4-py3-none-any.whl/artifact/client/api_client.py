...
from ..errors import ApiException, ApiValueError
from ..models import T as ApiResponseT, ApiResponse, rest
...
class ApiClient:
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None, cookie=None) -> None:
        ...
        self.user_agent = "OpenAPI-Generator/2.4.4/python"
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(models, klass) if hasattr(models, klass) else getattr(errors, klass)
