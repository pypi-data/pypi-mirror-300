...
class QueryRequest(BaseModel):
    ...
    community_level: Optional[Annotated[int, Field(le=5, strict=True, ge=0)]] = None
    response_type: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["query", "search_type", "community_level", "response_type"]
        ...
        _obj = cls.model_validate(
            {
                ...
                "community_level": obj.get("community_level"),
