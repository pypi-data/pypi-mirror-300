...
class InvocationBreakdown(BaseModel):
    """
    InvocationBreakdown
    """  # noqa: E501
    ...
    total_time: Optional[
        Union[Annotated[float, Field(strict=True, ge=0)], Annotated[int, Field(strict=True, ge=0)]]
    ] = None
    ...
    __properties: ClassVar[List[str]] = ["name", "total_time", "count", "input_tokens", "output_tokens", "num_retries"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of InvocationBreakdown from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of InvocationBreakdown from a dict"""
        if obj is None:
            return None
