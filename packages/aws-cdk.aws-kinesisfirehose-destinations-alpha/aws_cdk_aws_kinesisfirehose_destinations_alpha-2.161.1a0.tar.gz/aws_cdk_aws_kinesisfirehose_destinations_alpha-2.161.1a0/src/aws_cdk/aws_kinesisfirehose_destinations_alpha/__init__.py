...
class CommonDestinationProps:
    def __init__(
        ...
        *,
        ...
        :param logging_config: (experimental) Configuration that determines whether to log errors during data transformation or delivery failures, and specifies the CloudWatch log group for storing error logs. Default: - errors will be logged and a log group will be created for you.
...
class CommonDestinationS3Props:
    def __init__(
        ...
        *,
        ...
        :param buffering_interval: (experimental) The length of time that Firehose buffers incoming data before delivering it to the S3 bucket. Minimum: Duration.seconds(0) Maximum: Duration.seconds(900) Default: Duration.seconds(300)
...
class DisableLogging(
    ...
    '''(experimental) Disables logging for error logs.
