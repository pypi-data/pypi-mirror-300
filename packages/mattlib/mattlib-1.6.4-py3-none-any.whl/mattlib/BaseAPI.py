...
class BaseAPI:
    ...
    def run_with_defaults(self, service_type, use_methods = []) -> List[APIResultType]:
        ...
        if service_type == 'customized':
            for method in filtered_methods:
                rawdata = self.generic_method(method['url_method'],method['url_variables'],method['format'],method['next_link'],method['key_response'])
