...
class ReactivateUserRequest(_message.Message):
    __slots__ = ("user_id", "organization_id", "role_ids", "project_ids", "request_id")
    ...
    request_id: str
    def __init__(self, user_id: _Optional[str] = ..., organization_id: _Optional[str] = ..., role_ids: _Optional[_Iterable[_Union[_role_id_pb2.RoleIdProto, _Mapping]]] = ..., project_ids: _Optional[_Iterable[str]] = ..., request_id: _Optional[str] = ...) -> None: ...
