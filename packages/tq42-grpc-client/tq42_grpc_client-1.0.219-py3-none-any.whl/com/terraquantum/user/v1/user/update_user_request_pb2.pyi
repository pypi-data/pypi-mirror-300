...
class UpdateUserProto(_message.Message):
    __slots__ = ("id", "wizard_finished", "profile", "role_ids", "project_ids", "organization_id")
    ...
    organization_id: str
    def __init__(self, id: _Optional[str] = ..., wizard_finished: bool = ..., profile: _Optional[_Union[UpdateUserProfileProto, _Mapping]] = ..., role_ids: _Optional[_Iterable[_Union[_role_id_pb2.RoleIdProto, _Mapping]]] = ..., project_ids: _Optional[_Iterable[str]] = ..., organization_id: _Optional[str] = ...) -> None: ...
