...
class WaitingUserServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.AddWaitingUser = channel.unary_unary(
                ...
                _registered_method=True)
        self.GetWaitingUser = channel.unary_unary(
                '/com.terraquantum.user.v2.waiting_user.WaitingUserService/GetWaitingUser',
                request_serializer=com_dot_terraquantum_dot_user_dot_v1_dot_waiting__user_dot_get__waiting__user__request__pb2.GetWaitingUserRequest.SerializeToString,
                response_deserializer=com_dot_terraquantum_dot_user_dot_v1_dot_waiting__user_dot_waiting__user__pb2.WaitingUserProto.FromString,
                _registered_method=True)
...
class WaitingUserServiceServicer(object):
    ...
    def GetWaitingUser(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_WaitingUserServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetWaitingUser': grpc.unary_unary_rpc_method_handler(
                    servicer.GetWaitingUser,
                    request_deserializer=com_dot_terraquantum_dot_user_dot_v1_dot_waiting__user_dot_get__waiting__user__request__pb2.GetWaitingUserRequest.FromString,
                    response_serializer=com_dot_terraquantum_dot_user_dot_v1_dot_waiting__user_dot_waiting__user__pb2.WaitingUserProto.SerializeToString,
            ),
    }
...
class WaitingUserService(object):
    ...
    def GetWaitingUser(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/com.terraquantum.user.v2.waiting_user.WaitingUserService/GetWaitingUser',
            com_dot_terraquantum_dot_user_dot_v1_dot_waiting__user_dot_get__waiting__user__request__pb2.GetWaitingUserRequest.SerializeToString,
            com_dot_terraquantum_dot_user_dot_v1_dot_waiting__user_dot_waiting__user__pb2.WaitingUserProto.FromString,
            options,
            channel_credentials,
            insecure,
