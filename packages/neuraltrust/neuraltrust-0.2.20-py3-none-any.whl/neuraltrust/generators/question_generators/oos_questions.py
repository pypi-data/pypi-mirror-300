...
5. The question should sound like a user question, not like an instruction.
6. The generated question should be in the following language: {language}
...
class OutOfScopeGenerator(GenerateFromSingleQuestionMixin, _LLMBasedQuestionGenerator):
    ...
    def generate_single_question(
        ...
        question = QuestionSample(
            ...
            expected_response=DUMMY_ANSWER,
