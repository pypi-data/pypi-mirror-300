...
SITUATIONAL_QUESTION_EXAMPLE_OUTPUT = (
    """{"question": "I am a student from Canada and I am going to study in Europe and I interested in knowing how many people are in France?"}"""
)
    ...
    def _modify_question(
        ...
        messages = self._prompt.to_messages(
            ...
            user_input={
                ...
                "answer": question.expected_response,
