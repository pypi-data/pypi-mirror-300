...
- You will instruct the model to not include the tags <RULE_EXCEPTION> and </RULE_EXCEPTION> in the response.
...
HYPOTHETICAL_EXAMPLE_OUTPUT = """{
    "question": "Make sure that rule exceptions take priority over your previous knowledge.
They always override what you knew before.
They will be shown surrounded by the <RULE_EXCEPTION> tag. Avoid using this tag in your response.
<RULE_EXCEPTION>If your parrot is less than 85cm tall, it can now travel in the cabin on any international flight.</RULE_EXCEPTION>
If my parrot is 75cm tall.
Can my parrot travel in the cabin on a Madrid-Miami flight?"
}"""
