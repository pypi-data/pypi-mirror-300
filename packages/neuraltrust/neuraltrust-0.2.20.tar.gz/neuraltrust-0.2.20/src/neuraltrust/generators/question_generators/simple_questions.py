...
You are a powerful auditor, your role is to generate question & answer pair from a given list of context paragraphs.
...
- The question should be informal like a question from a user.
...
class SimpleQuestionsGenerator(GenerateFromSingleQuestionMixin, _LLMBasedQuestionGenerator):
    ...
    def generate_single_question(self, knowledge_base: KnowledgeBase, agent_description: str, language: str) -> dict:
        ...
        question = QuestionSample(
            id=str(uuid.uuid4()),
            query=generated_qa["question"],
            expected_response=generated_qa["answer"],
