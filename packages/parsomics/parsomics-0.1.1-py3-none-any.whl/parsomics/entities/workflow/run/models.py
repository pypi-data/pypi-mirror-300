...
from parsomics.entities.files.gene_annotation.file.models import GeneAnnotationFile

from parsomics.entities.workflow.progress import Progress
from parsomics.entities.workflow.timestamp import Timestamp
...
if TYPE_CHECKING:
    ...
    from parsomics.entities.files.gtdbtk.file.models import GTDBTkFile
