...
from parsomics.entities.files.gff.file.models import GFFFile
from parsomics.entities.omics.fragment.fragment_type import FragmentType
from parsomics.entities.workflow.source.models import Source, SourceCreate
...
class GFFParser(BaseModel):
    ...
    def _parse_attributes(self, attributes_raw: str) -> dict:
    ...
    def _add_gene_name_to_mapping(self, mapping) -> str | None:
    ...
    def parse(self, engine) -> None:
        ...
        for mapping in mappings:
            ...
            mapping["attributes"] = self._parse_attributes(mapping["attributes_raw"])
            mapping["gene_name"] = self._add_gene_name_to_mapping(mapping)
