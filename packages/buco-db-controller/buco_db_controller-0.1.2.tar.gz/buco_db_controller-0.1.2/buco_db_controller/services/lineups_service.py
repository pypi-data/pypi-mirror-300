...
class LineupsService:
    ...
    def upsert_many_lineups(self, fixture_injuries: dict):
    ...
    def get_team_lineups(self, team_id: int, league_id: int, season: int):
    ...
    def get_league_lineups(self, league_id: int, season: int):
