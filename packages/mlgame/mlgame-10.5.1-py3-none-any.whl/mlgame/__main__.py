...
if __name__ == '__main__':
    ...
    from mlgame.core.process import create_process_of_ai_clients_and_start, create_process_of_ws_and_start, \
        create_process_of_progress_log_and_start, terminate
    ...
    try:
        ...
        if arg_obj.progress_folder:
            # prepare transmitter for game executor
            progress_proc = create_process_of_progress_log_and_start(game_comm, arg_obj.progress_folder,
                                                                     arg_obj.progress_frame_frequency)
        ...
        if arg_obj.is_manual:
            ...
            game_executor = GameExecutor(
                game, game_comm, game_view, sound_controller=sound_controller,
