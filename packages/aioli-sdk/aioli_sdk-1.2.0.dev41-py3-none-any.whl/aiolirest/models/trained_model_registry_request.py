...
"""
    ...
    The version of the OpenAPI document: 1.2.0-dev41
...
class TrainedModelRegistryRequest(BaseModel):
    ...
    endpoint_url: Optional[StrictStr] = Field(default=None, description="The registry endpoint (host): * `s3` - The S3 registry endpoint. Required. * `openllm` - The huggingface.co-compatible endpoint (default https://huggingface.co). * `ngc` - The NVIDIA NGC-compatible api endpoint (default https://api.ngc.nvidia.com). * `pfs` - The required Pachyderm address.", alias="endpointUrl")
