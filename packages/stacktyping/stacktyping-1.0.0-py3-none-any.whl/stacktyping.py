...
class stack:
    ...
    def __init__(self, typing):
        """ Initialize stack. """
        if typing not in [str, int, float, bool, list, dict, tuple, set, stack]:
...
__all__ = ['stack', 'iters', 'stsum', 'update', 'clear', 'ssort', 'sinfo', 'move', 'seek']