...
PyDoc_STRVAR(doc_wxWizard_Create, "Create(parent, id=wx.ID_ANY, title=wx.EmptyString, bitmap=wx.BitmapBundle(), pos=wx.DefaultPosition, style=wx.DEFAULT_DIALOG_STYLE) -> bool\n"
"\n"
