...
PyDoc_STRVAR(doc_wxComboCtrl_SetButtonBitmaps, "SetButtonBitmaps(bmpNormal, pushButtonBg=False, bmpPressed=BitmapBundle(), bmpHover=BitmapBundle(), bmpDisabled=BitmapBundle())\n"
"\n"
...
PyDoc_STRVAR(doc_wxComboCtrl_SetMainControl, "SetMainControl(win)\n"
"\n"
