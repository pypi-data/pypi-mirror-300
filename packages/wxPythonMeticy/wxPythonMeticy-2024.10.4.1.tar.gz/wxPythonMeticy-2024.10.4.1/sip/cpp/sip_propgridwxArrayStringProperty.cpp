...
PyDoc_STRVAR(doc_wxArrayStringProperty_ConvertArrayToString, "ConvertArrayToString(arr, delimiter) -> String\n"
"\n"
...
PyDoc_STRVAR(doc_wxArrayStringProperty_ArrayStringToString, "ArrayStringToString(src, delimiter, flags) -> String\n"
"\n"
