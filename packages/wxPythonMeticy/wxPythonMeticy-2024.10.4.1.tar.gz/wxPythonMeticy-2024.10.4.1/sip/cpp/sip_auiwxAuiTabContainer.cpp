...
PyDoc_STRVAR(doc_wxAuiTabContainer_SetRect, "SetRect(rect, wnd=None)");
...
PyDoc_STRVAR(doc_wxAuiTabContainer_AddButton, "AddButton(id, location, normalBitmap=wx.BitmapBundle(), disabledBitmap=wx.BitmapBundle())");
