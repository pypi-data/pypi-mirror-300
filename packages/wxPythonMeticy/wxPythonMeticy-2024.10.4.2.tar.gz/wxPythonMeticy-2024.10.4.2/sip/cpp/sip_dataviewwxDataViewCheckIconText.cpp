...
PyDoc_STRVAR(doc_wxDataViewCheckIconText_SetCheckedState, "SetCheckedState(state)\n"
"\n"
...
PyDoc_STRVAR(doc_wxDataViewCheckIconText_GetCheckedState, "GetCheckedState() -> CheckBoxState\n"
"\n"
...
PyDoc_STRVAR(doc_wxDataViewCheckIconText, "DataViewCheckIconText(text=wx.EmptyString, icon=wx.BitmapBundle(), checkedState=wx.CHK_UNDETERMINED)\n"
