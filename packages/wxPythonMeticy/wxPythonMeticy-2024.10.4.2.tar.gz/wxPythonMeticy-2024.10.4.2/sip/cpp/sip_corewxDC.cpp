...
PyDoc_STRVAR(doc_wxDC_GetContentScaleFactor, "GetContentScaleFactor() -> double\n"
"\n"
...
PyDoc_STRVAR(doc_wxDC___nonzero__, "__nonzero__() -> int");
...
PyDoc_STRVAR(doc_wxDC__DrawLinesFromBuffer, "_DrawLinesFromBuffer(pyBuff) -> PyObject");
