...
PyDoc_STRVAR(doc_wxDataViewIconText_SetBitmapBundle, "SetBitmapBundle(bitmap)\n"
"\n"
...
PyDoc_STRVAR(doc_wxDataViewIconText, "DataViewIconText(text=wx.EmptyString, bitmap=wx.BitmapBundle())\n"
