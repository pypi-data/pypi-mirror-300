...
def log_error_message(message):
        print(print_red_text("API key is missing or invalid."))
        print(print_red_text("Please set the PROVIDER_API_KEY environment variable.\n"))
        print(print_yellow_text("You can find your API key in the Providers dashboard."))
        print(print_yellow_text("You can change the base URL by setting the BASE_URL environment variable."))
        print(print_blue_text("\nExample: export BASE_URL=https://api.openai.com/v1\n"))
        print(print_green_text("Note: The default base URL is https://api.together.xyz/v1\n"))
        print(print_yellow_text("You can also change the Model ID by setting the MODEL_ID environment variable."))
        print("Example: export MODEL_ID=meta-llama/Meta-Llama-3.1-70B-Instruct-Turbo")
        print(print_yellow_text("For more information, refer to the documentation."))
        print(print_red_text("----------------------------------------------"))
        print(print_blue_text("ENVIRONMENT VARIABLES:"))
        print(print_green_text("PROVIDER_API_KEY: Your OpenAI API key.\nBASE_URL: The base URL for the Providers API.\nMODEL_ID: The ID of the Model to use."))
        print(print_red_text("----------------------------------------------"))
