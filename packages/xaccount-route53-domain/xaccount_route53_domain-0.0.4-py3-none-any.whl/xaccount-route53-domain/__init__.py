...
class CrossRegionAccountSubZone(
    ...
    def setup_common(self, accounts: typing.Sequence[builtins.str]) -> None:
        '''
        :param accounts: -
        '''
        if __debug__:
        ...
        return typing.cast(None, jsii.invoke(self, "setupCommon", [accounts]))
    ...
    def setup_dns(
        ...
        return typing.cast(_aws_cdk_aws_route53_ceddda9d.IPublicHostedZone, jsii.invoke(self, "setupDns", [env_name, config]))
