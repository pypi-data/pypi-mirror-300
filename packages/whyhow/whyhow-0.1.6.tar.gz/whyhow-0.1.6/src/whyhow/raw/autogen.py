...
#   timestamp: 2024-09-09T13:56:44+00:00
#   version: v0.3.39-hotfix-extend-schemas
...
class TriplesCreate(BaseModel):
    ...
    strict_mode: Annotated[
        ...
        Field(
            False,
            description="Strict mode for triple creation. If True, triple validation will be performed. If False, invalid triples will be used to extend the graphs schema.",
            title="Strict Mode",
        ),
    ]
