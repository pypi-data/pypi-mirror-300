...
async def descartes(task):
    try:
        ...
        button_no_position = (1000, 568) #find_target_position(screenshot_path, "No", attempts=15)            
        ...
        screenshot_path = take_screenshot()
        model_descarte_position = find_target_position(screenshot_path, "Modelo", 0, 100, attempts=8)
        ...
        logger.info("Extraindo numero da nota fiscal")
