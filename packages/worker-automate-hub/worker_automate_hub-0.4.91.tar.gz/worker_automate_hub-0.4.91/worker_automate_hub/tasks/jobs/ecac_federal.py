            ...
            try:
                ...
                if items:
                    ...
                    async with async_playwright() as p:
                        ...
                        element_seu_certificado_digital = f'{locator_path}/SeuCertificadoDigital.png'     
                        ...
                        if element_popup_certificate_pos == None:
                            ...
                            try:
                                ...
                                element = pyautogui.locateCenterOnScreen(element_seu_certificado_digital, confidence=0.8)
                                if element:
                                    pyautogui.click(element)
                                    console.print(f"[green] Seu certificado digital encontrado e clicado.[/green]")
                                    await asyncio.sleep(3)
