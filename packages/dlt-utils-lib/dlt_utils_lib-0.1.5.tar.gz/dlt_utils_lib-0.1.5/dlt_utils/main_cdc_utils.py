...
def base_cdc_replication_process(dlt, spark,  table_name: str, files_path: str, bucket_name: str, cdc_data_list_maps: list, bronze_directory: str,time_diff_history_cdc_timestamp: int = 30):

    # parse list with tables for replication
    for table in cdc_data_list_maps:
