...
class PublisherResourceApi(BaseApi):
    ...
    def list_bundles(self, aid: str, rid: str, offset: int = 0, limit: int = 25, type: str = 'NA', order_direction: str = 'asc', order_by: str = 'name', q: str = None, disabled: bool = False, bundle_type: int = None) -> ApiResponse[List[Resource]]:
