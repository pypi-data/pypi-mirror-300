...
def generate(invoices_path, pdfs_path, image_path, product_id, product_name,
    ...
    for filepath in filepaths:
        ...
        pdf.cell(30, 8, txt=str(columns[0]), border=1)
        pdf.cell(70, 8, txt=str(columns[1]), border=1)
        pdf.cell(30, 8, txt=str(columns[2]), border=1)
        pdf.cell(30, 8, txt=str(columns[3]), border=1)
        pdf.cell(30, 8, txt=str(columns[4]), border=1, ln=1)
