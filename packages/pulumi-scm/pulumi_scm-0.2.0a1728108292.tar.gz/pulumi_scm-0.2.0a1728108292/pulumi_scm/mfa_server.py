...
class MfaServerArgs:
    def __init__(__self__, *,
                 mfa_cert_profile: pulumi.Input[str],
    ...
    def mfa_cert_profile(self) -> pulumi.Input[str]:
        """
    ...
    def mfa_cert_profile(self, value: pulumi.Input[str]):
...
class _MfaServerState:
    ...
    @property
    @pulumi.getter(name="mfaCertProfile")
    def mfa_cert_profile(self) -> Optional[pulumi.Input[str]]:
        """
        The MfaCertProfile param.
        """
        return pulumi.get(self, "mfa_cert_profile")
    ...
    @mfa_cert_profile.setter
    def mfa_cert_profile(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "mfa_cert_profile", value)
...
class MfaServer(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="mfaCertProfile")
    def mfa_cert_profile(self) -> pulumi.Output[str]:
        """
        The MfaCertProfile param.
        """
        return pulumi.get(self, "mfa_cert_profile")
