...
@_utilities.lift_output_func(get_service_connection_group_list)
def get_service_connection_group_list_output(folder: Optional[pulumi.Input[Optional[str]]] = None,
                                             limit: Optional[pulumi.Input[Optional[int]]] = None,
                                             name: Optional[pulumi.Input[Optional[str]]] = None,
                                             offset: Optional[pulumi.Input[Optional[int]]] = None,
                                             opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetServiceConnectionGroupListResult]:
    """
    Retrieves a listing of config items.
