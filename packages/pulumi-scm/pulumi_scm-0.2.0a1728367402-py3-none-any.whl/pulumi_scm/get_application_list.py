...
@_utilities.lift_output_func(get_application_list)
def get_application_list_output(device: Optional[pulumi.Input[Optional[str]]] = None,
                                folder: Optional[pulumi.Input[Optional[str]]] = None,
                                limit: Optional[pulumi.Input[Optional[int]]] = None,
                                name: Optional[pulumi.Input[Optional[str]]] = None,
                                offset: Optional[pulumi.Input[Optional[int]]] = None,
                                snippet: Optional[pulumi.Input[Optional[str]]] = None,
                                opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetApplicationListResult]:
    """
    Retrieves a listing of config items.
