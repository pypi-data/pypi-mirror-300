...
def get_authentication_rule_list(device: Optional[str] = None,
    ...
    :param str position: The Position param. String must be one of these: `"pre"`, `"post"`. Default: `"pre"`.
...
@_utilities.lift_output_func(get_authentication_rule_list)
def get_authentication_rule_list_output(device: Optional[pulumi.Input[Optional[str]]] = None,
                                        ...
                                        opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetAuthenticationRuleListResult]:
    """
    Retrieves a listing of config items.
