...
class UrlCategoryArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[str]]] lists: The List param.
        :param pulumi.Input[str] name: The Name param.
        :param pulumi.Input[str] snippet: The Snippet param.
        :param pulumi.Input[str] type: The Type param. String must be one of these: `"URL List"`, `"Category Match"`. Default: `"URL List"`.
        """
...
class UrlCategory(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            snippet: Optional[pulumi.Input[str]] = None,
            tfid: Optional[pulumi.Input[str]] = None,
            type: Optional[pulumi.Input[str]] = None) -> 'UrlCategory':
        """
