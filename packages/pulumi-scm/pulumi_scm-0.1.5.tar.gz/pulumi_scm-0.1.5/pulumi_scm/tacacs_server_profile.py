...
class TacacsServerProfileArgs:
    ...
    def use_single_connection(self) -> Optional[pulumi.Input[bool]]:
        """
    ...
    def use_single_connection(self, value: Optional[pulumi.Input[bool]]):
...
class TacacsServerProfile(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tfid: Optional[pulumi.Input[str]] = None,
            timeout: Optional[pulumi.Input[int]] = None,
            use_single_connection: Optional[pulumi.Input[bool]] = None) -> 'TacacsServerProfile':
        """
    ...
    @property
    @pulumi.getter(name="useSingleConnection")
    def use_single_connection(self) -> pulumi.Output[Optional[bool]]:
        """
        The UseSingleConnection param.
        """
        return pulumi.get(self, "use_single_connection")
