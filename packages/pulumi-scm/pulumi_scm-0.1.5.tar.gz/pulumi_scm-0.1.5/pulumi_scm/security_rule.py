...
class SecurityRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] action: The action to be taken when the rule is matched. String must be one of these: `"allow"`, `"deny"`, `"drop"`, `"reset-client"`, `"reset-server"`, `"reset-both"`.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] applications: The application(s) being accessed.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] categories: The URL categories being accessed.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] destinations: The destination address(es).
        :param pulumi.Input[Sequence[pulumi.Input[str]]] froms: The source security zone(s).
        :param pulumi.Input[Sequence[pulumi.Input[str]]] services: The service(s) being accessed.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] source_users: The source user(s) or group(s).
        :param pulumi.Input[Sequence[pulumi.Input[str]]] sources: The source address(es).
        :param pulumi.Input[Sequence[pulumi.Input[str]]] tos: The destination security zone(s).
        :param pulumi.Input[str] description: The description of the security rule.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] destination_hips: The destination Host Integrity Profile(s).
        :param pulumi.Input[str] device: The Device param.
        :param pulumi.Input[bool] disabled: The state of the security rule. Default: `false`.
        :param pulumi.Input[str] folder: The Folder param.
        :param pulumi.Input[str] log_setting: The external log forwarding profile.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[str]]] tags: The tags associated with the security rule.
        """
...
class SecurityRule(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
            tfid: Optional[pulumi.Input[str]] = None,
            tos: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None) -> 'SecurityRule':
        """
