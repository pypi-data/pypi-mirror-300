...
@_utilities.lift_output_func(get_decryption_rule_list)
def get_decryption_rule_list_output(device: Optional[pulumi.Input[Optional[str]]] = None,
                                    ...
                                    opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetDecryptionRuleListResult]:
    """
    Retrieves a listing of config items.
