...
class DateRules(QuantConnect.Scheduling.BaseScheduleRules):
    ...
    @overload
    def year_end(self, symbol: typing.Union[QuantConnect.Symbol, str], days_offset: int = 0) -> QuantConnect.Scheduling.IDateRule:
        """
    ...
    @overload
    def year_start(self, symbol: typing.Union[QuantConnect.Symbol, str], days_offset: int = 0) -> QuantConnect.Scheduling.IDateRule:
        """
