...
class RNNAttention(nn.Module):
	...
	def fit(self, inputs: torch.Tensor, sequence_lengths: Optional[torch.IntTensor] = None, labels: torch.LongTensor = None):
		logits = self.forward(inputs, sequence_lengths)
