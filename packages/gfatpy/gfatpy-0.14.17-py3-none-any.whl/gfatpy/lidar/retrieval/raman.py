...
def retrieve_backscatter(
    ...
    Parameters:
       ...
       reference (Tuple[float, float], optional): Reference altitude range (default: (8000, 8500)).
    ...
    extinction_profile[extinction_profile < 0] = 0
...
def retrieve_extinction(
    ...
    **kwargs: dict,
    ...
    Args:
        ...
        reference (Tuple[float, float], optional): Aerosol-partile free reference region. Defaults to (8000, 8500).
