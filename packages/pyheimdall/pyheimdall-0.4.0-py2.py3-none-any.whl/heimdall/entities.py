...
from .util import _get_node, _get_nodes, _get_root, _create_node, _create_nodes
...
def createEntity(tree, id, **kwargs):
    ...
    See `heimdall.createAttribute <#heimdall.createAttribute>`_
