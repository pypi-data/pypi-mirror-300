...
async def test_default_value():
    ...
    class LocalisableEntity(neomodantic.AsyncStructuredNode):
        """
...
async def test_array_of_points():
    ...
    class AnotherLocalisableEntity(neomodantic.AsyncStructuredNode):
        """
...
async def test_simple_storage_retrieval():
    ...
    class TestStorageRetrievalProperty(neomodantic.AsyncStructuredNode):
