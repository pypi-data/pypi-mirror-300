#!/usr/bin/env python
"""
.. _neodantic_install_labels:

``neodantic_install_labels``
---------------------------

::

    usage: neodantic_install_labels [-h] [--db bolt://neo4j:neo4j@localhost:7687] <someapp.models/app.py> [<someapp.models/app.py> ...]
    
    Setup indexes and constraints on labels in Neo4j for your neomodantic schema.
    ...
    positional arguments:
      <someapp.models/app.py>
                            python modules or files with neomodantic schema declarations.
...
from neomodantic.scripts.utils import load_python_module_or_file
...
def main():
    ...
    parser.add_argument(
        ...
        type=str,
        nargs="+",
        help="python modules or files with neomodantic schema declarations.",
    )
