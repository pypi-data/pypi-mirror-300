from neomodantic.exceptions import AttemptedCardinalityViolation, CardinalityViolation
from neomodantic.sync_.relationship_manager import (  # pylint:disable=unused-import
    RelationshipManager,
    ZeroOrMore,
)
...
class ZeroOrOne(RelationshipManager):
    ...
    description: str = "zero or one relationship"
...
class OneOrMore(RelationshipManager):
    ...
    description: str = "one or more relationships"
...
class One(RelationshipManager):
    ...
    description: str = "one relationship"
