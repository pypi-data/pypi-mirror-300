...
from neomodantic.properties import AliasProperty, Property
...
class AsyncPropertyManager:
    ...
    def __properties__(self):
        from neomodantic.async_.relationship_manager import AsyncRelationshipManager
    ...
    def defined_properties(cls, aliases=True, properties=True, rels=True):
        from neomodantic.async_.relationship_manager import AsyncRelationshipDefinition
