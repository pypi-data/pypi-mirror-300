...
from neomodantic.exceptions import MultipleNodesReturned
from neomodantic.match_q import Q, QBase
from neomodantic.properties import AliasProperty, ArrayProperty
from neomodantic.sync_.core import StructuredNode, db
from neomodantic.util import INCOMING, OUTGOING
...
def process_filter_args(cls, kwargs):
    ...
    for key, value in kwargs.items():
        ...
        print(cls, cls.__dict__.keys(), prop)
...
class Traversal(BaseSet):
    ...
    :type source: A :class:`~neomodantic.core.StructuredNode` subclass, an
                  instance of such, a :class:`~neomodantic.match.NodeSet` instance
                  or a :class:`~neomodantic.match.Traversal` instance.
