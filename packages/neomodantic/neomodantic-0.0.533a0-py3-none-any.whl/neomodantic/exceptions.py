class NeomodelException(Exception):
    """
    A base class that identifies all exceptions raised by :mod:`neomodantic`.
    """
...
class RelationshipClassNotDefined(ModelDefinitionException):
    ...
    def __str__(self):
        ...
        return f"""
            ...
            Otherwise, neomodantic will not be able to determine which relationship model to resolve into.
        """
...
class DoesNotExist(NeomodelException):
    ...
    belongs to. It is set by :class:`~neomodantic.core.NodeMeta`.
    """
