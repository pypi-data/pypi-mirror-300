...
Example:
    ...
    >>> from neomodantic.async_ import db
    >>> from neomodantic.integration.numpy import to_nparray
...
try:
    ...
    warn(
        "The neomodantic.integration.numpy module expects numpy to be installed "
