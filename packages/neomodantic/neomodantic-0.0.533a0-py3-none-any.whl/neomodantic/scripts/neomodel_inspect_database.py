"""
.. _neodantic_inspect_database:

``neodantic_inspect_database``
-----------------------------

::

    usage: neodantic_inspect_database [-h] [--db bolt://neo4j:neo4j@localhost:7687] [--write-to <someapp/models.py> ...]
...
def parse_imports():
    ...
    if IMPORTS:
        ...
        imports = f"from neomodantic import {', '.join(IMPORTS)}\n" + special_imports
    return imports
