"""
.. _neodantic_generate_diagram:

``neodantic_generate_diagram``
-----------------------------

::

    usage: _neodantic_generate_diagram [-h] [--file-type <arrows|puml>] [--write-to-dir <someapp/diagrams> ...]
...
from neomodantic.contrib import AsyncSemiStructuredNode, SemiStructuredNode
from neomodantic.contrib.spatial_properties import PointProperty
from neomodantic.scripts.utils import load_python_module_or_file, recursive_list_classes
