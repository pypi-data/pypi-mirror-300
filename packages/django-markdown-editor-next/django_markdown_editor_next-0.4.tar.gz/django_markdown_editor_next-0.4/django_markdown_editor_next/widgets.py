...
class MarkdownEditorWidget(Textarea):
    template_name = 'django_markdown_editor_next/templates/django_markdown_editor_next/widget.html'
    ...
    class Media:
        css = {
            'all': ('django_markdown_editor_next/static/django_markdown_editor_next/css/markdown_editor.css',)
        }
        js = (
            'django_markdown_editor_next/static/django_markdown_editor_next/js/markdown_editor.js',
