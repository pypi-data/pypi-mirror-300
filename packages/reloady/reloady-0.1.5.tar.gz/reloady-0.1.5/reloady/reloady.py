...
class Reloady(threading.Thread):  # Changed class name from SourceChangeMonitor to Reloady
	...
	# Here, we deliberately exclude files beginning with a dot (.)
        ...
        def display_help(self) -> None:
                """
                Display usage information for the Reloady script.
                """
                help_text = """
                Usage: Reloady [options]
