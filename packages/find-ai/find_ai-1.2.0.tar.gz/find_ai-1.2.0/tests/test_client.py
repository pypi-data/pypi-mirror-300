...
from find_ai import FindAI, AsyncFindAI, APIResponseValidationError
...
def _get_open_connections(client: FindAI | AsyncFindAI) -> int:
...
class TestFindAI:
            ...
            for frame in diff.traceback:
                if any(
                    ...
                    for fragment in [
                        ...
                        "find_ai/_legacy_response.py",
                        "find_ai/_response.py",
    ...
    def test_multipart_repeating_array(self, client: FindAI) -> None:
        request = client._build_request(
    ...
    def test_base_url_trailing_slash(self, client: FindAI) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: FindAI) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: FindAI) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    @mock.patch("find_ai._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
    def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter) -> None:
        respx_mock.get("/v1/searches/id").mock(side_effect=httpx.TimeoutException("Test timeout error"))

        with pytest.raises(APITimeoutError):
            self.client.get(
                "/v1/searches/id", cast_to=httpx.Response, options={"headers": {RAW_RESPONSE_HEADER: "stream"}}
            )
    ...
    def test_retrying_status_errors_doesnt_leak(self, respx_mock: MockRouter) -> None:
        respx_mock.get("/v1/searches/id").mock(return_value=httpx.Response(500))
    ...
    @mock.patch("find_ai._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
    def test_retries_taken(self, client: FindAI, failures_before_success: int, respx_mock: MockRouter) -> None:
        ...
        respx_mock.get("/v1/searches/id").mock(side_effect=retry_handler)

        response = client.searches.with_raw_response.retrieve("id")
    ...
    def test_omit_retry_count_header(
        self, client: FindAI, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = client.with_options(max_retries=4)
        ...
        response = client.searches.with_raw_response.retrieve("id", extra_headers={"x-stainless-retry-count": Omit()})
    ...
    def test_overwrite_retry_count_header(
        ...
        response = client.searches.with_raw_response.retrieve("id", extra_headers={"x-stainless-retry-count": "42"})
...
class TestAsyncFindAI:
    ...
    def test_multipart_repeating_array(self, async_client: AsyncFindAI) -> None:
    ...
    def test_base_url_trailing_slash(self, client: AsyncFindAI) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AsyncFindAI) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AsyncFindAI) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_retries_taken(
        self, async_client: AsyncFindAI, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        ...
        response = await client.searches.with_raw_response.retrieve("id")
    ...
    async def test_omit_retry_count_header(
        ...
        response = await client.searches.with_raw_response.retrieve(
