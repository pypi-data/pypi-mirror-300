...
def _uniffi_check_api_checksums(lib):
    ...
    if lib.uniffi_breez_sdk_liquid_bindings_checksum_func_default_config() != 20808:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
...
class Config:
    liquid_electrum_url: "str";bitcoin_electrum_url: "str";mempoolspace_url: "str";working_dir: "str";network: "LiquidNetwork";payment_timeout_sec: "int";zero_conf_min_fee_rate_msat: "int";zero_conf_max_amount_sat: "typing.Optional[int]";breez_api_key: "typing.Optional[str]";

    @typing.no_type_check
    def __init__(self, liquid_electrum_url: "str", bitcoin_electrum_url: "str", mempoolspace_url: "str", working_dir: "str", network: "LiquidNetwork", payment_timeout_sec: "int", zero_conf_min_fee_rate_msat: "int", zero_conf_max_amount_sat: "typing.Optional[int]", breez_api_key: "typing.Optional[str]"):
    ...
    def __str__(self):
        return "Config(liquid_electrum_url={}, bitcoin_electrum_url={}, mempoolspace_url={}, working_dir={}, network={}, payment_timeout_sec={}, zero_conf_min_fee_rate_msat={}, zero_conf_max_amount_sat={}, breez_api_key={})".format(self.liquid_electrum_url, self.bitcoin_electrum_url, self.mempoolspace_url, self.working_dir, self.network, self.payment_timeout_sec, self.zero_conf_min_fee_rate_msat, self.zero_conf_max_amount_sat, self.breez_api_key)
...
class ListPaymentsRequest:
    filters: "typing.Optional[typing.List[PaymentType]]";from_timestamp: "typing.Optional[int]";to_timestamp: "typing.Optional[int]";offset: "typing.Optional[int]";limit: "typing.Optional[int]";

    @typing.no_type_check
    def __init__(self, filters: "typing.Optional[typing.List[PaymentType]]" = _DEFAULT, from_timestamp: "typing.Optional[int]" = _DEFAULT, to_timestamp: "typing.Optional[int]" = _DEFAULT, offset: "typing.Optional[int]" = _DEFAULT, limit: "typing.Optional[int]" = _DEFAULT):
    ...
    def __str__(self):
        return "ListPaymentsRequest(filters={}, from_timestamp={}, to_timestamp={}, offset={}, limit={})".format(self.filters, self.from_timestamp, self.to_timestamp, self.offset, self.limit)
...
class PaymentDetails:
    ...
    # Each enum variant is a nested class of the enum itself.
    class LIGHTNING:
        swap_id: "str";description: "str";preimage: "typing.Optional[str]";bolt11: "typing.Optional[str]";refund_tx_id: "typing.Optional[str]";refund_tx_amount_sat: "typing.Optional[int]";

        @typing.no_type_check
        def __init__(self,swap_id: "str", description: "str", preimage: "typing.Optional[str]", bolt11: "typing.Optional[str]", refund_tx_id: "typing.Optional[str]", refund_tx_amount_sat: "typing.Optional[int]"):
        ...
        def __str__(self):
            return "PaymentDetails.LIGHTNING(swap_id={}, description={}, preimage={}, bolt11={}, refund_tx_id={}, refund_tx_amount_sat={})".format(self.swap_id, self.description, self.preimage, self.bolt11, self.refund_tx_id, self.refund_tx_amount_sat)
...
def default_config(network: "LiquidNetwork") -> "Config":
    
    return _UniffiConverterTypeConfig.lift(_rust_call(_UniffiLib.uniffi_breez_sdk_liquid_bindings_fn_func_default_config,
