...
class UnityPredictCli:
    ...
    def _deployEngineOnUpt(self, engineName: str, engineId: str, uptProfile: str = "default", uptEnv: str = "dev", permitTimeDiff: int = 20):
            ...
            try:
                ...
                if deployStat.casefold() == "ready":
                    ...
                    if ((endTime - startTime) >= permitTimeDiffSec):
                        print (f"Exceeded configured time of {permitTimeDiff} Minutes! Terminating deploy process!")
                        break
                    ...
                    print (f"Invalid deploy status received: {deployStat}")
                    break
        ...
        print (f"Engine {engineName} deployment Error!")
        return Ret.ERROR
