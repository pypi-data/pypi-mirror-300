...
from .utils import full_feed , bidask_feed , bar_feed , greek_feed , tick_feed , min_feed, TouchlineData
            ...
            if self.parent_app.full_feed:
                ...
                if 'trade' in msg_keys:
                    ...
                    if 'bidask' in msg_keys:
                        ...
                        bid_ask = bidask_feed( raw_tick=msg['bidaskL2'] , symbol=self.symbol_id_map[msg['bidask'][0]] , level = "L2" )
                    self.bidask_callback( bid_ask ) if self.bidask_callback else None
