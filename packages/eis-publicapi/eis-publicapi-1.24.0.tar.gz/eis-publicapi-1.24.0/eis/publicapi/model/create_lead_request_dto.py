...
class CreateLeadRequestDto(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            partner_code (str): An optional partner code to establish a link between a lead and a partner.     It must be sent together with the partner role code.     It will be validated regardless of the value of the 'validate' flag.. [optional]  # noqa: E501
            partner_role_code (str): An optional partner role code to establish a link between a lead and a partner.     It must be sent together with the partner code.     It will be validated regardless of the value of the 'validate' flag.. [optional]  # noqa: E501
        """
