...
class Scientist:
    ...
    def _get_gdoc_content(self, doc_id: str) -> str:
        ...
        return convert_to_markdown(doc['body']['content'])
    ...
    def check_citiations(self,
        ...
        for row in rows:
            ...
            for citation in citations:
                ...
                matched = fuzzy_find_in_text(citation, input_text)
    ...
    def check_citiations_google_sheet(self,
                                      sheet_key: str,
                                      output_field: str,
                                      input_fields: list[str] = [],
                                      rows: str = ':',
        ...
        self.check_citiations(data, output_field, input_fields, rows)
