...
def root(context, missing=missing):
    ...
    pass
    if t_1(environment.getattr((undefined(name='hardware') if l_0_hardware is missing else l_0_hardware), 'port_groups')):
        pass
        yield '!\n'
        for l_1_port_group in environment.getattr((undefined(name='hardware') if l_0_hardware is missing else l_0_hardware), 'port_groups'):
            _loop_vars = {}
            pass
            if t_1(environment.getattr(l_1_port_group, 'select')):
                pass
...
blocks = {}
debug_info = '7=18&9=21&10=24&11=27&15=32&17=35&19=37&21=40&22=43&23=46'