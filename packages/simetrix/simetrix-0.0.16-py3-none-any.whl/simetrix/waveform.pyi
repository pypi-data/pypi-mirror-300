...
Provides waveform specific functionality for SIMetrix/SIMPLIS Python integration. Accessed via a
`simetrix.Graph` object, this subpackage provides implementations for graph objects
including curve data.
"""
