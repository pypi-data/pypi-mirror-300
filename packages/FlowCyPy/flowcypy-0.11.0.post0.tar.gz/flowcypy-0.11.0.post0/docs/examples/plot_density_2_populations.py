...
from FlowCyPy.units import particle, milliliter, nanometer, refractive_index_unit, second, micrometer, millisecond, meter
...
scatterer = Scatterer(medium_refractive_index=1.33)  # Medium refractive index: 1.33
...
scatterer.add_population(
    ...
    refractive_index=distribution.Normal(
        ...
        std_dev=0.05 * refractive_index_unit # Standard deviation: 0.05 refractive index units
    )
)
...
source = Source(
    numerical_aperture=0.3,                  # Numerical aperture of the laser: 0.3
