...
from FlowCyPy.units import particle, milliliter, nanometer, refractive_index_unit

# Initialize scatterer with a medium refractive index
scatterer = Scatterer(medium_refractive_index=1.33)  # Medium refractive index of 1.33 (water)
...
scatterer.add_population(
    ...
    refractive_index=distribution.Normal(
        ...
        std_dev=0.02 * refractive_index_unit # Standard deviation: 0.02 refractive index units
    )
)
...
scatterer.add_population(
    ...
    refractive_index=distribution.Normal(
        mean=1.45 * refractive_index_unit,   # Mean refractive index: 1.45
        std_dev=0.02 * refractive_index_unit # Standard deviation: 0.02 refractive index units
    )
)
...
scatterer.add_population(
    ...
    refractive_index=distribution.Normal(
        mean=1.43 * refractive_index_unit,    # Mean refractive index: 1.43
        std_dev=0.02 * refractive_index_unit  # Standard deviation: 0.02 refractive index units
    )
)
...
from FlowCyPy.units import milliwatt, nanometer

# Set up the laser source parameters
source = Source(
    numerical_aperture=0.3,               # Laser numerical aperture: 0.3
...
cytometer.add_detector(
    ...
    numerical_aperture=1.2,                 # Detector numerical aperture: 1.2
