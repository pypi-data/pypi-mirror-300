...
class FlowCell:
    ...
    def validate_flow_speed(cls, value):
        """
        Validates that the flow speed is provided in meter per second.

        Args:
            value (Quantity): The flow speed to validate.

        Returns:
            Quantity: The flow speed frequency.
    ...
    def validate_flow_area(cls, value):
        """
        Validates that the flow area is provided in hertz.

        Args:
            value (Quantity): The flow area to validate.

        Returns:
            Quantity: The validated flow area.
    ...
    def validate_run_time(cls, value):
        ...
        Args:
            value (Quantity): The total time to validate.

        Returns:
            Quantity: The validated total time.
