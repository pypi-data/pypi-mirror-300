...
const index$1 = require('./index-30556617.js');
const workflowSteps = require('./workflow-steps-c4c8ac06.js');
...
const Root = class {
    ...
    render() {
        return [
            index.h("limel-flex-container", { key: 'fbeb6317b6240426b71f28d92e65c463234d18e5', class: "actionpad-container" }, index.h("button", { key: '803aa1e17fb61f4d1a5110d41aa8122069e7d622', class: "getaccept-button", onClick: this.openDialog }, index.h("img", { key: '3d5cd8e96f36e574d4e43c640c7268f7ce8c350b', src: "https://static-vue-rc.getaccept.com/img/integrations/logo_only.png" }), index.h("span", { key: '03cb3179518ca8ddeae70ffa2c7503698fea5cf2', class: "button-text" }, "Send document"), this.renderDocumentCount(!!this.session))),
            index.h("limel-dialog", { key: '1c9838054bd8cb206070a52e7b9738710f8bae1d', open: this.isOpen, closingActions: { escapeKey: true, scrimClick: false }, onClose: () => {
                    this.isOpen = false;
                }, class: { aside: this.checkIsAside() } }, index.h("div", { key: '287204612d9e1011ebd778fcdbc5ccb38886344c', class: "ga-top-bar" }, this.renderLogo(this.showWorkflow()), index.h("limel-icon", { key: '4be4bc4dbeb583b1845bae71aa699afa28016ded', class: "close", name: "cancel", size: "small", onClick: () => {
                    this.isOpen = false;
                } }), (() => {
            ...
            })()), index.h("div", { key: 'd3cd2c6dee77432ded9b2d228518a8df4bd553bf', class: "ga-body" }, this.renderLayout()), index.h("div", { key: '92baf0e4e5394361ad2e9c38bbcc80897f6771f3', class: "ga-version" }, index.h("span", { key: '8d00157e0e0a8a42e54a69780a8f8250f5be3e24' }, "Version: 1.3.8")), index.h("limel-button-group", { key: '16ff4873b882c1b9813c9d6d2177b337c47691be', slot: "button" }, index.h("limel-button", { key: '5ce4f3ff693d49facd59968a2dc244f22c8d9121', label: "Cancel", onClick: () => {
                    this.isOpen = false;
                } })), index.h("error-message", { key: '52ea3ebab0893a3de62ea112a309bcc2fbadcac5', error: this.errorMessage })),
        ];
    }
    checkIsAside() {
...
//# sourceMappingURL=lwc-getaccept-root.cjs.entry.js.map