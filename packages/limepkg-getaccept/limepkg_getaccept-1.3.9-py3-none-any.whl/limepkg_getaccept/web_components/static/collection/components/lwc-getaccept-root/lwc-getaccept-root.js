...
export class Root {
    ...
    render() {
        return [
            ...
            })()), h("div", { key: 'd3cd2c6dee77432ded9b2d228518a8df4bd553bf', class: "ga-body" }, this.renderLayout()), h("div", { key: '92baf0e4e5394361ad2e9c38bbcc80897f6771f3', class: "ga-version" }, h("span", { key: '8d00157e0e0a8a42e54a69780a8f8250f5be3e24' }, "Version: 1.3.8")), h("limel-button-group", { key: '16ff4873b882c1b9813c9d6d2177b337c47691be', slot: "button" }, h("limel-button", { key: '5ce4f3ff693d49facd59968a2dc244f22c8d9121', label: "Cancel", onClick: () => {
                    this.isOpen = false;
                } })), h("error-message", { key: '52ea3ebab0893a3de62ea112a309bcc2fbadcac5', error: this.errorMessage })),
        ];
    }
    checkIsAside() {
