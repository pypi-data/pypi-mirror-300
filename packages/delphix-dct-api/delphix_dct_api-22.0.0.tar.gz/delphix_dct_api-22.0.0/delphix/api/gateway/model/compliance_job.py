...
class ComplianceJob(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            connector_username (str, none_type): The username of the Connector used by the ComplianceJob (Standard Job only). For hyperscale jobs, see the connector of the dataset.. [optional]  # noqa: E501
            connector_password (str, none_type): The password of the Connector used by the ComplianceJob (Standard Job only). For hyperscale jobs, see the connector of the dataset.. [optional]  # noqa: E501
            ...
            on_the_fly_source_connector_username (str, none_type): The username of the source Connector used by the on-the-fly job (Standard Job only).. [optional]  # noqa: E501
            on_the_fly_source_connector_password (str, none_type): The password of the source Connector used by the on-the-fly job (Standard Job only).. [optional]  # noqa: E501
