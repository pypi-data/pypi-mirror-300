    ...
    def __init__(self, api_client=None):
        ...
        def __upgrade_oracle_dsource(
            ...
            **kwargs
            ...
            Keyword Args:
                upgrade_oracle_dsource_parameters (UpgradeOracleDsourceParameters): The new data to upgrade an Oracle dSource.. [optional]
                _return_http_data_only (bool): response data without head status
                    code and headers. Default is True.
                _preload_content (bool): if False, the urllib3.HTTPResponse object
                    will be returned without reading/decoding response data.
        ...
        self.upgrade_oracle_dsource = _Endpoint(
            ...
            params_map={
                'all': [
                    'dsource_id',
                    'upgrade_oracle_dsource_parameters',
                ],
                'required': [
                    'dsource_id',
                ],
            ...
            root_map={
                ...
                'openapi_types': {
                    'dsource_id':
                        (str,),
                    'upgrade_oracle_dsource_parameters':
                        (UpgradeOracleDsourceParameters,),
                },
                'attribute_map': {
                    'dsource_id': 'dsourceId',
                },
                'location_map': {
                    'dsource_id': 'path',
                    'upgrade_oracle_dsource_parameters': 'body',
                },
                'collection_format_map': {
                }
            },
