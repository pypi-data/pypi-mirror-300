from gsession import parsec_setup  # Pour configurer Parsec
from gsession import session_setup  # Pour préparer la session (déplacer des dossiers et créer des liens symboliques)
from gsession import gnome_favorite_apps_setup  # Pour définir les applications favorites dans GNOME
from gsession import launch_chrome_and_vscode  # Pour lancer Chrome et VSCode
from gsession import ssh_key_maknager # Pour gérer les clés SSH
