...
_release_version: str = '0.4.34'

# The following line is overwritten by build scripts in distributions &
# releases. Do not modify this manually, or jax/jaxlib build will fail.
_git_hash: str = 'affba367c5533df8900e32cbc3d31ca92dd1c1ea'
...
def _write_version(fname: str) -> None:
  ...
  old_version_string = "_release_version: str = '0.4.34'"
  ...
  if githash:
    old_githash_string = "_git_hash: str = 'affba367c5533df8900e32cbc3d31ca92dd1c1ea'"
