...
def read_ptx_sreg_ntid_x(res, *, range=None, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(BlockDimXOp(res=res, range=range, loc=loc, ip=ip))
...
def read_ptx_sreg_ntid_y(res, *, range=None, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(BlockDimYOp(res=res, range=range, loc=loc, ip=ip))
...
def read_ptx_sreg_ntid_z(res, *, range=None, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(BlockDimZOp(res=res, range=range, loc=loc, ip=ip))
...
def read_ptx_sreg_ctaid_x(res, *, range=None, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(BlockIdXOp(res=res, range=range, loc=loc, ip=ip))
...
def read_ptx_sreg_ctaid_y(res, *, range=None, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(BlockIdYOp(res=res, range=range, loc=loc, ip=ip))
...
def read_ptx_sreg_ctaid_z(res, *, range=None, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(BlockIdZOp(res=res, range=range, loc=loc, ip=ip))
...
def read_ptx_sreg_cluster_ctaid_x(res, *, range=None, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(BlockInClusterIdXOp(res=res, range=range, loc=loc, ip=ip))
...
def read_ptx_sreg_cluster_ctaid_y(res, *, range=None, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(BlockInClusterIdYOp(res=res, range=range, loc=loc, ip=ip))
...
def read_ptx_sreg_cluster_ctaid_z(res, *, range=None, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(BlockInClusterIdZOp(res=res, range=range, loc=loc, ip=ip))
...
def breakpoint(*, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(Breakpoint(loc=loc, ip=ip))
...
def read_ptx_sreg_cluster_nctarank(res, *, range=None, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(ClusterDim(res=res, range=range, loc=loc, ip=ip))
...
def read_ptx_sreg_cluster_nctaid_x(res, *, range=None, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(ClusterDimBlocksXOp(res=res, range=range, loc=loc, ip=ip))
...
def read_ptx_sreg_cluster_nctaid_y(res, *, range=None, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(ClusterDimBlocksYOp(res=res, range=range, loc=loc, ip=ip))
...
def read_ptx_sreg_cluster_nctaid_z(res, *, range=None, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(ClusterDimBlocksZOp(res=res, range=range, loc=loc, ip=ip))
...
def read_ptx_sreg_nclusterid_x(res, *, range=None, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(ClusterDimXOp(res=res, range=range, loc=loc, ip=ip))
...
def read_ptx_sreg_nclusterid_y(res, *, range=None, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(ClusterDimYOp(res=res, range=range, loc=loc, ip=ip))
...
def read_ptx_sreg_nclusterid_z(res, *, range=None, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(ClusterDimZOp(res=res, range=range, loc=loc, ip=ip))
...
def read_ptx_sreg_cluster_ctarank(res, *, range=None, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(ClusterId(res=res, range=range, loc=loc, ip=ip))
...
def read_ptx_sreg_clusterid_x(res, *, range=None, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(ClusterIdXOp(res=res, range=range, loc=loc, ip=ip))
...
def read_ptx_sreg_clusterid_y(res, *, range=None, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(ClusterIdYOp(res=res, range=range, loc=loc, ip=ip))
...
def read_ptx_sreg_clusterid_z(res, *, range=None, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(ClusterIdZOp(res=res, range=range, loc=loc, ip=ip))
...
def read_ptx_sreg_nctaid_x(res, *, range=None, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(GridDimXOp(res=res, range=range, loc=loc, ip=ip))
...
def read_ptx_sreg_nctaid_y(res, *, range=None, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(GridDimYOp(res=res, range=range, loc=loc, ip=ip))
...
def read_ptx_sreg_nctaid_z(res, *, range=None, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(GridDimZOp(res=res, range=range, loc=loc, ip=ip))
...
def read_ptx_sreg_laneid(res, *, range=None, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(LaneIdOp(res=res, range=range, loc=loc, ip=ip))
...
def read_ptx_sreg_tid_x(res, *, range=None, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(ThreadIdXOp(res=res, range=range, loc=loc, ip=ip))
...
def read_ptx_sreg_tid_y(res, *, range=None, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(ThreadIdYOp(res=res, range=range, loc=loc, ip=ip))
...
def read_ptx_sreg_tid_z(res, *, range=None, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(ThreadIdZOp(res=res, range=range, loc=loc, ip=ip))
...
def read_ptx_sreg_warpsize(res, *, range=None, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(WarpSizeOp(res=res, range=range, loc=loc, ip=ip))
