...
class NamedComputationOp(_ods_ir.OpView):
  ...
  def __init__(self, result, name, operands_, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
def named_computation(result, name, operands_, *, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(NamedComputationOp(result=result, name=name, operands_=operands_, loc=loc, ip=ip))
