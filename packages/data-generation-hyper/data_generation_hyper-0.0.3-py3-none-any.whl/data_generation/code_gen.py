...
from data_generation.code_generator.prompts.prompt_list_and_probabilities import prompt_list, probabilities
from data_generation.code_generator.dataframe_generation.get_seed import get_seed
from data_generation.code_generator.helpers.generator_helper import fun, problem_text, solution_text
from data_generation.code_generator.helpers.save_batches import save_batch_result_and_concat
...
class code_generator:
    ...
    def __init__(self, custom_prompts : List[str] = [None, None],
        ...
        #default values of some parameters are taken from a config json file
        path = r'code_generator\config\arguments.json'
