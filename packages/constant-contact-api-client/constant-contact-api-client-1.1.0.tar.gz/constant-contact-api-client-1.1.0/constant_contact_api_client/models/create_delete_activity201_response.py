...
class CreateDeleteActivity201Response(BaseModel):
    """
    ...
    status: Optional[CreateDeleteActivity201ResponseStatus] = None
    links: Optional[CreateDeleteActivity201ResponseLinks] = Field(default=None, alias="_links")
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of CreateDeleteActivity201Response from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of CreateDeleteActivity201Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "status": CreateDeleteActivity201ResponseStatus.from_dict(obj.get("status")) if obj.get("status") is not None else None,
            "_links": CreateDeleteActivity201ResponseLinks.from_dict(obj.get("_links")) if obj.get("_links") is not None else None
        })
        return _obj
