...
class CreateOrUpdateContactCustomField(BaseModel):
    ...
    """ # noqa: E501
    custom_field_id: Optional[StrictStr] = Field(default=None, description="The unique ID for the <code>custom_field</code>.")
    value: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="The value of the <code>custom_field</code>.")
