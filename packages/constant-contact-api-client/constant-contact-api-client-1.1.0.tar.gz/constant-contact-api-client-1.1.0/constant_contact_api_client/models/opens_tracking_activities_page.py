...
class OpensTrackingActivitiesPage(BaseModel):
    ...
    """ # noqa: E501
    tracking_activities: List[GetEmailOpensReport200ResponseTrackingActivitiesInner] = Field(description="Lists contacts that opened the specified <code>campaign_activity_id</code>.")
