...
class GetAllSegments200ResponseSegmentsInner(BaseModel):
    """
    ...
    edited_at: Optional[datetime] = Field(default=None, description="The system generated date and time that the segment's <code>name</code> or <code>segment_criteria</code> was last updated (ISO-8601 format).")
