...
class GetEmailSendsReport200Response(BaseModel):
    ...
    """ # noqa: E501
    tracking_activities: List[GetEmailSendsReport200ResponseTrackingActivitiesInner] = Field(description="Lists the contacts to which the email campaign activity (<code>campaign_activity_id</code>) was sent.")
