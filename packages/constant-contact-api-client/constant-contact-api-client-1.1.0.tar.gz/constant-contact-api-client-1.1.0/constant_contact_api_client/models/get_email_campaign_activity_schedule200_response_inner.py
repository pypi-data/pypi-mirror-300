...
class GetEmailCampaignActivitySchedule200ResponseInner(BaseModel):
    ...
    """ # noqa: E501
    scheduled_date: Optional[datetime] = Field(default=None, description="The date when Constant Contact will send the email campaign activity to contacts in ISO-8601 format. For example, <code>2022-05-17</code> and <code>2022-05-17T16:37:59.091Z</code> are valid dates.")
