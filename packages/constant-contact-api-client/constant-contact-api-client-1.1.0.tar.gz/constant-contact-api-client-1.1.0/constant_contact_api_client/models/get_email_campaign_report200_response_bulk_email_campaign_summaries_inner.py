...
class GetEmailCampaignReport200ResponseBulkEmailCampaignSummariesInner(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of GetEmailCampaignReport200ResponseBulkEmailCampaignSummariesInner from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of GetEmailCampaignReport200ResponseBulkEmailCampaignSummariesInner from a dict"""
        if obj is None:
            return None
