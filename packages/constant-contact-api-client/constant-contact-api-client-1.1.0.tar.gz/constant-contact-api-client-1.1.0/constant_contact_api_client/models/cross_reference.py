...
class CrossReference(BaseModel):
    ...
    campaign_id: Optional[StrictStr] = Field(default=None, description="<p>Identifies a campaign in the V3 API. In the V3 API, each campaign contains one or more activities. For more information, see <a href=\"/api_guide/v3_v2_email_campaign_deltas.html\" target_\"blank\">V3 Email Campaign Resource Changes<a/>.<p>")
    campaign_activity_id: Optional[StrictStr] = Field(default=None, description="<p>Identifies a campaign activity in the V3 API. In the V3 API, each campaign contains one or more activities. Email type activities represent the detailed information in an email and contain properties like <code>from_email</code> and <code>from_name</code>. For more information, see <a href=\"/api_guide/v3_v2_email_campaign_deltas.html\" target_\"blank\">V3 Campaign Resource Changes<a/>.<p>")
