...
class GetAllEmailCampaigns200ResponseCampaignsInner(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["campaign_id", "created_at", "current_status", "name", "type", "type_code", "updated_at"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of GetAllEmailCampaigns200ResponseCampaignsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of GetAllEmailCampaigns200ResponseCampaignsInner from a dict"""
        if obj is None:
            return None
