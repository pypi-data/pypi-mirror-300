...
class DidNotOpensTrackingActivitiesPage(BaseModel):
    """
    DidNotOpensTrackingActivitiesPage
    """ # noqa: E501
    tracking_activities: List[GetDidNotOpensReport200ResponseTrackingActivitiesInner] = Field(description="Lists contacts that did not open the specified <code>campaign_activity_id</code>.")
