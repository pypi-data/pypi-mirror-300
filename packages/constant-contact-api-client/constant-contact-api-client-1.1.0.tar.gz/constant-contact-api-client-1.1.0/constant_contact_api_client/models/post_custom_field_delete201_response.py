...
class PostCustomFieldDelete201Response(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["activity_id", "state", "started_at", "completed_at", "created_at", "updated_at", "percent_done", "activity_errors", "_links"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of PostCustomFieldDelete201Response from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of PostCustomFieldDelete201Response from a dict"""
        if obj is None:
            return None
