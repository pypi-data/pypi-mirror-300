...
class ActivityListsMembership(BaseModel):
    """
    ...
    status: Optional[CreateListRemoveActivity201ResponseStatus] = None
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ActivityListsMembership from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of ActivityListsMembership from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "status": CreateListRemoveActivity201ResponseStatus.from_dict(obj.get("status")) if obj.get("status") is not None else None,
