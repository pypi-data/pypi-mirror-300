...
class CreateListRemoveActivityRequestExclude(BaseModel):
    ...
    """ # noqa: E501
    contact_ids: Optional[List[StrictStr]] = Field(default=None, description="Excludes specified contacts (<code>contact_id</code>) from being deleted from the target list and only applicable if using either the <code>all_active_contacts</code> (billable) or <code>list_ids</code> as the source.")
