...
class GetEmailCampaignReport200ResponseAggregatePercents(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of GetEmailCampaignReport200ResponseAggregatePercents from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of GetEmailCampaignReport200ResponseAggregatePercents from a dict"""
        if obj is None:
            return None
