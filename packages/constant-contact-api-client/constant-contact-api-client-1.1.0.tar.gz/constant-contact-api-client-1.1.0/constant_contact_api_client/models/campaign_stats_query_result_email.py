...
class CampaignStatsQueryResultEmail(BaseModel):
    ...
    results: Optional[List[GetEmailStatsReport200ResponseResultsInner]] = Field(default=None, description="An array of results listing statistics for each requested <code>campaign_id</code>.")
