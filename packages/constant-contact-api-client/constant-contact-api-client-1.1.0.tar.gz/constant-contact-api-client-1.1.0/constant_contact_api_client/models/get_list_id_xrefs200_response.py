...
class GetListIdXrefs200Response(BaseModel):
    ...
    """ # noqa: E501
    xrefs: Optional[Annotated[List[GetListIdXrefs200ResponseXrefsInner], Field(max_length=500)]] = Field(default=None, description="An array of cross-referenced V3 API <code>list_id</code> and V2 API <code>sequence_id</code> properties. Response is sorted ascending by <code>sequence_id</code>.")
