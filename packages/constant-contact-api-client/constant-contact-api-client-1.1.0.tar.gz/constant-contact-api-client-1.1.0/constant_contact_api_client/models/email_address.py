...
class EmailAddress(BaseModel):
    ...
    opt_in_source: Optional[StrictStr] = Field(default=None, description="Describes who opted-in the email_address; valid values are Contact or Account. Your integration must accurately identify <code>opt_in_source</code> for compliance reasons; value is set on POST, and is read-only going forward.")
