...
from snowflake.core.role._generated.models.match_criteria import MatchCriteria
...
class Grant(BaseModel):
    ...
    match_criteria : MatchCriteria, optional
    ...
    __properties = [
        "securable", "match_criteria", "securable_type", "grant_option",
    ...
    def to_dict(self):
        ...
        if self.match_criteria:
            _dict['match_criteria'] = self.match_criteria.to_dict()
    ...
    def from_dict(cls, obj: dict) -> Grant:
        ...
        _obj = Grant.parse_obj({
            ...
            "match_criteria":
            MatchCriteria.from_dict(obj.get("match_criteria"))
            if obj.get("match_criteria") is not None else None,
            "securable_type":
...
class GrantModel():
    ...
    def _to_model(self):
        return Grant(
            ...
            match_criteria=self.match_criteria._to_model()
            if self.match_criteria is not None else None,
    ...
    def _from_model(cls, model) -> GrantModel:
        return GrantModel(
            ...
            match_criteria=MatchCriteriaModel._from_model(model.match_criteria)
            if model.match_criteria is not None else None,
