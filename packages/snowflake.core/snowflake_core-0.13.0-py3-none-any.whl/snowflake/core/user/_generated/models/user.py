...
class User(BaseModel):
    ...
    default_secondary_roles : str, optional
        The default secondary roles of this user to use when starting a session. Only valid set values are ALL or NONE. Default (null) is equivalent to ALL after 2024-07 BCR.
    ...
    type : str, optional
        Indicates the type of user (REGULAR or SERVICE)
