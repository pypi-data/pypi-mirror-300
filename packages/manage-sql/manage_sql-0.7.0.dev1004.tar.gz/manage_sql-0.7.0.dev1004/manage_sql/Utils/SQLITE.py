...
class SQLITE:
    ...
    def tables(self) -> list[Table]:
        ...
        ----------
        list[Table]
            A list of Table objects containing table names and their respective columns.
        """
    ...
    def create_table(self, tablename: str, columns: list[Column]) -> None:
        ...
        columns : list[Column]
            List of Column objects defining the structure of the table columns.
        """
    ...
    def insert_data(self, tablename: str, insert_query: list[ColumnData]) -> None:
        ...
        insert_query : list[ColumnData]
            List of ColumnData objects containing the data to be inserted.
        """
    ...
    def detele_data(self, tablename: str, condition: Filter = None):
        ...
        condition : Filter, optional
            Filtering condition to specify which records to delete.
        """
    ...
    def select_data(self, tablename: str, columns: list[str] = ['*'], condition: Filter = None):
        ...
        ----------
        list
            List of fetched records from the table.
        """
