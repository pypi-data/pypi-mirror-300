...
class ExplainableFileFinderAgent:
    ...
    async def get_file_planning(self, idea, file_attachments):
        """
    ...
    async def get_file_plannings(self, idea, file_attachments):
        """
        Request file planning from Azure OpenAI API for a given idea and project structure.
        ...
        logger.info("\n-------------------------------------------------")
        plan = await self.get_file_planning(idea,file_attachments)
