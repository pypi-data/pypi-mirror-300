        ...
        messages = [
            {
                "role": "system",
                "content": (
                    "Check if the user's request involves generating any new PNG, JPG, JPEG or .ico images. Return '1' if image generation is needed for those types, '0' if no types match. Respond in this exact JSON format:\n"
                    "{\n"
                    '    "result": "0" or "1"\n'
                    "}"
                )
