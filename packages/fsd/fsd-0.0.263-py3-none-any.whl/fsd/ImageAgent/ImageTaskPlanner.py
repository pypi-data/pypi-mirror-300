...
class ImageTaskPlanner:
    ...
    async def get_task_plans(self, instruction):
        ...
        """
        logger.debug(f"\n #### Beginning task plan retrieval process in {instruction}")
