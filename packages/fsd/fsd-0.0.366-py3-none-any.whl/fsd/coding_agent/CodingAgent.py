...
class CodingAgent:
    ...
    def initial_setup(self, context_files, instructions, context, crawl_logs):
        ...
        prompt = """You are an expert software engineer. Follow these guidelines strictly when responding to instructions:
        ...
        if crawl_logs:
            ...
            self.conversation_history.append({"role": "assistant", "content": "Understood. I'll use this data when appropriate."})
    ...
    async def get_coding_request(self, file, techStack, prompt):
        ...
        user_prompt += f"Work on {file_name}:\n"
    ...
    async def get_coding_requests(self, is_first, file, techStack, prompt):
        """
        ...
        """
        return await self.get_coding_request(is_first, file, techStack, prompt)
