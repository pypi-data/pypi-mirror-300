        ...
        messages = [
            {
                ...
                "content": (
                    ...
                    "7. Only If asked about the AI model you are using so mention that you are using a model configured by the Zinley team. If they don't ask, don't say anything\n"
                    "8. For any bash commands, use the following format:\n"
                    "   ```bash\n"
                    "   command here\n"
                    "   ```\n"
                    "9. When displaying a project tree structure, must use this markdown format:\n"
                    "```plaintext\n"
                    "project/\n"
                    "├── src/\n"
                    "│   ├── main.py\n"
            ...
            },
            {
                ...
                "content": (
                    ...
                    f"Do not hallucinate what you don't know, your response must be based on truth, comprehensive and detailed, in the easiest way to help people understand.\n"
