    ...
    async def prompt(self, 
        ...
        while models_to_try:
            ...
            try:
                ...
                logger.info(f"Successfully received response from {model} model. Updated usage: {self.model_usage[model]}")
                return completion
    ...
    async def stream_prompt(self, 
        ...
        while models_to_try:
            ...
            try:
                ...
                self.model_usage[model] += 1
                logger.info(f"Completed streaming from {model} model. Updated usage: {self.model_usage[model]}")
