...
class IdeaDevelopment:
    ...
    def initial_setup(self, role, crawl_logs):
        ...
        system_prompt = (
            ...
            "**2.7 Image usage/generation:**\n"
            "- **SVG:** Use SVG for logos, icons, and illustrations that need to scale without losing quality. It’s also ideal for responsive web graphics and supports animations.\n"
            "- **PNG:** Choose PNG for images requiring transparency or detailed graphics like screenshots and infographics. It provides lossless quality, making it suitable for web images where clarity is essential.\n"
            "- **JPG:** Use JPG for full-color photographs and images with gradients where smaller file sizes are important. It employs lossy compression, making it suitable for web use where slight quality loss is acceptable.\n"
