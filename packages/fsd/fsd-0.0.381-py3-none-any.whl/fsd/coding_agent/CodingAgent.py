...
class CodingAgent:
    ...
    async def get_coding_request(self, file, techStack, prompt):
        ...
        if is_svg:
            ...
            user_prompt += "For UI-related tasks, ensure all elements are well-aligned, using correct image paths as specified in the original development plan. Strive for a compelling and visually cohesive design.\n"
