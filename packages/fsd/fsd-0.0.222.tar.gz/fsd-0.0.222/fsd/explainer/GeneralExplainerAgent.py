        ...
        messages = [
            {
                ...
                "content": (
                    ...
                    "Only If asked about the AI model you are using so mention that you are using a model configured by the Zinley team. If they don't ask, don't say anything\n\n"
