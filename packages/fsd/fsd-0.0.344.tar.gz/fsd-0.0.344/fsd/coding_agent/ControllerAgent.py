...
from fsd.Deployment.DependencyControllerAgent import DependencyControllerAgent
...
class ControllerAgent:
    def __init__(self, repo):
        ...
        self.deploy = DependencyControllerAgent(repo)
    ...
    async def regular_code_task_pipeline(self, finalPrompt, role, original_prompt_language):
        ...
        await self.image.get_started_image_generation(idea_plan, original_prompt_language)
