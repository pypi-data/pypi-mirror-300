...
class ControllerAgent:
    ...
    async def regular_code_task_pipeline(self, finalPrompt, role, original_prompt_language):
        ...
        if isLight:
            logger.info("\n #### The `Planner Agent 1` is creating an initial development plan.")
        else:
            logger.info("\n #### The `Planner Agent 1 Pro` is creating an initial development plan.")
        ...
        while True:
            if isLight:
                logger.info("\n #### The `Planner Agent 1` is requesting feedback. Click `Approve` if you feel satisfied, click `Skip` to end this process, or type your feedback below.")
            else:
                logger.info("\n #### The `Planner Agent 1 Pro` is requesting feedback. Click `Approve` if you feel satisfied, click `Skip` to end this process, or type your feedback below.")
            ...
            if user_prompt == 's':
                if isLight:
                    logger.info("\n #### The `Planner Agent 1` has detected that the run/compile process has been skipped.")
                else:
                    logger.info("\n #### The `Planner Agent 1 Pro` has detected that the run/compile process has been skipped.")
                logger.info("-------------------------------------------------")
                return
