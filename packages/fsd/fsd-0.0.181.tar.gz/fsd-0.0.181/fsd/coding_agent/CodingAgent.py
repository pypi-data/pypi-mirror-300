...
class CodingAgent:
    ...
    def initial_setup(self, context_files, instructions, context, role):
        ...
        prompt = f"""You are a expert software engineer. You will receive detailed instructions to work on. Follow these guidelines strictly:
                "For all images mentioned in the original instructions, make sure to implement a use case for them perfectly. Don't waste any specified images.\n"
                **Response Guidelines:**
    ...
    async def get_coding_request(self, is_first, file, techStack, crawl_logs, prompt):
        ...
        if is_svg:
            ...
            user_prompt = (
                f"You are a top {techStack} developer with years of experience. Complete this task efficiently and accurately: "
                f"{'Start' if is_first else 'Continue'} working on {file_name} with expert skill:\n"
                f"Follow {techStack} best practices and write excellent, idiomatic code that shows your expertise.\n"
                "Follow instructions exactly to reach the main goal.\n"
                f"{lazy_prompt}\n"
                "Respect and use existing conventions, libraries, and patterns in the codebase.\n"
                "For UI tasks, create well-designed layouts with good spacing, showing your expert UI/UX skills.\n"
                "Only work with images or icons that are explicitly mentioned in the original instructions. Do not add or suggest additional images or icons that weren't specified.\n"
                "If the task involves images, align them perfectly to make customers happy.\n"
                "Remember: You are an excellent coder. Your work should show your top skills and attention to detail.\n"
                "Use best practices for speed, avoid memory leaks, and ensure smooth running.\n"
