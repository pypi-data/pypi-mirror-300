...
class AIGateway:
    ...
    def __init__(self):
        self.azure_model = AzureModel(self.API_KEY, self.VIRTUAL_KEYS["azure"], self.CONFIG_ID)
        self.bedrock_model = BedrockModel(self.API_KEY, self.VIRTUAL_KEYS["bedrock"], self.CONFIG_ID)
        self.gemini_model = GeminiModel(self.API_KEY, self.VIRTUAL_KEYS["gemini"], self.CONFIG_ID)
        logger.info("AIGateway initialized with all models")
    ...
    def generate_image(self, prompt: str, size: str = "1024x1024"):
        ...
        try:
            ...
            logger.info("Successfully generated image with DALL-E 3 model")
            return image
        except Exception as e:
