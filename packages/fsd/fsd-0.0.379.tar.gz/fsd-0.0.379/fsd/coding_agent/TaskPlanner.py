        ...
        messages = [
            {
                ...
                "content": (
                    ...
                    "10. **Prompt:** For all files, provide a comprehensive prompt that includes:\n"
                    ...
                    "    For UI-related tasks, always emphasize creating a top-notch, well-aligned, modern design. Pay special attention to spacing, visual appeal, and the use of appropriate images. Design everything to be visually compelling and aesthetically pleasing.\n"
