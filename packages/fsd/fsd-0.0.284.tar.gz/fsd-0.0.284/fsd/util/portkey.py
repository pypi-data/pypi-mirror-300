...
class AIGateway:
    ...
    async def prompt(self, 
        ...
        """
        models_to_try = [model for model in self.models if model != "gemini"]
        while models_to_try:
    ...
    async def stream_prompt(self, 
        ...
        Raises:
            Exception: If there's an error in making the API call after trying all models.
        """
        models_to_try = self.models.copy()  # Use a copy of self.models to avoid modifying the original list
        while models_to_try:
