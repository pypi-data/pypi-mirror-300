        ...
        messages = [
            {
                ...
                "content": (
                    ...
                    f'            "prompt": "Detailed description of exact content to be updated, including specific lines, configurations, or dependencies to be added, modified, or removed. Must use {original_prompt_language} language",\n'
            ...
            {
                "role": "user",
                "content": f"Create compilation plan. OS: {os_architecture}. Project tree:\n\n{self.repo.print_tree()}\n\nFollow this plan strictly:\n{instruction}\n"
            }
        ]
