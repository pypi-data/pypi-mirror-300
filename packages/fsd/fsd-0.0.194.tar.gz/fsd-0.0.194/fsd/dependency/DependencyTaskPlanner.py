...
class DependencyTaskPlanner:
    ...
    async def get_task_plan(self, instruction, os_architecture, original_prompt_language):
        ...
        messages = [
            {
                ...
                "content": (
                    ...
                    f'            "prompt": "Detailed description of exact content to be updated, including specific lines, configurations, or dependencies to be added, modified, or removed. Must use {original_prompt_language}",\n'
        ...
        try:
            ...
            logger.error(f"\n #### The `DependencyTaskPlanner` encountered an error while retrieving the task plan:\n Error: {e}")
            return {"reason": str(e)}
