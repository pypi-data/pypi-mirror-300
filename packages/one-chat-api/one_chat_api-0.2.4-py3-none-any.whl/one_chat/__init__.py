...
def get_friend_by_one_id(one_id=None, bot_id=None):
    if one_chat_instance is None:
        raise Exception(
            "OneChat is not initialized. Call init(authorization_token, to, bot_id) first."
        )
    ...
    return one_chat_instance.get_friend_by_one_id(one_id, bot_id)
...
def get_group_by_group_id(group_id=None, bot_id=None):
    if one_chat_instance is None:
        raise Exception(
            "OneChat is not initialized. Call init(authorization_token, to, bot_id) first."
        )
    ...
    return one_chat_instance.get_group_by_group_id(group_id, bot_id)