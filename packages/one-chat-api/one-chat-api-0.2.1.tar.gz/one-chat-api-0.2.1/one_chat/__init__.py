...
def send_message(to=None, bot_id=None, message, custom_notification=None):
...
def broadcast_message(bot_id=None, to=None, message):
    if one_chat_instance is None:
        raise Exception(
            "OneChat is not initialized. Call init(authorization_token, to, bot_id) first."
        )
...
def send_location(to=None, bot_id=None, latitude, longitude, address, custom_notification=None):
    if one_chat_instance is None:
        raise Exception(
            "OneChat is not initialized. Call init(authorization_token, to, bot_id) first."
        )
...
def send_sticker(to=None, bot_id=None, sticker_id, custom_notification=None):
    if one_chat_instance is None:
        raise Exception(
            "OneChat is not initialized. Call init(authorization_token, to, bot_id) first."
        )
