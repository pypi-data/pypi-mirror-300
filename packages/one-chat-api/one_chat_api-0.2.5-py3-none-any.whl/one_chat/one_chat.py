...
class OneChat:
    ...
    def get_friend_by_one_id(self, bot_id):
        return self.friends_and_groups.get_friend_by_one_id(bot_id)

    def get_all_groups(self, bot_id):
        return self.friends_and_groups.get_all_groups(bot_id)

    def get_group_by_group_id(self, bot_id):
        return self.friends_and_groups.get_group_by_group_id(bot_id)