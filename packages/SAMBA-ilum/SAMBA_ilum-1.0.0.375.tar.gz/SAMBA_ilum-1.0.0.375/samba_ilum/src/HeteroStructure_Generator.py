...
crit_dist_lattice =  float(crit_dist_lattice)
...
if (crit_dist_lattice <= 0.0):  crit_dist_lattice = 0.01
   ...
   for s in range(len(dir_matchings)):
       ...
       if (n_structures != 0):
          ...
          for i in range(n_structures):
              ...
              #-------------------------------------------------------------------------------------------
              if (dist_1 > crit_dist_lattice or dist_2 > crit_dist_lattice or dist_3 > crit_dist_lattice):
...
vector = [0.0, (1/8), (1/6), (1/4), (1/3), (1/2), (2/3), (3/4), (5/6), 1.0]
#--------------------------------------------------------------------------
...
for i in range(len(files)):
    ...
    poscar  = open(dir1 + diret[i], "r")
    poscar2 = open(dir2 + diret[i], "w")
