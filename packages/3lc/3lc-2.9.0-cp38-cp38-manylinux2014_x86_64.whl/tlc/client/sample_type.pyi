...
def NumpyArray(shape: tuple[int, ...], content: SampleType) -> SmallNumpyArray | LargeNumpyArray:
    ...
    :return: The created SampleType.
    '''
def TorchTensor(shape: tuple[int, ...], content: SampleType) -> SmallTorchTensor | LargeTorchTensor:
