...
from tlc.core.builtins.constants.column_names import FOREIGN_TABLE_ID as FOREIGN_TABLE_ID, SHOULD_DELETE as SHOULD_DELETE
...
class Table(Object):
    ...
    **STATE MUTABILITY:**
    ...
    rows: Incomplete
    def __init__(self, url: Url | None = None, created: str | None = None, description: str | None = None, row_cache_url: Url | None = None, row_cache_populated: bool | None = None, override_table_rows_schema: Any = None, init_parameters: Any = None) -> None:
    ...
    def from_names(table_name: str | None = None, dataset_name: str | None = None, project_name: str | None = None, root_url: Url | str | None = None) -> Table:
        ...
        """
    @staticmethod
    def from_torch_dataset(dataset: TorchDataset, structure: _SampleTypeStructure | None = None, table_name: str | None = None, dataset_name: str | None = None, project_name: str | None = None, root_url: Url | str | None = None, if_exists: Literal['raise', 'reuse', 'rename', 'overwrite'] = 'reuse', add_weight_column: bool = True, all_arrays_are_fixed_size: bool = False, description: str | None = None, extra_columns: dict[str, _SampleTypeStructure] | None = None, *, table_url: Url | Path | str | None = None) -> TableFromTorchDataset:
        ...
        """
    @staticmethod
    def from_pandas(df: pd.DataFrame, structure: _SampleTypeStructure | None = None, table_name: str | None = None, dataset_name: str | None = None, project_name: str | None = None, root_url: Url | str | None = None, if_exists: Literal['raise', 'reuse', 'rename', 'overwrite'] = 'reuse', add_weight_column: bool = True, description: str | None = None, extra_columns: dict[str, _SampleTypeStructure] | None = None, *, table_url: Url | Path | str | None = None) -> TableFromPandas:
        ...
        """
    @staticmethod
    def from_dict(data: Mapping[str, object], structure: _SampleTypeStructure | None = None, table_name: str | None = None, dataset_name: str | None = None, project_name: str | None = None, root_url: Url | str | None = None, if_exists: Literal['raise', 'reuse', 'rename', 'overwrite'] = 'reuse', add_weight_column: bool = True, description: str | None = None, extra_columns: dict[str, _SampleTypeStructure] | None = None, *, table_url: Url | Path | str | None = None) -> TableFromPydict:
        ...
        """
    @staticmethod
    def from_csv(csv_file: str | Path | Url, structure: _SampleTypeStructure | None = None, table_name: str | None = None, dataset_name: str | None = None, project_name: str | None = None, root_url: Url | str | None = None, if_exists: Literal['raise', 'reuse', 'rename', 'overwrite'] = 'reuse', add_weight_column: bool = True, description: str | None = None, extra_columns: dict[str, _SampleTypeStructure] | None = None, *, table_url: Url | Path | str | None = None) -> TableFromCsv:
    ...
    def from_coco(annotations_file: str | Path | Url, image_folder: str | Path | Url | None = None, structure: _SampleTypeStructure | None = None, table_name: str | None = None, dataset_name: str | None = None, project_name: str | None = None, root_url: Url | str | None = None, if_exists: Literal['raise', 'reuse', 'rename', 'overwrite'] = 'reuse', add_weight_column: bool = True, description: str | None = None, extra_columns: dict[str, _SampleTypeStructure] | None = None, *, table_url: Url | Path | str | None = None) -> TableFromCoco:
        ...
        """
    @staticmethod
    def from_parquet(parquet_file: str | Path | Url, structure: _SampleTypeStructure | None = None, table_name: str | None = None, dataset_name: str | None = None, project_name: str | None = None, root_url: Url | str | None = None, if_exists: Literal['raise', 'reuse', 'rename', 'overwrite'] = 'reuse', add_weight_column: bool = True, description: str | None = None, extra_columns: dict[str, _SampleTypeStructure] | None = None, *, table_url: Url | Path | str | None = None) -> TableFromParquet:
        ...
        """
    @staticmethod
    def from_yolo(dataset_yaml_file: str | Path | Url, split: str = 'train', datasets_dir: str | Path | Url | None = None, override_split_path: str | Path | Url | Iterable[str | Path | Url] | None = None, structure: _SampleTypeStructure | None = None, table_name: str | None = None, dataset_name: str | None = None, project_name: str | None = None, root_url: Url | str | None = None, if_exists: Literal['raise', 'reuse', 'rename', 'overwrite'] = 'reuse', add_weight_column: bool = True, description: str | None = None, extra_columns: dict[str, _SampleTypeStructure] | None = None, *, table_url: Url | Path | str | None = None) -> TableFromYolo:
        ...
        """
    @staticmethod
    def from_hugging_face(path: str, name: str | None = None, split: str = 'train', table_name: str | None = None, dataset_name: str | None = None, project_name: str | None = None, root_url: Url | str | None = None, if_exists: Literal['raise', 'reuse', 'rename', 'overwrite'] = 'reuse', add_weight_column: bool = True, description: str | None = None, extra_columns: dict[str, _SampleTypeStructure] | None = None, *, table_url: Url | Path | str | None = None) -> TableFromHuggingFace:
    ...
    def from_image_folder(root: str | Path | Url, image_column_name: str = 'image', label_column_name: str = 'label', include_label_column: bool = True, extensions: str | tuple[str, ...] | None = None, table_name: str | None = None, dataset_name: str | None = None, project_name: str | None = None, root_url: Url | str | None = None, if_exists: Literal['raise', 'reuse', 'rename', 'overwrite'] = 'reuse', add_weight_column: bool = True, description: str | None = None, extra_columns: dict[str, _SampleTypeStructure] | None = None, *, table_url: Url | Path | str | None = None) -> Table:
        ...
        """
    @staticmethod
    def join_tables(tables: Sequence[Table] | Sequence[Url | str | Path], table_name: str = ..., dataset_name: str | None = None, project_name: str | None = None, root_url: Url | str | None = None, if_exists: Literal['raise', 'reuse', 'rename', 'overwrite'] = 'reuse', add_weight_column: bool = True, description: str | None = None, extra_columns: dict[str, _SampleTypeStructure] | None = None, *, table_url: Url | str | Path | None = None) -> Table:
