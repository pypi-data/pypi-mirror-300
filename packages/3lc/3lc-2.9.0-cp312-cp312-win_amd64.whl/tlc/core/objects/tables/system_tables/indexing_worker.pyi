...
class _UrlIndexingWorker(ABC, metaclass=abc.ABCMeta):
    def __init__(self, data_event: threading.Event, blacklist_config: list[_BlacklistExceptionHandler] | None, tag: str = '', stop_event: threading.Event | None = None) -> None: ...
    @property
...
class _CrawlUrlIndexer(threading.Thread, _UrlIndexingWorker):
    ...
    """
    def __init__(self, interval: float, data_event: threading.Event, blacklist_config: list[_BlacklistExceptionHandler], tag: str = '', stop_event: threading.Event | None = None) -> None: ...
    def add_scan_url(self, url_config: _ScanUrl) -> None: ...
    def remove_scan_url(self, url_config: _ScanUrl) -> None: ...
...
class _StaticUrlIndexer(_UrlIndexingWorker):
    """An indexer that scans a fixed set of URLs that are considered static.

    This indexer will need a process restart to update.
    """
    def __init__(self, data_event: threading.Event, blacklist_config: list[_BlacklistExceptionHandler], tag: str = '', stop_event: threading.Event | None = None) -> None: ...
    def get_index(self) -> dict[Url, _UrlIndex]: ...
    def add_scan_url(self, url_config: _ScanUrl) -> None: ...
