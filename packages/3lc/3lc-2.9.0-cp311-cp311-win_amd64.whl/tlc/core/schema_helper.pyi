...
class SchemaHelper:
    ...
    @staticmethod
    def pyarrow_list_to_tlc_schema(arrow_schema: pa.Schema, **schema_kwargs: Any) -> Schema: ...
    @staticmethod
