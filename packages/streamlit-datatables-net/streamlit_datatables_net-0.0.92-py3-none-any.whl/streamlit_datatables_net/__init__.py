...
try:
    ...
    from .utility_functions import allow_top_navigation, stringify_javascript_function, generate_js_function_from_json, stringify_file
except Exception:
    from date_formatter import python_to_luxon_format
    from utility_functions import allow_top_navigation, stringify_javascript_function, generate_js_function_from_json, stringify_file
...
def st_datatable(data: pd.DataFrame | list[dict] = None, boolean_to_string: bool = False, column_order: List[str] = None, options: Dict = None, dt_config: str = "default", class_name: str = None, common_js_functions: Dict = None, context_menu: Dict = None,  js_scripts: List[str] = None, stylesheets: List[str] = None, css_files: List[str] = None, enable_top_navigation: bool = False, date_format: str = None, is_datetime: bool = False, export_file_name: str = None, on_select: Optional[Union[Literal["ignore"], Literal["rerun"], Callable]] = "rerun", on_change: Optional[Callable] = None, on_click: Optional[Callable] = None, ajax_reload: bool = False, ajax_setup: Dict = None, ajax_auto_refresh_period: int = None, enable_diagnostics: bool = False, args: Optional[Tuple[Any, ...]] = None,
...
if not _RELEASE:
    ...
    with content_column:
        with st.container(border=True):
            ...
            dt_click = st_datatable(None, options=options, context_menu=context_menu, css_files=[css_file], common_js_functions=common_js_functions, ajax_setup=ajax_setup, ajax_reload=ajax_reload, ajax_auto_refresh_period=None,
