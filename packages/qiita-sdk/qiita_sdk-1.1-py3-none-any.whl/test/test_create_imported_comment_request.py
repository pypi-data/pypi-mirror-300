...
class TestCreateImportedCommentRequest(unittest.TestCase):
    """CreateImportedCommentRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateImportedCommentRequest:
        """Test CreateImportedCommentRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateImportedCommentRequest`
        """
        model = CreateImportedCommentRequest()
        if include_optional:
            return CreateImportedCommentRequest(
                body = '# Example',
                user_id = 'qiita',
    ...
    def testCreateImportedCommentRequest(self):
        """Test CreateImportedCommentRequest"""
