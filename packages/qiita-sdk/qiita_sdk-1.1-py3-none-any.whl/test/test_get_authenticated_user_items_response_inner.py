...
class TestGetAuthenticatedUserItemsResponseInner(unittest.TestCase):
    """GetAuthenticatedUserItemsResponseInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetAuthenticatedUserItemsResponseInner:
        """Test GetAuthenticatedUserItemsResponseInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetAuthenticatedUserItemsResponseInner`
        """
        model = GetAuthenticatedUserItemsResponseInner()
        if include_optional:
            return GetAuthenticatedUserItemsResponseInner(
                rendered_body = '',
                body = '',
                coediting = True,
                comments_count = 56,
                created_at = '',
                group = qiita.v2.models.get_authenticated_user_items_response_inner_group.GetAuthenticatedUserItemsResponse_inner_group(
                    created_at = '', 
                    description = '', 
                    name = '', 
                    private = True, 
                ...
                stocks_count = 56,
                tags = [
                    qiita.v2.models.get_authenticated_user_items_response_inner_tags_inner.GetAuthenticatedUserItemsResponse_inner_tags_inner(
                        name = '', 
                        versions = [
                            ''
                            ], )
                ...
                updated_at = '',
                url = '',
                user = qiita.v2.models.get_authenticated_user_items_response_inner_user.GetAuthenticatedUserItemsResponse_inner_user(
                    description = '', 
                    facebook_id = '', 
                    followees_count = 56, 
                    followers_count = 56, 
                    ...
                    website_url = '', ),
                page_views_count = 56,
                team_membership = qiita.v2.models.get_authenticated_user_items_response_inner_team_membership.GetAuthenticatedUserItemsResponse_inner_team_membership(
                    name = '', ),
    ...
    def testGetAuthenticatedUserItemsResponseInner(self):
        """Test GetAuthenticatedUserItemsResponseInner"""
