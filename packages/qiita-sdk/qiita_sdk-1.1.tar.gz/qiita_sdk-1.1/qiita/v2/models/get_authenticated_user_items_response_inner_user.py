...
class GetAuthenticatedUserItemsResponseInnerUser(BaseModel):
    """
    GetAuthenticatedUserItemsResponseInnerUser
    """ # noqa: E501
    description: Optional[StrictStr] = None
    facebook_id: Optional[StrictStr] = None
    followees_count: Optional[StrictInt] = None
    followers_count: Optional[StrictInt] = None
    github_login_name: Optional[StrictStr] = None
    ...
    permanent_id: Optional[StrictInt] = None
    profile_image_url: Optional[StrictStr] = None
    team_only: Optional[StrictBool] = None
    twitter_screen_name: Optional[StrictStr] = None
