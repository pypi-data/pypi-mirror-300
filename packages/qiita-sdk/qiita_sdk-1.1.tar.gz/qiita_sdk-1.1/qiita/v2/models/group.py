...
class Group(BaseModel):
    ...
    description: StrictStr = Field(description="グループの詳細を表します。")
    name: StrictStr = Field(description="グループに付けられた表示用の名前を表します。")
    private: StrictBool = Field(description="非公開グループかどうかを表します。")
    updated_at: StrictStr = Field(description="データが最後に更新された日時")
    url_name: StrictStr = Field(description="グループのチーム上での一意な名前を表します。")
    __properties: ClassVar[List[str]] = ["created_at", "description", "name", "private", "updated_at", "url_name"]
