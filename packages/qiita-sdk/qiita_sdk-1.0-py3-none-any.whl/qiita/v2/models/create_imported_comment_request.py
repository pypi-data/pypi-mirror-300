...
class CreateImportedCommentRequest(BaseModel):
    """
    CreateImportedCommentRequest
    """ # noqa: E501
    body: StrictStr = Field(description="コメントの内容を表すMarkdown形式の文字列")
    user_id: StrictStr = Field(description="ユーザーID")
    created_at: Optional[StrictStr] = Field(default=None, description="データが作成された日時")
    updated_at: Optional[StrictStr] = Field(default=None, description="データが最後に更新された日時")
    __properties: ClassVar[List[str]] = ["body", "user_id", "created_at", "updated_at"]
