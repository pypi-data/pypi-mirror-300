...
class AuthenticatedUser(BaseModel):
    ...
    AuthenticatedUser
    """ # noqa: E501
    description: Optional[StrictStr] = Field(description="自己紹介文")
    facebook_id: Optional[StrictStr] = Field(description="Facebook ID")
    followees_count: StrictInt = Field(description="このユーザーがフォローしているユーザーの数")
    followers_count: StrictInt = Field(description="このユーザーをフォローしているユーザーの数")
    github_login_name: Optional[StrictStr] = Field(description="GitHub ID")
    id: StrictStr = Field(description="ユーザーID")
    items_count: StrictInt = Field(description="このユーザーが qiita.com 上で公開している記事の数 (Qiita Teamでの記事数は含まれません)")
    linkedin_id: Optional[StrictStr] = Field(description="LinkedIn ID")
    location: Optional[StrictStr] = Field(description="居住地")
    name: Optional[StrictStr] = Field(description="設定している名前")
    organization: Optional[StrictStr] = Field(description="所属している組織")
    permanent_id: StrictInt = Field(description="ユーザーごとに割り当てられる整数のID")
    profile_image_url: StrictStr = Field(description="設定しているプロフィール画像のURL")
    team_only: StrictBool = Field(description="Qiita Team専用モードに設定されているかどうか")
    twitter_screen_name: Optional[StrictStr] = Field(description="Twitterのスクリーンネーム")
    website_url: Optional[StrictStr] = Field(description="設定しているWebサイトのURL")
    image_monthly_upload_limit: StrictInt = Field(description="1ヶ月あたりにQiitaにアップロードできる画像の総容量")
    image_monthly_upload_remaining: StrictInt = Field(description="その月にQiitaにアップロードできる画像の残りの容量")
    __properties: ClassVar[List[str]] = ["description", "facebook_id", "followees_count", "followers_count", "github_login_name", "id", "items_count", "linkedin_id", "location", "name", "organization", "permanent_id", "profile_image_url", "team_only", "twitter_screen_name", "website_url", "image_monthly_upload_limit", "image_monthly_upload_remaining"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.facebook_id is None and "facebook_id" in self.model_fields_set:
            _dict['facebook_id'] = None

        # set to None if github_login_name (nullable) is None
        # and model_fields_set contains the field
        if self.github_login_name is None and "github_login_name" in self.model_fields_set:
            _dict['github_login_name'] = None
        ...
        # set to None if twitter_screen_name (nullable) is None
        # and model_fields_set contains the field
        if self.twitter_screen_name is None and "twitter_screen_name" in self.model_fields_set:
            _dict['twitter_screen_name'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "followees_count": obj.get("followees_count"),
            "followers_count": obj.get("followers_count"),
            "github_login_name": obj.get("github_login_name"),
            "id": obj.get("id"),
            ...
            "permanent_id": obj.get("permanent_id"),
            "profile_image_url": obj.get("profile_image_url"),
            "team_only": obj.get("team_only"),
            "twitter_screen_name": obj.get("twitter_screen_name"),
            "website_url": obj.get("website_url"),
            "image_monthly_upload_limit": obj.get("image_monthly_upload_limit"),
            "image_monthly_upload_remaining": obj.get("image_monthly_upload_remaining")
        })
        return _obj
