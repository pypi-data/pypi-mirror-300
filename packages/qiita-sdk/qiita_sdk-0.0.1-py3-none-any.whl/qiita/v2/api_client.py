...
from qiita.v2.api_response import ApiResponse, T as ApiResponseT
import qiita.v2.models
from qiita.v2 import rest
from qiita.v2.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(qiita.v2.models, klass)
