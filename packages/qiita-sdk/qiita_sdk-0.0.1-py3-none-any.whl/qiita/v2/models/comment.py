...
class Comment(BaseModel):
    ...
    id: StrictStr = Field(description="コメントの一意なID")
    rendered_body: StrictStr = Field(description="コメントの内容を表すHTML形式の文字列")
    updated_at: StrictStr = Field(description="データが最後に更新された日時")
    user: User
    __properties: ClassVar[List[str]] = ["body", "created_at", "id", "rendered_body", "updated_at", "user"]
