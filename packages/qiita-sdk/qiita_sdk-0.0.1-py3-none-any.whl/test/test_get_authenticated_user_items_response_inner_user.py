...
class TestGetAuthenticatedUserItemsResponseInnerUser(unittest.TestCase):
    """GetAuthenticatedUserItemsResponseInnerUser unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetAuthenticatedUserItemsResponseInnerUser:
        """Test GetAuthenticatedUserItemsResponseInnerUser
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetAuthenticatedUserItemsResponseInnerUser`
        """
        model = GetAuthenticatedUserItemsResponseInnerUser()
        if include_optional:
            return GetAuthenticatedUserItemsResponseInnerUser(
                description = '',
                facebook_id = '',
                followees_count = 56,
                followers_count = 56,
    ...
    def testGetAuthenticatedUserItemsResponseInnerUser(self):
        """Test GetAuthenticatedUserItemsResponseInnerUser"""
