...
class TestGetAuthenticatedUserItemsResponseInnerTeamMembership(unittest.TestCase):
    """GetAuthenticatedUserItemsResponseInnerTeamMembership unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetAuthenticatedUserItemsResponseInnerTeamMembership:
        """Test GetAuthenticatedUserItemsResponseInnerTeamMembership
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetAuthenticatedUserItemsResponseInnerTeamMembership`
        """
        model = GetAuthenticatedUserItemsResponseInnerTeamMembership()
        if include_optional:
            return GetAuthenticatedUserItemsResponseInnerTeamMembership(
                name = ''
            )
        else:
            return GetAuthenticatedUserItemsResponseInnerTeamMembership(
    ...
    def testGetAuthenticatedUserItemsResponseInnerTeamMembership(self):
        """Test GetAuthenticatedUserItemsResponseInnerTeamMembership"""
