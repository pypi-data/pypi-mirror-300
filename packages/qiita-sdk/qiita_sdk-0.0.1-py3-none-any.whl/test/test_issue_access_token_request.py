...
class TestIssueAccessTokenRequest(unittest.TestCase):
    """IssueAccessTokenRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IssueAccessTokenRequest:
        """Test IssueAccessTokenRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IssueAccessTokenRequest`
        """
        model = IssueAccessTokenRequest()
        if include_optional:
    ...
    def testIssueAccessTokenRequest(self):
        """Test IssueAccessTokenRequest"""
