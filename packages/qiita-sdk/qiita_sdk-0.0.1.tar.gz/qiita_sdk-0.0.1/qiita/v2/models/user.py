...
class User(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["description", "facebook_id", "followees_count", "followers_count", "github_login_name", "id", "items_count", "linkedin_id", "location", "name", "organization", "permanent_id", "profile_image_url", "team_only", "twitter_screen_name", "website_url"]
