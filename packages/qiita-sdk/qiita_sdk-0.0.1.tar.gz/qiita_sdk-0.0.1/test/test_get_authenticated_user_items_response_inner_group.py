...
class TestGetAuthenticatedUserItemsResponseInnerGroup(unittest.TestCase):
    """GetAuthenticatedUserItemsResponseInnerGroup unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetAuthenticatedUserItemsResponseInnerGroup:
        """Test GetAuthenticatedUserItemsResponseInnerGroup
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetAuthenticatedUserItemsResponseInnerGroup`
        """
        model = GetAuthenticatedUserItemsResponseInnerGroup()
        if include_optional:
            return GetAuthenticatedUserItemsResponseInnerGroup(
                created_at = '',
                description = '',
                name = '',
                private = True,
    ...
    def testGetAuthenticatedUserItemsResponseInnerGroup(self):
        """Test GetAuthenticatedUserItemsResponseInnerGroup"""
