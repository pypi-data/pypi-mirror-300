...
class TestItemTeamMembership(unittest.TestCase):
    """ItemTeamMembership unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ItemTeamMembership:
        """Test ItemTeamMembership
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ItemTeamMembership`
        """
        model = ItemTeamMembership()
        if include_optional:
            return ItemTeamMembership(
                name = ''
            )
        else:
            return ItemTeamMembership(
    ...
    def testItemTeamMembership(self):
        """Test ItemTeamMembership"""
