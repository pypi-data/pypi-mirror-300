...
class FireberryClient:
    ...
    def post(self, endpoint: str, data: dict[str, Any]) -> dict[str, Any] | list[dict[str, Any]]:
    ...
    def get_multiple_records(self, object_type: str | int, fields: Optional[list[str]]) -> list[dict[str, Any]]:
    ...
    def get_crm_users(self, fields: Optional[list[str]]) -> list[dict[str, Any]]:
        return self.get_multiple_records(ACCOUNT_OBJECT_CODE, fields)
    ...
    def get_account_id_by_email(self, email: str) -> Optional[str]:
        ...
        data = self.query(ACCOUNT_OBJECT_CODE, query, fields=account_id_key)
        if data:
    ...
    def query_all_crm_users(self) -> list[str]:
