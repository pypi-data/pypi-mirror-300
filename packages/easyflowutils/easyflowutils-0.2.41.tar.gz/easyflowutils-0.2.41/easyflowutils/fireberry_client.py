...
class FireberryClient:
    ...
    def get_record_url_of_object(cls, object_type_code: int, object_id: str) -> str:
        return f"{cls.APP_URL}/record/{object_type_code}/{object_id}"
    ...
    def create_view(self, view_name: str, object_type: str | int, query: str) -> dict[str, Any]:
        data = {"name": view_name}
        url = f"{self.APP_URL}/api/v2/views/{object_type}"
