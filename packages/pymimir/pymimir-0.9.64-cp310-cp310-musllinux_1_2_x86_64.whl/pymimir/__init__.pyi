...
class Certificate:
    ...
    def __hash__(self) -> int:
        ...
    def __init__(self, num_vertices: int, num_edges: int, nauty_certificate: str, canonical_initial_coloring: list[int]) -> None:
        ...
...
class DenseNautyGraph:
    ...
    def __init__(self, num_vertices: int) -> None:
        ...
    @typing.overload
    def __init__(self, digraph: StaticVertexColoredDigraph) -> None:
        ...
...
class DerivedGroundAtomList:
    ...
    def insert(self, i: int, x: DerivedGroundAtom) -> None:
        ...
        Insert an item at a given position.
        """
    def lift(self, pddl_factories: ...) -> tuple[VariableList, DerivedAtomList]:
        ...
    @typing.overload
...
class DerivedGroundLiteralList:
    ...
    def insert(self, i: int, x: DerivedGroundLiteral) -> None:
        ...
        Insert an item at a given position.
        """
    def lift(self, pddl_factories: ...) -> tuple[VariableList, ..., ...]:
        ...
    @typing.overload
...
class DerivedLiteralList:
    ...
    def __setitem__(self, arg0: slice, arg1: DerivedLiteralList) -> None:
        ...
        Assign list elements using a slice object
        """
    def __str__(self: DerivedGroundLiteralList) -> str:
        ...
...
class FaithfulAbstraction:
    ...
    def get_ssg(self) -> StateRepository:
        ...
    def get_states(self) -> list[FaithfulAbstractStateVertex]:
        ...
    def get_transition_cost(self, transition_index: int) -> float:
        ...
    def get_transitions(self) -> list[GroundActionsEdge]:
        ...
    def is_alive_state(self, state_index: int) -> bool:
        ...
    def is_deadend_state(self, state_index: int) -> bool:
...
class FluentGroundAtomList:
    ...
    def insert(self, i: int, x: FluentGroundAtom) -> None:
        ...
        Insert an item at a given position.
        """
    def lift(self, pddl_factories: ...) -> tuple[VariableList, FluentAtomList]:
        ...
    @typing.overload
...
class FluentLiteralList:
    ...
    def __setitem__(self, arg0: slice, arg1: FluentLiteralList) -> None:
        ...
        Assign list elements using a slice object
        """
    def __str__(self: FluentGroundLiteralList) -> str:
        ...
...
class FunctionExpressionVariantList:
    ...
    def __setitem__(self, arg0: slice, arg1: FunctionExpressionVariantList) -> None:
        ...
        Assign list elements using a slice object
        """
    def __str__(self: EffectComplexList) -> str:
        ...
...
class FunctionList:
    ...
    def __setitem__(self, arg0: slice, arg1: FunctionList) -> None:
        ...
        Assign list elements using a slice object
        """
    def __str__(self: FunctionSkeletonList) -> str:
        ...
...
class GroundAction:
    ...
    def to_string(self, arg0: PDDLFactories) -> str:
        ...
    def to_string_for_plan(self, arg0: PDDLFactories) -> str:
        ...
...
class GroundedApplicableActionGenerator(IApplicableActionGenerator):
    ...
    def __init__(self, problem: Problem, pddl_factories: PDDLFactories) -> None:
        ...
    @typing.overload
    def __init__(self, problem: Problem, pddl_factories: PDDLFactories, event_handler: IGroundedApplicableActionGeneratorEventHandler) -> None:
        ...
...
class IApplicableActionGenerator:
    ...
    def get_ground_action(self, action_index: int) -> GroundAction:
        ...
    @typing.overload
    def get_ground_action(self, axiom_index: int) -> ...:
        ...
...
class LiftedApplicableActionGenerator(IApplicableActionGenerator):
    ...
    def __init__(self, problem: Problem, pddl_factories: PDDLFactories) -> None:
        ...
    @typing.overload
    def __init__(self, problem: Problem, pddl_factories: PDDLFactories, event_handler: ILiftedApplicableActionGeneratorEventHandler) -> None:
        ...
class LiftedConjunctionGrounder:
    def __init__(self, problem: Problem, variables: VariableList, static_literals: StaticLiteralList, fluent_literals: FluentLiteralList, derived_literals: DerivedLiteralList, pddl_factories: PDDLFactories) -> None:
        ...
    def ground(self, state: State) -> list[ObjectList]:
        ...
...
class PDDLFactories:
    ...
    def get_fluent_ground_atoms_from_indices(self, arg0: list[int]) -> FluentGroundAtomList:
        ...
    def get_ground_atoms(self) -> list:
        ...
...
class StateSpace:
    ...
    def get_ssg(self) -> StateRepository:
        ...
    def get_state(self, state_index: int) -> StateVertex:
        ...
    def get_state_index(self, state: State) -> int:
        ...
    def get_states(self) -> list[StateVertex]:
        ...
    def get_transition_cost(self, transition_index: int) -> float:
        ...
    def get_transitions(self) -> list[GroundActionEdge]:
        ...
    def is_alive_state(self, state_index: int) -> bool:
        ...
    def is_deadend_state(self, state_index: int) -> bool:
...
class StaticGroundAtomList:
    ...
    def insert(self, i: int, x: StaticGroundAtom) -> None:
        ...
        Insert an item at a given position.
        """
    def lift(self, pddl_factories: ...) -> tuple[VariableList, StaticAtomList]:
        ...
    @typing.overload
...
class StaticLiteralList:
    ...
    def __setitem__(self, arg0: slice, arg1: StaticLiteralList) -> None:
        ...
        Assign list elements using a slice object
        """
    def __str__(self: StaticGroundLiteralList) -> str:
        ...
