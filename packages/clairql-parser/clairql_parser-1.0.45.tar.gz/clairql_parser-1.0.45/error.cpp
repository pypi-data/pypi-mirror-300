...
ERROR_CLASS_IMPLEMENTATION(ClairQLError, runtime_error)

ERROR_CLASS_IMPLEMENTATION(SyntaxError, ClairQLError)
ERROR_CLASS_IMPLEMENTATION(NotImplementedError, ClairQLError)
ERROR_CLASS_IMPLEMENTATION(ParsingError, ClairQLError)
