...
class BotNetworkConnection:
    ...
    def check_status(self):
        ...
        try:
            ...
            print("API Connection: Successful ✔️", self.base_url, response.status_code)
            return response.json()
        except requests.exceptions.ConnectionError:
            print("API Connection: Failed ❌ - Please check if the BotNetworkConnection server is running.")
            return None
