...
class EcuInfo:
	...
	def __init__ (self, docType, docFieldsPath, runningDir):
		self.docType              = docType
		self.inputsParametersFile = Utils.getInputsParametersFile (docType)

		self.fieldsJsonFile = docFieldsPath
	...
	def getNumeroDocumento (self, docKey="00b_Numero"):
	...
	def getNumeroCartaporte (docFields, docType):
		keys    = {"CARTAPORTE":"00b_Numero", "MANIFIESTO":"28_Mercancia_Cartaporte", "DECLARACION":"15_Cartaporte"}
