...
def test():
    ...
    mobi.set_platform_velocity_target(0.0, 0.0, math.pi / 8, timeout=2.0, instantaneous=True)
    time.sleep(2)

    mobi.set_platform_velocity_target(0.2, 0.0, 0.0, instantaneous=True)
    time.sleep(1)

    mobi.set_platform_velocity_target(0.0, 0.2, 0.0, instantaneous=True)
    time.sleep(1)
    ...
    mobi.set_platform_velocity_target(0.0, 0.0, 0.0, instantaneous=True)
    time.sleep(0.5)
