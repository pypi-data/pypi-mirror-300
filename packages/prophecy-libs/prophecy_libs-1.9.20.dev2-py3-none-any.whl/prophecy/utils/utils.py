...
class ProphecyDataFrame:
    ...
    def fuzzyPurgeMode(
            self, recordId, matchFields, threshold, algorithm, includeSimilarityScore
    ) -> DataFrame:
        result = self.extended_dataframe.fuzzyPurgeMode(
            recordId,
            createScalaList(self.spark, matchFields),
            threshold,
            algorithm,
    ...
    def fuzzyMergeMode(
            self, recordId, sourceId, matchFields, threshold, algorithm, includeSimilarityScore
    ) -> DataFrame:
