...
def fuzzyPurgeMode(
        df, spark, recordId, matchFields, threshold, algorithm, includeSimilarityScore=False
) -> DataFrame:
...
def fuzzyMergeMode(
        df, spark, recordId, sourceId, matchFields, threshold, algorithm, includeSimilarityScore=False
) -> DataFrame:
