...
from clairviewanalytics.consumer import Consumer
from clairviewanalytics.exception_capture import DEFAULT_DISTINCT_ID, ExceptionCapture
from clairviewanalytics.exception_utils import exc_info_from_error, exceptions_from_error_tuple, handle_in_app
from clairviewanalytics.feature_flags import InconclusiveMatchError, match_feature_flag_properties
from clairviewanalytics.poller import Poller
from clairviewanalytics.request import DEFAULT_HOST, APIError, batch_post, decide, determine_server_host, get
from clairviewanalytics.utils import SizeLimitedDict, clean, guess_timezone, remove_trailing_slash
...
class Client(object):
    """Create a new ClairView client."""

    log = logging.getLogger("clairview")
    ...
    def _enqueue(self, msg, disable_geoip):
        ...
        if not msg.get("properties"):
            msg["properties"] = {}
        msg["properties"]["$lib"] = "clairview-python"
    ...
    def _load_feature_flags(self):
        try:
            ...
            if e.status == 401:
                self.log.error(
                    "[FEATURE FLAGS] Error loading feature flags: To use feature flags, please set a valid personal_api_key. More information: https://clairview.com/docs/api/overview"
                )
                if self.debug:
                    raise APIError(
                        status=401,
                        ...
                        "More information: https://clairview.com/docs/api/overview",
                    )
            else:
