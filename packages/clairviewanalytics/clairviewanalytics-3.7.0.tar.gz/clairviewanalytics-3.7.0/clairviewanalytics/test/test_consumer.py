...
from clairviewanalytics.consumer import MAX_MSG_SIZE, Consumer
...
class TestConsumer(unittest.TestCase):
    ...
    def test_flush_interval(self):
        ...
        with mock.patch("clairview.consumer.batch_post") as mock_post:
            consumer.start()
            for i in range(0, 3):
    ...
    def _test_request_retry(self, consumer, expected_exception, exception_count):
        ...
        with mock.patch("clairview.consumer.batch_post", mock.Mock(side_effect=mock_post)):
            track = {"type": "track", "event": "python event", "distinct_id": "distinct_id"}
    ...
    def test_max_batch_size(self):
        ...
        with mock.patch("clairview.request._session.post", side_effect=mock_post_fn) as mock_post:
            consumer.start()
