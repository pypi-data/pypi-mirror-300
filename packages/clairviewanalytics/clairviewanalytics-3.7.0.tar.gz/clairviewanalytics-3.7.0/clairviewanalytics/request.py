...
from clairviewanalytics.utils import remove_trailing_slash
from clairviewanalytics.version import VERSION

_session = requests.sessions.Session()

US_INGESTION_ENDPOINT = "https://us.i.clairview.com"
EU_INGESTION_ENDPOINT = "https://eu.i.clairview.com"
DEFAULT_HOST = US_INGESTION_ENDPOINT
USER_AGENT = "clairview-python/" + VERSION
...
def determine_server_host(host: Optional[str]) -> str:
    ...
    if trimmed_host in ("https://app.clairview.com", "https://us.clairview.com"):
        return US_INGESTION_ENDPOINT
    elif trimmed_host == "https://eu.clairview.com":
