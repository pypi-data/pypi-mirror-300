...
class OptimizeStateResponse(BaseModel):
    ...
    __properties = ["success", "error", "config", "status", "tunerJobId", "tunerCoordinatorJobId", "tunerJobIsRunning", "trials", "projectDataType", "jobError", "workers", "nextRunIndex", "isWhitelabel"]
