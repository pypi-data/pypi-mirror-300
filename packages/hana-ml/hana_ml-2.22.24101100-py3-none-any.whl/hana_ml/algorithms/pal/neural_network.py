...
class _MLPMultiTaskBase(PALBase):#pylint:disable=too-many-instance-attributes
    ...
    def _fit(self, data=None, key=None, features=None, label=None, categorical_variable=None,
             pre_model=None):
        conn = data.connection_context
        has_id = False
        index_col = None
    ...
    def _predict(self, data=None, key=None, features=None, verbose=None, model=None):
        conn = data.connection_context
        if getattr(self, 'model_') is None:
            raise FitIncompleteError()
        index = data.index
...
class MLPMultiTaskClassifier(_MLPMultiTaskBase):
    ...
    Parameters
    ----------
    hidden_layer_size : list (tuple) of int
    ...
    def fit(self, data=None, key=None, features=None, label=None, categorical_variable=None,
            pre_model=None):
        r"""
    ...
    def predict(self, data=None, key=None, features=None, verbose=None, model=None):
        r"""
