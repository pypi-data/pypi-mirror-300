...
class TaskManager(threading.Thread):
    def __init__(self, automatic_obj_proxy: Union[AutomaticObjProxy, AutomaticEmptyObjProxy], update_ui_interval, fetch_table_interval, debug=False):
        ...
        self.already_switch_to_another_fetch_task = False  # default fetch table: PAL Content Table | auto detect and switch to another table
    ...
    def switch_to_another_fetch_task(self):
        if self.already_switch_to_another_fetch_task:
            self.set_cancelling()
        else:
            self.already_switch_to_another_fetch_task = True
