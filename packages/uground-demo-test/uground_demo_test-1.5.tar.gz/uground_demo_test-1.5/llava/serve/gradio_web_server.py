...
def resize_image(image_data, default_width=(1344, 896), request_width=None):
...
def http_bot(state, model_selector, temperature, top_p, max_new_tokens, request: gr.Request):
    ...
    if len(all_images) > 0:
        ...
        resized_image = resize_image(all_images[0])
        ...
        with gr.Row():
            with gr.Column(scale=3):
                ...
                gr.Examples(examples=[
                    [f"{cur_dir}/amazon.jpg", "Where are the pixel coordinates of the element corresponding to \"Search bar at the top of the page\"?"],
