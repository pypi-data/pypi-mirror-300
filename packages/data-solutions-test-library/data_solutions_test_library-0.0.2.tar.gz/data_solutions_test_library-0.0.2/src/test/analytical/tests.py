...
class AnalyticalTests(unittest.TestCase):
    ...
    def test_successful_query(self, mocked_issue_request: Mock, mocked_sleep: Mock):
        ...
        query_result = ds.sql.analytical(
    ...
    @patch("chainalysis.sql._analytical.sleep", return_value=None)
    @patch("chainalysis.sql._analytical.issue_request")
    def test_missing_query_id(self, mocked_issue_request: Mock, mocked_sleep: Mock):
        ds = DataSolutionsClient(
            api_key="",
        )
    ...
    @patch("chainalysis.sql._analytical.sleep", return_value=None)
    @patch("chainalysis.sql._analytical.issue_request")
    def test_first_api_exception(self, mocked_issue_request: Mock, mocked_sleep: Mock):
        ds = DataSolutionsClient(
            api_key="",
        )
    ...
    @patch("chainalysis.sql._analytical.sleep", return_value=None)
    @patch("chainalysis.sql._analytical.issue_request")
    def test_second_api_exception(self, mocked_issue_request: Mock, mocked_sleep: Mock):
        ds = DataSolutionsClient(
            api_key="",
        )
        ...
        query_result = ds.sql.analytical("", polling_interval_sec=0, autopaginate=False)
    ...
    def test_interval_server_exception(
        self, mocked_issue_request: Mock, mocked_sleep: Mock
    ):
        ds = DataSolutionsClient(
            api_key="",
        )
    ...
    @patch("chainalysis.sql._analytical.sleep", return_value=None)
    @patch("chainalysis.sql._analytical.issue_request")
    def test_unhandled_exception(self, mocked_issue_request: Mock, mocked_sleep: Mock):
        ds = DataSolutionsClient(
            api_key="",
        )
    ...
    def test_get_next_page_successful(
        ...
        first_query_result = ds.sql.analytical(
    ...
    @patch("chainalysis.sql._analytical.sleep", return_value=None)
    @patch("chainalysis.sql._analytical.issue_request")
    def test_get_next_page_error(self, mocked_issue_request: Mock, mocked_sleep: Mock):
        ds = DataSolutionsClient(
            api_key="",
        )
    ...
    def test_get_next_page_with_no_next_page_error(
        ...
        first_query_result = ds.sql.analytical("", polling_interval_sec=0)
    ...
    @patch("chainalysis.sql._analytical.sleep", return_value=None)
    @patch("chainalysis.sql._analytical.issue_request")
    def test_auto_pagination(self, mocked_issue_request: Mock, mocked_sleep: Mock):
        """
        ...
        query_result = ds.sql.analytical("", polling_interval_sec=0, autopaginate=True)
    ...
    @patch("chainalysis.sql._analytical.sleep", return_value=None)
    @patch("chainalysis.sql._analytical.issue_request")
    def test_status_error(self, mocked_issue_request: Mock, mocked_sleep: Mock):
        ds = DataSolutionsClient(
            api_key="",
        )
    ...
    @patch("chainalysis.sql._analytical.sleep", return_value=None)
    @patch("chainalysis.sql._analytical.issue_request")
    def test_polling_interval_is_updated_if_less_than_5(
        self, mocked_issue_request: Mock, mocked_sleep: Mock
    ):
        ds = DataSolutionsClient(
            api_key="",
        ...
        ds.sql.analytical("", polling_interval_sec=3, autopaginate=False)
