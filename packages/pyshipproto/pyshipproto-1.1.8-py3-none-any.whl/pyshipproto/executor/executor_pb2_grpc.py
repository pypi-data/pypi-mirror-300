...
from . import executor_pb2 as executor_dot_executor__pb2
...
class ExecutorServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ExecuteCode = channel.unary_unary(
                '/executor.ExecutorService/ExecuteCode',
                request_serializer=executor_dot_executor__pb2.ExecutorRequest.SerializeToString,
                response_deserializer=executor_dot_executor__pb2.ExecutorResponse.FromString,
...
def add_ExecutorServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'ExecuteCode': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=executor_dot_executor__pb2.ExecutorRequest.FromString,
                    response_serializer=executor_dot_executor__pb2.ExecutorResponse.SerializeToString,
            ),
    }
...
class ExecutorService(object):
    ...
    def ExecuteCode(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/executor.ExecutorService/ExecuteCode',
            executor_dot_executor__pb2.ExecutorRequest.SerializeToString,
            executor_dot_executor__pb2.ExecutorResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
