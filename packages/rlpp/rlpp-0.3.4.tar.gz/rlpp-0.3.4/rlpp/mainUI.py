...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tabWidget.setStyleSheet("background-color: rgb(0, 255, 247);")
        ...
        self.pushButton.setStyleSheet("background-color: rgb(20,65,65);")
        self.pushButton.setText("")
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(RESOURCES_PATH+"/icons/select.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButton.setIcon(icon4)
        self.pushButton.setIconSize(QtCore.QSize(30, 30))
        self.pushButton.setObjectName("pushButton")
        self.pushButton_2 = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_2.setGeometry(QtCore.QRect(660, 90, 51, 51))
        self.pushButton_2.setStyleSheet("background-color: rgb(20,65,65);")
        self.pushButton_2.setText("")
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(RESOURCES_PATH+"/icons/stamp.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButton_2.setIcon(icon5)
        self.pushButton_2.setIconSize(QtCore.QSize(30, 30))
        self.pushButton_2.setObjectName("pushButton_2")
        self.pushButton_3 = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_3.setGeometry(QtCore.QRect(660, 150, 51, 51))
        self.pushButton_3.setStyleSheet("background-color: rgb(20,65,65);")
        self.pushButton_3.setText("")
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(RESOURCES_PATH+"/icons/trash.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButton_3.setIcon(icon6)
        self.pushButton_3.setIconSize(QtCore.QSize(30, 30))
        self.pushButton_3.setObjectName("pushButton_3")
        self.pushButton_4 = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_4.setGeometry(QtCore.QRect(660, 210, 51, 51))
        self.pushButton_4.setStyleSheet("background-color: rgb(20,65,65);")
        self.pushButton_4.setText("")
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(RESOURCES_PATH+"/icons/rotate.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.pushButton_5.setStyleSheet("background-color: rgb(20,65,65);")
        self.pushButton_5.setText("")
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(RESOURCES_PATH+"/icons/move.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
    ...
    def createNewButton(self,file_name,scrollArea,game_object_type):
        ...
        new_pushButton.setObjectName(f"pushButton_new")  # Set a unique object name
        ...
        if layout is not None:
            ...
            new_pushButton.clicked.connect(lambda: objectManager.create_new_gameObject(new_pushButton.img_path_name,game_object_type))
        else:
    ...
    def changeRes(self, file_name,res):
        ...
        new_dims = (RES,int(RES * height_ratio))
