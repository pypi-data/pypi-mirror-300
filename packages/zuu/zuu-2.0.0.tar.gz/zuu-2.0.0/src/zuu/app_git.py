from zuu._os import preserve_cwd
import os


@preserve_cwd
def git_create_empty_branch(path: str, name: str, switch_back: bool = False):
    """
...
@preserve_cwd
def git_update_repo(path: str, url: str = None, branch: str = None):
    """
