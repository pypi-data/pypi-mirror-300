import pytest
import os
from zuu.app_github import (
    download_github_raw_content,
    git_last_commit,
    extract_commit,
    download_github_gist,
)
...
class TestGitHubFunctions:
    ...
    def test_download_github_raw_content(self):
        content = download_github_raw_content(
    ...
    def test_git_last_commit(self):
        commit = git_last_commit(self.test_repo, self.test_file)
    ...
    def test_download_github_gist(self):
        content = download_github_gist(
