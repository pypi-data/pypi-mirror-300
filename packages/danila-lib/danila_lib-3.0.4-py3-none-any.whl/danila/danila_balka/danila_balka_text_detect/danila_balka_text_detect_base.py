...
from data.neuro.balka_text_detect_altai_class import Balka_text_detect_altai_class
...
class Danila_balka_text_detect_base:
    def __init__(self, yolov5_dir, balka_detect_version, balka_text_detect_version):
        ...
        self.balka_detect_objects[balka_prod.Balka_Prod.begickaya] = Balka_detect_class(
            LOCAL_BALKA_BEGICKAYA_DETECT_MODEL_ADDRESS, yolov5_dir)
        ...
        self.balka_detect_objects[balka_prod.Balka_Prod.promlit] = Balka_detect_class(
            LOCAL_BALKA_PROMLIT_DETECT_MODEL_ADDRESS, yolov5_dir)
        ...
        self.balka_detect_objects[balka_prod.Balka_Prod.ruzhimmash] = Balka_detect_class(
            LOCAL_BALKA_RUZHIMMASH_DETECT_MODEL_ADDRESS, yolov5_dir)
        ...
        self.balka_detect_objects[balka_prod.Balka_Prod.tihvin] = Balka_detect_class(
            LOCAL_BALKA_TIHVIN_DETECT_MODEL_ADDRESS,
            yolov5_dir)
        print('reading and loading - BALKA_ALTAI_DETECT_MODEL')
        if balka_detect_version == 2:
            self.balka_detect_objects[balka_prod.Balka_Prod.altai] = Balka_detect_class(
                LOCAL_BALKA_ALTAI_DETECT_MODEL_ADDRESS_2, yolov5_dir)
        else:
            self.balka_detect_objects[balka_prod.Balka_Prod.altai] = Balka_detect_class(
                LOCAL_BALKA_ALTAI_DETECT_MODEL_ADDRESS, yolov5_dir)
        ...
        self.balka_text_detect_objects[balka_prod.Balka_Prod.ruzhimmash] = Balka_text_detect_class(
            LOCAL_BALKA_RUZHIMMASH_TEXT_DETECT_MODEL_ADDRESS, yolov5_dir, balka_prod.Balka_Prod.ruzhimmash)
        ...
        self.balka_text_detect_objects[balka_prod.Balka_Prod.tihvin] = Balka_text_detect_class(
            LOCAL_BALKA_TIHVIN_TEXT_DETECT_MODEL_ADDRESS,
            yolov5_dir, balka_prod.Balka_Prod.tihvin)
        if balka_text_detect_version > 1:
            print('reading and loading - BALKA_ALTAI_TEXT_DETECT_MODEL')
            self.balka_text_detect_objects[balka_prod.Balka_Prod.altai] = Balka_text_detect_altai_class(
                LOCAL_BALKA_ALTAI_TEXT_DETECT_MODEL_ADDRESS_2, yolov5_dir, balka_prod.Balka_Prod.altai)
            if balka_text_detect_version > 2:
                ...
                self.balka_text_detect_objects[balka_prod.Balka_Prod.begickaya] = Balka_text_detect_class(
                    LOCAL_BALKA_BEGICKAYA_TEXT_DETECT_MODEL_ADDRESS_2, yolov5_dir, balka_prod.Balka_Prod.begickaya)
                if balka_text_detect_version > 3:
                    ...
                    self.balka_text_detect_objects[balka_prod.Balka_Prod.promlit] = Balka_text_detect_class(
                        LOCAL_BALKA_PROMLIT_TEXT_DETECT_MODEL_ADDRESS_2, yolov5_dir, balka_prod.Balka_Prod.promlit)
                else:
                    print('reading and loading - BALKA_PROMLIT_TEXT_DETECT_MODEL')
                    self.balka_text_detect_objects[balka_prod.Balka_Prod.promlit] = Balka_text_detect_class(
                        LOCAL_BALKA_PROMLIT_TEXT_DETECT_MODEL_ADDRESS, yolov5_dir, balka_prod.Balka_Prod.promlit)
            else:
                print('reading and loading - BALKA_BEGICKAYA_TEXT_DETECT_MODEL')
                self.balka_text_detect_objects[balka_prod.Balka_Prod.begickaya] = Balka_text_detect_class(
                    LOCAL_BALKA_BEGICKAYA_TEXT_DETECT_MODEL_ADDRESS, yolov5_dir, balka_prod.Balka_Prod.begickaya)
                print('reading and loading - BALKA_PROMLIT_TEXT_DETECT_MODEL')
                self.balka_text_detect_objects[balka_prod.Balka_Prod.promlit] = Balka_text_detect_class(
                    LOCAL_BALKA_PROMLIT_TEXT_DETECT_MODEL_ADDRESS, yolov5_dir, balka_prod.Balka_Prod.promlit)
        else:
            ...
            self.balka_text_detect_objects[balka_prod.Balka_Prod.altai] = Balka_text_detect_class(
                LOCAL_BALKA_ALTAI_TEXT_DETECT_MODEL_ADDRESS, yolov5_dir, balka_prod.Balka_Prod.altai)
            print('reading and loading - BALKA_BEGICKAYA_TEXT_DETECT_MODEL')
            self.balka_text_detect_objects[balka_prod.Balka_Prod.begickaya] = Balka_text_detect_class(
                LOCAL_BALKA_BEGICKAYA_TEXT_DETECT_MODEL_ADDRESS, yolov5_dir, balka_prod.Balka_Prod.begickaya)
            print('reading and loading - BALKA_PROMLIT_TEXT_DETECT_MODEL')
