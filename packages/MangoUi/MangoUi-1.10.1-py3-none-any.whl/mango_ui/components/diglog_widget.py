...
from mango_ui.enums.enums import *
from mango_ui.models.models import FormDataModel, DialogCallbackModel
...
class DialogWidget(MangoDialog):
    ...
    def __init__(self, tips: str, form_data: list[FormDataModel], size: super = (400, 300)):
        ...
        cancel_button = MangoPushButton("取消", color=THEME.bg_one)
        cancel_button.clicked.connect(self.reject)
        button_layout.addWidget(cancel_button)
        submit_button = MangoPushButton("提交", color=THEME.blue)
        ...
        for form in self.form_data:
            ...
            if form.required:
                if value is None or value == '':
                    from mango_ui.components import error_message
                    self.data = {}
