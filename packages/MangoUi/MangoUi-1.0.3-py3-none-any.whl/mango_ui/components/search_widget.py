...
from mango_ui.models.models import SearchDataModel
...
class SearchWidget(QWidget):
    ...
    def __init__(self, search_data: list[SearchDataModel]):
        ...
        self.search_but = MangoPushButton('搜索',color=THEME.blue)
        ...
        self.reset_but = MangoPushButton('重置', color=THEME.red)
