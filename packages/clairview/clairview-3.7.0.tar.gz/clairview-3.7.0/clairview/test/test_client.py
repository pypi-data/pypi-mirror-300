...
from clairview.client import Client
from clairview.test.test_utils import FAKE_TEST_API_KEY
from clairview.version import VERSION
...
class TestClient(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.client_post_patcher = mock.patch("clairview.client.batch_post")
        cls.consumer_post_patcher = mock.patch("clairview.consumer.batch_post")
    ...
    def test_basic_capture(self):
        ...
        self.assertEqual(msg["properties"]["$lib"], "clairview-python")
        ...
        with mock.patch.object(Client, "capture", return_value=None) as patch_capture:
            ...
            self.assertEqual(
                capture_call[2],
                {
                    ...
                    "$exception_personURL": "https://us.i.clairview.com/project/random_key/person/python-exceptions",
                },
            )
        ...
        with mock.patch.object(Client, "capture", return_value=None) as patch_capture:
            ...
            self.assertEqual(
                capture_call[2],
                {
                    ...
                    "$exception_personURL": "https://us.i.clairview.com/project/random_key/person/distinct_id",
                },
            )
    ...
    def test_basic_capture_exception_with_correct_host_generation_for_server_hosts(self):
        ...
        with mock.patch.object(Client, "capture", return_value=None) as patch_capture:
            client = Client(FAKE_TEST_API_KEY, on_error=self.set_fail, host="https://app.clairview.com")
            exception = Exception("test exception")
            client.capture_exception(exception, "distinct_id")
            ...
            self.assertEqual(
                capture_call[2],
                {
                    ...
                    "$exception_personURL": "https://app.clairview.com/project/random_key/person/distinct_id",
                },
            )
    ...
    def test_basic_capture_exception_with_no_exception_given(self):
        ...
        with mock.patch.object(Client, "capture", return_value=None) as patch_capture:
            ...
            self.assertEqual(
                capture_call[2]["$exception_list"][0]["stacktrace"]["frames"][0]["module"], "clairview.test.test_client"
            )
    ...
    def test_basic_capture_exception_with_no_exception_happening(self):
        ...
        with mock.patch.object(Client, "capture", return_value=None) as patch_capture:
            with self.assertLogs("clairview", level="WARNING") as logs:
                ...
                self.assertEqual(
                    logs.output[0],
                    "WARNING:clairview:No exception information available",
                )

    @mock.patch("clairview.client.decide")
        ...
        multivariate_flag = {
            ...
            "filters": {
                "groups": [
                    {
                        "properties": [
                            {"key": "email", "type": "person", "value": "test@clairview.com", "operator": "exact"}
                        ],
                        "rollout_percentage": 100,
                    },
                    {
    ...
    def test_groups_capture(self):
        success, msg = self.client.capture(
            "distinct_id",
            "test_event",
            groups={"company": "id:5", "instance": "app.clairview.com"},
        )

        self.assertTrue(success)
        self.assertEqual(msg["properties"]["$groups"], {"company": "id:5", "instance": "app.clairview.com"})
    ...
    def test_basic_page(self):
        client = self.client
        success, msg = client.page("distinct_id", url="https://clairview.com/contact")
        self.assertFalse(self.failed)
        client.flush()
        self.assertTrue(success)
        self.assertEqual(msg["distinct_id"], "distinct_id")
        self.assertEqual(msg["properties"]["$current_url"], "https://clairview.com/contact")
    ...
    def test_user_defined_flush_at(self):
        ...
        # each time.
        with mock.patch("clairview.consumer.batch_post", side_effect=mock_post_fn) as mock_post:
            for _ in range(20):
                client.identify("distinct_id", {"trait": "value"})
            time.sleep(1)
    ...
    @mock.patch("clairview.client.Poller")
    @mock.patch("clairview.client.get")
    ...
    def test_default_properties_get_added_properly(self, patch_decide):
        ...
        client = Client(FAKE_TEST_API_KEY, host="http://app2.clairview.com", on_error=self.set_fail, disable_geoip=False)
        ...
        patch_decide.assert_called_with(
            ...
            group_properties={
                ...
                "instance": {"$group_key": "app.clairview.com"},
            },
            disable_geoip=False,
        )
