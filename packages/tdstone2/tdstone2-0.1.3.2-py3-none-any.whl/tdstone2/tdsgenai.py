...
def save_tokenizer_and_embeddings_model_onnx(model_name: str, local_dir: str, device: str = "cpu",
    ...
    command = f"optimum-cli export onnx --task sentence-similarity --opset {opset_version} --trust-remote-code -m {model_name} {local_dir.replace('\\','/')}"
