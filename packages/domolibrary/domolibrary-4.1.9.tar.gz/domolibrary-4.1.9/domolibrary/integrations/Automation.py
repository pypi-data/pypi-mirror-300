...
async def share_domo_account_with_domo_group(
    ...
    access_level = dmacc.ShareAccount_V2_AccessLevel.CAN_VIEW
) -> str:
    ...
    return await domo_account._share_v2(group_id=share_domo_group.id, auth=auth, debug_api = debug_api, access_level=access_level)
...
# %% ../../nbs/integrations/Automation.ipynb 11
