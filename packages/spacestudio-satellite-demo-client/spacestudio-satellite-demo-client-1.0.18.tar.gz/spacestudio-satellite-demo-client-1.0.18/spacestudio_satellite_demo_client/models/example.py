...
class Example(BaseModel):
    ...
    Example
    """ # noqa: E501
    name: StrictStr = Field(description="The name of the example to import")
    description: Optional[StrictStr] = Field(default=None, description="The description of the example to import")
