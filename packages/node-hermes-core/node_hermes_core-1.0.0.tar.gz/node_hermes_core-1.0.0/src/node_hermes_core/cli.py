...
import click
from hermes_core.nodes.depedency import HermesDependencies
from hermes_core.loader import load_modules
...
def schema(output: str, packages: List[str] | None, config: str | None):
    ...
    from hermes_core.nodes.root_nodes import HermesConfig
