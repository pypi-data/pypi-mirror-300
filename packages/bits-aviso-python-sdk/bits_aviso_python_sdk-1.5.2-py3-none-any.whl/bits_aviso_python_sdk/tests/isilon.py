...
def test():
    ...
    google_project = 'bits-aviso-data-lake-dev'
    credentials_secret = 'isilon-api'
    clusters_secret = 'isilon-clusters'
    ...
    isilon = Isilon(username, password, clusters, dns_resolve=True)
