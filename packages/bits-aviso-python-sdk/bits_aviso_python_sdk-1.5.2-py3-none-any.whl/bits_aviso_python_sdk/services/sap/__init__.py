...
class SAP:
    def __init__(self, username, password, url='https://pasteur.broadinstitute.org:8005', dns_resolve=False):
        """Initializes the SAP class.

        Args:
            username (str): The username to authenticate with.
            password (str): The password to authenticate with.
            url (str, optional): The URL of the SAP server. Defaults to 'https://pasteur.broadinstitute.org:8005'.
    ...
    def api_handler(self, endpoint, payload):
        ...
        if self.dns_resolve:
            base_url = resolve_dns(url=self.url)
        ...
        try:
            ...
            if response.status_code != 200:
                ...
                requests.exceptions.ConnectTimeout, TimeoutError) as e:
