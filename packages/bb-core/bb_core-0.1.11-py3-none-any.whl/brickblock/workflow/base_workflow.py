...
class Workflow:
    ...
    def _build_output_model(self) -> Type[BaseModel]:
        ...
        output_fields = {pipeline.id: (pipeline.output_model, ...) for pipeline in self.workflow_pipelines}
    ...
    async def _process_pipeline_async(self, pipeline: Pipeline, input_data: dict) -> dict:
    ...
    def run(self, input_data: dict) -> dict:
        ...
        with ThreadPoolExecutor() as executor:
            futures = [executor.submit(self._process_pipeline, p, input_data) for p in self.workflow_pipelines]
