...
class MachaaoSession:
    def __init__(self, request, environ="dev", server_session_create_time=None):
        ...
        self.user_message, self.user, self.os, self.client, self.sdk, self.attachments = self._extract_message(request)
    ...
    def _extract_message(self, req):
        ...
        return message, _user, _os, _client, _sdk, attachments
