...
class Elbv2Api:
    ...
    def create_load_balancer(
        ...
        :param ip_address_type: Note: Internal load balancers must use the ``ipv4`` IP address type.
    ...
    def set_subnets(
        ...
        **kwargs,
        ...
        :param ip_address_type: [Application Load Balancers] The IP address type.
