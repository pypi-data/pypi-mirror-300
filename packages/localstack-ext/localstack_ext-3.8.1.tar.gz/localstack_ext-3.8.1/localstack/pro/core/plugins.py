...
from localstack.pro.core.bootstrap import licensingv2,tls_certificate
...
def setup_pro_infra():
	...
	modify_gateway_listen_config(localstack_config);from localstack.pro.core.aws.protocol import service_router as B;from localstack.pro.core.utils.aws import aws_utils as C;B.patch_service_router();C.patch_aws_utils();configure_licensing_for_service_plugins();set_default_providers_to_pro();tls_certificate.patch_setup_ssl_cert()
