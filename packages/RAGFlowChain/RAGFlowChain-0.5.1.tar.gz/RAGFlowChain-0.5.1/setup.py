...
setup(
    ...
    install_requires=[
        ...
        "chromadb>=0.3.21",
        "python-pptx>=0.6.21",
        "python-docx>=0.8.11",  # Keep this one; remove `docx`
        "faiss-cpu>=1.7.2",  
        "annoy>=1.17.0",
        "pytube>=12.0.0",
        "pypdf>=3.0.0",
    ...
    python_requires='>=3.7',  # More reasonable minimum Python version
    classifiers=[
    ...
    keywords=[
        ...
        "Generative AI", "AI", "Machine Learning", "ML", "GenAI", "LangChain",
        "Data Processing", "Information Retrieval", "NLP", "Natural Language Processing",
        "Data Science", "Python", "Text Mining", "Document Processing",
        "FAISS", "Annoy", "Chroma", "pytube", "nltk", "transformers"
    ],
)
