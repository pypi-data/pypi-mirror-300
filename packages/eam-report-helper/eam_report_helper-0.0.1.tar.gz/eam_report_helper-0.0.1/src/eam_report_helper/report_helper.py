...
from shared_functions.reports.report_helper_forms import FormReportHelper

from shared_functions.reports.helpers import generate_csv

from shared_functions.reports.report_safety_tickets import SafetyTicketsReport
from shared_functions.reports.report_vendor_documents import VendorDocumentsReport
from shared_functions.reports.report_emp_questions import EmpQuestionsReport
from shared_functions.reports.report_vendor_deficiencies import VendorDeficienciesReport
from shared_functions.reports.report_newly_added_vendors import NewlyAddedVendorReport
from shared_functions.reports.report_operator_tickets import OperatorTicketReport
        ...
        match report_id:
            ...
            case 'cecee74f-2f2f-46d5-8fb3-3e3e624f7587':
                results = FormReportHelper(self.db, self.b2c_helper).get_form_report(
                    "bbb961a1-e9ab-4419-bb21-34f4515e3997", "Insignia_IncidentReport_Tracking.csv")

            case 'dc9b4bb1-91d6-4b37-aa9d-ee53cc7209b5':
                results = FormReportHelper(self.db, self.b2c_helper).get_form_report(
                    "19ae3e00-bfb9-4105-8f44-7e5bb740afc8", "Insignia_NearMiss_HazID_Tracking.csv")

            case '57dcd8cd-49bb-4ebc-8c6c-5db3c360d308':
                results = FormReportHelper(self.db, self.b2c_helper).get_form_report(
                    "b3e979a8-19e0-49bb-b5dd-504df0b056bc", "Insignia_RegulatoryCorrectiveAction_Tracking.csv")
