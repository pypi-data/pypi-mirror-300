...
from .conv import Conv, DWConv, GhostConv, BeeF, LightConv, RepConv, autopad
...
class Bi2f(nn.Module):
    ...
    def __init__(self, c1, c2, n=1, shortcut=False, g=1, e=0.5):
        ...
        super().__init__()
        self.c = int(c2 * e)  # hidden channels
        self.cv1 = BeeF(c1, 2 * self.c, 1, 1)
        self.cv2 = BeeF((2 + n) * self.c, c2, 1)  # optional act=FReLU(c2)
        self.m = nn.ModuleList(Bottleneck(self.c, self.c, shortcut, g, k=((3, 3), (3, 3)), e=1.0) for _ in range(n))
