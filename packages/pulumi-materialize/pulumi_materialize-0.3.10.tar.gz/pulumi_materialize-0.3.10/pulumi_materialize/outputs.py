...
class ConnectionAwsAccessKeyIdSecret(dict):
    ...
    def __init__(__self__, *,
        ...
        :param str database_name: The identifier for the connection database in Materialize. Defaults to `MZ_DATABASE` environment variable if set or `materialize` if environment variable is not set.
        :param str schema_name: The identifier for the connection schema in Materialize. Defaults to `public`.
        """
...
class GetSystemParametersParameterResult(dict):
    def __init__(__self__, *,
                 ...
                 setting: str):
        """
        :param str name: The name of the specific system parameter to fetch.
        """
        pulumi.set(__self__, "description", description)
        pulumi.set(__self__, "name", name)
...
class SinkKafkaFormatAvroAvroDocColumnObject(dict):
    ...
    def __init__(__self__, *,
        ...
        :param str database_name: The identifier for the sink database in Materialize. Defaults to `MZ_DATABASE` environment variable if set or `materialize` if environment variable is not set.
        :param str schema_name: The identifier for the sink schema in Materialize. Defaults to `public`.
        """
        pulumi.set(__self__, "name", name)
        if database_name is not None:
            pulumi.set(__self__, "database_name", database_name)
