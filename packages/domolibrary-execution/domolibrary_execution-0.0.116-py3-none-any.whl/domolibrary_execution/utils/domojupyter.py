...
# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/domojupyter/domojupyter.ipynb.
...
# %% ../../nbs/domojupyter/domojupyter.ipynb 3
...
import domolibrary_execution.client as dxde
...
def read_domo_jupyter_account(
    ...
    try:
        ...
        raise DJ_Workspace_NoAuth(
            ...
            message= f"🤯🤯 unable to retrieve {account_name} - {e}",
        ) from e
...
# %% ../../nbs/domojupyter/domojupyter.ipynb 7
def remove_asterix(text):
    if text == "" or text == "********":
        return None
    return text

# %% ../../nbs/domojupyter/domojupyter.ipynb 8
...
# %% ../../nbs/domojupyter/domojupyter.ipynb 9
...
# %% ../../nbs/domojupyter/domojupyter.ipynb 10
...
# %% ../../nbs/domojupyter/domojupyter.ipynb 11
async def generate_domo_auth(
    ...
    if backup_auth and not backup_auth.is_valid_token:
        await backup_auth.print_is_token()
        return backup_auth

    raise DJ_Workspace_NoAuth(account_name = account_name, message = "no account or backup account returned")
