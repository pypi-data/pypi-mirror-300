...
__all__ = ['which_environment', 'DJ_Workspace_NoAuth', 'read_domo_jupyter_account', 'get_creds_from_domojupyter_account',
           'DJ_Workspace_InvalidCreds', 'generate_token_auth', 'generate_full_auth']

# %% ../../nbs/domojupyter/domojupyter.ipynb 2
...
# %% ../../nbs/domojupyter/domojupyter.ipynb 4
...
def read_domo_jupyter_account(
    ...
    try:
        ...
        raise DJ_Workspace_NoAuth(
            ...
            message="🤯🤯 unable to retrieve {account_name} - {e}",
        ) from e
...
async def get_creds_from_domojupyter_account(
    account_name: str,
    domojupyter_fn: Callable,
    is_abstract: bool,
) -> dict:
...
async def generate_token_auth(
    ...
    auth = dmda.DomoTokenAuth(
        domo_instance=domo_instance, domo_access_token=creds["domoAccessToken"]
    )
