...
def main():
    ...
    parser.add_argument('-m', '--mode', '--engine', type=str, help='Method to use for calculating the size of files in Cloud Storage. Options are: auto, rclone, metrics, sdk')
    ...
    result = get_bucket_objects_count_and_bytes(input_uri)
    if result is None:
