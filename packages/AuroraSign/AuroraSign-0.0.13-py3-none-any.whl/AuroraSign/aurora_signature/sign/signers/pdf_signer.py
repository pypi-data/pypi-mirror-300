...
from ...pdf_utils.crypt import pdfmac
from ...pdf_utils.generic import pdf_name
from ...pdf_utils.incremental_writer import IncrementalPdfFileWriter
from ...pdf_utils.reader import PdfFileReader
from ...pdf_utils.writer import BasePdfFileWriter
from ...sign import attributes
from ...sign.ades.api import CAdESSignedAttrSpec
...
from ...stamp import BaseStampStyle
...
class PdfSigner:
    ...
    def _enforce_certification_constraints(self, reader: PdfFileReader):
        ...
        from ...sign.validation import read_certification_data
...
class PdfSigningSession:
    ...
    async def _perform_prev_ts_validation(
        ...
        signer = self.pdf_signer.signer
        from ...sign.validation import get_timestamp_chain
