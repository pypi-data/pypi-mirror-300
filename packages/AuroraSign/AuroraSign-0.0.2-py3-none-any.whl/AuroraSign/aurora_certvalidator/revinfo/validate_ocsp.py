...
from AuroraSign.aurora_certvalidator.authority import (
    Authority,
    AuthorityWithCert,
    TrustAnchor,
)
...
from AuroraSign.aurora_certvalidator.policy_decl import (
    CertRevTrustPolicy,
    RevocationCheckingPolicy,
    RevocationCheckingRule,
)
from AuroraSign.aurora_certvalidator.registry import (
...
async def verify_ocsp_response(
    ...
    :param validation_context:
        A AuroraSign.aurora_certvalidator.context.ValidationContext object to use for
    ...
    :raises:
        AuroraSign.aurora_certvalidator.errors.OCSPNoMatchesError - when none of the OCSP responses match the certificate
        AuroraSign.aurora_certvalidator.errors.OCSPValidationIndeterminateError - when the OCSP response could not be verified
        AuroraSign.aurora_certvalidator.errors.RevokedError - when the OCSP response indicates the certificate has been revoked
    """
