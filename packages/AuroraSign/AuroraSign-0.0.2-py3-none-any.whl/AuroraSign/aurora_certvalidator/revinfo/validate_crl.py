...
from AuroraSign.aurora_certvalidator._state import ValProcState
from AuroraSign.aurora_certvalidator.authority import Authority, AuthorityWithCert
from AuroraSign.aurora_certvalidator.context import ValidationContext
from AuroraSign.aurora_certvalidator.errors import (
...
from AuroraSign.aurora_certvalidator.ltv.types import ValidationTimingParams
from AuroraSign.aurora_certvalidator.path import ValidationPath
from AuroraSign.aurora_certvalidator.policy_decl import CertRevTrustPolicy
from AuroraSign.aurora_certvalidator.registry import CertificateRegistry
from AuroraSign.aurora_certvalidator.revinfo._err_gather import Errors
from AuroraSign.aurora_certvalidator.revinfo.archival import (
    CRLContainer,
    RevinfoUsabilityRating,
)
from AuroraSign.aurora_certvalidator.revinfo.constants import (
    KNOWN_CRL_ENTRY_EXTENSIONS,
    KNOWN_CRL_EXTENSIONS,
    VALID_REVOCATION_REASONS,
)
from AuroraSign.aurora_certvalidator.revinfo.manager import RevinfoManager
from AuroraSign.aurora_certvalidator.util import (
    ConsList,
...
def _verify_crl_signature(certificate_list, public_key):
    ...
    :raises:
        AuroraSign.aurora_certvalidator.errors.CRLValidationError - when the signature is
...
async def _validate_crl_issuer_path(
    *,
    ...
    try:
        ...
        from AuroraSign.aurora_certvalidator.validate import intl_validate_path
...
async def verify_crl(
    ...
    :param path:
        A AuroraSign.aurora_certvalidator.path.ValidationPath object of the cert's
        validation path, or in the case of an AC, the AA's validation path.

    :param validation_context:
        A AuroraSign.aurora_certvalidator.context.ValidationContext object to use for caching
    ...
    :raises:
        AuroraSign.aurora_certvalidator.errors.CRLNoMatchesError - when none of the CRLs match the certificate
        AuroraSign.aurora_certvalidator.errors.CRLValidationError - when any error occurs trying to verify the CertificateList
        AuroraSign.aurora_certvalidator.errors.RevokedError - when the CRL indicates the certificate has been revoked
    """
