...
class PathBuilder:
    ...
    def build_paths(self, end_entity_cert):
        ...
        :return:
            A list of AuroraSign.aurora_certvalidator.path.ValidationPath objects that
    ...
    def async_build_paths_lazy(
        ...
        :return:
            ...
            AuroraSign.aurora_certvalidator.path.ValidationPath objects that
            represent the possible paths from the end-entity certificate to one
        ...
        lazy = LazyPathIterator(walker, end_entity_cert)
        return lazy
