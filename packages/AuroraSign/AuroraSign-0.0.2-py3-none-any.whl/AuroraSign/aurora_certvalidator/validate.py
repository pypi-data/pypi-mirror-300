...
async def intl_validate_path(
    ...
    :param path:
        A AuroraSign.aurora_certvalidator.path.ValidationPath object of the path to validate
...
async def async_validate_path(
    ...
    :raises:
        AuroraSign.aurora_certvalidator.errors.PathValidationError - when an error occurs validating the path
        AuroraSign.aurora_certvalidator.errors.RevokedError - when the certificate or another certificate in its path has been revoked
...
def validate_tls_hostname(
    ...
    AuroraSign.aurora_certvalidator.path.ValidationPath object to ensure that the certificate
    ...
    :raises:
        AuroraSign.aurora_certvalidator.errors.InvalidCertificateError - when the certificate is not valid for TLS or the hostname
    """
...
def validate_usage(
    ...
    """
    Validates the end-entity certificate from a
    AuroraSign.aurora_certvalidator.path.ValidationPath object to ensure that the
    ...
    :raises:
        AuroraSign.aurora_certvalidator.errors.InvalidCertificateError - when the certificate is not valid for the usages specified
    """
