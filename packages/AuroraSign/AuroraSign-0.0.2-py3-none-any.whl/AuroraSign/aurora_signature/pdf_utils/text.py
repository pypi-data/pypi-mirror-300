...
from AuroraSign.aurora_signature.pdf_utils import layout
from AuroraSign.aurora_signature.pdf_utils.content import PdfContent, PdfResources, ResourceType
from AuroraSign.aurora_signature.pdf_utils.font import FontEngineFactory, SimpleFontEngineFactory
...
class TextStyle(ConfigurableMixin):
    ...
    def process_entries(cls, config_dict):
        ...
        try:
            ...
            from AuroraSign.aurora_signature.pdf_utils.font.opentype import GlyphAccumulatorFactory
