...
from AuroraSign.aurora_signature.pdf_utils.crypt import (
    SecurityHandler,
)
from AuroraSign.aurora_signature.pdf_utils.extensions import (
    DeveloperExtension,
    DevExtensionMultivalued,
)
from AuroraSign.aurora_signature.pdf_utils.generic import pdf_name
from AuroraSign.aurora_signature.pdf_utils.metadata.info import (
    update_info_dict,
    view_from_info_dict,
)
from AuroraSign.aurora_signature.pdf_utils.metadata.model import DocumentMetadata
...
from AuroraSign.aurora_signature.pdf_utils.xref import (
    OBJSTREAM_FORBIDDEN,
    ObjectStream,
    PositionDict,
    XRefStream,
...
class BasePdfFileWriter(PdfHandler):
    ...
    def set_custom_trailer_entry(
        ...
        .. warning::
            Calling this method to set an entry that is managed by aurora
    ...
    def _update_meta(self):
        ...
        try:
            ...
            from AuroraSign.aurora_signature.pdf_utils.metadata import xmp_xml
