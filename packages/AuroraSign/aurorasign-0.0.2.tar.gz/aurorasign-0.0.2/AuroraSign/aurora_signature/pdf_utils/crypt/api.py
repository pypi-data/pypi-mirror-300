...
from AuroraSign.aurora_signature.pdf_utils.crypt.cred_ser import SerialisableCredential
from AuroraSign.aurora_signature.pdf_utils.crypt.permissions import PdfPermissions
from AuroraSign.aurora_signature.pdf_utils.extensions import DeveloperExtension
from AuroraSign.aurora_signature.pdf_utils.misc import PdfReadError
...
class CryptFilter:
    ...
    *any* security handler (the leaf classes in this module aren't), but
    ...
    def _set_security_handler(self, handler):
        ...
        Called by aurora during initialisation.
        """
...
class SecurityHandler:
    ...
    :param crypt_filter_config:
        ...
        .. note::
            aurora implements legacy security handlers (which, according to
    ...
    :param encrypt_metadata:
        ...
        .. warning::
            Currently, aurora does not manage metadata streams, so until
    ...
    def build(encrypt_dict: generic.DictionaryObject) -> 'SecurityHandler':
        ...
        aurora will search the registry for a security handler with
        ...
        selected, aurora will invoke the subclass's
...
class CryptFilterConfiguration:
    ...
    :param default_file_filter:
        ...
        .. note::
            aurora currently is not aware of embedded files, so managing these
