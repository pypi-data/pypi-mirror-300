...
try:
    ...
    raise ImportError(
        "AuroraSign.aurora_signature.pdf_utils.images requires aurora to be installed with "
...
class PdfImage(PdfContent):
    ...
    def image_ref(self) -> generic.IndirectObject:
        ...
        (see :meth:`~AuroraSign.aurora_signature.pdf_utils.content.PdfContent.set_writer`).
