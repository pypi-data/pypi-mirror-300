...
class TrailerReference(Dereferenceable):
    ...
    :param reader:
        a :class:`~AuroraSign.aurora_signature.pdf_utils.reader.PdfFileReader`
    """
        ...
        if stream_data is not None:
            ...
            if as_metadata_stream:
                try:
                    ...
                    from AuroraSign.aurora_signature.pdf_utils.metadata.xmp_xml import (
                        MetadataStream,
                    )
...
class StreamObject(DictionaryObject):
    ...
    :param handler:
        ...
        :class:`.AuroraSign.aurora_signature.pdf_utils.crypt.SecurityHandler`.
    ...
    def apply_filter(
        ...
        *Note:* Calling this method on an encoded stream will first cause the
        ...
        :param filter_name:
            Name of the filter
            (see :const:`~AuroraSign.aurora_signature.pdf_utils.filters.DECODERS`)
        :param params:
