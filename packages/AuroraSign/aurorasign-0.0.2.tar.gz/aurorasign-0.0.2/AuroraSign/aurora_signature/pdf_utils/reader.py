...
class PdfFileReader(PdfHandler):
    ...
    def decrypt(self, password: Union[str, bytes]) -> AuthResult:
        ...
        .. danger::
            ...
            Currently, aurora does not enforce these restrictions, but it
            may in the future.
    ...
    def decrypt_pubkey(self, credential: EnvelopeKeyDecrypter) -> AuthResult:
        ...
        .. danger::
            ...
            data and file keys.
            aurora uses sane defaults everywhere, but other software may not.
    ...
    def embedded_signatures(self):
        ...
        :return:
            ...
            see :class:`~AuroraSign.aurora_signature.sign.validation.EmbeddedPdfSignature`.
        """
        if self._embedded_signatures is not None:
            return self._embedded_signatures
        from AuroraSign.aurora_signature.sign.fields import enumerate_sig_fields
