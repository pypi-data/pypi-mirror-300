...
from AuroraSign.aurora_signature.pdf_utils.font.api import (
    FontEngine,
    FontEngineFactory,
    ShapeResult,
)
from AuroraSign.aurora_signature.pdf_utils.misc import peek
...
try:
    ...
    raise ImportError(
        "AuroraSign.aurora_signature.pdf_utils.font.opentype requires aurora to be installed with "
