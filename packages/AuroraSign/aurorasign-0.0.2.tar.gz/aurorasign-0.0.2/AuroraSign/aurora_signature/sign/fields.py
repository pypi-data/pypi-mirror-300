...
from AuroraSign.aurora_certvalidator.authority import AuthorityWithCert
from AuroraSign.aurora_certvalidator.errors import InvalidCertificateError
from AuroraSign.aurora_certvalidator.path import ValidationPath

from AuroraSign.aurora_signature.pdf_utils import generic
from AuroraSign.aurora_signature.pdf_utils.generic import pdf_name, pdf_string
from AuroraSign.aurora_signature.pdf_utils.misc import (
    OrderedEnum,
    PdfReadError,
    get_and_apply,
)
from AuroraSign.aurora_signature.sign.general import SigningError, UnacceptableSignerError
from AuroraSign.aurora_signature.pdf_utils.rw_common import PdfHandler
...
class SigSeedValueSpec:
    ...
    def build_timestamper(self):
        ...
        :return:
            A :class:`~.AuroraSign.aurora_signature.sign.timestamps.HTTPTimeStamper`.
        """
        from AuroraSign.aurora_signature.sign.timestamps import HTTPTimeStamper
