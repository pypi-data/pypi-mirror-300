...
from AuroraSign.aurora_certvalidator._asyncio_compat import to_thread
from AuroraSign.aurora_certvalidator.registry import (
    CertificateStore,
    SimpleCertificateStore,
)

from AuroraSign.aurora_signature.pdf_utils import misc
...
from AuroraSign.aurora_signature.sign.attributes import (
...
class Signer:
    ...
    * :class:`~AuroraSign.aurora_signature.sign.pkcs11.PKCS11Signer` implements a signer that is
