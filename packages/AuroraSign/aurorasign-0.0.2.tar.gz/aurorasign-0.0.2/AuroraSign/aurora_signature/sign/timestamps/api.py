"""
Module to handle the timestamping functionality in AuroraSign.aurora_signature.
...
from AuroraSign.aurora_certvalidator import CertificateValidator
...
class TimeStamper:
    ...
    async def _ensure_dummy(self):
        ...
        if not self._dummy_response_cache:
            from AuroraSign.aurora_signature.sign import DEFAULT_MD
