...
from .aurora_signature.pdf_utils.crypt import (
    SecurityHandler,
)
from .aurora_signature.pdf_utils.extensions import (
    DeveloperExtension,
    DevExtensionMultivalued,
)
from .aurora_signature.pdf_utils.generic import pdf_name
from .aurora_signature.pdf_utils.metadata.info import (
    update_info_dict,
    view_from_info_dict,
)
from .aurora_signature.pdf_utils.metadata.model import DocumentMetadata
...
from .aurora_signature.pdf_utils.xref import (
    OBJSTREAM_FORBIDDEN,
    ObjectStream,
    PositionDict,
    XRefStream,
...
class BasePdfFileWriter(PdfHandler):
    ...
    def _update_meta(self):
        ...
        try:
            ...
            from .aurora_signature.pdf_utils.metadata import xmp_xml
