"""
Module to handle the timestamping functionality in .aurora_signature.
...
from .aurora_certvalidator import CertificateValidator
from .aurora_certvalidator.registry import SimpleCertificateStore
...
class TimeStamper:
    ...
    async def _ensure_dummy(self):
        ...
        if not self._dummy_response_cache:
            from .aurora_signature.sign import DEFAULT_MD
