...
from .aurora_certvalidator import CertificateValidator, ValidationContext
from .aurora_certvalidator.errors import PathBuildingError, PathValidationError
from .aurora_certvalidator.path import ValidationPath
from .aurora_certvalidator.validate import ACValidationResult, async_validate_ac

from .aurora_signature.pdf_utils import generic, misc
from .aurora_signature.pdf_utils.crypt import pdfmac
from .aurora_signature.pdf_utils.generic import pdf_name
from .aurora_signature.pdf_utils.incremental_writer import IncrementalPdfFileWriter
from .aurora_signature.pdf_utils.reader import PdfFileReader
from .aurora_signature.pdf_utils.writer import BasePdfFileWriter
from .aurora_signature.sign import attributes
from .aurora_signature.sign.ades.api import CAdESSignedAttrSpec
from .aurora_signature.sign.fields import (
    FieldMDPSpec,
    InvisSigSettings,
    MDPPerm,
    SeedLockDocument,
...
from .aurora_signature.sign.general import (
    SigningError,
...
from .aurora_signature.sign.timestamps import TimeStamper
from .aurora_signature.stamp import BaseStampStyle
...
class PdfTimeStamper:
    ...
    def timestamp_pdf(
        ...
        *,
        ...
        :param validation_context:
            The :class:`.aurora_certvalidator.ValidationContext`
    ...
    async def async_timestamp_pdf(
        ...
        *,
        ...
        from .aurora_signature.sign import validation
    ...
    def update_archival_timestamp_chain(
        ...
        :param validation_context:
            :class:`.aurora_certvalidator.ValidationContext` object to validate
            the last timestamp.
        :param output:
            Write the output to the specified output stream.
            If ``None``, write to a new :class:`.BytesIO` object.
...
class PdfSigner:
    ...
    def default_md_for_signer(self) -> Optional[str]:
        ...
        :class:`~aurora_signature.sign.signers.pdf_cms.Signer`.
    ...
    def _enforce_certification_constraints(self, reader: PdfFileReader):
        ...
        from .aurora_signature.sign.validation import read_certification_data
...
class PdfSigningSession:
    ...
    async def _perform_prev_ts_validation(
        ...
        signer = self.pdf_signer.signer
        from .aurora_signature.sign.validation import get_timestamp_chain
...
class PostSignInstructions:
    ...
    Defaults to :const:`~aurora_signature.sign.signers.constants.DEFAULT_MD`.
    """
