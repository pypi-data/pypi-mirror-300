...
from ..pdf_utils.crypt import (
    SecurityHandler,
)
from ..pdf_utils.extensions import (
    DeveloperExtension,
    DevExtensionMultivalued,
)
from ..pdf_utils.generic import pdf_name
from ..pdf_utils.metadata.info import (
    update_info_dict,
    view_from_info_dict,
)
from ..pdf_utils.metadata.model import DocumentMetadata
...
class BasePdfFileWriter(PdfHandler):
    ...
    def _update_meta(self):
        ...
        try:
            ...
            from ..pdf_utils.metadata import xmp_xml
