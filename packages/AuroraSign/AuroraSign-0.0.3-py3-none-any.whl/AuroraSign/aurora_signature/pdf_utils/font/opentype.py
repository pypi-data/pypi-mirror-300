...
from aurora_signature.pdf_utils.font.api import (
    FontEngine,
    FontEngineFactory,
    ShapeResult,
)
from aurora_signature.pdf_utils.misc import peek
...
try:
    ...
    raise ImportError(
        "aurora_signature.pdf_utils.font.opentype requires aurora to be installed with "
