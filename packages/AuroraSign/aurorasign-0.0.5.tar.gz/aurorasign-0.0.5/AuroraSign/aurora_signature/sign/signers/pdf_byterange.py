...
from .aurora_signature.pdf_utils.generic import pdf_date, pdf_name, pdf_string
...
from .aurora_signature.sign.general import SigningError, get_pyca_cryptography_hash
...
class PdfByteRangeDigest(generic.DictionaryObject):
    ...
    def fill(
        ...
        .. danger::
            ...
            use :class:`~aurora_signature.sign.signers.cms_embedder.PdfCMSEmbedder`
            instead.
        """
