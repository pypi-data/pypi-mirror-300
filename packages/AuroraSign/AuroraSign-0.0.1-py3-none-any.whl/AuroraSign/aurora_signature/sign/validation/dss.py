...
from aurora_sdk.aurora_certvalidator import ValidationContext
...
from aurora_sdk.aurora_signature.pdf_utils.misc import get_and_apply
...
class DocumentSecurityStore:
    ...
    def supply_dss_in_writer(
        ...
        *,
        ...
        pass them in as output from `aurora_certvalidator`.
