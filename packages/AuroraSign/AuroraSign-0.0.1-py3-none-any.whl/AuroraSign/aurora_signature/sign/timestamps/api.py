"""
Module to handle the timestamping functionality in aurora_sdk.aurora_signature.

Many PDF signature profiles require trusted timestamp tokens.
The tools in this module allow aurora to obtain such tokens from
...
from aurora_sdk.aurora_certvalidator import CertificateValidator
from aurora_sdk.aurora_certvalidator.registry import SimpleCertificateStore
...
class TimeStamper:
    ...
    async def _ensure_dummy(self):
        ...
        if not self._dummy_response_cache:
            from aurora_sdk.aurora_signature.sign import DEFAULT_MD
