...
from aurora_sdk.aurora_signature.config.api import ConfigurableMixin
from aurora_sdk.aurora_signature.config.errors import ConfigurationError
from aurora_sdk.aurora_signature.pdf_utils.layout import LayoutError
from aurora_sdk.aurora_signature.pdf_utils import content, generic, layout
from aurora_sdk.aurora_signature.pdf_utils.generic import IndirectObject, pdf_name
from aurora_sdk.aurora_signature.pdf_utils.misc import rd
from aurora_sdk.aurora_signature.pdf_utils.writer import BasePdfFileWriter
from aurora_sdk.aurora_signature.pdf_utils.text import TextBoxStyle, TextBox, DEFAULT_BOX_LAYOUT
...
def _get_background_content(bg_spec) -> content.PdfContent:
    ...
    if bg_spec == '__stamp__':
        ...
        from aurora_sdk.aurora_signature.pdf_utils.images import PdfImage
...
class BaseStampStyle(ConfigurableMixin):
    ...
    def process_entries(cls, config_dict):
        ...
        :const:`~aurora_sdk.aurora_signature.stamp.STAMP_ART_CONTENT`.
        """
