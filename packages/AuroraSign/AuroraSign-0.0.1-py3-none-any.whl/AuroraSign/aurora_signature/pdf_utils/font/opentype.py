...
from aurora_sdk.aurora_signature.pdf_utils.font.api import (
    FontEngine,
    FontEngineFactory,
    ShapeResult,
)
from aurora_sdk.aurora_signature.pdf_utils.misc import peek
...
try:
    ...
    raise ImportError(
        "aurora_sdk.aurora_signature.pdf_utils.font.opentype requires aurora to be installed with "
        "the [opentype] option. You can install missing "
        "dependencies by running \"pip install 'aurora[opentype]'\".",
        import_err,
    )
