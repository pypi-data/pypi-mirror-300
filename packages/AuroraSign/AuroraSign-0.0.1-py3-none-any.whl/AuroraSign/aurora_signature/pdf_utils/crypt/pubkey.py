...
class PubKeyCryptFilter(CryptFilter, abc.ABC):
    ...
    :param encrypt_metadata:
        ...
        .. warning::
            ...
            way aurora interprets this value.
    """
...
def _rsaes_oaep_recipient(
    ...
    from aurora_sdk.aurora_signature.sign.general import get_pyca_cryptography_hash
    from aurora_sdk.aurora_signature.sign.signers.pdf_cms import select_suitable_signing_md
...
def construct_recipient_cms(
    ...
    # KeyTransRecipientInfo object). aurora always uses AES-256 to encrypt
