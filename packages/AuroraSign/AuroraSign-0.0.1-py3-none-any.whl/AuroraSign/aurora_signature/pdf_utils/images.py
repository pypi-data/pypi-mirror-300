...
try:
    ...
    raise ImportError(
        "aurora_sdk.aurora_signature.pdf_utils.images requires aurora to be installed with "
        "the [image-support] option. You can install missing "
        "dependencies by running "
        "\"pip install 'aurora[image-support]'\".",
        e,
    )
...
class PdfImage(PdfContent):
    ...
    def image_ref(self) -> generic.IndirectObject:
        ...
        (see :meth:`~aurora_sdk.aurora_signature.pdf_utils.content.PdfContent.set_writer`).
