...
from ._util import aes_cbc_encrypt, aes_cbc_decrypt, rc4_encrypt
from .api import (
    AuthStatus,
    AuthResult,
    SecurityHandler,
...
class StandardSecurityHandler(SecurityHandler):
    ...
    For decrypting existing documents, aurora will take care of instantiating
    ...
    def build_from_pw_legacy(
        ...
        **kwargs,
        ...
        :class:`~.aurora_sdk.aurora_signature.pdf_utils.writer.PdfFileWriter`.
        ...
        :param crypt_filter_config:
            Custom crypt filter configuration. aurora will supply a reasonable
    ...
    def build_from_pw(
        ...
        **kwargs,
        ...
        to attach to a :class:`~.aurora_sdk.aurora_signature.pdf_utils.writer.PdfFileWriter`.
