...
class MemorySearchControlPanel(javax.swing.JPanel):
    ...
    class RestrictedInputDocument(javax.swing.text.DefaultStyledDocument):
        ...
        def __init__(self, __a0: ghidra.features.base.memsearch.gui.MemorySearchControlPanel): ...
        ...
        def addUndoableEditListener(self, __a0: javax.swing.event.UndoableEditListener) -> None: ...

        def createPosition(self, __a0: int) -> javax.swing.text.Position: ...

        def dump(self, __a0: java.io.PrintStream) -> None: ...

        def equals(self, __a0: object) -> bool: ...

        def getAsynchronousLoadPriority(self) -> int: ...

        def getBackground(self, __a0: javax.swing.text.AttributeSet) -> java.awt.Color: ...

        def getBidiRootElement(self) -> javax.swing.text.Element: ...

        def getCharacterElement(self, __a0: int) -> javax.swing.text.Element: ...

        def getClass(self) -> java.lang.Class: ...

        def getDefaultRootElement(self) -> javax.swing.text.Element: ...

        def getDocumentFilter(self) -> javax.swing.text.DocumentFilter: ...

        def getDocumentListeners(self) -> List[javax.swing.event.DocumentListener]: ...

        def getDocumentProperties(self) -> java.util.Dictionary: ...

        def getEndPosition(self) -> javax.swing.text.Position: ...

        def getFont(self, __a0: javax.swing.text.AttributeSet) -> java.awt.Font: ...

        def getForeground(self, __a0: javax.swing.text.AttributeSet) -> java.awt.Color: ...

        def getLength(self) -> int: ...

        def getListeners(self, __a0: java.lang.Class) -> List[java.util.EventListener]: ...

        def getLogicalStyle(self, __a0: int) -> javax.swing.text.Style: ...

        def getParagraphElement(self, __a0: int) -> javax.swing.text.Element: ...

        def getProperty(self, __a0: object) -> object: ...

        def getRootElements(self) -> List[javax.swing.text.Element]: ...

        def getStartPosition(self) -> javax.swing.text.Position: ...

        def getStyle(self, __a0: unicode) -> javax.swing.text.Style: ...

        def getStyleNames(self) -> java.util.Enumeration: ...

        @overload
        def getText(self, __a0: int, __a1: int) -> unicode: ...

        @overload
        def getText(self, __a0: int, __a1: int, __a2: javax.swing.text.Segment) -> None: ...

        def getUndoableEditListeners(self) -> List[javax.swing.event.UndoableEditListener]: ...

        def hashCode(self) -> int: ...

        def insertString(self, __a0: int, __a1: unicode, __a2: javax.swing.text.AttributeSet) -> None: ...

        def notify(self) -> None: ...

        def notifyAll(self) -> None: ...

        def putProperty(self, __a0: object, __a1: object) -> None: ...

        def readLock(self) -> None: ...

        def readUnlock(self) -> None: ...

        def remove(self, __a0: int, __a1: int) -> None: ...

        def removeDocumentListener(self, __a0: javax.swing.event.DocumentListener) -> None: ...

        def removeElement(self, __a0: javax.swing.text.Element) -> None: ...

        def removeStyle(self, __a0: unicode) -> None: ...

        def removeUndoableEditListener(self, __a0: javax.swing.event.UndoableEditListener) -> None: ...

        def render(self, __a0: java.lang.Runnable) -> None: ...

        def replace(self, __a0: int, __a1: int, __a2: unicode, __a3: javax.swing.text.AttributeSet) -> None: ...

        def setAsynchronousLoadPriority(self, __a0: int) -> None: ...

        def setCharacterAttributes(self, __a0: int, __a1: int, __a2: javax.swing.text.AttributeSet, __a3: bool) -> None: ...

        def setDocumentFilter(self, __a0: javax.swing.text.DocumentFilter) -> None: ...

        def setDocumentProperties(self, __a0: java.util.Dictionary) -> None: ...

        def setLogicalStyle(self, __a0: int, __a1: javax.swing.text.Style) -> None: ...

        def setParagraphAttributes(self, __a0: int, __a1: int, __a2: javax.swing.text.AttributeSet, __a3: bool) -> None: ...
