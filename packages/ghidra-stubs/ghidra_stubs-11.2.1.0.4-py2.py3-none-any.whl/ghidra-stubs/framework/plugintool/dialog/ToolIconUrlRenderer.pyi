...
class ToolIconUrlRenderer(docking.widgets.list.GListCellRenderer):
    ...
    @staticmethod
    def createDefaultTextRenderer(cellToTextMappingFunction: java.util.function.Function) -> docking.widgets.list.GListCellRenderer:
        """
    ...
    def setBaseFontId(self, fontId: unicode) -> None:
        """
