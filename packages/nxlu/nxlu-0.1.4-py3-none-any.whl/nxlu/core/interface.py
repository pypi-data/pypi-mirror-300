...
from nxlu.constants import get_available_algorithms
...
class LLMGraph(nx.Graph):
    ...
    def run_algorithm(self, algorithm_name: str, **kwargs) -> dict[str, Any]:
        ...
        **kwargs : dict
        ...
        if not hasattr(nx, algorithm_name):
            raise ValueError(
        ...
        if algorithm_name not in available_algorithms:
            raise ValueError(
                f"Algorithm '{algorithm_name}' is not available in NetworkX algorithms."
            )
    ...
    def get_explanation(self, algorithm_name: str) -> str:
        ...
        try:
            ...
            error_msg = f"No explanation found for algorithm '{algorithm_name}'. Run "
            "the algorithm first."
