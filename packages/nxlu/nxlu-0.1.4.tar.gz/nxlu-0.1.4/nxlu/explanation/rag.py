...
from nxlu.explanation.corpus import (
    ...
    load_graph_theory_corpus_from_txt,
    normalize_name,
)
...
class Neo4jHelper:
    ...
    def delete_nodes_in_list(self, node_names):
        ...
        DETACH DELETE n
        """
        # Convert all node names to lowercase
...
class GraphRAGPipeline:
    ...
    def load_graph_theory_corpus(self):
        ...
        self.graph_theory_corpus = load_graph_theory_corpus_from_txt(
...
def get_nodes_by_type(
    ...
    try:
        with driver.session(database=database) as session:
            ...
            RETURN value.n AS n
            """
            # Execute the query with the algorithm_type parameter
...
class AlgorithmDocstringSummarizer:
    ...
    def _get_related_knowledge(self, algorithm_name: str) -> tuple[str, list]:
        ...
        try:
            ...
            # Convert dicts to TextNode and then to NodeWithScore
            nodes = []
