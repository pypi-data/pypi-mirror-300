...
def Shopify_archive_products(shop, access_token, api_version, product_ids):
    ...
    for product_id in product_ids:
        ...
        print(f"Making post request product {product_id}")
        ...
        print(f"Product {product_id} archived successfully.")
...
def main():
    ...
    collection_unpublish=os.getenv("SHOPIFY_ETW_COLLECTION_UNPUBLISH")
    ...
    if option == '6':
        Shopify_collection_archive(shop=shop, access_token=access_token, collection_id=collection_unpublish)
    if option == '7':
        Shopify_collection_unpublish(shop=shop, access_token=access_token, collection_id=collection_unpublish)
