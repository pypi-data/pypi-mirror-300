...
def test_unit_cpuawkward_IndexedArray64_getitem_nextcarry_outindex_64_1():
    tocarry = []
...
def test_unit_cpuawkward_IndexedArray64_getitem_nextcarry_outindex_64_2():
    tocarry = []
    tocarry = (ctypes.c_int64*len(tocarry))(*tocarry)
    toindex = []
    toindex = (ctypes.c_int64*len(toindex))(*toindex)
...
def test_unit_cpuawkward_IndexedArray64_getitem_nextcarry_outindex_64_3():
...
def test_unit_cpuawkward_IndexedArray64_getitem_nextcarry_outindex_64_4():
    tocarry = [123, 123, 123, 123]
    tocarry = (ctypes.c_int64*len(tocarry))(*tocarry)
    toindex = [123, 123, 123, 123]
    toindex = (ctypes.c_int64*len(toindex))(*toindex)
...
def test_unit_cpuawkward_IndexedArray64_getitem_nextcarry_outindex_64_5():
    tocarry = [123, 123, 123, 123]
    tocarry = (ctypes.c_int64*len(tocarry))(*tocarry)
    toindex = [123, 123, 123, 123]
    toindex = (ctypes.c_int64*len(toindex))(*toindex)
