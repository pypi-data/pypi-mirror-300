...
def test_unit_cpuawkward_reduce_argmax_complex64_64_1():
    toptr = []
...
def test_unit_cpuawkward_reduce_argmax_complex64_64_3():
    toptr = [123]
    toptr = (ctypes.c_int64*len(toptr))(*toptr)
    fromptr = [1, 0, 0, 1]
    fromptr = (ctypes.c_float*len(fromptr))(*fromptr)
...
def test_unit_cpuawkward_reduce_argmax_complex64_64_4():
...
def test_unit_cpuawkward_reduce_argmax_complex64_64_5():
