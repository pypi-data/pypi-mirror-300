...
def test_unit_cpuawkward_sort_uint8_1():
    toptr = []
    ...
    ascending = True
    stable = True
    funcC = getattr(lib, 'awkward_sort_uint8')
...
def test_unit_cpuawkward_sort_uint8_2():
...
def test_unit_cpuawkward_sort_uint8_3():
    toptr = [123, 123, 123, 123, 123, 123, 123]
    toptr = (ctypes.c_uint8*len(toptr))(*toptr)
    fromptr = [8, 6, 7, 5, 3, 0, 9]
    fromptr = (ctypes.c_uint8*len(fromptr))(*fromptr)
...
def test_unit_cpuawkward_sort_uint8_4():
    toptr = [123, 123, 123, 123, 123, 123, 123]
    toptr = (ctypes.c_uint8*len(toptr))(*toptr)
    fromptr = [8, 6, 7, 5, 3, 0, 9]
    fromptr = (ctypes.c_uint8*len(fromptr))(*fromptr)
...
def test_unit_cpuawkward_sort_uint8_5():
    toptr = [123, 123, 123, 123, 123, 123, 123]
    toptr = (ctypes.c_uint8*len(toptr))(*toptr)
    fromptr = [8, 6, 7, 5, 3, 0, 9]
    fromptr = (ctypes.c_uint8*len(fromptr))(*fromptr)
