...
def test_unit_cpuawkward_sort_float64_1():
    toptr = []
    ...
    ascending = True
    stable = True
    funcC = getattr(lib, 'awkward_sort_float64')
...
def test_unit_cpuawkward_sort_float64_2():
...
def test_unit_cpuawkward_sort_float64_3():
    toptr = [123.0, 123.0, 123.0, 123.0, 123.0, 123.0, 123.0]
    toptr = (ctypes.c_double*len(toptr))(*toptr)
    fromptr = [8, 6, 7, 5, 3, 0, 9]
    fromptr = (ctypes.c_double*len(fromptr))(*fromptr)
...
def test_unit_cpuawkward_sort_float64_4():
    toptr = [123.0, 123.0, 123.0, 123.0, 123.0, 123.0, 123.0]
    toptr = (ctypes.c_double*len(toptr))(*toptr)
    fromptr = [8, 6, 7, 5, 3, 0, 9]
    fromptr = (ctypes.c_double*len(fromptr))(*fromptr)
...
def test_unit_cpuawkward_sort_float64_5():
    toptr = [123.0, 123.0, 123.0, 123.0, 123.0, 123.0, 123.0]
    toptr = (ctypes.c_double*len(toptr))(*toptr)
    fromptr = [8, 6, 7, 5, 3, 0, 9]
    fromptr = (ctypes.c_double*len(fromptr))(*fromptr)
