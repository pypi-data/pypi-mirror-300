...
def test_unit_cpuawkward_UnionArray8_64_nestedfill_tags_index_64_1():
    totags = []
    ...
    length = 0
    tag = 0
    funcC = getattr(lib, 'awkward_UnionArray8_64_nestedfill_tags_index_64')
...
def test_unit_cpuawkward_UnionArray8_64_nestedfill_tags_index_64_2():
    totags = [123]
    totags = (ctypes.c_int8*len(totags))(*totags)
    toindex = [123]
    toindex = (ctypes.c_int64*len(toindex))(*toindex)
...
def test_unit_cpuawkward_UnionArray8_64_nestedfill_tags_index_64_3():
    totags = [123, 123, 123]
    totags = (ctypes.c_int8*len(totags))(*totags)
    toindex = [123, 123, 123]
    toindex = (ctypes.c_int64*len(toindex))(*toindex)
...
def test_unit_cpuawkward_UnionArray8_64_nestedfill_tags_index_64_4():
...
def test_unit_cpuawkward_UnionArray8_64_nestedfill_tags_index_64_5():
