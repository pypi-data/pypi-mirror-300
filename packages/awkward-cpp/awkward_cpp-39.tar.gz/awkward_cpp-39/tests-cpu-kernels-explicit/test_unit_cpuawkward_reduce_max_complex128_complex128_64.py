...
def test_unit_cpuawkward_reduce_max_complex128_complex128_64_1():
    toptr = []
    ...
    funcC = getattr(lib, 'awkward_reduce_max_complex128_complex128_64')
...
def test_unit_cpuawkward_reduce_max_complex128_complex128_64_2():
    toptr = [123.0, 123.0]
    toptr = (ctypes.c_double*len(toptr))(*toptr)
    identity = -9223372036854775808
    fromptr = [0, 0]
...
def test_unit_cpuawkward_reduce_max_complex128_complex128_64_3():
    toptr = [123.0, 123.0]
    toptr = (ctypes.c_double*len(toptr))(*toptr)
    identity = -9223372036854775808
    fromptr = [1, 0, 0, 1]
...
def test_unit_cpuawkward_reduce_max_complex128_complex128_64_4():
...
def test_unit_cpuawkward_reduce_max_complex128_complex128_64_5():
