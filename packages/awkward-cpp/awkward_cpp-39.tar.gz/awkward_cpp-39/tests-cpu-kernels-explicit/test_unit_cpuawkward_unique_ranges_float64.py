...
def test_unit_cpuawkward_unique_ranges_float64_1():
    toptr = []
    ...
    offsetslength = 1
    funcC = getattr(lib, 'awkward_unique_ranges_float64')
...
def test_unit_cpuawkward_unique_ranges_float64_2():
    toptr = [123.0, 123.0]
    toptr = (ctypes.c_double*len(toptr))(*toptr)
    tooffsets = [123, 123]
    tooffsets = (ctypes.c_int64*len(tooffsets))(*tooffsets)
...
def test_unit_cpuawkward_unique_ranges_float64_3():
...
def test_unit_cpuawkward_unique_ranges_float64_4():
