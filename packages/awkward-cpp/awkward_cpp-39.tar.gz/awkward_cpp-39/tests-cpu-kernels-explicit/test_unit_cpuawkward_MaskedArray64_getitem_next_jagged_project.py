...
def test_unit_cpuawkward_MaskedArray64_getitem_next_jagged_project_1():
    starts_out = []
...
def test_unit_cpuawkward_MaskedArray64_getitem_next_jagged_project_2():
...
def test_unit_cpuawkward_MaskedArray64_getitem_next_jagged_project_3():
    starts_out = [123, 123, 123, 123]
    starts_out = (ctypes.c_int64*len(starts_out))(*starts_out)
    stops_out = [123, 123, 123, 123]
    stops_out = (ctypes.c_int64*len(stops_out))(*stops_out)
...
def test_unit_cpuawkward_MaskedArray64_getitem_next_jagged_project_4():
    starts_out = [123, 123, 123, 123]
    starts_out = (ctypes.c_int64*len(starts_out))(*starts_out)
    stops_out = [123, 123, 123, 123]
    stops_out = (ctypes.c_int64*len(stops_out))(*stops_out)
...
def test_unit_cpuawkward_MaskedArray64_getitem_next_jagged_project_5():
    starts_out = [123, 123, 123, 123]
    starts_out = (ctypes.c_int64*len(starts_out))(*starts_out)
    stops_out = [123, 123, 123, 123]
    stops_out = (ctypes.c_int64*len(stops_out))(*stops_out)
