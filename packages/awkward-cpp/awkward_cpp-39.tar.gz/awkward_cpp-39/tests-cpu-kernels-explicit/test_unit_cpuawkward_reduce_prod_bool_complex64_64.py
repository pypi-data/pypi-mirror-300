...
def test_unit_cpuawkward_reduce_prod_bool_complex64_64_1():
    toptr = []
...
def test_unit_cpuawkward_reduce_prod_bool_complex64_64_3():
...
def test_unit_cpuawkward_reduce_prod_bool_complex64_64_4():
...
def test_unit_cpuawkward_reduce_prod_bool_complex64_64_5():
    toptr = [True, True, True, True]
    toptr = (ctypes.c_bool*len(toptr))(*toptr)
