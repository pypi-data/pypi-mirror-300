...
def test_unit_cpuawkward_unique_ranges_uint32_1():
    toptr = []
    ...
    offsetslength = 1
    funcC = getattr(lib, 'awkward_unique_ranges_uint32')
...
def test_unit_cpuawkward_unique_ranges_uint32_2():
    toptr = [123, 123]
    toptr = (ctypes.c_uint32*len(toptr))(*toptr)
    tooffsets = [123, 123]
    tooffsets = (ctypes.c_int64*len(tooffsets))(*tooffsets)
...
def test_unit_cpuawkward_unique_ranges_uint32_3():
...
def test_unit_cpuawkward_unique_ranges_uint32_4():
