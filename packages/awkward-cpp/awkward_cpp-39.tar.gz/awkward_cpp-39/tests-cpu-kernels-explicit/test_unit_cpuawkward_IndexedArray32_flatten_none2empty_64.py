...
def test_unit_cpuawkward_IndexedArray32_flatten_none2empty_64_1():
    outoffsets = [123]
...
def test_unit_cpuawkward_IndexedArray32_flatten_none2empty_64_2():
    outoffsets = [123]
    outoffsets = (ctypes.c_int64*len(outoffsets))(*outoffsets)
    offsets = [0]
    offsets = (ctypes.c_int64*len(offsets))(*offsets)
...
def test_unit_cpuawkward_IndexedArray32_flatten_none2empty_64_3():
...
def test_unit_cpuawkward_IndexedArray32_flatten_none2empty_64_4():
    outoffsets = [123, 123, 123, 123, 123]
    outoffsets = (ctypes.c_int64*len(outoffsets))(*outoffsets)
    offsets = [0, 1, 1, 6]
    offsets = (ctypes.c_int64*len(offsets))(*offsets)
...
def test_unit_cpuawkward_IndexedArray32_flatten_none2empty_64_5():
    outoffsets = [123, 123, 123, 123, 123]
    outoffsets = (ctypes.c_int64*len(outoffsets))(*outoffsets)
    offsets = [0, 1, 1, 6]
    offsets = (ctypes.c_int64*len(offsets))(*offsets)
...
def test_unit_cpuawkward_IndexedArray32_flatten_none2empty_64_6():
...
def test_unit_cpuawkward_IndexedArray32_flatten_none2empty_64_7():
    outoffsets = [123, 123, 123, 123, 123, 123]
    outoffsets = (ctypes.c_int64*len(outoffsets))(*outoffsets)
    offsets = [0, 3, 3, 5]
    offsets = (ctypes.c_int64*len(offsets))(*offsets)
...
def test_unit_cpuawkward_IndexedArray32_flatten_none2empty_64_8():
    outoffsets = [123, 123, 123, 123, 123, 123]
    outoffsets = (ctypes.c_int64*len(outoffsets))(*outoffsets)
    offsets = [0, 3, 3, 4, 7]
    offsets = (ctypes.c_int64*len(offsets))(*offsets)
...
def test_unit_cpuawkward_IndexedArray32_flatten_none2empty_64_9():
    outoffsets = [123, 123, 123, 123, 123, 123]
    outoffsets = (ctypes.c_int64*len(outoffsets))(*outoffsets)
    offsets = [0, 3, 3, 4, 7]
    offsets = (ctypes.c_int64*len(offsets))(*offsets)
...
def test_unit_cpuawkward_IndexedArray32_flatten_none2empty_64_10():
...
def test_unit_cpuawkward_IndexedArray32_flatten_none2empty_64_11():
...
def test_unit_cpuawkward_IndexedArray32_flatten_none2empty_64_12():
...
def test_unit_cpuawkward_IndexedArray32_flatten_none2empty_64_13():
    outoffsets = [123, 123, 123, 123, 123, 123, 123]
    outoffsets = (ctypes.c_int64*len(outoffsets))(*outoffsets)
    offsets = [0, 5, 5, 6, 9]
    offsets = (ctypes.c_int64*len(offsets))(*offsets)
