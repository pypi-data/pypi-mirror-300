...
def test_unit_cpuawkward_IndexedArray_fill_to64_from32_1():
    toindex = []
...
def test_unit_cpuawkward_IndexedArray_fill_to64_from32_2():
...
def test_unit_cpuawkward_IndexedArray_fill_to64_from32_3():
    toindex = [123, 123, 123, 123, 123]
    toindex = (ctypes.c_int64*len(toindex))(*toindex)
    base = 0
    fromindex = [0, 1, 2, 3, -1]
...
def test_unit_cpuawkward_IndexedArray_fill_to64_from32_4():
    toindex = [123, 123, 123]
    toindex = (ctypes.c_int64*len(toindex))(*toindex)
    base = 0
    fromindex = [0, 1, 2]
...
def test_unit_cpuawkward_IndexedArray_fill_to64_from32_5():
...
def test_unit_cpuawkward_IndexedArray_fill_to64_from32_6():
    toindex = [123, 123, 123, 123, 123, 123]
    toindex = (ctypes.c_int64*len(toindex))(*toindex)
    base = 0
