...
def test_unit_cpuawkward_UnionArray8_64_regular_index_1():
    current = []
...
def test_unit_cpuawkward_UnionArray8_64_regular_index_2():
    current = [123, 123]
    current = (ctypes.c_int64*len(current))(*current)
...
def test_unit_cpuawkward_UnionArray8_64_regular_index_3():
    current = [123, 123]
    current = (ctypes.c_int64*len(current))(*current)
...
def test_unit_cpuawkward_UnionArray8_64_regular_index_4():
    current = [123, 123]
    current = (ctypes.c_int64*len(current))(*current)
