...
PS_DUMP_ENDPOINT = "/yc-receiver?dt=ps"
DF_DUMP_ENDPOINT = "/yc-receiver?dt=df"
NETSTAT_DUMP_ENDPOINT = "/yc-receiver?dt=ns"
KERNAL_DUMP_ENDPOINT = "/yc-receiver?dt=kernal"
TOP_DUMP_ENDPOINT = "/yc-receiver?dt=top"
TOPH_DUMP_ENDPOINT = "/yc-receiver?dt=toph"
DMSEG_DUMP_ENDPOINT = "/yc-receiver?dt=dmesg"
PING_DUMP_ENDPOINT = "/yc-receiver?dt=ping"
VMSTAT_DUMP_ENDPOINT = "/yc-receiver?dt=vmstat"
...
def export_all_system_data(config):
    ...
    ycrash_logger.debug(f"System Info {system_info}")
...
def capture_and_upload_system_data(config, endpoint, command):
    ...
    ycrash_logger.debug("Uploading system data...")
