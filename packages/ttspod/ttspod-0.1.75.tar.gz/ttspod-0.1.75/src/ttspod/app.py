...
ttspod_engine="whisper" # should be openai / eleven / whisper / coqui / tortoise
# sample settings for tortoise
# preset options are ultra_fast, fast, standard, high_quality
...
# or add your own folder with a few short WAV files and specify the path here
ttspod_tortoise_voice='deniro'
