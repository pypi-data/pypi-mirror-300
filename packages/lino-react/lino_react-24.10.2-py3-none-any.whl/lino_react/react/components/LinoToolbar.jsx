...
export function LayoutButton(props) {
    ...
    React.useEffect(() => {
        ...
        if (ad.extra_display_modes.includes(constants.DISPLAY_MODE_GALLERY))
          opt.push({icon: "pi-clone",
            help: localEx.i18n.t("Gallery view"),
            value: constants.DISPLAY_MODE_GALLERY});
        // if (ad.card_layout)
        if (ad.extra_display_modes.includes(constants.DISPLAY_MODE_CARDS))
