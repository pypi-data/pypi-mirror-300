...
def delete_prefill_for_skjema(
    ...
    try:
        ...
        content_json = json.loads(content)
        context.log(message=f"Deleted prefill for skjema {ra_nummer}-{versjon}: {content_json['deleted_entries']} rows ({content_json['message']})")
        return OperationResult(
            value=content_json, log=context.logs()
        )
    except Exception as e:
...
def delete_prefill_for_enhet(
    ...
    try:
        ...
        content_json = json.loads(content)
        context.log(message=f"Deleted prefill for enhet {enhetsident}-{enhetstype}: {content_json['deleted_entries']} rows ({content_json['message']})")
        return OperationResult(
            value=content_json, log=context.logs()
        )
    except Exception as e:
...
def save_prefill_for_enhet(
    ...
    try:
        ...
        return OperationResult(value=result_json, log=context.log())
    except Exception as e:
