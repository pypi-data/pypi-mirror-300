...
class FT_NorenApi:
    ...
    def login(
        ...
        config = FT_NorenApi.__service_config
    ...
    def subscribe(self, instrument: str, feed_type: int = FeedType.TOUCHLINE):
        values = {}
    ...
    def unsubscribe(self, instrument: str, feed_type: int = FeedType.TOUCHLINE):
        values = {}
