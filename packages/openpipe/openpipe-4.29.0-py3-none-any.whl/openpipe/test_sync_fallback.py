...
ft_model = "openpipe:test-tool-calls-mistral-p3"
...
def test_fallback_to_specific_client():
    client_with_fallback_client = OpenAI(timeout=0.1, api_key="wrong", openpipe={
        "fallback_client": BaseOpenAI(
...
def test_fallback_client_uses_settings():
    client_with_fallback_client = OpenAI(timeout=0.1, openpipe={
        "fallback_client": BaseOpenAI(
            api_key="wrong"
        )
    })
