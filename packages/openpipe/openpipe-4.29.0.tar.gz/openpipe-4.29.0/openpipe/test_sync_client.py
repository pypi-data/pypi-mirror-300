...
def test_sync_content_mistral():
    completion = client.chat.completions.create(
        ...
        messages=[{"role": "system", "content": "count to 3"}],
        metadata={"prompt_id": "test_sync_content_mistral"},
    )
...
def test_sync_function_call_mistral():
    completion = client.chat.completions.create(
        ...
        function_call=function_call,
        functions=[function],
        metadata={"prompt_id": "test_sync_function_call_mistral"},
    )
...
def test_sync_tool_calls_mistral():
    completion = client.chat.completions.create(
        ...
        metadata={"prompt_id": "test_sync_tool_calls_mistral"},
    )
...
def test_async_beta_parse_success():
...
def test_async_beta_parse_failure():
    try:
