...
def test_sync_reports_valid_response_payload():
    ...
    assert last_logged.metadata["prompt_id"] == "test_sync_reports_valid_response_payload"
...
def test_sync_reports_null_response_payload():
    ...
    assert last_logged.metadata["prompt_id"] == "test_sync_reports_null_response_payload"


def test_sync_reports_invalid_request_payload():
    payload = {"x": "invalid", "metadata": {"prompt_id": "test_sync_reports_invalid_request_payload"}}
    ...
    assert last_logged.resp_payload == None
    assert last_logged.metadata["prompt_id"] == "test_sync_reports_invalid_request_payload"
...
def test_sync_reports_unusual_deprecated_tags():
    ...
    assert last_logged.req_payload["messages"][0]["content"] == "count to 3"
    assert last_logged.resp_payload == None
    assert last_logged.metadata["prompt_id"] == "test_sync_reports_unusual_deprecated_tags"
