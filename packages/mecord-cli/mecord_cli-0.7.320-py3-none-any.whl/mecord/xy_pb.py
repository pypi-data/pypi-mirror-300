...
def _aigc_post(country, request, function, objStr="mecord.aigc.AigcExtObj", keep_alive=False,timeout=5):
...
def _post(url, objStr, request, function, token, keep_alive=False, timeout=5):
...
def TaskNotify(country, taskUUID, status, msg, dataStr, failSaveNotify=True, keep_alive=False, timeout=10):
    ...
    return ok
TaskNotify('sg', 'cedf672c-2de5-5b5c-aa43-c9d563ed550a', True, '', '{"data": "test"}')
