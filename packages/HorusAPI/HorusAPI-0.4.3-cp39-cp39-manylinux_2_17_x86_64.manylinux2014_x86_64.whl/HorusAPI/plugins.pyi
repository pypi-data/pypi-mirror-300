...
class PluginVariable:
    ...
    def __init__(self, id: str, name: str, description: str, type: VariableTypes, defaultValue: typing.Optional[typing.Any] = None, allowedValues: typing.Optional[typing.List[typing.Any]] = None, category: typing.Optional[str] = None, disabled: bool = False, required: bool = False, placeholder: typing.Optional[str] = None) -> None:
        """
...
class PluginBlock:
    ...
    action: Incomplete
    TYPE: Incomplete
    def __init__(self, name: str, description: str, action: typing.Optional[typing.Callable] = None, variables: typing.List[PluginVariable] = [], inputs: typing.List[PluginVariable] = [], inputGroups: typing.List[VariableGroup] = [], outputs: typing.List[PluginVariable] = [], blockType: PluginBlockTypes = ..., id: typing.Optional[str] = None) -> None:
        """
...
class InputBlock(PluginBlock):
    ...
    """
    def __init__(self, name, description, variable: PluginVariable, output: typing.Optional[PluginVariable] = None, action: typing.Optional[typing.Callable] = None, id: typing.Optional[str] = None) -> None:
        """
        :param name: The name of the block.
        :param description: The description of the block.
...
class SlurmBlock(PluginBlock):
    ...
    def __init__(self, name: str, description: str, initialAction: typing.Callable, finalAction: typing.Callable, variables: typing.List[PluginVariable] = [], inputs: typing.List[PluginVariable] = [], inputGroups: typing.List[VariableGroup] = [], outputs: typing.List[PluginVariable] = [], id: typing.Optional[str] = None, failOnSlurmError: bool = True) -> None:
        """
        :param name: The name of the block.
        :param description: The description of the block.
