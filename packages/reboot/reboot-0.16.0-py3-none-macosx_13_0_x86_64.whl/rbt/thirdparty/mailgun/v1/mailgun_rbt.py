...
class MessageServicerMiddleware(reboot.aio.internals.middleware.Middleware):
    ...
    def add_to_server(self, server: grpc.aio.Server) -> None:
        rbt.thirdparty.mailgun.v1.mailgun_pb2_grpc.add_MessageInterfaceServicer_to_server(
            self, server
        )
    ...
    async def react_mutate(
        ...
        if method == 'Send':
            ...
            while True:
                ...
                stub = rbt.thirdparty.mailgun.v1.mailgun_pb2_grpc.MessageInterfaceStub(
        ...
        async with self._state_manager.transactionally(
            ...
            async with self._state_manager.writer(
                ...
                await self._maybe_authorize(
                    method_name=
                    'rbt.thirdparty.mailgun.v1.Message.Send',
    ...
    async def Send(
        ...
        if authoritative_consensus != self.consensus_id:
            ...
            stub = rbt.thirdparty.mailgun.v1.mailgun_pb2_grpc.MessageInterfaceStub(channel)
            call = stub.Send(
                request=request,
        ...
        *,
        ...
        async with self._state_manager.transactionally(
            ...
            async with self._state_manager.writer(
                ...
                await self._maybe_authorize(
                    method_name=
                    'rbt.thirdparty.mailgun.v1.Message.SendTask',
                    headers=context._headers,
                    auth=context.auth,
                    state=state,
                    request=request,
...
class _MessageStub(reboot.aio.stubs.Stub):
    ...
    __service_name__ = reboot.aio.types.ServiceName('rbt.thirdparty.mailgun.v1.MessageInterface')
    ...
    def __init__(
        ...
        *,
        ...
        self._stub = rbt.thirdparty.mailgun.v1.mailgun_pb2_grpc.MessageInterfaceStub(channel)
...
class MessageAuthorizer(
    ...
    async def authorize(
        ...
        *,
        ...
        if method_name == 'rbt.thirdparty.mailgun.v1.Message.Send':
            return await self.Send(
                context,
                typing.cast(rbt.thirdparty.mailgun.v1.mailgun_pb2.SendRequest, request),
            )
        elif method_name == 'rbt.thirdparty.mailgun.v1.Message.SendTask':
...
class Message:
    ...
    class WeakReference(typing.Generic[Message_ScheduleTypeVar]):
        ...
        def reactively(self):
            return Message.WeakReference._Reactively(
                service_name=reboot.aio.types.ServiceName('rbt.thirdparty.mailgun.v1.MessageInterface'),
                state_ref=self._state_ref,
                bearer_token=self._bearer_token,
            )
                ...
                *,
                ...
                if isinstance(__context__, reboot.aio.contexts.TransactionContext):
                    return reboot.aio.tasks.TaskEffect(
                        service_name=reboot.aio.types.ServiceName(
                            'rbt.thirdparty.mailgun.v1.MessageInterface'
                        ),
    ...
    class _Construct:
        ...
        @typing.overload
        def idempotently(self) -> Message._ConstructIdempotently:
            ...

        @typing.overload
        def idempotently(self, alias: str) -> Message._ConstructIdempotently:
            ...
    ...
    def construct(
        ...
        *,
        ...
        return Message._Construct(_state_id=id)
