...
class _SortedMapStub(reboot.aio.stubs.Stub):
    ...
    __service_name__ = reboot.aio.types.ServiceName('rbt.std.collections.v1.SortedMapInterface')
    ...
    class WeakReference(typing.Generic[SortedMap_ScheduleTypeVar]):
        ...
        def reactively(self):
            return SortedMap.WeakReference._Reactively(
                service_name=reboot.aio.types.ServiceName('rbt.std.collections.v1.SortedMapInterface'),
                state_ref=self._state_ref,
                bearer_token=self._bearer_token,
            )
