...
class ApplicationServicerMiddleware(reboot.aio.internals.middleware.Middleware):
    ...
    def add_to_server(self, server: grpc.aio.Server) -> None:
        rbt.cloud.v1alpha1.application.application_pb2_grpc.add_ApplicationInterfaceServicer_to_server(
            self, server
        )
    ...
    async def react_mutate(
        ...
        if method == 'Create':
            ...
            while True:
                ...
                stub = rbt.cloud.v1alpha1.application.application_pb2_grpc.ApplicationInterfaceStub(
        ...
        async with self._state_manager.transactionally(
            ...
            async with self._state_manager.writer(
                ...
                await self._maybe_authorize(
                    method_name=
                    'rbt.cloud.v1alpha1.application.Application.Create',
    ...
    async def Create(
        ...
        if authoritative_consensus != self.consensus_id:
            ...
            stub = rbt.cloud.v1alpha1.application.application_pb2_grpc.ApplicationInterfaceStub(channel)
            call = stub.Create(
                request=request,
        ...
        *,
        ...
        async with self._state_manager.transactionally(
            ...
            async with self._state_manager.writer(
                ...
                await self._maybe_authorize(
                    method_name=
                    'rbt.cloud.v1alpha1.application.Application.Up',
                    headers=context._headers,
                    auth=context.auth,
                    state=state,
                    request=request,
        ...
        *,
        ...
        async with self._state_manager.transactionally(
            ...
            async with self._state_manager.writer(
                ...
                await self._maybe_authorize(
                    method_name=
                    'rbt.cloud.v1alpha1.application.Application.UpTask',
                    headers=context._headers,
                    auth=context.auth,
                    state=state,
                    request=request,
        ...
        *,
        ...
        async with self._state_manager.transactionally(
            ...
            async with self._state_manager.writer(
                ...
                await self._maybe_authorize(
                    method_name=
                    'rbt.cloud.v1alpha1.application.Application.Down',
                    headers=context._headers,
                    auth=context.auth,
                    state=state,
                    request=request,
        ...
        *,
        ...
        async with self._state_manager.transactionally(
            ...
            async with self._state_manager.writer(
                ...
                await self._maybe_authorize(
                    method_name=
                    'rbt.cloud.v1alpha1.application.Application.DownTask',
                    headers=context._headers,
                    auth=context.auth,
                    state=state,
                    request=request,
...
class _ApplicationStub(reboot.aio.stubs.Stub):
    ...
    __service_name__ = reboot.aio.types.ServiceName('rbt.cloud.v1alpha1.application.ApplicationInterface')
    ...
    def __init__(
        ...
        *,
        ...
        self._stub = rbt.cloud.v1alpha1.application.application_pb2_grpc.ApplicationInterfaceStub(channel)
...
class ApplicationAuthorizer(
    ...
    async def authorize(
        ...
        *,
        ...
        if method_name == 'rbt.cloud.v1alpha1.application.Application.Create':
            return await self.Create(
                context,
                typing.cast(rbt.cloud.v1alpha1.application.application_pb2.CreateRequest, request),
            )
        elif method_name == 'rbt.cloud.v1alpha1.application.Application.Up':
        ...
        elif method_name == 'rbt.cloud.v1alpha1.application.Application.UpTask':
            return await self.UpTask(
                context,
                typing.cast(rbt.cloud.v1alpha1.application.application_pb2.Application, state),
                typing.cast(rbt.cloud.v1alpha1.application.application_pb2.UpRequest, request),
            )
        elif method_name == 'rbt.cloud.v1alpha1.application.Application.Down':
            return await self.Down(
                context,
                typing.cast(rbt.cloud.v1alpha1.application.application_pb2.Application, state),
                typing.cast(rbt.cloud.v1alpha1.application.application_pb2.DownRequest, request),
            )
        elif method_name == 'rbt.cloud.v1alpha1.application.Application.DownTask':
...
class Application:
    ...
    Interface: typing.TypeAlias = ApplicationServicer
    ...
    UpEffects: typing.TypeAlias = Interface.UpEffects
    ...
    UpTaskEffects: typing.TypeAlias = Interface.UpTaskEffects
    ...
    DownEffects: typing.TypeAlias = Interface.DownEffects
    ...
    DownTaskEffects: typing.TypeAlias = Interface.DownTaskEffects
    ...
    class WeakReference(typing.Generic[Application_ScheduleTypeVar]):
        ...
        def reactively(self):
            return Application.WeakReference._Reactively(
                service_name=reboot.aio.types.ServiceName('rbt.cloud.v1alpha1.application.ApplicationInterface'),
                state_ref=self._state_ref,
                bearer_token=self._bearer_token,
            )
                ...
                *,
                ...
                if isinstance(__context__, reboot.aio.contexts.TransactionContext):
                    return reboot.aio.tasks.TaskEffect(
                        service_name=reboot.aio.types.ServiceName(
                            'rbt.cloud.v1alpha1.application.ApplicationInterface'
                        ),
    ...
    class _Construct:
        ...
        @typing.overload
        def idempotently(self) -> Application._ConstructIdempotently:
            ...

        @typing.overload
        def idempotently(self, alias: str) -> Application._ConstructIdempotently:
            ...
    ...
    def construct(
        ...
        *,
        ...
        return Application._Construct(_state_id=id)
