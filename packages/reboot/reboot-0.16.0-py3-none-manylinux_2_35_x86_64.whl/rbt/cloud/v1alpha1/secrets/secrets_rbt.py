...
class SecretServicerMiddleware(reboot.aio.internals.middleware.Middleware):
    ...
    def add_to_server(self, server: grpc.aio.Server) -> None:
        rbt.cloud.v1alpha1.secrets.secrets_pb2_grpc.add_SecretInterfaceServicer_to_server(
            self, server
        )
                ...
                async with self._state_manager.reactively(
                    ...
                    async for (state, idempotency_keys) in states:
                        ...
                        await self._maybe_authorize(
                            method_name=
                            'rbt.cloud.v1alpha1.secrets.Secret.Read',
                            headers=headers,
                            auth=context.auth,
                            state=state,
                            request=request,
    ...
    async def react_mutate(
        ...
        if method == 'Write':
            ...
            while True:
                ...
                stub = rbt.cloud.v1alpha1.secrets.secrets_pb2_grpc.SecretInterfaceStub(
        ...
        *,
        ...
        async with self._state_manager.transactionally(
            ...
            async with self._state_manager.writer(
                ...
                await self._maybe_authorize(
                    method_name=
                    'rbt.cloud.v1alpha1.secrets.Secret.Write',
    ...
    async def Write(
        ...
        if authoritative_consensus != self.consensus_id:
            ...
            stub = rbt.cloud.v1alpha1.secrets.secrets_pb2_grpc.SecretInterfaceStub(channel)
            call = stub.Write(
                request=request,
        ...
        *,
        ...
        async with self._state_manager.transactionally(
            ...
            async with self._state_manager.writer(
                ...
                await self._maybe_authorize(
                    method_name=
                    'rbt.cloud.v1alpha1.secrets.Secret.WriteTask',
                    headers=context._headers,
                    auth=context.auth,
                    state=state,
                    request=request,
        ...
        *,
        ...
        async with self._state_manager.transactionally(
            ...
            async with self._state_manager.writer(
                ...
                await self._maybe_authorize(
                    method_name=
                    'rbt.cloud.v1alpha1.secrets.Secret.Delete',
                    headers=context._headers,
                    auth=context.auth,
                    state=state,
                    request=request,
        ...
        *,
        ...
        async with self._state_manager.transactionally(
            ...
            async with self._state_manager.writer(
                ...
                await self._maybe_authorize(
                    method_name=
                    'rbt.cloud.v1alpha1.secrets.Secret.DeleteTask',
                    headers=context._headers,
                    auth=context.auth,
                    state=state,
                    request=request,
...
class _SecretStub(reboot.aio.stubs.Stub):
    ...
    __service_name__ = reboot.aio.types.ServiceName('rbt.cloud.v1alpha1.secrets.SecretInterface')
    ...
    def __init__(
        ...
        *,
        ...
        self._stub = rbt.cloud.v1alpha1.secrets.secrets_pb2_grpc.SecretInterfaceStub(channel)
...
class SecretAuthorizer(
    ...
    async def authorize(
        ...
        *,
        ...
        if method_name == 'rbt.cloud.v1alpha1.secrets.Secret.Write':
        ...
        elif method_name == 'rbt.cloud.v1alpha1.secrets.Secret.WriteTask':
            return await self.WriteTask(
                context,
                typing.cast(rbt.cloud.v1alpha1.secrets.secrets_pb2.Secret, state),
                typing.cast(rbt.cloud.v1alpha1.secrets.secrets_pb2.WriteRequest, request),
            )
        elif method_name == 'rbt.cloud.v1alpha1.secrets.Secret.Read':
            return await self.Read(
                context,
                typing.cast(rbt.cloud.v1alpha1.secrets.secrets_pb2.Secret, state),
                typing.cast(google.protobuf.empty_pb2.Empty, request),
            )
        elif method_name == 'rbt.cloud.v1alpha1.secrets.Secret.Delete':
            return await self.Delete(
                context,
                typing.cast(rbt.cloud.v1alpha1.secrets.secrets_pb2.Secret, state),
                typing.cast(google.protobuf.empty_pb2.Empty, request),
            )
        elif method_name == 'rbt.cloud.v1alpha1.secrets.Secret.DeleteTask':
...
class Secret:
    ...
    class WeakReference(typing.Generic[Secret_ScheduleTypeVar]):
        ...
        def reactively(self):
            return Secret.WeakReference._Reactively(
                service_name=reboot.aio.types.ServiceName('rbt.cloud.v1alpha1.secrets.SecretInterface'),
                state_ref=self._state_ref,
                bearer_token=self._bearer_token,
            )
                ...
                *,
                ...
                if isinstance(__context__, reboot.aio.contexts.TransactionContext):
                    return reboot.aio.tasks.TaskEffect(
                        service_name=reboot.aio.types.ServiceName(
                            'rbt.cloud.v1alpha1.secrets.SecretInterface'
                        ),
    ...
    class _Construct:
        ...
        @typing.overload
        def idempotently(self) -> Secret._ConstructIdempotently:
            ...

        @typing.overload
        def idempotently(self, alias: str) -> Secret._ConstructIdempotently:
            ...
    ...
    def construct(
        ...
        *,
        ...
        return Secret._Construct(_state_id=id)
