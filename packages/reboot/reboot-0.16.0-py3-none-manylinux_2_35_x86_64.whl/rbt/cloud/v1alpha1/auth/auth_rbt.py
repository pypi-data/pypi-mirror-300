...
class APIKeyServicer(reboot.aio.servicers.Servicer):
    ...
    class _Idempotently:
        ...
        async def write(
            self,
            context: reboot.aio.contexts.TransactionContext | reboot.aio.contexts.WorkflowContext,
            writer: APIKeyServicer.InlineWriterCallable,
    ...
    ) -> APIKeyServicer._Idempotently:
        return APIKeyServicer._Idempotently(
            servicer=self,
...
class APIKey:
    ...
    class _Construct:
        ...
        @typing.overload
        def idempotently(self) -> APIKey._ConstructIdempotently:
            ...

        @typing.overload
        def idempotently(self, alias: str) -> APIKey._ConstructIdempotently:
            ...
