...
class MemoizeServicerMiddleware(reboot.aio.internals.middleware.Middleware):
    ...
    def add_to_server(self, server: grpc.aio.Server) -> None:
        reboot.memoize.v1.memoize_pb2_grpc.add_MemoizeInterfaceServicer_to_server(
            self, server
        )
                ...
                async with self._state_manager.reactively(
                    ...
                    async for (state, idempotency_keys) in states:
                        ...
                        await self._maybe_authorize(
                            method_name=
                            'reboot.memoize.v1.Memoize.Status',
                            headers=headers,
                            auth=context.auth,
                            state=state,
                            request=request,
    ...
    async def react_mutate(
        ...
        if method == 'Reset':
            ...
            while True:
                ...
                stub = reboot.memoize.v1.memoize_pb2_grpc.MemoizeInterfaceStub(
        ...
        *,
        ...
        async with self._state_manager.transactionally(
            ...
            async with self._state_manager.writer(
                ...
                await self._maybe_authorize(
                    method_name=
                    'reboot.memoize.v1.Memoize.Reset',
    ...
    async def Reset(
        ...
        if authoritative_consensus != self.consensus_id:
            ...
            stub = reboot.memoize.v1.memoize_pb2_grpc.MemoizeInterfaceStub(channel)
            call = stub.Reset(
                request=request,
        ...
        *,
        ...
        async with self._state_manager.transactionally(
            ...
            async with self._state_manager.writer(
                ...
                await self._maybe_authorize(
                    method_name=
                    'reboot.memoize.v1.Memoize.Start',
                    headers=context._headers,
                    auth=context.auth,
                    state=state,
                    request=request,
        ...
        *,
        ...
        async with self._state_manager.transactionally(
            ...
            async with self._state_manager.writer(
                ...
                await self._maybe_authorize(
                    method_name=
                    'reboot.memoize.v1.Memoize.Store',
                    headers=context._headers,
                    auth=context.auth,
                    state=state,
                    request=request,
        ...
        *,
        ...
        async with self._state_manager.transactionally(
            ...
            async with self._state_manager.writer(
                ...
                await self._maybe_authorize(
                    method_name=
                    'reboot.memoize.v1.Memoize.Fail',
                    headers=context._headers,
                    auth=context.auth,
                    state=state,
                    request=request,
...
class _MemoizeStub(reboot.aio.stubs.Stub):
    ...
    __service_name__ = reboot.aio.types.ServiceName('reboot.memoize.v1.MemoizeInterface')
    ...
    def __init__(
        ...
        *,
        ...
        self._stub = reboot.memoize.v1.memoize_pb2_grpc.MemoizeInterfaceStub(channel)
...
class MemoizeAuthorizer(
    ...
    async def authorize(
        ...
        *,
        ...
        if method_name == 'reboot.memoize.v1.Memoize.Reset':
...
class MemoizeServicer(reboot.aio.servicers.Servicer):
    ...
    async def write(
        self,
        context: reboot.aio.contexts.TransactionContext | reboot.aio.contexts.WorkflowContext,
        ...
        assert_type(context, [reboot.aio.contexts.TransactionContext, reboot.aio.contexts.WorkflowContext])
    ...
    def idempotently(
        ...
        *,
        ...
        return MemoizeServicer._Idempotently(
            servicer=self,
            idempotency=reboot.aio.idempotency.Idempotency(key=key, alias=alias),
        )
...
class Memoize:
    ...
    FailEffects: typing.TypeAlias = Interface.FailEffects
    ...
    class WeakReference(typing.Generic[Memoize_ScheduleTypeVar]):
        ...
        def reactively(self):
            return Memoize.WeakReference._Reactively(
                service_name=reboot.aio.types.ServiceName('reboot.memoize.v1.MemoizeInterface'),
                state_ref=self._state_ref,
                bearer_token=self._bearer_token,
            )
            ...
            async def Reset(
                ...
                if isinstance(__context__, reboot.aio.contexts.TransactionContext):
                    return reboot.aio.tasks.TaskEffect(
                        service_name=reboot.aio.types.ServiceName(
                            'reboot.memoize.v1.MemoizeInterface'
                        ),
        ...
        def idempotently(
            ...
            *,
            ...
            return Memoize._ConstructIdempotently(
                _idempotency=reboot.aio.idempotency.Idempotency(alias=alias, key=key),
...
class MemoizeServicerNodeAdaptor(Memoize.Interface):
    ...
    async def _read(self, context: reboot.aio.contexts.WorkflowContext) -> str:
        ...
        with reboot.aio.internals.contextvars.use_application_id(context.application_id):
    ...
    async def _write(
        self,
        context: reboot.aio.contexts.TransactionContext | reboot.aio.contexts.WorkflowContext,
        writer: typing.Callable[[reboot.aio.contexts.WriterContext, str], typing.Awaitable[str]],
        json_options: str,
    ):
        # TODO: we need to set the `application_id` context variable
        # when getting called from nodejs as it won't be set. Is there
