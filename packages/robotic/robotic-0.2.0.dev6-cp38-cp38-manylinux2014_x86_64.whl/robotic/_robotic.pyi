...
import typing
from . import test
__all__ = ['ArgWord', 'BotOp', 'CameraView', 'CameraViewSensor', 'Ceres', 'Config', 'ConfigurationViewer', 'ControlMode', 'FS', 'Frame', 'Ipopt', 'JT', 'KOMO', 'KOMO_Objective', 'LBFGS', 'LGP_Tool', 'Logic2KOMO_Translator', 'NLP', 'NLP_Factory', 'NLP_Sampler', 'NLP_Solver', 'NLP_SolverID', 'NLP_SolverOptions', 'NLopt', 'OT', 'OptBench_Skeleton_Handover', 'OptBench_Skeleton_Pick', 'OptBench_Skeleton_StackAndBalance', 'OptBenchmark_InvKin_Endeff', 'PathFinder', 'ST', 'SY', 'Simulation', 'SimulationEngine', 'Skeleton', 'SolverReturn', 'TAMP_Provider', 'XBall', 'above', 'aboveBox', 'acceleration', 'accumulatedCollisions', 'alignByInt', 'angularVel', 'augmentedLag', 'bounce', 'box', 'boxGraspX', 'boxGraspY', 'boxGraspZ', 'break', 'bullet', 'camera', 'capsule', 'compiled', 'contact', 'contactComplementary', 'contactConstraints', 'contactStick', 'cylinder', 'dampMotion', 'default_Logic2KOMO_Translator', 'default_TAMP_Provider', 'depthImage2PointCloud', 'distance', 'downUp', 'dynamic', 'dynamicOn', 'dynamicTrans', 'end', 'energy', 'eq', 'f', 'forceBalance', 'free', 'gazeAt', 'generic', 'gradientDescent', 'hingeX', 'hingeY', 'hingeZ', 'identical', 'ineq', 'ineqB', 'ineqP', 'inside', 'insideBox', 'jointLimits', 'jointState', 'kinematic', 'lift', 'logBarrier', 'magic', 'magicTrans', 'makeFree', 'marker', 'mesh', 'negDistance', 'newton', 'none', 'oppose', 'pairCollision_negScalar', 'pairCollision_normal', 'pairCollision_p1', 'pairCollision_p2', 'pairCollision_vector', 'params_add', 'params_clear', 'params_file', 'params_print', 'phiTransXY', 'physics', 'physx', 'pointCloud', 'pose', 'poseDiff', 'poseEq', 'poseRel', 'position', 'positionDiff', 'positionEq', 'positionRel', 'push', 'pushAndPlace', 'qItself', 'quad', 'quasiStatic', 'quasiStaticOn', 'quatBall', 'quaternion', 'quaternionDiff', 'quaternionRel', 'raiPath', 'relPosY', 'restingOn', 'rigid', 'rprop', 'scalarProductXX', 'scalarProductXY', 'scalarProductXZ', 'scalarProductYX', 'scalarProductYY', 'scalarProductYZ', 'scalarProductZZ', 'sdf', 'setRaiPath', 'singleSquaredPenalty', 'sos', 'sphere', 'spline', 'squaredPenalty', 'ssBox', 'ssBoxElip', 'ssCvx', 'ssCylinder', 'stable', 'stableOn', 'stableOnX', 'stableOnY', 'stablePose', 'stableRelPose', 'stableYPhi', 'stableZero', 'standingAbove', 'tau', 'test', 'topBoxGrasp', 'topBoxPlace', 'touch', 'touchBoxNormalX', 'touchBoxNormalY', 'touchBoxNormalZ', 'trans3', 'transAccelerations', 'transVelocities', 'transX', 'transXY', 'transXYPhi', 'transY', 'transYPhi', 'transZ', 'universal', 'vectorX', 'vectorXDiff', 'vectorXRel', 'vectorY', 'vectorYDiff', 'vectorYRel', 'vectorZ', 'vectorZDiff', 'vectorZRel', 'velocity']
class ArgWord:
    """
    [todo: replace by str]
...
class LGP_Tool:
    ...
    def getSolvedPlan(self) -> StringAA:
        ...
        """
    def get_fullMotionProblem(self, arg0: bool) -> KOMO:
        """
...
class PathFinder:
    ...
    def setExplicitCollisionPairs(self, collisionPairs: StringA) -> None:
        ...
        """
    def setProblem(self, Configuration: Config, starts: arr, goals: arr) -> None:
        ...
...
class SY:
    ...
    break: typing.ClassVar[SY]  # value = <SY.break: 17>
...
def setRaiPath(arg0: str) -> None:
    ...
    """
Ceres: NLP_SolverID  # value = <NLP_SolverID.Ceres: 10>
Ipopt: NLP_SolverID  # value = <NLP_SolverID.Ipopt: 9>
LBFGS: NLP_SolverID  # value = <NLP_SolverID.LBFGS: 2>
NLopt: NLP_SolverID  # value = <NLP_SolverID.NLopt: 8>
XBall: JT  # value = <JT.XBall: 15>
...
above: SY  # value = <SY.above: 1>
aboveBox: FS  # value = <FS.aboveBox: 33>
acceleration: ControlMode  # value = <ControlMode.acceleration: 3>
accumulatedCollisions: FS  # value = <FS.accumulatedCollisions: 27>
alignByInt: SY  # value = <SY.alignByInt: 31>
angularVel: FS  # value = <FS.angularVel: 26>
augmentedLag: NLP_SolverID  # value = <NLP_SolverID.augmentedLag: 4>
bounce: SY  # value = <SY.bounce: 22>
box: ST  # value = <ST.box: 0>
boxGraspX: SY  # value = <SY.boxGraspX: 38>
boxGraspY: SY  # value = <SY.boxGraspY: 39>
boxGraspZ: SY  # value = <SY.boxGraspZ: 40>
break: SY  # value = <SY.break: 17>
bullet: SimulationEngine  # value = <SimulationEngine.bullet: 2>
camera: ST  # value = <ST.camera: 12>
capsule: ST  # value = <ST.capsule: 2>
contact: SY  # value = <SY.contact: 19>
contactComplementary: SY  # value = <SY.contactComplementary: 21>
contactConstraints: FS  # value = <FS.contactConstraints: 42>
contactStick: SY  # value = <SY.contactStick: 20>
cylinder: ST  # value = <ST.cylinder: 4>
dampMotion: SY  # value = <SY.dampMotion: 29>
distance: FS  # value = <FS.distance: 29>
downUp: SY  # value = <SY.downUp: 16>
dynamic: SY  # value = <SY.dynamic: 11>
dynamicOn: SY  # value = <SY.dynamicOn: 12>
dynamicTrans: SY  # value = <SY.dynamicTrans: 13>
end: SY  # value = <SY.end: 46>
energy: FS  # value = <FS.energy: 43>
eq: OT  # value = <OT.eq: 4>
f: OT  # value = <OT.f: 1>
forceBalance: SY  # value = <SY.forceBalance: 33>
free: JT  # value = <JT.free: 16>
gazeAt: FS  # value = <FS.gazeAt: 25>
generic: JT  # value = <JT.generic: 17>
gradientDescent: NLP_SolverID  # value = <NLP_SolverID.gradientDescent: 0>
hingeX: JT  # value = <JT.hingeX: 1>
hingeY: JT  # value = <JT.hingeY: 2>
hingeZ: JT  # value = <JT.hingeZ: 3>
identical: SY  # value = <SY.identical: 30>
ineq: OT  # value = <OT.ineq: 3>
ineqB: OT  # value = <OT.ineqB: 5>
ineqP: OT  # value = <OT.ineqP: 6>
inside: SY  # value = <SY.inside: 2>
insideBox: FS  # value = <FS.insideBox: 34>
jointLimits: FS  # value = <FS.jointLimits: 28>
jointState: FS  # value = <FS.qItself: 31>
kinematic: SimulationEngine  # value = <SimulationEngine.kinematic: 3>
lift: SY  # value = <SY.lift: 41>
logBarrier: NLP_SolverID  # value = <NLP_SolverID.logBarrier: 6>
magic: SY  # value = <SY.magic: 24>
magicTrans: SY  # value = <SY.magicTrans: 25>
makeFree: SY  # value = <SY.makeFree: 32>
marker: ST  # value = <ST.marker: 5>
mesh: ST  # value = <ST.mesh: 3>
negDistance: FS  # value = <FS.distance: 29>
newton: NLP_SolverID  # value = <NLP_SolverID.newton: 3>
none: OT  # value = <OT.none: 0>
oppose: SY  # value = <SY.oppose: 3>
pairCollision_negScalar: FS  # value = <FS.pairCollision_negScalar: 35>
pairCollision_normal: FS  # value = <FS.pairCollision_normal: 37>
pairCollision_p1: FS  # value = <FS.pairCollision_p1: 38>
pairCollision_p2: FS  # value = <FS.pairCollision_p2: 39>
pairCollision_vector: FS  # value = <FS.pairCollision_vector: 36>
phiTransXY: JT  # value = <JT.phiTransXY: 14>
physics: FS  # value = <FS.physics: 41>
physx: SimulationEngine  # value = <SimulationEngine.physx: 1>
pointCloud: ST  # value = <ST.pointCloud: 6>
pose: FS  # value = <FS.pose: 6>
poseDiff: FS  # value = <FS.poseDiff: 7>
poseEq: SY  # value = <SY.poseEq: 5>
poseRel: FS  # value = <FS.poseRel: 8>
position: ControlMode  # value = <ControlMode.position: 1>
positionDiff: FS  # value = <FS.positionDiff: 1>
positionEq: SY  # value = <SY.positionEq: 6>
positionRel: FS  # value = <FS.positionRel: 2>
push: SY  # value = <SY.push: 23>
pushAndPlace: SY  # value = <SY.pushAndPlace: 26>
qItself: FS  # value = <FS.qItself: 31>
quad: ST  # value = <ST.quad: 11>
quasiStatic: SY  # value = <SY.quasiStatic: 14>
quasiStaticOn: SY  # value = <SY.quasiStaticOn: 15>
quatBall: JT  # value = <JT.quatBall: 13>
quaternion: FS  # value = <FS.quaternion: 3>
quaternionDiff: FS  # value = <FS.quaternionDiff: 4>
quaternionRel: FS  # value = <FS.quaternionRel: 5>
relPosY: SY  # value = <SY.relPosY: 34>
restingOn: SY  # value = <SY.restingOn: 4>
rigid: JT  # value = <JT.rigid: 12>
rprop: NLP_SolverID  # value = <NLP_SolverID.rprop: 1>
scalarProductXX: FS  # value = <FS.scalarProductXX: 18>
scalarProductXY: FS  # value = <FS.scalarProductXY: 19>
scalarProductXZ: FS  # value = <FS.scalarProductXZ: 20>
scalarProductYX: FS  # value = <FS.scalarProductYX: 21>
scalarProductYY: FS  # value = <FS.scalarProductYY: 22>
scalarProductYZ: FS  # value = <FS.scalarProductYZ: 23>
scalarProductZZ: FS  # value = <FS.scalarProductZZ: 24>
sdf: ST  # value = <ST.sdf: 13>
singleSquaredPenalty: NLP_SolverID  # value = <NLP_SolverID.singleSquaredPenalty: 7>
sos: OT  # value = <OT.sos: 2>
sphere: ST  # value = <ST.sphere: 1>
spline: ControlMode  # value = <ControlMode.spline: 5>
squaredPenalty: NLP_SolverID  # value = <NLP_SolverID.squaredPenalty: 5>
ssBox: ST  # value = <ST.ssBox: 8>
ssBoxElip: ST  # value = <ST.ssBoxElip: 10>
ssCvx: ST  # value = <ST.ssCvx: 7>
ssCylinder: ST  # value = <ST.ssCylinder: 9>
stable: SY  # value = <SY.stable: 9>
stableOn: SY  # value = <SY.stableOn: 10>
stableOnX: SY  # value = <SY.stableOnX: 43>
stableOnY: SY  # value = <SY.stableOnY: 44>
stablePose: SY  # value = <SY.stablePose: 8>
stableRelPose: SY  # value = <SY.stableRelPose: 7>
stableYPhi: SY  # value = <SY.stableYPhi: 42>
stableZero: SY  # value = <SY.stableZero: 18>
standingAbove: FS  # value = <FS.standingAbove: 40>
tau: JT  # value = <JT.tau: 18>
topBoxGrasp: SY  # value = <SY.topBoxGrasp: 27>
topBoxPlace: SY  # value = <SY.topBoxPlace: 28>
touch: SY  # value = <SY.touch: 0>
touchBoxNormalX: SY  # value = <SY.touchBoxNormalX: 35>
touchBoxNormalY: SY  # value = <SY.touchBoxNormalY: 36>
touchBoxNormalZ: SY  # value = <SY.touchBoxNormalZ: 37>
trans3: JT  # value = <JT.trans3: 8>
transAccelerations: FS  # value = <FS.transAccelerations: 44>
transVelocities: FS  # value = <FS.transVelocities: 45>
transX: JT  # value = <JT.transX: 4>
transXY: JT  # value = <JT.transXY: 7>
transXYPhi: JT  # value = <JT.transXYPhi: 9>
transY: JT  # value = <JT.transY: 5>
transYPhi: JT  # value = <JT.transYPhi: 10>
transZ: JT  # value = <JT.transZ: 6>
universal: JT  # value = <JT.universal: 11>
vectorX: FS  # value = <FS.vectorX: 9>
vectorXDiff: FS  # value = <FS.vectorXDiff: 10>
vectorXRel: FS  # value = <FS.vectorXRel: 11>
vectorY: FS  # value = <FS.vectorY: 12>
vectorYDiff: FS  # value = <FS.vectorYDiff: 13>
vectorYRel: FS  # value = <FS.vectorYRel: 14>
vectorZ: FS  # value = <FS.vectorZ: 15>
vectorZDiff: FS  # value = <FS.vectorZDiff: 16>
vectorZRel: FS  # value = <FS.vectorZRel: 17>
velocity: ControlMode  # value = <ControlMode.velocity: 2>
