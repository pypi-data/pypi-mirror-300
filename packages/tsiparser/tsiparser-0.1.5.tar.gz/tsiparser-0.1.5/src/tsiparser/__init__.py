...
def main(): 
    ...
    parser.add_argument("--progress", action='store_true', help="Show progress for each map.")
    parser.add_argument("--module", action='store_true', help="Show progress for each module of each map (use only with --progress).")
