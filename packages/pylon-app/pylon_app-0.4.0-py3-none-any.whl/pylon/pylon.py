...
def custom_message_handler(mode, context, message):
    if ('Failed to load vulkan' in message) or ('No Vulkan library available' in message) or ('Failed to create platform Vulkan instance' in message):
        print('\033[93mWarning: Vulkan driver issue detected. Switching to software backend.\033[0m')
