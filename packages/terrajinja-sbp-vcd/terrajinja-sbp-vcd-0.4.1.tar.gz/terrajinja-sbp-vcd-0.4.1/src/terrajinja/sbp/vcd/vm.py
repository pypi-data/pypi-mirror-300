...
class SbpVcdVmDefaultLifecycle:
    ignore_changes: list = field(default_factory=lambda: ['vapp_template_id', 'power_on', 'guest_properties', 'consolidate_disks_on_create'])
    ...
    def __init__(
        ...
        for vm in vms:
            ...
            new_vm = Vm(
                ...
                lifecycle=kwargs.get('lifecycle', SbpVcdVmDefaultLifecycle().settings),
