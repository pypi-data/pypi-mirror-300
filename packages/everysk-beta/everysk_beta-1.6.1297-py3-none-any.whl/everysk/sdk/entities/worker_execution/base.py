...
class InputParams(BaseDict):
    ...
    worker_type = ChoiceField(default=Undefined, choices=settings.WORKER_TEMPLATE_TYPES)
...
class WorkerExecution(BaseEntity):
    ...
    parallel_info = ParallelInfoField()
    status = ChoiceField(default=settings.WORKER_EXECUTION_STATUS_PREPARING, choices=settings.WORKER_EXECUTION_STATUS_LIST)
