...
class WorkflowExecution(BaseEntity):
    ...
    status = StrField(default=settings.WORKFLOW_EXECUTION_STATUS_OK, empty_is_none=True)
    run_status = StrField(default=settings.WORKFLOW_EXECUTION_STATUS_OK, empty_is_none=True)
