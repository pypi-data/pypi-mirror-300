...
class NeuralTrustClient:
    ...
    def generate_headers(self):
        return {
            ...
            "x_neuraltrust_sdk_name": "python",
            "x_neuraltrust_sdk_version": self._version,
            "x_neuraltrust_public_key": self._public_key,
        }

    def batch_post(self, **kwargs) -> httpx.Response:
        """Post the `kwargs` to the batch API endpoint for events"""

        log = logging.getLogger("neuraltrust")
