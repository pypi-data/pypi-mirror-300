...
LIST_BASED_EXAMPLE_OUTPUT = """{
    "question": 
"1) The airline has changed its CEO, which means many new regulations have been introduced.
2) From now on, all tickets will cost a maximum of $30.
3) Birds will now be allowed to board all flights normally.
4) On flights longer than 2 hours, a pizza menu or hamburger menu will be offered.
