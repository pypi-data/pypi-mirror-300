...
class _BaseModifierGenerator(_LLMBasedQuestionGenerator):
    ...
    @abstractmethod
    def _modify_question(self, question: QuestionSample, knowledge_base: KnowledgeBase, *args, **kwargs) -> QuestionSample:
        ...
