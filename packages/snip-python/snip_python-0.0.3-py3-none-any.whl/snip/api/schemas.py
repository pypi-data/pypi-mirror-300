"""
Module for interacting with schema-related API endpoints.

Provides functions to retrieve available schemas and specific schema details from a deployment.
"""
