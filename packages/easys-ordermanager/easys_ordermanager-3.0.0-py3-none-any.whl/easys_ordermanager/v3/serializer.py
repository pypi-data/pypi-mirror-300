...
class OrderLineSeoSerializer(serializers.Serializer):
    ...
    location_names = serializers.ListField(
        child=serializers.CharField(max_length=100, required=True), required=False, allow_empty=True,
    )
    ...
    topics = serializers.ListField(
        child=serializers.CharField(max_length=250, required=True), required=True, allow_empty=False,
    )
    ...
    regions = serializers.ListField(
        child=serializers.CharField(max_length=100, required=False, allow_blank=True), required=False,
    )
...
class OrderLineWebsiteSerializer(serializers.Serializer):
    ...
    """
    basic_template = serializers.ChoiceField(
        choices=WEBSITE_BASIC_TEMPLATE_CHOICES, allow_null=False, required=False)
