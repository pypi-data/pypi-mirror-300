...
[![PyPI - Downloads](https://static.pepy.tech/badge/boto3-stubs-full)](https://pepy.tech/project/boto3-stubs-full)

![boto3.typed](https://github.com/youtype/mypy_boto3_builder/raw/main/logo.png)

All-in-one type annotations for
[boto3 1.35.35](https://boto3.amazonaws.com/v1/documentation/api/1.35.35/index.html)
...
```bash
# uninstall boto3-stubs-full
python -m pip uninstall -y boto3-stubs-full
```
...
- Install `boto3-stubs-full` with services you use in your environment:
