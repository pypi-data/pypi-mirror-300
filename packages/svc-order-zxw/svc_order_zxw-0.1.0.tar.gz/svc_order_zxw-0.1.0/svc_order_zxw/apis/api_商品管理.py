...
@router.get("/applications/{application_id}", response_model=PYD_ApplicationResponse)
...
@router.get("/products/{product_id}", response_model=PYD_ProductResponse)
...
@router.get("/orders/{order_id}", response_model=PYD_OrderResponse)
...
@router.get("/payments/{payment_id}", response_model=PYD_PaymentResponse)
