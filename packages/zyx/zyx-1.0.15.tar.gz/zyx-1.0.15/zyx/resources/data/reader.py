...
def _read_single_file(
    ...
    # Add a check for markdown files based on file extension
    if mime_type == "application/octet-stream" and path.suffix == ".md":
    ...
    try:
        ...
        match mime_type:
            ...
            case "application/json":
                content = _read_json_content(path)
            case "text/markdown":
                content = _read_text(path)  # Use the same function as plain text
