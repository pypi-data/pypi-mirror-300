...
class SupportToolInput(BaseModel):
    internal_question: str = Field(
        ..., description="Question to ask the internal support team. This will be sent to our internal slack channel. Always start your message with <!channel> to notify the team."
    )
...
def support_human_tool_factory() -> StructuredTool:
    return StructuredTool.from_function(
        ...
        description=(
            ...
            "You can use this tool to ask the internal team to help you with a task, to answer a question that you don't know because the context you have is not enough, or to do something that you don't have ability, tell internal team about the user's request."
        ),
