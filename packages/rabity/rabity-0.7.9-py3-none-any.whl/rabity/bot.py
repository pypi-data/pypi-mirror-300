    ...
    def page(name, template = None, **kwargs):
        ...
        def create():
            ...
            if template is None:
                ...
                print(Fore.YELLOW + "[INFO]" + Fore.BLUE + f" Page Loaded " + Fore.YELLOW + template + Fore.BLUE + " directory" + Style.RESET_ALL)
        ...
        def decorator(func):
            ...
            def create():
                ...
                if first_time_panel is True:
                    ...
                    print(Fore.YELLOW + "[INFO]" + Fore.BLUE + f" Page loaded " + Fore.YELLOW + name + Fore.BLUE + " directory" + Style.RESET_ALL)
