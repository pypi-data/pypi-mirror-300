...
class ModelsApi(object):
    ...
    def models_id_predict_interaction_post(
        ...
        **kwargs
        ...
        Given two columns and an output column from the model, an interaction for a specified amount of bins will be calculated  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def models_id_predict_trendline_put(
        ...
        **kwargs
        ...
        Given an input column and an output column from the model, a trendline of a specified amount of bins will be calculated  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def models_id_validation_predictions_put(
        ...
        **kwargs
        ...
        """Return the predictions used to calculate the model's quality metric during training for given columns  # noqa: E501
