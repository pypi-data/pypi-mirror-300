...
class DatasetChunk(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, chunk_number, row_count, column_count, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, chunk_number, row_count, column_count, *args, **kwargs):  # noqa: E501
        """DatasetChunk - a model defined in OpenAPI
