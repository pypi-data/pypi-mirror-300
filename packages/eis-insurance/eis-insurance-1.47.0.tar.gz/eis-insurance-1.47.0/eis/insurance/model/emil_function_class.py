...
class EmilFunctionClass(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, name, slug, description, expression, created_at, updated_at, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, name, slug, description, expression, created_at, updated_at, *args, **kwargs):  # noqa: E501
        """EmilFunctionClass - a model defined in OpenAPI
