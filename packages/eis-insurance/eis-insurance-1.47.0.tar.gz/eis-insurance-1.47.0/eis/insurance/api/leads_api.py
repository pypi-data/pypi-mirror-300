...
class LeadsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.clone_lead_endpoint = _Endpoint(
            settings={
                'response_type': (CreateLeadResponseClass,),
                'auth': [
                    'bearer'
                ],
                'endpoint_path': '/insuranceservice/v1/leads/{code}/clone',
                'operation_id': 'clone_lead',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
    ...
    def clone_lead(
        ...
        **kwargs
        ...
        This endpoint clones the lead and updates account and status data.      It effectively initiates a new lead creation workflow, including the creation of an account, policy, and banking information.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.clone_lead(code, clone_lead_request_dto, async_req=True)
        >>> result = thread.get()

        Args:
            code (str): Unique identifier for the object.
            clone_lead_request_dto (CloneLeadRequestDto):
        ...
        kwargs['code'] = \
            code
        kwargs['clone_lead_request_dto'] = \
            clone_lead_request_dto
        return self.clone_lead_endpoint.call_with_http_info(**kwargs)
