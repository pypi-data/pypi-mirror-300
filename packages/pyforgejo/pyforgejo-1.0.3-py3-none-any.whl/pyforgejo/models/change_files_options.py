...
if TYPE_CHECKING:
    from ..models.change_file_operation import ChangeFileOperation
    from ..models.commit_date_options import CommitDateOptions
    from ..models.identity import Identity


T = TypeVar("T", bound="ChangeFilesOptions")
...
class ChangeFilesOptions:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for files_item_data in _files:
            files_item = ChangeFileOperation.from_dict(files_item_data)
        ...
        change_files_options.additional_properties = d
        return change_files_options
