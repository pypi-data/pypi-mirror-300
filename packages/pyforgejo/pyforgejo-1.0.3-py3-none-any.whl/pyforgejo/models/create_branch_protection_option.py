...
T = TypeVar("T", bound="CreateBranchProtectionOption")
...
class CreateBranchProtectionOption:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        create_branch_protection_option = cls(
        ...
        create_branch_protection_option.additional_properties = d
        return create_branch_protection_option
