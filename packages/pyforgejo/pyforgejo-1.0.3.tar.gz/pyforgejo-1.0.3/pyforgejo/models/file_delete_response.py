...
if TYPE_CHECKING:
    ...
    from ..models.file_delete_response_content import FileDeleteResponseContent
    from ..models.payload_commit_verification import PayloadCommitVerification


T = TypeVar("T", bound="FileDeleteResponse")
...
class FileDeleteResponse:
    ...
    Attributes:
        ...
        content (Union[Unset, FileDeleteResponseContent]):
    ...
    content: Union[Unset, "FileDeleteResponseContent"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_content, Unset):
            ...
            content = FileDeleteResponseContent.from_dict(_content)
        ...
        file_delete_response = cls(
            commit=commit,
            content=content,
            verification=verification,
        )

        file_delete_response.additional_properties = d
