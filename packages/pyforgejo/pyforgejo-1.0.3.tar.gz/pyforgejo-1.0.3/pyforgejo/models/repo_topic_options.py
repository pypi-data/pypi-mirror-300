...
T = TypeVar("T", bound="RepoTopicOptions")
...
class RepoTopicOptions:
    ...
    Attributes:
        topics (Union[Unset, List[str]]): list of topic names
    """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        repo_topic_options = cls(
            topics=topics,
        )

        repo_topic_options.additional_properties = d
        return repo_topic_options
