...
def _get_kwargs(
    ...
    repo: str,
    *,
    state: Union[Unset, IssueListIssuesState] = UNSET,
    labels: Union[Unset, str] = UNSET,
    q: Union[Unset, str] = UNSET,
    type: Union[Unset, IssueListIssuesType] = UNSET,
    ...
    mentioned_by: Union[Unset, str] = UNSET,
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        owner (str):
        repo (str):
        state (Union[Unset, IssueListIssuesState]):
        labels (Union[Unset, str]):
        q (Union[Unset, str]):
        type (Union[Unset, IssueListIssuesType]):
