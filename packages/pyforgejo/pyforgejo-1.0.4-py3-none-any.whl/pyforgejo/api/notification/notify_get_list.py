...
from ...models.notify_get_list_subject_type_item import NotifyGetListSubjectTypeItem
...
def _get_kwargs(
    *,
    ...
    subject_type: Union[Unset, List[NotifyGetListSubjectTypeItem]] = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        subject_type (Union[Unset, List[NotifyGetListSubjectTypeItem]]):
