...
def _get_kwargs(
    ...
    ref: str,
    *,
    sort: Union[Unset, RepoListStatusesByRefSort] = UNSET,
    state: Union[Unset, RepoListStatusesByRefState] = UNSET,
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        repo (str):
        ref (str):
        sort (Union[Unset, RepoListStatusesByRefSort]):
        state (Union[Unset, RepoListStatusesByRefState]):
