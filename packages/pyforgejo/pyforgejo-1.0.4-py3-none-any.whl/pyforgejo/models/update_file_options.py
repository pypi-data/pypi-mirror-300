...
T = TypeVar("T", bound="UpdateFileOptions")
...
class UpdateFileOptions:
    ...
    authenticated user will be used)
        ...
        Attributes:
            ...
            dates (Union[Unset, CommitDateOptions]): CommitDateOptions store dates for GIT_AUTHOR_DATE and
                GIT_COMMITTER_DATE
            from_path (Union[Unset, str]): from_path (optional) is the path of the original file which will be moved/renamed
                to the path in the URL
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        update_file_options.additional_properties = d
        return update_file_options
