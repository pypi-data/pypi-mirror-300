...
*MSPNextGenApi* | [**add_msp_tenant_nonotuse**](docs/MSPNextGenApi.md#add_msp_tenant_nonotuse) | **POST** /v0/msp/tenants | Add Tenant to MSP Portal (API token)
