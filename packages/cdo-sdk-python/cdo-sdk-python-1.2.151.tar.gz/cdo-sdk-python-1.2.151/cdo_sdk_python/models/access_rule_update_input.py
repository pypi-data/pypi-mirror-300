...
class AccessRuleUpdateInput(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["uid", "index", "ruleAction", "protocol", "sourcePort", "destinationPort", "sourceNetwork", "destinationNetwork", "sourceDynamicObject", "destinationDynamicObject", "logSettings", "ruleTimeRange", "remark", "isActiveRule"]
