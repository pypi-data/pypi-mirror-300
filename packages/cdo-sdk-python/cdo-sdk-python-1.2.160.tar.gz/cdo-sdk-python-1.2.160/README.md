...
*MSPNextGenApi* | [**add_active_directory_groups_to_tenant_in_msp_portal_nonotuse**](docs/MSPNextGenApi.md#add_active_directory_groups_to_tenant_in_msp_portal_nonotuse) | **POST** /v1/msp/tenants/{tenantUid}/users/groups | Add Active Directory Groups to CDO tenant in MSP Portal
*MSPNextGenApi* | [**add_msp_tenant_nonotuse**](docs/MSPNextGenApi.md#add_msp_tenant_nonotuse) | **POST** /v1/msp/tenants | Add Tenant to MSP Portal (API token)
*MSPNextGenApi* | [**add_tenant_to_msp_portal_nonotuse**](docs/MSPNextGenApi.md#add_tenant_to_msp_portal_nonotuse) | **POST** /v1/msp/tenants/{tenantUid} | Add tenant to MSP Portal
*MSPNextGenApi* | [**add_users_to_tenant_in_msp_portal_nonotuse**](docs/MSPNextGenApi.md#add_users_to_tenant_in_msp_portal_nonotuse) | **POST** /v1/msp/tenants/{tenantUid}/users | Add users to CDO tenant in MSP Portal
*MSPNextGenApi* | [**create_tenant_nonotuse**](docs/MSPNextGenApi.md#create_tenant_nonotuse) | **POST** /v1/msp/tenants/create | Create CDO Tenant
*MSPNextGenApi* | [**enable_multicloud_defense_for_tenant_in_msp_portal_nonotuse**](docs/MSPNextGenApi.md#enable_multicloud_defense_for_tenant_in_msp_portal_nonotuse) | **POST** /v1/msp/tenants/{tenantUid}/mcd | Enable Multicloud Defense for CDO tenant in MSP Portal
*MSPNextGenApi* | [**generate_api_token_for_user_in_tenant**](docs/MSPNextGenApi.md#generate_api_token_for_user_in_tenant) | **POST** /v1/msp/tenants/{tenantUid}/users/{apiUserUid}/token | Generate token for API-only user on tenant managed by MSP portal
*MSPNextGenApi* | [**get_msp_managed_tenants_nonotuse**](docs/MSPNextGenApi.md#get_msp_managed_tenants_nonotuse) | **GET** /v1/msp/tenants | Get CDO tenants managed by MSP Portal
*MSPNextGenApi* | [**provision_cd_fmc_for_tenant_in_msp_portal_nonotuse**](docs/MSPNextGenApi.md#provision_cd_fmc_for_tenant_in_msp_portal_nonotuse) | **POST** /v1/msp/tenants/{tenantUid}/cdfmc | Provision cdFMC for CDO tenant in MSP Portal
...
*TransactionApi* | [**get_transaction**](docs/TransactionApi.md#get_transaction) | **GET** /v1/transactions/{transactionUid} | Get Transaction
